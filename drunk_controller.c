...
void func_2() // Position - 0xE3
{
	...
	if (Global_45217 > num || Global_45217 == -1)
	{
		...
		{
			num6 = Global_45221 - Global_45220;
			Global_45220 = Global_45220 + (num6 * 0.1f);
		...
		if (!unk_0x7F2356076C3D052D() && !func_8(unk_0x259BE71D8A81D4FA()))
			unk_0xD5681045964A2975("DRUNK_SHAKE", Global_45220 * num3 * num5);
		...
		if (unk_0x1DD05E817C89C737() % 100 == 0)
		{
			...
			else
			{
				...
				unk_0xB3CAD109683148E3(Global_45220 * num3 * num5);
				unk_0x9B669C0440D2AB57(Global_45219 * num3 * num5);
				fLocal_26 = num3;
			}
		}
	
		if (Global_45219 * num3 * num5 < 1f)
			unk_0xC30B691CAD767629(Global_45219 * num3 * num5);
		else
			unk_0xC30B691CAD767629(1f);
	
		if (!unk_0x0E9A1CE27A31950D())
			unk_0xE31C735DEE2BF705("DRUNK_SHAKE", Global_45220 * Global_45214 * num3 * num5);
	
		unk_0xAD0E20104A60B568(Global_45220 * Global_45214 * num3 * num5);
	
		if (unk_0x78411E34CF90EA8C(Global_45216))
			if (unk_0xDD87838D03B64B0A(Global_45216))
				unk_0x17F06E9D89A05855(Global_45216, Global_45220 * num3 * num5);
		...
		if (Global_45223 > 0f)
		{
			...
			else
			{
				...
				num7 = Global_45217 - num;
			
				if (num7 <= Global_45218 / 2 && Global_45217 != -1)
				{
					flag = false;
