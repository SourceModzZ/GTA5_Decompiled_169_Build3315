		...
		if (num > 0)
		{
			...
			if (!unk_0x4FAFF4BCB7633475(unk2))
			{
				...
				if (!unk_0x1C2F771CDC87A3A5(Global_113000, 0))
					if (unk_0xCECDBB848D53DEB2(unk2, Global_113000, 0))
						unk_0x23EB5FC236231892(unk2, Global_113000, 64);
			}
...
void func_13(int iParam0) // Position - 0xF91
{
	...
	else if (IS_BIT_SET(Global_113969.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_15() /*5570*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_113969.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_15() /*5570*/].f_681.f_10), iParam0);
	}
	...
	if (func_227())
	{
		...
		switch (iLocal_949)
		{
			case 0:
				if (!unk_0x4FAFF4BCB7633475(Global_113001) && unk_0xD9F5E1FEFD1329E4(Global_113000, 0))
					if (unk_0xF4244288C3EF3306(Global_113001, Global_113000))
						if (!unk_0x13CCB1AD131C1082(Global_113001, &uLocal_952, "leanover_enter", 3) && !unk_0x13CCB1AD131C1082(Global_113001, &uLocal_952, "leanover_idle", 3))
...
void func_80() // Position - 0x37CD
{
	...
	switch (iLocal_951)
	{
		...
		case 2:
			if (func_125(&uLocal_41, &Global_113007, &Global_113013))
			{
				func_158();
				iLocal_951 = 3;
			}
		...
		case 6:
			...
			if (iLocal_823 != -1)
			{
				...
				if (flag2)
					unk_0x77A5275126602303(Global_92301[iLocal_823 /*34*/].f_13, 0, 0);
			}
		...
		case 7:
			...
			if (flag)
			{
				...
				{
					bLocal_67 = false;
					unk_0xB1EAADCB692D69CE(Global_113007 + { 100f, 0f, 0f }, &num, 0, 0);
				
					if (num > Global_113007.f_2)
						Global_113007.f_2 = num + 0.5f;
				}
...
void func_82() // Position - 0x3E48
{
	...
	switch (iLocal_824)
	{
		case 92:
			num = { func_84(229, 0) };
			value = unk_0xED977E2AE2CB16EE(Global_113007, num, 1);
		
			if (value < 100f)
			{
				num = { func_83(Global_113007 - num) };
				num = { Global_113007 + (num * (float)100 - SYSTEM::ROUND(value)), Global_113007.f_1 + (num.f_1 * (float)100 - SYSTEM::ROUND(value)), Global_113007.f_2 };
				unk_0x813ADF2A2A03F440(num, &Global_113007, &Global_113013, 1, 1077936128, 0);
				unk_0xB2BD5837A8D3CEDA(Global_113000, Global_113007, 1, 0, 0, 1);
				unk_0x5C96CEA06531AB03(Global_113000, Global_113013);
			}
			break;
...
void func_112(int iParam0) // Position - 0x5F23
{
	...
	while (!flag && num2 < 10)
	{
		...
		if (func_113(&num, vector, iParam0))
		{
			...
			if (unk_0x8B777C12D64DF209(Global_113007, num2, &vector, 1, 1077936128, 0))
				num2 = num2 + 1;
		}
	}

	if (SYSTEM::VDIST2(vector, Global_113007) > 2f)
		unk_0xC0EEE6A2207F3CB8(vector, 0, &Global_113007, 0);
...
void func_117() // Position - 0x6154
{
	...
	num = func_120(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), Global_113007);
...
void func_121() // Position - 0x62D6
{
	...
	value = (func_120(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), Global_113007) / 50f) * fLocal_73 * 2.4f;
...
void func_122() // Position - 0x633E
{
	...
	if (iLocal_101 != iLocal_102)
	{
		...
		unk_0xE6B753D52F4CA222();
		fLocal_83 = SYSTEM::VDIST(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), Global_113007);
...
void func_123() // Position - 0x63DC
{
	...
	if (!func_39(14))
	{
		unk = unk_0x1287CC087A5CE000(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), Global_113007);
	...
	if (unk_0xC450B06E5AAA0985(*uParam0))
	{
		switch (iLocal_948)
		{
			case 0:
				...
				if (unk_0xC450B06E5AAA0985(Global_113005) && *uParam0 == Global_113005)
				{
			...
			case 2:
				...
				{
					if (func_126(&Global_113000, unk_0xD1A6A821F5AC81DB(Global_113000, 0), uLocal_960, fParam1, uParam2, &iLocal_88, uParam0, 1000))
					{
						iLocal_948 = 3;
						return false;
					}
...
BOOL func_153(int iParam0) // Position - 0xBF14
{
	...
	return unk_0xC450B06E5AAA0985(Global_33328[num /*23*/].f_19);
}
...
int func_157(var uParam0, var uParam1, var uParam2) // Position - 0xC1A4
{
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (Global_98446[i /*17*/])
		{
			if (Global_98446[i /*17*/].f_9 != 263)
			{
				if (unk_0xC450B06E5AAA0985(Global_33328[Global_98446[i /*17*/].f_9 /*23*/].f_19))
				{
					vector = { unk_0x3CF9D442F2C902BD(Global_33328[Global_98446[i /*17*/].f_9 /*23*/].f_19) };
	...
	if (unk_0xDC469CE2BE7CE722(func_6()))
	{
		...
		if (num > 0)
		{
			if (num > 1)
			{
				...
				if (!unk_0x4FAFF4BCB7633475(unk2))
				{
					if (!unk_0xF4244288C3EF3306(unk2, Global_113000))
					{
						num2 = 0;
					
						if (!unk_0xC39AE5D390581AD5(Global_113000, num2, 0))
						{
							num2 = func_160(&Global_113000);
						
							if (unk_0xC39AE5D390581AD5(Global_113000, num2, 0))
							{
								unk_0x974022927CB47E68(unk2);
								unk_0x73CAFD2038E812B3(unk2, Global_113000, num2);
							}
						}
						else
						{
...
void func_170() // Position - 0xC643
{
	...
	if (!unk_0x4FAFF4BCB7633475(Global_113001) && unk_0xD9F5E1FEFD1329E4(Global_113000, 0))
	{
		if (unk_0xF4244288C3EF3306(Global_113001, Global_113000))
		{
			...
			{
				unk = { unk_0xD1A6A821F5AC81DB(Global_113000, 1) };
				unk4 = unk_0xCFC0C995455A6204(Global_113000);
				unk_0x2D864CC37DDFA963(Global_113001, Global_113000, unk, unk4, 3, 60f, 0);
			}
		}
	}
		...
		if (bLocal_61)
		{
			...
			if (unk_0xD9F5E1FEFD1329E4(Global_113000, 0))
			{
				if (!unk_0x4FAFF4BCB7633475(Global_113001))
				{
					...
					else if (unk_0x13CCB1AD131C1082(Global_113001, &uLocal_952, "leanover_enter", 3) || unk_0x13CCB1AD131C1082(Global_113001, &uLocal_952, "leanover_idle", 3))
					{
						if (unk_0x9E437CA2E2CAD79D(Global_113001, unk_0x4A8C381C258A124D()))
							unk_0x84B06A81C98DA4B8(Global_113001);
					
						unk_0x10425721983AE158(Global_113001, &uLocal_952, "leanover_exit", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					else if (unk_0x13CCB1AD131C1082(Global_113001, &uLocal_952, "leanover_exit", 3))
					{
						unk_0x458AA1A01F53901E(Global_113001, &uLocal_952, "leanover_exit", 1.2f);
					...
					else if (!func_2(Global_113001, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")))
					{
						...
						else
						{
							...
							unk_0x6C33493626F3C0D1(0, Global_113000, Global_113007, num2, num, 45f);
							unk_0x2D864CC37DDFA963(0, Global_113000, Global_113007, Global_113013, iLocal_110, 60f, 1);
							unk_0x93C0674FC00824D0(uLocal_813);
							unk_0x4BD42B0527065BB6(Global_113001, uLocal_813);
...
BOOL func_172(var uParam0, int iParam1) // Position - 0xC91A
{
	...
	if (!unk_0x4FAFF4BCB7633475(num3))
	{
		...
		flag = true;
		num2 = unk_0xFD5C5BBD1FE92BB7(Global_113000, num4, 0);
		...
		if (flag)
		{
			unk_0xEBA229B2E0BB05E0(num3, Global_113000, 20000, num4, 2f, 9437185, 0, 0);
			flag2 = true;
		}
	}
...
{
	if (unk_0x65FFA94B82A71741(Global_113000, Global_113007, 45f, 45f, 20f, 0, 1, 0) || iLocal_56 || iLocal_949 == 4)
	{
		iLocal_56 = 1;
...
BOOL func_174() // Position - 0xCAF8
{
	if (bLocal_60)
	{
		...
		else if (func_125(&uLocal_41, &Global_113007, &Global_113013))
		{
			iLocal_103 = 0;
			uLocal_972 = { unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0) };
			fLocal_83 = SYSTEM::VDIST(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), Global_113007);
...
BOOL func_177() // Position - 0xCD38
{
	...
	if (unk_0xFC8BFE4B41177C22(Global_113000))
	{
		if (unk_0xD9F5E1FEFD1329E4(Global_113000, 0))
		{
			uLocal_109 = unk_0x4E55EAB577C13329(iLocal_108, unk_0xD1A6A821F5AC81DB(Global_113000, 1), 1, 1, 0);
			unk_0x4D306DD94DD6FDBA(uLocal_109, Global_113000, unk_0x365DC1E8054AF31A(Global_113000, "Chassis"), uLocal_984, uLocal_987, 0, 0, 0, 0, 2, 1, 0);
...
void func_179() // Position - 0xCE2C
{
	...
	if (!unk_0x78411E34CF90EA8C(uLocal_68))
	{
		if (!func_187() && !func_186(8, -1))
		{
			...
			unk_0x03F10D56CCA2C055(uLocal_68, Global_113000, uLocal_978, 1);
			func_183();
...
void func_183() // Position - 0xD025
{
	if (unk_0x78411E34CF90EA8C(uLocal_68))
	{
		func_184(Global_113000, &uLocal_68, uLocal_981);
...
void func_184(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD064
{
	...
	if (!unk_0x1C2F771CDC87A3A5(iParam0, 0))
	{
		if (unk_0x78411E34CF90EA8C(*uParam1))
		{
			...
			unk6 = unk.f_1;
			unk7 = { func_83(unk_0x0D1381B6E0F3987D(Global_113000, uParam2) - unk_0x0D1381B6E0F3987D(Global_113000, uLocal_978)) };
...
int func_191(var uParam0) // Position - 0xDE18
{
	int i;
	int num;
	int num2;
...
BOOL func_195(var uParam0) // Position - 0xE703
{
...
BOOL func_196(var uParam0) // Position - 0xE749
{
	int num;
...
void func_198(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0xEBCF
{
	int i;
	int num;
...
BOOL func_202(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEDAF
{
...
float func_203(var uParam0) // Position - 0xEDCC
{
	Vector3 vector;
...
BOOL func_209(var uParam0) // Position - 0xEFDC
{
	float num;
			...
			if (iLocal_949 == 2)
			{
				...
				if (!bLocal_64)
				{
					if (unk_0x875A214D5EBCA509(2, 179))
					{
						...
						if (!unk_0x4FAFF4BCB7633475(Global_113001))
							if (!unk_0x13CCB1AD131C1082(Global_113001, &uLocal_952, "leanover_enter", 3))
								if (!unk_0x13CCB1AD131C1082(Global_113001, &uLocal_952, "leanover_idle", 3))
									if (!unk_0x13CCB1AD131C1082(Global_113001, &uLocal_952, "leanover_exit", 3))
										unk_0x974022927CB47E68(Global_113001);
					}
				}
...
BOOL func_228(var uParam0) // Position - 0xF9D4
{
...
BOOL func_229(int iParam0) // Position - 0xF9EF
{
	...
	if (iLocal_949 != 4)
	{
		...
		unk = { unk_0xD1A6A821F5AC81DB(Global_113000, 0) };
...
BOOL func_231() // Position - 0xFB90
{
	...
	if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
	{
		...
		if (func_235(&unk, func_237(), func_236()))
		{
			...
			{
				uLocal_969 = { unk_0xD1A6A821F5AC81DB(Global_113000, 1) - unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1) };
				uLocal_969.f_2 = 0f;
...
void func_232() // Position - 0xFC74
{
	...
	if (unk_0xD9F5E1FEFD1329E4(Global_113000, 0))
	{
		if (!unk_0xC39AE5D390581AD5(Global_113000, 1, 0))
		{
			unk = unk_0xFD5C5BBD1FE92BB7(Global_113000, 1, 0);
		...
		if (!unk_0xC39AE5D390581AD5(Global_113000, 2, 0))
		{
			unk = unk_0xFD5C5BBD1FE92BB7(Global_113000, 2, 0);
			...
			if (!unk_0x4FAFF4BCB7633475(*uParam1))
			{
				if (unk_0xF4244288C3EF3306(*uParam1, *uParam0))
				{
					...
					if (bParam2)
					{
						...
						TEXT_LABEL_ASSIGN_STRING(&Global_113031, unk_0x1AF90EB93E0012D6(), 24);
					}
					else
					{
						...
						if (unk_0xD9F5E1FEFD1329E4(Global_113000, 0))
						{
							if (unk_0xF4244288C3EF3306(Global_113001, Global_113000))
							{
								if (unk_0x9B5C1660CCDF7189(Global_113001, joaat("SCRIPT_TASK_VEHICLE_DRIVE_WANDER")) != 1 && unk_0x9B5C1660CCDF7189(Global_113001, joaat("SCRIPT_TASK_VEHICLE_DRIVE_WANDER")) != 0)
								{
									...
									unk_0x4BD42B0527065BB6(Global_113001, unk);
...
BOOL func_235(var uParam0, int iParam1, int iParam2) // Position - 0x1009C
{
	var unk;
	int num;
...
void func_238(BOOL bParam0) // Position - 0x1014A
{
	...
	{
		if (unk_0x13CCB1AD131C1082(Global_113001, &uLocal_952, "leanover_enter", 3))
			unk_0x1D949F0AD44C7F05(Global_113001, "leanover_enter", &uLocal_952, -2f);
		else if (unk_0x13CCB1AD131C1082(Global_113001, &uLocal_952, "leanover_idle", 3))
			unk_0x1D949F0AD44C7F05(Global_113001, "leanover_idle", &uLocal_952, -2f);
		else if (unk_0x13CCB1AD131C1082(Global_113001, &uLocal_952, "leanover_exit", 3))
			unk_0x1D949F0AD44C7F05(Global_113001, "leanover_exit", &uLocal_952, -2f);
...
BOOL func_239(int iParam0) // Position - 0x103A8
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
		if (!unk_0x1C2F771CDC87A3A5(iParam0, 0))
			if (!unk_0x4FAFF4BCB7633475(iParam0))
