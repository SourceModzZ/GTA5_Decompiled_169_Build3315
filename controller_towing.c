...
void func_2(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x19A
{
	...
	*uParam3 = 500;
	...
	if (!unk_0x1C2F771CDC87A3A5(uParam1, 0))
	{
		...
		func_157(Global_113969.f_19976.f_3, &unk4, &unk8, &unk, &unk7);
...
void func_25(char* sParam0, int iParam1, int iParam2) // Position - 0x1056
{
	if (Global_101533 != 10 && Global_101533 != 9)
	{
		...
		func_27(&Global_104530, sParam0, 0, "Start", iParam1, iParam2);
		func_26();
		Global_95691 = 0;
	}
...
void func_68(var uParam0) // Position - 0x5AD0
{
	eCharacter character;
...
BOOL func_70(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x605B
{
	var unk;
	var unk2;
...
int func_79(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6CF3
{
	int i;
	float num;
	float num2;
...
int func_115() // Position - 0x9076
{
	...
	if (unk_0xA6E4F7A73ABC4A76("Towing"))
	{
		...
		if (num == 1)
		{
			...
			iLocal_51.f_2 = 1;
			iLocal_247 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS("Towing", &iLocal_51, 9, 62500);
			unk_0xFD49725F3FE7EE13("Towing");
...
BOOL func_133(int iParam0, int iParam1) // Position - 0x9A3D
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x9DB9
{
...
float func_144(var uParam0) // Position - 0x9E54
{
	if (func_149(uParam0))
		if (func_146(uParam0))
			return uParam0->f_2;
...
BOOL func_146(var uParam0) // Position - 0x9EE8
{
	return IS_BIT_SET(*uParam0, 2);
}

void func_147(var uParam0) // Position - 0x9EF5
{
	func_148(uParam0, 0f);
	return;
}

void func_148(var uParam0, float fParam1) // Position - 0x9F04
{
...
BOOL func_149(var uParam0) // Position - 0x9F2F
{
...
BOOL func_151(var uParam0) // Position - 0x9F5E
{
	var unk;
	int num;
...
void func_154(var uParam0, var uParam1) // Position - 0xA003
{
	if (!func_158(uParam0, false, true))
	{
		if (func_151(uParam1))
...
void func_155(var uParam0) // Position - 0xA109
{
	if (!func_149(uParam0))
		func_147(uParam0);
...
void func_156(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xA121
{
	float num;
	var unk;
	int num2;
	...
	switch (iLocal_73)
	{
		...
		case 2:
			...
			{
				if (!unk_0x7B780C491DEC834E(uLocal_256, fLocal_259) || func_22(Global_113969.f_19976.f_1, 1073741824))
				{
					if (!unk_0xFC8BFE4B41177C22(iLocal_273))
					{
