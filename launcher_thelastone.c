...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D7E
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A16
{
	int i;
	float num;
	float num2;
...
void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8E1F
{
...
BOOL func_136(var uParam0) // Position - 0xAD17
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAD37
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAE7B
{
	int i;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB01A
{
	if (bParam0)
	{
...
BOOL func_148(int iParam0) // Position - 0xB21B
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB23D
{
...
int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB28A
{
	int num;
...
BOOL func_154(var uParam0) // Position - 0xB307
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB43A
{
...
void func_161(var uParam0) // Position - 0xB491
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_179(var uParam0, int iParam1) // Position - 0xBC67
{
	int num;
	var unk;
	var unk33;
...
BOOL func_186(var uParam0) // Position - 0xC65D
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD021
{
...
float func_202(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD0BC
{
	var unk;
...
void func_203(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11) // Position - 0xD0F6
{
	float num;
	float num2;
	float num3;
...
void func_217(var uParam0) // Position - 0xDD83
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_220(var uParam0, var uParam1) // Position - 0xDFEC
{
	var unk;
...
BOOL func_223(var uParam0, int iParam1) // Position - 0xE30C
{
	float num;
...
BOOL func_224(var uParam0, int iParam1) // Position - 0xE382
{
	return func_225(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_225(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE39A
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_226(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE45B
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_227(var uParam0, int iParam1) // Position - 0xE587
{
	int num;
...
BOOL func_229(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE696
{
	var unk;
	var unk4;
	float num;
...
int func_233(var uParam0, var uParam1) // Position - 0xE7A2
{
	int i;
...
int func_234(var uParam0) // Position - 0xE7E1
{
...
BOOL func_235(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE809
{
	float num;
	float num2;
	int num3;
...
BOOL func_236(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE904
{
	float num;
	float num2;
...
BOOL func_237(var uParam0, float fParam1) // Position - 0xEA10
{
	var unk;
	var unk2;
...
BOOL func_238(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEAA5
{
	var unk;
	var unk4;
	float num;
...
BOOL func_239(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEB33
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_241(var uParam0) // Position - 0xEBC5
{
	var unk;
...
void func_251(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF01B
{
	func_252(uParam0);
...
void func_252(var uParam0) // Position - 0xF05E
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_272(var uParam0, BOOL bParam1) // Position - 0xF781
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_275(var uParam0) // Position - 0xF80B
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_278(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF896
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_279(var uParam0) // Position - 0xF8E6
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
