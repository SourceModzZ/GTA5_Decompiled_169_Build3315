					...
					switch (iLocal_27)
					{
						case 0:
							...
							else
							{
								...
								Global_33009[iLocal_41 /*11*/] = unk_0xC5935DFB3F39785A(0, 2);
						...
						case 2:
							...
							if (!func_65(iLocal_41))
							{
								...
								unk_0xECDF98280946398E(Global_33009[iLocal_41 /*11*/]);
							...
							else
							{
								...
								unk_0x7C7F282055FB517C(iLocal_42, func_42(iLocal_43), Global_33009[iLocal_41 /*11*/].f_9);
...
{
	if (iLocal_41 != -1)
		Global_33009[iLocal_41 /*11*/] = unk_0x6609A7E82612E0DF();
...
void func_56(var uParam0) // Position - 0x1F56
{
	func_57(uParam0, 0f);
	return;
}

void func_57(var uParam0, float fParam1) // Position - 0x1F65
{
