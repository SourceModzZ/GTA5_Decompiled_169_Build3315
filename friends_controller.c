...
void func_6(var uParam0) // Position - 0x721
{
	...
	func_22(Global_97247, uParam0->f_74, &unk42, &unk58);
...
void func_32(var uParam0, var uParam1) // Position - 0x1094
{
	...
	switch (uParam0->f_50)
	{
		...
		case 21:
			...
			if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0) || func_90(uParam0, uParam1, Global_97247, uParam0->f_51, 18, true))
				func_92(uParam0, 22);
			break;
...
int _CONTEXT_IS_HELP_TEXT_BEING_DISPLAYED(int iParam0, int iParam1) // Position - 0x2334
{
	int num;
	int num2;
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6) // Position - 0x24DC
{
	int i;
...
BOOL func_70(var uParam0, var uParam1, eCharacter echParam2, eCharacter echParam3, int iParam4, int iParam5) // Position - 0x2896
{
	...
	if (uParam0->f_52)
	{
		...
		{
			unk_0x0B0C9A0F9AAEB7F0(&(Global_113969.f_18106.f_410), iParam5);
			uParam0->f_52 = 0;
		}
	}
				...
				if (num6 != -1)
				{
					...
					if (num7 != 0)
						if (!func_363(num6) || func_351(num6) == 6)
							func_290(Global_97247, uParam1->f_1, 2, 0, num7, num6, -1);
				}
			}
...
BOOL func_103(var uParam0, var uParam1) // Position - 0x41E2
{
	...
	func_22(Global_97247, uParam1->f_1, &unk41, &unk57);
...
int func_109(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x480A
{
	...
	if (iParam5 == 0)
	{
		Global_79172[1 /*14*/] = { func_161(num8, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79172[1 /*14*/] = { func_161(num8, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79172[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79172[1 /*14*/] = { func_161(num8, 14, unk18[j], -1) };
							func_129(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
							func_152(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_119(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_119(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_119(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79172[1 /*14*/] = { func_161(num8, i, func_118(uParam0, i, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79172[1 /*14*/] = { func_161(num8, 14, unk59[j], -1) };
			func_129(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
			func_152(14);
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_119(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_119(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_119(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
...
BOOL func_110(var uParam0, int iParam1, var uParam2) // Position - 0x501B
{
	...
	{
		if (!func_225(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_64, Global_113969.f_2366.f_539[num /*65*/].f_63))
		{
...
BOOL func_117(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x5924
{
	...
	{
		if (!func_225(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_61, Global_113969.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
BOOL func_168(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x117E3
{
	int num;
	int num2;
	int num3;
...
void func_170(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x118F5
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_164(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_164(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_164(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_225(var uParam0, int iParam1, int iParam2) // Position - 0x22E36
{
	...
	num = unk_0x4B423FAA24E8ABF0(uParam0);
	Global_79172[1 /*14*/] = { func_161(num, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_225(uParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_225(uParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79172[2 /*14*/] = { func_161(num, 14, k, -1) };
								
									if (Global_79172[2 /*14*/].f_12 == j)
										if (func_225(uParam0, 14, k))
											if (!func_115(num, iParam2, 14, k, &unk, &Global_79172[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79172[2 /*14*/] = { func_161(num, i, num2, -1) };
					
						if (!func_115(num, iParam2, i, num2, &unk, &Global_79172[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79172[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_119(iParam1)) && Global_79172[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_119(iParam1)))
	{
		return true;
	}
...
void func_289(var uParam0, var uParam1, var uParam2) // Position - 0x261A1
{
	...
	if (!unk_0x4FAFF4BCB7633475(uParam1->f_2))
	{
		...
		func_237(uParam2, Global_97247, unk_0x4A8C381C258A124D(), false);
		func_237(uParam2, uParam1->f_1, uParam1->f_2, false);
...
void func_296(int iParam0) // Position - 0x26D96
{
	...
	else if (IS_BIT_SET(Global_113969.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_298() /*5570*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_113969.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_298() /*5570*/].f_681.f_10), iParam0);
	}
						...
						if (Global_9369[i] == 0)
						{
							...
							else if (num == 7)
							{
								if (Global_79389)
								{
									...
									func_333(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8807[num /*15*/].f_10), SYSTEM::TO_FLOAT(value), -1f, &Global_8807[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20930)
...
void func_333(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x28438
{
...
void func_334(int iParam0) // Position - 0x284EB
{
...
void func_336(var uParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x28520
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	unk_0x330108B080A2132F(SYSTEM::ROUND(fParam2));
...
BOOL func_343(var uParam0, eCharacter echParam1) // Position - 0x28A8A
{
	int num;
	int num2;
	...
	while (num < 35)
	{
		if (!unk_0xFF692AB7350A74D7(&Global_113969.f_14144[num /*104*/]))
			if (unk_0x1B79E937E91F40C3(&Global_113969.f_14144[num /*104*/], uParam0))
...
int func_352(int iParam0, var uParam1) // Position - 0x29026
{
	int num;
	BOOL flag;
	...
	if (num.f_6 != 144)
		if (Global_44594[num.f_6] > uParam1)
			return 3;

	if (Global_44593 > uParam1)
		return 2;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x291D1
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x2920E
{
...
int func_357(eCharacter echParam0) // Position - 0x29233
{
...
int func_359(int iParam0, var uParam1) // Position - 0x29291
{
	int num;
	BOOL flag;
...
int func_361(int iParam0, var uParam1) // Position - 0x2936C
{
	int num;
	BOOL flag;
...
int func_364(var uParam0) // Position - 0x29558
{
	var unk;
...
int func_365(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x295EB
{
	int i;
	float num;
	float num2;
	...
	for (i = 0; i <= 5 - 1; i = i + 1)
	{
		if (Global_96716[i /*9*/].f_7 != 263)
		{
			...
			{
				num = unk_0xED977E2AE2CB16EE(uParam0, Global_96716[i /*9*/].f_3, 1);
...
void func_368(var uParam0) // Position - 0x2973A
{
	if (func_63(uParam0))
	{
		if (!func_413(uParam0))
...
void func_374(int iParam0) // Position - 0x29BA3
{
	int num;
	int i;
	...
	{
		if (num < 0)
			if (!unk_0xFC8BFE4B41177C22(Global_101458[i]))
				num = i;
	}
...
void func_387(var uParam0) // Position - 0x29F1F
{
	eCharacter character;
	Vector3 vector;
	var unk3;
	...
	unk3 = Global_113969.f_2366.f_539.f_2310[character];
	unk4 = Global_113969.f_2366.f_539.f_2314[character];
	unk5 = { Global_113969.f_2366.f_539.f_2318[character /*3*/] };
	func_389(uParam0, false);

	if (!func_388(vector, 0f, 0f, 0f, false))
	{
		num = unk_0x1D5CD3EAAA7422B0(Global_113969.f_2366.f_539.f_2300[character /*3*/].f_2 - vector.f_2);
		num2 = SYSTEM::VDIST2(vector, Global_113969.f_2366.f_539.f_2300[character /*3*/]);
		num3 = SYSTEM::VMAG(Global_113969.f_2366.f_539.f_2318[character /*3*/]);
		flag = false;
		...
		if (flag)
		{
			...
			Global_113969.f_2366.f_539.f_2310[character] = unk3;
			Global_113969.f_2366.f_539.f_2314[character] = unk4;
			Global_113969.f_2366.f_539.f_2318[character /*3*/] = { unk5 };
		}
	}
...
void func_389(var uParam0, BOOL bParam1) // Position - 0x2A0E5
{
	func_402(uParam0);
...
void func_390(var uParam0) // Position - 0x2A119
{
	eCharacter character;
...
void func_391(var uParam0) // Position - 0x2A160
{
	eCharacter character;
...
void func_392(var uParam0) // Position - 0x2A19E
{
	eCharacter character;
...
void func_393(var uParam0) // Position - 0x2A32B
{
	eCharacter character;
...
void func_394(var uParam0) // Position - 0x2A367
{
	eCharacter character;
...
void func_395(var uParam0, BOOL bParam1) // Position - 0x2A3C4
{
	eCharacter character;
	var unk;
	int i;
	...
	if (func_407(character) && !unk_0x4FAFF4BCB7633475(uParam0))
	{
		if (uParam0 == unk_0x4A8C381C258A124D())
		{
			func_396(uParam0, &Global_113969.f_2366.f_539.f_298[character /*477*/]);
...
void func_396(var uParam0, var uParam1) // Position - 0x2A4B7
{
	int i;
	int j;
	int k;
...
void func_402(var uParam0) // Position - 0x2B9C2
{
	eCharacter character;
...
void func_405(var uParam0, int iParam1) // Position - 0x2BAC6
{
	if (uParam0->f_50 != 0)
	{
...
void func_410(var uParam0) // Position - 0x2BBB7
{
	if (func_63(uParam0))
	{
		if (func_413(uParam0))
...
void func_430(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2C249
{
	if (iParam0 < 9)
		if (bParam2)
			...
			unk_0x8744D2E3FC95740E(&(Global_113969.f_18106.f_175[iParam0 /*19*/].f_18), iParam1);
...
BOOL func_444(var uParam0, var uParam1, var uParam2) // Position - 0x2CED2
{
	var unk;
	float num;
	var unk4;
	...
	if (func_448())
		if (unk_0xED977E2AE2CB16EE(uParam0, Global_96814[0 /*18*/], 1) < 10f)
			return true;
		else
			func_447();
	...
	if (!func_446())
	{
		if (Global_98441 == 0)
		{
			if (unk_0x6009FBA2EAAA60BE(uParam0, 1, &unk, &num, &unk4, 4, 1077936128, 0))
			{
				...
				Global_96814[0 /*18*/] = { unk5 };
				Global_96814[0 /*18*/].f_3 = { unk26 - unk5 };
				Global_96814[0 /*18*/].f_6 = { unk29 - unk5 };
				Global_96814[0 /*18*/].f_9 = { 0f, 0f, 0f };
				Global_96814[0 /*18*/].f_12 = 0f;
				Global_96814[0 /*18*/].f_13 = { unk23 };
...
BOOL func_449(var uParam0) // Position - 0x2D1E2
{
...
BOOL func_450(var uParam0) // Position - 0x2D203
{
...
BOOL func_467(int iParam0) // Position - 0x2D7BA
{
	...
	if (!func_468(character))
	{
		...
		else
		{
			...
			if (num2 < 3)
				if (unk_0xFC8BFE4B41177C22(Global_97347[num2]))
					return false;
		}
	}
...
void func_482() // Position - 0x2E46E
{
	...
	for (j = 0; j < 3; j = j + 1)
	{
		if (!unk_0x4FAFF4BCB7633475(Global_97351[j]))
		{
