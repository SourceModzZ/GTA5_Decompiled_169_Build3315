	...
	while (true)
	{
		if (Global_113969.f_20413.f_145 > 0 || Global_112606)
		{
							...
							if (func_18(_GET_CURRENT_PLAYER_CHARACTER_0()))
							{
								if (IS_BIT_SET(Global_113969.f_20413[iLocal_35 /*16*/].f_11, _GET_CURRENT_PLAYER_CHARACTER()))
								{
									if (Global_113969.f_20413[iLocal_35 /*16*/].f_12 == Global_113969.f_20413.f_146[_GET_CURRENT_PLAYER_CHARACTER()])
									{
										...
										{
											if (unk_0x1DD05E817C89C737() > Global_113969.f_20413[iLocal_35 /*16*/].f_8)
											{
												if (unk_0x1B79E937E91F40C3(&(Global_113969.f_20413[iLocal_35 /*16*/].f_4), ""))
												{
			...
			else if (!func_4())
			{
				...
				if (unk_0x1DD05E817C89C737() - Global_112607 > 4000 || uLocal_18.f_16)
				{
					if (uLocal_18.f_14 != 0)
			...
			if (!unk_0x1B79E937E91F40C3(&Global_113969.f_20413[iLocal_35 /*16*/], &uLocal_18) && !unk_0x1B79E937E91F40C3(&Global_113969.f_20413[iLocal_35 /*16*/], ""))
			{
				if (Global_113969.f_20413[iLocal_35 /*16*/].f_10 != -1)
				{
					if (unk_0x1DD05E817C89C737() > Global_113969.f_20413[iLocal_35 /*16*/].f_10)
					{
...
BOOL func_4() // Position - 0x670
{
	...
	if (uLocal_18.f_9 != -1 && unk_0x1DD05E817C89C737() - Global_112607 > uLocal_18.f_9)
		return false;
