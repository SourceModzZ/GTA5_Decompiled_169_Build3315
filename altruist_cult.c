...
void func_65(int iParam0) // Position - 0x1D7D
{
	...
	if (func_93())
	{
		...
		func_70(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_69(Global_113958, true), 64);
...
void func_158() // Position - 0x613F
{
	...
	if (fLocal_181 >= 0f)
	{
		unk_0x3A15B21067339E98(Global_42738[10 /*31*/], fLocal_181, 0, 1);
	...
	if (fLocal_180 <= 0f)
	{
		unk_0x3A15B21067339E98(Global_42738[9 /*31*/], fLocal_180, 0, 1);
...
void func_165(int iParam0) // Position - 0x7446
{
	...
	else if (IS_BIT_SET(Global_113969.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_167() /*5570*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_113969.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_167() /*5570*/].f_681.f_10), iParam0);
	}
...
void func_168(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x76D0
{
	int num;
...
int func_169(int iParam0, int iParam1) // Position - 0x76FE
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x7747
{
	if (iParam2 == -1)
		iParam2 = func_27();
...
void func_182(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x7B7E
{
...
void func_197(var uParam0) // Position - 0x8DBD
{
	if (unk_0xA0C7B98BCF1EEF9E(*uParam0))
	{
		unk_0xD314260005F064BF(uParam0);
