	...
	if (bParam1)
	{
		if (!flag)
		{
			...
			switch (iParam2)
			{
				...
				case 6:
				case 7:
					unk_0x0B0C9A0F9AAEB7F0(&(Global_2359296[func_82() /*5570*/].f_681.f_1273), iParam0);
...
void func_141() // Position - 0x6AE1
{
	if (iLocal_58 != 3)
	{
		if (func_144())
		{
			...
			if (!unk_0x4FAFF4BCB7633475(uLocal_83))
			{
				if (unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), uLocal_91, 3f, 3f, 2f, 1, 1, 0) && unk_0x65FFA94B82A71741(uLocal_83, uLocal_91, Global_20, 0, 1, 0))
				{
	...
	else if (bLocal_110)
	{
		...
		if (!unk_0x4FAFF4BCB7633475(uLocal_83))
		{
			if (unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), 805.501f, 1269.9261f, 361.4025f, 25f, 30f, 2f, 0, 1, 0) || unk_0x65FFA94B82A71741(uLocal_83, 824.8886f, 1275.6705f, 359.4312f, Global_20, 1, 1, 0) && unk_0xFAA48325A90263BE(uLocal_83, unk_0x4A8C381C258A124D(), 8f, 8f, 8f, 0, 1, 0))
			{
				func_55();
				SYSTEM::WAIT(0);
...
{
	switch (func_202(&Global_33008, 0, 5, false, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return true;
...
{
	if (Global_113958 == func_46() && unk_0x9FA91AA1AC724CD0() && Global_113959)
		return true;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_248() || Global_32951 || func_247() || func_21(8, -1) || func_244() || func_246() || func_245() || func_243() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_248() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_21(8, -1) || func_243() || func_242() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
...
void func_257(int iParam0) // Position - 0xF06D
{
	...
	if (func_223())
	{
		...
		func_260(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_259(Global_113958, true), 64);
