...
void func_6() // Position - 0x1F6
{
	...
	if (unk_0xFC8BFE4B41177C22(unk))
		if (!func_124(unk, CHAR_FRANKLIN, 1))
	...
	while (unk_0xFD216000DC314A92() || !flag)
	{
		...
		if (!unk_0xFC8BFE4B41177C22(uLocal_28))
		{
			...
			if (unk_0xFC8BFE4B41177C22(unk))
				if (!func_124(unk, CHAR_FRANKLIN, 1) && !func_95(CHAR_FRANKLIN, 1, -1.3389f, 544.1759f, 172.7673f, -1f))
		...
		else
		{
			...
			if (unk_0x6252BC0DD8A320DB(num))
			{
				...
				*uParam0 = unk_0x5779387E956077A6(num, fParam2, fParam5, 1, 1, 0);
				...
				func_85(uParam0, &(num.f_31), &(num.f_81));
				unk_0x4DC7FAAC148F9B2F(*uParam0, num.f_96);
...
void func_9(eCharacter echParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x12D9
{
	...
	if (func_94(echParam0) && unk_0xFC8BFE4B41177C22(*uParam1) && unk_0xD9F5E1FEFD1329E4(*uParam1, 0))
	{
		...
		if (unk_0xA9DFDFED12311CA7(*uParam1) >= 0 && func_14(*uParam1, false, &unk))
		{
			...
			if (bParam3)
			{
				...
				func_10(Global_113969.f_2366.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_5, Global_113969.f_2366.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_7, num2, true, &(Global_113969.f_20121[echParam0 /*43*/].f_1));
				...
				func_10(Global_113969.f_2366.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_6, -1, num2, false, &(Global_113969.f_20121[echParam0 /*43*/].f_2));
			}
		}
	}
...
BOOL func_14(var uParam0, BOOL bParam1, var uParam2) // Position - 0x36C6
{
	...
	*uParam2 = 0;
	...
	if (!func_56(num, bParam1, uParam2) && !func_55(unk_0x259BE71D8A81D4FA()) && !func_28(uParam0))
		return false;
...
BOOL func_15(var uParam0) // Position - 0x3834
{
	int i;
...
BOOL func_20(int iParam0) // Position - 0x3E1F
{
...
BOOL func_21(var uParam0) // Position - 0x3E61
{
	switch (unk_0x4B423FAA24E8ABF0(uParam0))
	{
...
BOOL func_25(int iParam0) // Position - 0x3FFD
{
	BOOL flag;
...
BOOL func_28(var uParam0) // Position - 0x40D1
{
...
BOOL func_29(var uParam0) // Position - 0x4100
{
...
BOOL func_30(var uParam0) // Position - 0x4245
{
	int num;
...
BOOL func_31(int iParam0) // Position - 0x42C2
{
	switch (iParam0)
	{
		case joaat("mule"):
...
BOOL func_33(var uParam0, BOOL bParam1) // Position - 0x4357
{
	switch (unk_0x4B423FAA24E8ABF0(uParam0))
	{
...
int func_34(var uParam0) // Position - 0x43B2
{
	int i;
...
BOOL func_35(int iParam0, int iParam1) // Position - 0x43EB
{
	if (iParam1 == 0)
...
BOOL func_44(int iParam0, int iParam1) // Position - 0x48E6
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
BOOL func_45(var uParam0) // Position - 0x4CC5
{
	if (unk_0x259BE71D8A81D4FA() != _INVALID_PLAYER_INDEX())
	{
		...
		if (func_49(unk_0x259BE71D8A81D4FA(), true, false) && Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_268.f_35 > 0 || IS_BIT_SET(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_268.f_33, 14) || IS_BIT_SET(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_268.f_33, 11))
			return false;
			...
			if (unk_0xD130E7CDEE903624(uParam0, "Player_Vehicle"))
				if (unk_0xE2F6FE9B61232165(uParam0, "Player_Vehicle") == unk_0x3351FEF40EC734DB(unk_0x259BE71D8A81D4FA()))
					if (func_47() != -1 && func_47() < 517)
						if (!func_46(uParam0) || unk_0x4B423FAA24E8ABF0(uParam0) != Global_1586521[func_47() /*142*/].f_66)
							return true;
					else
						return true;
	}
...
BOOL func_46(var uParam0) // Position - 0x4DBE
{
...
BOOL func_56(int iParam0, BOOL bParam1, var uParam2) // Position - 0x4FBD
{
	BOOL flag;
...
BOOL func_57(int iParam0) // Position - 0x53B4
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_58(var uParam0, eCharacter echParam1) // Position - 0x53E9
{
	var unk;
	int i;
	int j;
	...
	func_59(uParam0, &(Global_113969.f_32753.f_5510));
	return;
}

void func_59(var uParam0, var uParam1) // Position - 0x55EB
{
	int i;
		...
		*uParam1 = unk_0x4F06416A18248EA0(uParam0);
		...
		for (i = 0; i <= 11; i = i + 1)
		{
			if (unk_0x5318DF85BEB6B95F(uParam0, i + 1))
				unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_60(i + 1));
		}
...
BOOL func_63(var uParam0) // Position - 0x5A17
{
	if (!unk_0xFC8BFE4B41177C22(uParam0) || !unk_0xD9F5E1FEFD1329E4(uParam0, 0) || func_80(uParam0, CHAR_MICHAEL, false) || func_80(uParam0, CHAR_FRANKLIN, false) || func_80(uParam0, CHAR_TREVOR, false) || func_79(uParam0) != _CHAR_NULL || func_78(uParam0) || func_77(uParam0) || func_15(uParam0) || func_76(uParam0) || !func_64(unk_0x4B423FAA24E8ABF0(uParam0)))
	{
		func_77(uParam0);
		func_77(uParam0);
		func_80(uParam0, CHAR_MICHAEL, false);
		func_80(uParam0, CHAR_FRANKLIN, false);
		func_80(uParam0, CHAR_TREVOR, false);
		func_79(uParam0) != _CHAR_NULL;
		return false;
	}
...
BOOL func_64(int iParam0) // Position - 0x5AF4
{
	if (iParam0 == 0)
		return false;

	if (!func_65(iParam0, false, -1))
		return false;
...
BOOL func_65(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5CB2
{
	int i;
	var unk;
...
BOOL func_66(int iParam0) // Position - 0x5E37
{
	int num;
	var unk;
	var unk2;
...
BOOL func_68(int iParam0, int iParam1) // Position - 0x5F1A
{
	int num;
	int num2;
...
BOOL func_76(var uParam0) // Position - 0x6283
{
	int num;
	var unk;
	...
	if (!func_65(num, false, -1))
		return true;

	return false;
}

BOOL func_77(var uParam0) // Position - 0x62CA
{
	int i;
...
BOOL func_78(var uParam0) // Position - 0x6346
{
	int i;
...
eCharacter func_79(var uParam0) // Position - 0x642E
{
	int i;
...
BOOL func_80(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x6491
{
	int i;
	var unk;
	int num;
	...
	for (i = 0; func_81(echParam1, i, &unk, &num); i = i + 1)
	{
...
void func_82(var uParam0, eCharacter echParam1) // Position - 0x65D8
{
	int i;
...
BOOL func_84(var uParam0) // Position - 0x6685
{
...
int func_85(var uParam0, var uParam1, var uParam2) // Position - 0x6694
{
	...
	for (i = 0; i < *uParam1; i = i + 1)
	{
		...
		else if (unk_0x94C9CD3D66808551(*uParam0, num) != uParam1->[i] - 1)
		{
			...
			if (uParam1->[i] > 0)
			{
				...
				else if (func_90(*uParam0, num, uParam1->[i] - 1))
				{
				}
				else
				{
	...
	if (func_44(unk_0x4B423FAA24E8ABF0(*uParam0), 1) && unk_0x94C9CD3D66808551(*uParam0, 24) != func_88(*uParam0, uParam1->[38] - 1))
		unk_0x8450270DC5896D39(*uParam0, 24, func_88(*uParam0, uParam1->[38] - 1), 0);
...
BOOL func_86(var uParam0) // Position - 0x686E
{
	int i;
	int num;
	int num2;
...
int func_88(var uParam0, int iParam1) // Position - 0x69A1
{
	int value;
	int value2;
	float num;
	...
	if (unk_0xFC8BFE4B41177C22(uParam0) && unk_0xD9F5E1FEFD1329E4(uParam0, 0))
	{
		...
		value = func_89(uParam0, 38) + 1;
		value2 = func_89(uParam0, 24) + 1;
...
int func_89(var uParam0, int iParam1) // Position - 0x6A8A
{
	int i;
	...
	for (i = unk_0x5B59C12A02157D00(uParam0, iParam1) - 1; i >= 0 && func_90(uParam0, iParam1, i); i = i - 1)
	{
	}
...
BOOL func_90(var uParam0, int iParam1, int iParam2) // Position - 0x6AEC
{
	if (!func_91() && unk_0xAF82FE1B3E949337(uParam0, iParam1, iParam2))
		return true;
		...
		for (i = 0; i < 9; i = i + 1)
		{
			if (unk_0xFC8BFE4B41177C22(Global_98844[i]) && unk_0xD9F5E1FEFD1329E4(Global_98844[i], 0))
				if (unk_0x4B423FAA24E8ABF0(Global_98844[i]) == num2 && Global_98854[i] == echParam0)
					if (fParam5 == -1f || unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(Global_98844[i], 0), fParam2, 1) <= fParam5)
						return true;
		}
	}
...
void func_97(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, float fParam12, float fParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x6EB0
{
	var unk;
	BOOL flag;
	BOOL flag2;
		...
		if (unk_0xD9F5E1FEFD1329E4(unk, 0))
		{
			...
			else
			{
				...
				if (unk7.f_2 > uParam0.f_2 && unk7.f_2 < uParam3.f_2 || unk7.f_2 > uParam3.f_2 && unk7.f_2 < uParam0.f_2)
					if (func_105(unk, uParam0, uParam3, fParam6))
						flag = true;
			}
			...
			if (bParam16)
				if (func_80(unk, _GET_CURRENT_PLAYER_CHARACTER(), true))
					flag = false;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x73F4
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x7431
{
...
int func_104(eCharacter echParam0) // Position - 0x7456
{
	return Global_2169[echParam0 /*29*/];
}

BOOL func_105(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x7465
{
	float num;
	var unk3;
	var unk6;
...
void func_108(var uParam0) // Position - 0x784E
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_111(int iParam0, float fParam1, var uParam2, var uParam3, int iParam4) // Position - 0x78FA
{
	var unk;
	float num;
...
void func_113(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4) // Position - 0x797B
{
	int i;
...
int func_123(eCharacter echParam0, int iParam1) // Position - 0x9475
{
	int num;
...
BOOL func_124(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x94B7
{
	int i;
		...
		if (unk_0xFC8BFE4B41177C22(Global_98844[i]))
			if (Global_98844[i] == uParam0)
				if (echParam1 == _CHAR_NULL || echParam1 == Global_98854[i])
					if (iParam2 == 0 || unk_0x4B423FAA24E8ABF0(uParam0) == func_123(echParam1, iParam2))
						return true;
	}
...
void func_127(int iParam0, var uParam1, int iParam2) // Position - 0x9640
{
	...
	for (i = 0; i < 12; i = i + 1)
	{
		...
		{
			if (func_209(num, func_211(i), func_210(iParam0, unk2.f_13[i], unk2[i], func_211(i)), &unk))
			{
				unk67 = { func_139(num, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = unk67.f_3;
				uParam1->[2] = unk67.f_4;
				num2 = 1;
			}
		
			if (func_137(num, func_211(i), func_210(iParam0, unk2.f_13[i], unk2[i], func_211(i)), &unk))
			{
				unk67 = { func_139(num, 1, uParam1->f_62, -1) };
	...
	for (i = 0; i < 9; i = i + 1)
	{
		...
		{
			if (func_209(num, 14, func_129(iParam0, unk2.f_39[i], unk2.f_49[i], i), &unk))
			{
				unk67 = { func_139(num, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = unk67.f_3;
				uParam1->[2] = unk67.f_4;
			...
			if (func_137(num, 14, func_129(iParam0, unk2.f_39[i], unk2.f_49[i], i), &unk))
			{
				unk67 = { func_139(num, 1, uParam1->f_62, -1) };
				uParam1->f_13[1] = unk67.f_3;
				uParam1->[1] = unk67.f_4;
	...
	if (num3 || num2)
	{
		num4 = func_210(iParam0, uParam1->f_13[1], uParam1->[1], 1);
		num5 = func_210(iParam0, uParam1->f_13[2], uParam1->[2], 2);
		num6 = func_128(num, num5, num4);
	
		if (num6 != -99)
		{
			unk67 = { func_139(num, 0, num6, -1) };
...
int func_129(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x9A0C
{
	...
	if (num2 != -1 && num2 != 0)
		if (num == joaat("MP_M_Freemode_01"))
			return func_131(unk_0x4B423FAA24E8ABF0(iParam0), num2, 14, 3);
		else if (num == joaat("MP_F_Freemode_01"))
			return func_131(unk_0x4B423FAA24E8ABF0(iParam0), num2, 14, 4);
	...
	for (i = 0; i <= num3 - 1; i = i + 1)
	{
		...
		else
		{
			for (j = 0; j <= num5 - 1; j = j + 1)
			{
				...
				{
					num4 = num4 + func_130(iParam0, iParam3);
					return num4;
				}
				else
				{
...
int func_131(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x9C46
{
	var unk;
	int i;
	int num;
	...
	else
	{
		...
		if (num3 != -1)
			return func_132(uParam0, func_133(iParam2)) + num3;
	}
...
BOOL func_137(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0xA29E
{
	int num;
...
var func_146(int iParam0, int iParam1) // Position - 0xC4EF
{
...
BOOL func_151(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xD7E2
{
	int num;
	int num2;
	int num3;
	...
	if (func_152(uParam0, iParam1, &num3, &num2, bParam2, bParam3))
	{
...
void func_154(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1049C
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_142(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_142(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_142(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_209(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x21ABC
{
	int num;
...
int func_210(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x21DC3
{
	int num;
	int num2;
	int num3;
...
void func_212(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x21ECA
{
	...
	if (!unk_0x4FAFF4BCB7633475(iParam0))
	{
		...
		for (i = 0; i < 12; i = i + 1)
		{
			func_216(iParam0, i, &uParam1->f_13[i], &uParam1->[i], &uParam1->f_26[i], iParam2, 145);
		}
	
		for (i = 0; i < 9; i = i + 1)
		{
			func_215(iParam0, i, &uParam1->f_39[i], &uParam1->f_49[i], iParam2, 145);
		}
...
var func_214(int iParam0, int iParam1) // Position - 0x22088
{
	return unk_0xD69CE161FE614531(2, iParam0, func_147(iParam1));
}

void func_215(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x2209D
{
	eCharacter character;
...
void func_216(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x225E6
{
	eCharacter character;
