...
BOOL func_4() // Position - 0x1B6
{
	...
	if (!func_3(&unk))
	{
		...
		else if (unk_0x5266F1D2AEF6F73A(Global_98843))
		{
			...
			if (!func_5(Global_101254, uLocal_73, 2))
				if (num >= 0.9f)
					unk_0x73CAFD2038E812B3(Global_101254, uLocal_73, 2);
...
void func_22() // Position - 0x6A5
{
	...
	while (!unk_0xFC8BFE4B41177C22(Global_101254) || !unk_0xFC8BFE4B41177C22(uLocal_73) || !unk_0x6252BC0DD8A320DB(iLocal_72) && num < 400)
	{
