...
void func_2(int iParam0, BOOL bParam1) // Position - 0x3AD
{
	...
	{
		if (bParam1)
			unk_0x0B0C9A0F9AAEB7F0(&(Global_113969.f_24998), num);
		else
			unk_0x8744D2E3FC95740E(&(Global_113969.f_24998), num);
	}
	else
	{
		num = num - 31;
		...
		if (bParam1)
			unk_0x0B0C9A0F9AAEB7F0(&(Global_113969.f_24998.f_1), num);
		else
			unk_0x8744D2E3FC95740E(&(Global_113969.f_24998.f_1), num);
	}
...
void func_24(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6674
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_13(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_13(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_13(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x1AE57
{
	...
	if (bParam1)
		unk_0x0B0C9A0F9AAEB7F0(&Global_113969.f_10052.f_135[num], unk);
	else
		unk_0x8744D2E3FC95740E(&Global_113969.f_10052.f_135[num], unk);
