...
BOOL func_1() // Position - 0x1D1
{
	...
	if (bLocal_2411.f_2861 != 0)
	{
		...
		else
		{
			...
			func_603(func_604(num), &unk, &unk2, &unk3, &unk4);
			unk_0xEDC9B904B870CE80(bLocal_2411.f_2861, unk, unk2, unk3, func_602(SYSTEM::CEIL(1.5f * (float)bLocal_2411.f_2862), 255));
...
void func_27(var uParam0) // Position - 0x1B72
{
...
void func_40(var uParam0) // Position - 0x1E52
{
	if (func_3(uParam0))
	{
		if (!func_7(uParam0))
...
void func_64(var uParam0, var uParam1) // Position - 0x3645
{
	if (uParam0->f_1)
	{
...
void func_65(var uParam0, var uParam1) // Position - 0x374C
{
	if (iLocal_49 == 0)
	{
		if (!unk_0x1C2F771CDC87A3A5(uParam0->f_358[0 /*189*/].f_9, 0))
...
void func_76(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0x4208
{
...
void func_81(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x4319
{
	...
	if (*uParam0 != 0)
	{
		...
		*uParam2 = 255;
		...
		func_603(func_604(num), &unk, &unk2, &unk3, uParam2);
...
void func_83(var uParam0) // Position - 0x4397
{
...
void func_89(var uParam0, float fParam1) // Position - 0x4790
{
	if (func_3(uParam0))
...
void func_90(var uParam0, var uParam1) // Position - 0x47B3
{
	...
	if (uParam1->f_6 != 0)
	{
		...
		func_603(func_604(num2), &unk, &unk2, &unk3, &unk4);
...
int func_91(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x487D
{
	float num;
	int num2;
	float num3;
...
int func_93(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x48F3
{
	var unk;
	var unk4;
	var unk7;
...
BOOL func_94(var uParam0, var uParam1, var uParam2) // Position - 0x5258
{
	float num;
	var unk;
...
BOOL func_97(var uParam0) // Position - 0x533B
{
	var unk;
	var unk4;
	var unk7;
...
BOOL func_99(var uParam0) // Position - 0x5505
{
	var unk;
	var unk4;
	var unk7;
...
int func_100(var uParam0, var uParam1) // Position - 0x5544
{
	var unk;
	var unk4;
	var unk7;
...
float func_102(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x5746
{
	if (unk_0x1C2F771CDC87A3A5(uParam0, 0))
		return -1f;
...
float func_107(var uParam0) // Position - 0x5F5B
{
	if (func_3(uParam0))
		if (func_7(uParam0))
			return uParam0->f_2;
...
void func_109(var uParam0, float fParam1, BOOL bParam2, float fParam3, int iParam4) // Position - 0x5FD0
{
	float num;
	BOOL flag;
	float num2;
...
void func_111(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6303
{
	int num;
	int num2;
	int i;
	...
	if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
	{
		...
		else if (uParam1->f_66 == joaat("casco"))
		{
			...
			{
				unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_134(num + 1));
			}
		}
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_134(num2 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			for (i = 1; i <= 9; i = i + 1)
			{
				...
				{
					unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_134(i));
				}
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			for (j = 1; j <= 6; j = j + 1)
			{
				...
				{
					unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_134(j));
				}
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			for (k = 1; k <= 11; k = k + 1)
			{
				if (k != 9 && k != 10)
				{
					...
					{
						unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_134(k));
					}
				}
			}
		}
		else if (uParam1->f_66 == -1035489563)
		{
			for (l = 1; l <= 2; l = l + 1)
			{
				...
				{
					unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_134(l));
				}
			}
		}
		...
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			for (m = 1; m <= 2; m = m + 1)
			{
				...
				{
					unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_134(m));
				}
			}
		}
		...
		if (IS_BIT_SET(uParam1->f_77, 15) || func_131(uParam0) || uParam1->f_62 == 0 && uParam1->f_63 == 0 && uParam1->f_64 == 0 && uParam1->f_9[20] > 0 && func_130())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
BOOL func_112(var uParam0, float fParam1) // Position - 0x6A08
{
	var unk;
	var unk4;
...
int func_120(var uParam0, var uParam1, var uParam2) // Position - 0x6BB3
{
	...
	for (i = 0; i < *uParam1; i = i + 1)
	{
		...
		else if (unk_0x94C9CD3D66808551(*uParam0, num) != uParam1->[i] - 1)
		{
			...
			if (uParam1->[i] > 0)
			{
				...
				else if (func_126(*uParam0, num, uParam1->[i] - 1))
				{
				}
				else
				{
	...
	if (func_125(unk_0x4B423FAA24E8ABF0(*uParam0), 1) && unk_0x94C9CD3D66808551(*uParam0, 24) != func_123(*uParam0, uParam1->[38] - 1))
...
BOOL func_121(var uParam0) // Position - 0x6D8D
{
	int i;
	int num;
	int num2;
...
int func_123(var uParam0, int iParam1) // Position - 0x6EC0
{
	int value;
	int value2;
	float num;
...
int func_124(var uParam0, int iParam1) // Position - 0x6FA9
{
	int i;
	...
	for (i = unk_0x5B59C12A02157D00(uParam0, iParam1) - 1; i >= 0 && func_126(uParam0, iParam1, i); i = i - 1)
	{
	}
...
BOOL func_125(int iParam0, int iParam1) // Position - 0x700B
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
BOOL func_126(var uParam0, int iParam1, int iParam2) // Position - 0x73EA
{
...
void func_128(var uParam0, var uParam1) // Position - 0x7417
{
	int num;
	int num2;
...
BOOL func_131(var uParam0) // Position - 0x74C0
{
	int num;
...
BOOL func_135(var uParam0) // Position - 0x762B
{
	if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
...
int func_136(var uParam0) // Position - 0x76B2
{
...
{
	if (func_139(iParam0, false))
		return Global_1887305[iParam0 /*610*/].f_10.f_182;

	return -1;
}

BOOL func_139(int iParam0, BOOL bParam1) // Position - 0x7721
{
	if (func_140(iParam0))
...
BOOL func_140(int iParam0) // Position - 0x7765
{
	int num;
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(var uParam0, int iParam1) // Position - 0x77B3
{
	var unk;
...
void func_144(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, BOOL bParam7) // Position - 0x7860
{
	var unk;
	float i;
	float num;
	...
	if ((float)SYSTEM::TIMERA() > 1500f * 0.2f)
	{
		...
		else if ((float)SYSTEM::TIMERB() > 1500f * 0.075f || unk_0x15CCE8886267624F())
		{
			...
			else if (iLocal_42 == 0)
			{
				...
				func_167(0, 2, true);
				func_159(true, true, true, 0, false, false, false);
				func_151(true);
...
void func_159(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x800A
{
	if (bParam0)
	{
...
BOOL func_163(int iParam0) // Position - 0x820B
{
...
int func_165(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8258
{
	int num;
...
void func_168(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x830C
{
	...
	if (!func_174(uParam0->f_1, 256) || func_174(uParam0->f_1, 8192) && unk_0x7811C74D5B749F76(2))
	{
		...
		num2 = bParam4 ? func_174(uParam0->f_1, 32) ? 1f : 0f : -1f;
...
void func_173(var uParam0) // Position - 0x8615
{
...
void func_176() // Position - 0x8659
{
	iLocal_41 = 0;
	iLocal_42 = 0;
	func_159(false, true, true, 0, false, false, false);
	func_151(true);
	return;
}
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x889F
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x88DC
{
...
int func_185(eCharacter echParam0) // Position - 0x8901
{
...
void func_189(var uParam0) // Position - 0x8EFA
{
	if (*uParam0 != 0)
	{
		unk_0xD314260005F064BF(uParam0);
...
void func_196(int iParam0) // Position - 0x9133
{
	if (iParam0 >= 4)
	{
		if (!unk_0xFC8BFE4B41177C22(uLocal_2058[0]) && !func_376(iLocal_2070, 1))
		{
...
BOOL func_205() // Position - 0x9948
{
	...
	{
		case 3:
			if (func_199(&iLocal_2052) && unk_0x266D9DB5FCE4003B(101, "SPRStuntAF"))
				return true;
			else
				return false;
			break;
		...
		case 2:
			if (func_199(&iLocal_2052) && unk_0xA08EEC7306CF6198("SPR_Fluff_01"))
				return true;
			else
				return false;
			break;
...
void func_212(var uParam0, char* sParam1, int iParam2) // Position - 0x9BBC
{
	char* str;
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x9C96
{
...
void func_214(var uParam0) // Position - 0x9CA9
{
	...
	if (uParam0->f_358[0 /*189*/].f_11 >= uParam0->f_12 - 2)
	{
		...
		if (!unk_0x5561E31B168FA823(uLocal_2302))
			if (SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), func_215()) <= num * 1.5f * num * 1.5f)
				uLocal_2302 = unk_0x4F6F8824BE43F1F7(func_215(), uParam0->f_27[uParam0->f_12 - 1 /*10*/] - func_215(), 2000f, 12, 127);
		else if (!(SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), func_215()) <= num * 2f * num * 2f))
			func_267();
	}
...
void func_220(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, int iParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x9F91
{
	char* str;
	...
	if (!unk_0xE37AC296E66C33AF())
	{
		if (func_236(uParam0, bParam6, bParam8, false))
			func_235(uParam0, uParam1, iParam5);
...
BOOL func_222(var uParam0) // Position - 0xA2D4
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
BOOL func_225(char* sParam0) // Position - 0xA404
{
...
BOOL func_226(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA49D
{
	...
	if (func_233() || func_232(*Global_4718592.f_185586) || func_231())
	{
		if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
		{
			...
			if (unk_0x333A2A6253C809D2(unk, num) || unk_0x4B423FAA24E8ABF0(unk) == joaat("apc") && num != -1 || unk_0x4B423FAA24E8ABF0(unk) == joaat("akula") && num != -1 || unk_0x4B423FAA24E8ABF0(unk) == joaat("riot2") && num == 0 && func_229(unk, 10) && unk_0x94C9CD3D66808551(unk, 10) != -1)
				return false;
		}
	}
...
BOOL func_229(var uParam0, int iParam1) // Position - 0xA765
{
	if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
	{
		if (unk_0x90E3EAFF8AAA1A42(uParam0) > 0)
...
int _GET_VEHICLE_SEAT_PED_IS_IN(var ped, int includeLastVehicle) // Position - 0xA7C7
{
	var unk;
	int num;
	int i;
...
void func_235(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xA88A
{
	int num;
	int num2;
	int num3;
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0xAE28
{
	...
	switch (iLocal_1988)
	{
		...
		case 4:
			if (bParam1)
			{
				...
				func_260(uLocal_2046, uLocal_2251);
			}
...
void func_255(var uParam0) // Position - 0xB3F4
{
	unk_0xD314260005F064BF(uParam0);
	*uParam0 = 0;
	return;
...
void func_260(var uParam0, float fParam1, var uParam2, var uParam3) // Position - 0xB613
{
	float num;
	float num2;
	var unk3;
	...
	if (bLocal_2250 && num3 > num2 || !bLocal_2250 && num3 < num2)
	{
		...
		num2 = func_261(num2, num3, fLocal_2247);
	}
	...
	if (bLocal_2249 && num2.f_2 - num4 < 0f || !bLocal_2249 && num2.f_2 - num4 > 0f)
	{
		...
		num2.f_2 = func_261(num2.f_2, num4, fLocal_2248);
	}
...
void func_264(var uParam0) // Position - 0xB89E
{
	var unk;
	var unk4;
	var unk7;
...
BOOL func_274(char* sParam0, int iParam1, int iParam2) // Position - 0xBB22
{
...
BOOL func_318(var uParam0) // Position - 0xCC56
{
	func_323();
	...
	switch (iLocal_2301)
	{
		...
		case 1:
			...
			{
				func_319(&uLocal_2296, true, 0, true, 3, true, 0, false);
				iLocal_2301 = 2;
			}
			break;
	
		case 2:
			if (func_319(&uLocal_2296, false, 0, true, 3, true, false, false))
				return false;
			break;
	}
...
void func_321(var uParam0, BOOL bParam1) // Position - 0xD020
{
	if (bParam1)
	...
	if (Global_79644 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !unk_0x15CCE8886267624F())
			{
				...
				unk = { func_327(Global_79645, Global_79647, iParam10) };
				num4 == -0.014f;
...
float func_326(var uParam0) // Position - 0xD3DA
{
...
BOOL func_338(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0xDC47
{
	...
	switch (Global_79644)
	{
		...
		case 5:
			if (unk_0xFD216000DC314A92() || func_157(0) || func_339(true))
			{
			}
			else
			{
...
int func_349(var uParam0, int iParam1, BOOL bParam2) // Position - 0xE25F
{
	...
	if (!func_355(&uParam0->f_27[iParam1 /*10*/], num, num2, iParam1, uParam0->f_12))
		return 0;
...
BOOL func_351(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0xE3FF
{
	int num;
	var unk;
	var unk2;
	...
	if (uParam3->f_7 == 2)
	{
		num = func_353(uParam3->f_7, uParam0, *uParam3, uParam4);
		func_603(func_604(func_92()), &unk, &unk2, &unk3, &unk4);
	...
	else if (uParam3->f_7 == 3)
	{
		...
		{
			func_603(func_604(18), &unk, &unk2, &unk3, &unk4);
			uParam3->f_6 = unk_0xDCC9FF4954D6DCB1(func_352(uParam3->f_7, uParam3->f_8), *uParam3, uParam4, fParam7, unk, unk2, unk3, func_91(*uParam3, 25, 200), 0);
		}
		else if (uParam3->f_8 == 1)
		{
			func_603(func_604(9), &unk, &unk2, &unk3, &unk4);
			uParam3->f_6 = unk_0xDCC9FF4954D6DCB1(func_352(uParam3->f_7, uParam3->f_8), *uParam3, uParam4, fParam7, unk, unk2, unk3, func_91(*uParam3, 25, 200), 0);
		}
	}
	else
	{
		uParam3->f_6 = unk_0xDCC9FF4954D6DCB1(func_352(uParam3->f_7, uParam3->f_8), *uParam3, uParam4, fParam7, 254, 207, 12, func_91(*uParam3, 25, 200), 0);
	}
...
BOOL func_355(var uParam0, int iParam1, float fParam2, int iParam3, int iParam4) // Position - 0xE76F
{
...
BOOL func_356(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, float fParam5, int iParam6, int iParam7, int iParam8) // Position - 0xE798
{
	func_83(uParam0);
...
void func_377(var uParam0) // Position - 0xED01
{
	if (!func_3(uParam0))
		func_11(uParam0);
...
void func_392(var uParam0) // Position - 0xF32A
{
	...
	for (i = 0; i < 5; i = i + 1)
	{
		if (i < 5)
		{
			...
			if (i == Global_112999)
			{
				func_281(&uParam0->f_420[num /*8*/], 1, true);
					...
					case 1:
						if (i < 5)
						{
							if (Global_113969.f_19046.f_6[i] <= 0f)
							{
								...
								func_408(&num4, 1);
								func_423("Shared", "NewStar_32", &num4, 0, 0, 5, 0);
				...
				if (iLocal_49.f_18[Global_112999] > 0f)
				{
					...
					unk_0x16EC7160BEBE7A6F(1);
					func_401(&uParam0->f_316[7 /*2*/], &(uParam0->f_741.f_198), SYSTEM::FLOOR(iLocal_49.f_18[Global_112999] * 1000f), 6, "", 0, 1);
					unk_0x16EC7160BEBE7A6F(0);
					func_410(&(uParam0->f_741.f_198));
					func_417(&(uParam0->f_741.f_198));
				}
			...
			else
			{
				...
				func_281(&uParam0->f_420[num /*8*/], 117, true);
				func_418(uParam0->f_420[num /*8*/], 0, 0);
				func_408(&uParam0->[num3 /*9*/], 1);
			...
			{
				func_423("Shared", "Locked_Icon_32", &uParam0->[num3 /*9*/], 0, 0, 5, 0);
			}
			else if ((float)uLocal_529[i] > 0f)
			{
				if ((float)uLocal_529[i] <= iLocal_49.f_106[i] && (float)uLocal_529[i] <= iLocal_49.f_112[i])
				{
					...
					func_423("Shared", "MedalDot_32", &uParam0->[num3 /*9*/], 0, 0, 5, 0);
				}
	...
	if (num6 < 40)
	{
		...
		func_423("Shared", "Info_Icon_32", &uParam0->[num3 /*9*/], 0, 0, 5, 0);
	...
	func_423("SPRRaces", &unk23, &uParam0->[7 /*9*/], 0, 0, 5, 0);
	...
	func_401(&uParam0->f_316[13 /*2*/], &(uParam0->f_741.f_198), SYSTEM::FLOOR(iLocal_49.f_112[Global_112999]) * 1000, 6, "", 1, 0);
	func_410(&(uParam0->f_741.f_198));
	func_418(uParam0->f_420[23 /*8*/], 0, 0);
	func_413(&(uParam0->f_741.f_198), &uParam0->f_420[23 /*8*/], 0, 0);
	func_401(&uParam0->f_316[14 /*2*/], &(uParam0->f_741.f_198), SYSTEM::FLOOR(((iLocal_49.f_112[Global_112999] - iLocal_49.f_106[Global_112999]) / 2f) + iLocal_49.f_106[Global_112999]) * 1000, 6, "", 1, 0);
	func_410(&(uParam0->f_741.f_198));
	func_418(uParam0->f_420[24 /*8*/], 0, 0);
	func_413(&(uParam0->f_741.f_198), &uParam0->f_420[24 /*8*/], 0, 0);
	func_401(&uParam0->f_316[15 /*2*/], &(uParam0->f_741.f_198), SYSTEM::FLOOR(iLocal_49.f_106[Global_112999]) * 1000, 6, "", 1, 0);
	func_410(&(uParam0->f_741.f_198));
	func_417(&(uParam0->f_741.f_198));
	return;
}
...
float func_393(var uParam0, char* sParam1, var uParam2, var uParam3, float fParam4, float fParam5, int iParam6, float fParam7) // Position - 0x1035B
{
	...
	uParam0->f_3 = func_285((SYSTEM::TO_FLOAT(value) * fParam4) - fParam5, num);
	uParam0->f_1 = func_285((fParam7 + ((SYSTEM::TO_FLOAT(iParam6) + (SYSTEM::TO_FLOAT(value) * 0.5f)) * fParam4)) - (fParam5 * 0.5f), num);
	return 0f;
}
...
void func_401(var uParam0, var uParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6) // Position - 0x104FC
{
	char* str;
...
var func_402(var uParam0) // Position - 0x10556
{
	return uParam0;
}

var func_403(var uParam0) // Position - 0x10560
{
	return uParam0;
}
...
void func_411(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x10692
{
	char* str;
...
void func_412(var uParam0, var uParam1, char* sParam2, int iParam3) // Position - 0x106D8
{
...
void func_416(var uParam0, var uParam1, char* sParam2, BOOL bParam3) // Position - 0x10770
{
	...
	func_411(uParam0, uParam1, sParam2, 0, 0);
	return;
}
...
void func_418(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, int iParam9) // Position - 0x1079D
{
	...
	if (func_404())
		if (iParam9 == 1)
			unk_0x81645EE95A114FAE(func_403(unk), func_402(unk.f_1), unk.f_2, unk.f_3, unk.f_4, unk.f_5, unk.f_6, unk.f_7, 0);
		else
			unk_0x81645EE95A114FAE(func_403(unk), func_402(unk.f_1), unk.f_2, unk.f_3, unk.f_4, unk.f_5, unk.f_6, unk.f_7, 0);
...
void func_423(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x108DE
{
	var unk;
	...
	if (func_404())
	{
		...
		if (iParam3 == 1)
			unk_0xFFA2B456A81EA1EB(sParam0, sParam1, func_403(unk), func_402(unk.f_1), unk.f_2, unk.f_3, unk.f_8, unk.f_4, unk.f_5, unk.f_6, unk.f_7, iParam6, 0);
		else
			unk_0xFFA2B456A81EA1EB(sParam0, sParam1, func_403(unk), func_402(unk.f_1), unk.f_2, unk.f_3, unk.f_8, unk.f_4, unk.f_5, unk.f_6, unk.f_7, iParam6, 0);
...
int func_435(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7, BOOL bParam8) // Position - 0x10F2E
{
	...
	if (num3 >= fParam0 && num3 <= num && num4 >= fParam1 && num4 <= num2)
	{
		...
		if (bParam7)
		{
			unk_0x9A122D542F2BB60E(76, 84);
			unk_0x9C066F8D86A1A438(-0.05f, -0.05f, 0f, 0f);
			func_436(num6, num7 + ((float)num8 * fParam3), fParam2, fParam4, 255, 255, 255, iParam6);
			unk_0x90B531766063C5CD();
		}
		else
		{
			func_436(fParam0, fParam1 + ((float)num8 * fParam3), fParam2, fParam4, 255, 255, 255, iParam6);
		}
...
void func_442(var uParam0) // Position - 0x11373
{
	...
	func_288(&uParam0->[0 /*9*/], unk, unk2, unk3, unk4);
	...
	func_281(&uParam0->f_420[9 /*8*/], 117, true);
	func_283(&uParam0->f_420[10 /*8*/], 257f, 186f, 254f, 25f, true);
	func_281(&uParam0->f_420[10 /*8*/], 117, true);
...
BOOL func_448(var uParam0) // Position - 0x120E2
{
	...
	if (func_470(uParam0->f_44))
		...
		unk176 = { func_469(unk_0x259BE71D8A81D4FA()) };

	switch (Global_2097157)
	{
		case 0:
			if (func_468(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44), &unk176))
			{
		...
		case 100:
			if (func_449(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44), 1, &unk176, true, true, Global_2097157.f_280.f_36[0], Global_2097157.f_280.f_3[0]))
			{
				func_467(&unk99, &(uParam0->f_44));
...
BOOL func_449(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, BOOL bParam5, BOOL bParam6, int iParam7, int iParam8) // Position - 0x12506
{
	int num;
	int num2;
...
BOOL func_454(int iParam0) // Position - 0x126D1
{
...
BOOL func_468(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x12B1B
{
	switch (*uParam0)
	{
		case 0:
...
struct<13> func_469(var uParam0) // Position - 0x12BCF
{
	var unk;
...
BOOL _LEADERBOARDS2_TRY_BEGIN_WRITE_DATA(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x12EEA
{
	...
	if (!unk_0xB10D024D4A098884() && unk_0xD25970CBEE074E07() || !unk_0xB0DF27929B02C57E() && unk_0xAE6B753124318E29())
	{
		...
		if (iParam4 == -1)
		{
			...
			{
				unk68 = { func_469(unk_0x259BE71D8A81D4FA()) };
...
var func_483(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, BOOL bParam12) // Position - 0x1868A
{
	var unk;
...
BOOL func_485(var uParam0, BOOL bParam1) // Position - 0x1881F
{
	...
	if (func_494() && num == 4 || num == 2 || num == 1 || num == 5 || !func_492() && unk_0x261E3728EE56B3AC())
	{
...
void func_497(var uParam0, var uParam1) // Position - 0x18E69
{
	...
	unk23 = 3;
	unk27 = { func_469(unk_0x259BE71D8A81D4FA()) };
	...
	if (unk_0xA0C7B98BCF1EEF9E(*uParam0))
	{
		if (!unk_0x1595D1B690089487() || !unk_0x99DFE4CAC19D527F() || !unk_0xD25970CBEE074E07() && unk_0xB0DF27929B02C57E() || Global_2097536.f_2832 != 0)
		{
			...
			if (!IS_BIT_SET(uParam1->f_42, 1))
			{
				...
				func_553(*uParam0, &num, num2, true, true);
				num2 = 0;
			...
			if (!func_523(uParam1))
			{
				...
				if (Global_2097536.f_2825 == -1)
				{
					...
					for (i = 0; i < 3; i = i + 1)
					{
						if (i == 0)
						{
							num2 = 0;
							unk_0x0B0C9A0F9AAEB7F0(&num2, 4);
							func_553(*uParam0, &num, num2, false, false);
						}
						else if (i == 1)
						{
							num2 = 0;
						...
						func_522(*uParam0, num, num2, &unk46);
						num = num + 1;
					}
				...
				else if (_STOPWATCH_HAS_TIME_PASSED(&(Global_2097536.f_2823), 300, false))
				{
					...
					for (i = 0; i < 3; i = i + 1)
					{
						...
						num2 = 0;
						unk_0x0B0C9A0F9AAEB7F0(&num2, 7);
						func_522(*uParam0, num, num2, &unk52);
						num = num + 1;
					}
						...
						for (i = 0; i < 12; i = i + 1)
						{
							...
							else if (Global_2101867[i /*100*/].f_75 == 2)
							{
								if (!unk23[1])
								{
									...
									{
										func_553(*uParam0, &num, num2, true, false);
										flag3 = true;
									}
									else
									{
							...
							if (IS_GAMER_HANDLE_VALID(Global_2101867[i /*100*/].f_32))
							{
								...
								if (!flag3)
								{
									...
									if (func_470(uParam1->f_44))
									{
										...
										func_515(*uParam0, num, num2, Global_2101867[i /*100*/].f_59, &unk5, &(Global_2101867[i /*100*/].f_80));
									...
									{
										func_515(*uParam0, num, num2, Global_2101867[i /*100*/].f_59, &Global_2101867[i /*100*/], &(Global_2101867[i /*100*/].f_80));
										uParam1->f_246.f_6[i /*15*/] = num;
										uParam1->f_246.f_6[i /*15*/].f_1 = num2;
										uParam1->f_246.f_6[i /*15*/].f_2 = { Global_2101867[i /*100*/].f_32 };
										uParam1->f_246.f_2 = uParam1->f_246.f_2 + 1;
...
BOOL func_499(var uParam0, int iParam1) // Position - 0x1A1C4
{
	var unk;
	int num;
	var unk2;
...
void func_501(var uParam0, int iParam1, int iParam2) // Position - 0x1A338
{
...
void func_506(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, int iParam43, int iParam44, BOOL bParam45, BOOL bParam46) // Position - 0x1A4A9
{
	var unk;
	...
	switch (uParam0.f_29[iParam43])
	{
		...
		case 8:
			...
			{
				unk_0x882AEFD55B8D51FB(func_511(func_514(iParam44), false));
				unk_0xCFAD3D478C87321A();
			}
			else
			{
		...
		case 22:
			...
			{
				unk_0x882AEFD55B8D51FB("NUMBER" /*~1~*/);
				unk_0x511D14ED2DA887E1(func_507(iParam44));
				unk_0xCFAD3D478C87321A();
			}
			else
			{
...
void func_515(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5) // Position - 0x1BB31
{
...
BOOL func_516(var uParam0, var uParam1) // Position - 0x1BB83
{
...
void func_519(var uParam0) // Position - 0x1BDD7
{
	...
	unk = { func_469(unk_0x259BE71D8A81D4FA()) };
...
void func_522(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0x1C308
{
...
BOOL func_528(var uParam0, int iParam1, var uParam2, var uParam3) // Position - 0x1C998
{
	var unk;
	int i;
...
void func_529(var uParam0, var uParam1) // Position - 0x1CA51
{
	unk_0x29B9959EF2236634(uParam0, 35, uParam1);
	return;
}

BOOL func_530(var uParam0, var uParam1) // Position - 0x1CA63
{
	int i;
...
BOOL func_535(var uParam0, var uParam1, char* sParam2) // Position - 0x1CBDF
{
	if (*uParam0 == 2)
		return true;
...
BOOL func_539(var uParam0, var uParam1, char* sParam2, var uParam3, var uParam4) // Position - 0x1D045
{
	int num;
	var unk;
...
BOOL func_540(var uParam0) // Position - 0x1D14B
{
	...
	num2 = -1;
	num4 = 2;
	unk107 = { func_469(unk_0x259BE71D8A81D4FA()) };
	...
	switch (uParam0->[num4])
	{
		...
		case 1:
			...
			if (func_449(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44), 11, &unk107, func_546(), false, 0, 0))
			{
				func_467(&unk99, &(uParam0->f_44));
					...
					if (unk99.f_3 > 0)
					{
						...
						if (func_546())
						{
							for (k = 0; k < unk99.f_3; k = k + 1)
							{
								...
								if (Global_2097157.f_374 < 0)
									if (func_516(&unk, &unk107) || func_516(&unk, &(Global_2097157.f_361)))
						...
						if (unk.f_96 <= 1)
						{
							if (Global_2097536.f_2704[num4] < 11)
							{
								if (func_546() && num2 == 0)
								{
									func_544(uParam0, &Global_2097536[num4 /*901*/][Global_2097536.f_2704[num4] /*75*/], unk.f_96);
						...
						for (k = num3; k <= unk99.f_3 - 1; k = k + 1)
						{
							...
							if (Global_2097536.f_2704[num4] < 11 && unk.f_96 > 1)
							{
								if (func_546() && num2 == k)
								{
									if (!func_516(&(Global_2097536[num4 /*901*/][0 /*75*/].f_32), &unk107))
									{
										func_544(uParam0, &Global_2097536[num4 /*901*/][Global_2097536.f_2704[num4] /*75*/], unk.f_96);
								...
								{
									if (IS_GAMER_HANDLE_VALID(unk) && !func_516(&unk, &(Global_2097536[num4 /*901*/][0 /*75*/].f_32)))
									{
										if (func_516(&unk, &unk107))
						...
						if (flag)
						{
							if (Global_2097536.f_2775[num4] == -1 && func_546())
							{
								if (Global_2097536.f_2704[num4] >= 1)
									func_544(uParam0, &Global_2097536[num4 /*901*/][Global_2097536.f_2704[num4] /*75*/], Global_2097536[num4 /*901*/][Global_2097536.f_2704[num4] - 1 /*75*/].f_59 + 1);
								else
									func_544(uParam0, &Global_2097536[num4 /*901*/][Global_2097536.f_2704[num4] /*75*/], 1);
		...
		case 2:
			...
			if (func_542(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44), 1, num5))
			{
				func_467(&unk99, &(uParam0->f_44));
		...
		case 3:
			func_541(num4, Global_2097157.f_374);
			uParam0->[num4] = 4;
			break;
...
BOOL func_542(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x1E094
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_547(var uParam0) // Position - 0x1E37D
{
	...
	switch (uParam0->[1])
	{
				...
				if (func_548(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44), &(uParam0->f_113), uParam0->f_113[0 /*66*/], flag, 0, 100))
				{
					...
					if (uParam0->f_5 && unk_0xF685596DB2F81084(&unk99))
					{
						...
						if (func_546() && num2 == 0)
						{
							...
							{
								func_544(uParam0, &Global_2097536[num5 /*901*/][Global_2097536.f_2704[num5] /*75*/], 1);
						...
						if (unk99.f_3 > 0)
						{
							...
							else
							{
								...
								if (Global_2097536.f_2775[num5] == -1 && func_546())
								{
									if (Global_2097536.f_2704[num5] >= 1)
										func_544(uParam0, &Global_2097536[num5 /*901*/][Global_2097536.f_2704[num5] /*75*/], Global_2097536[num5 /*901*/][Global_2097536.f_2704[num5] - 1 /*75*/].f_59 + 1);
									else
										func_544(uParam0, &Global_2097536[num5 /*901*/][Global_2097536.f_2704[num5] /*75*/], 1);
						...
						for (j = num3; j <= unk99.f_3 - 1; j = j + 1)
						{
							...
							if (Global_2097536.f_2704[num5] < 11 && unk.f_96 > 1)
							{
								if (func_546() && num2 == j)
								{
									if (!func_516(&(Global_2097536[num5 /*901*/][0 /*75*/].f_32), &unk107))
									{
										func_544(uParam0, &Global_2097536[num5 /*901*/][Global_2097536.f_2704[num5] /*75*/], unk.f_96);
								...
								{
									if (IS_GAMER_HANDLE_VALID(unk) && !func_516(&unk, &(Global_2097536[num5 /*901*/][0 /*75*/].f_32)))
									{
										if (func_516(&unk, &unk107))
		...
		case 1:
			func_541(num5, Global_2097157.f_374);
			uParam0->[1] = 2;
			break;
					...
					if (unk112.f_3 > 0)
					{
						...
						if (unk14.f_96 <= 1)
						{
							if (Global_2097536.f_2704[num4] < 11)
							{
								if (func_546() && num2 == 0)
								{
									func_544(uParam0, &Global_2097536[num4 /*901*/][Global_2097536.f_2704[num4] /*75*/], unk14.f_96);
									Global_2097536.f_2775[num4] = 0;
									Global_2097536.f_2704[num4] = Global_2097536.f_2704[num4] + 1;
								}
						...
						for (k = num3; k <= unk112.f_3 - 1; k = k + 1)
						{
							...
							if (Global_2097536.f_2704[num4] < 11 && unk14.f_96 > 1)
							{
								if (func_546() && num2 == k)
								{
									if (!func_516(&(Global_2097536[num4 /*901*/][0 /*75*/].f_32), &unk14))
									{
										func_544(uParam0, &Global_2097536[num4 /*901*/][Global_2097536.f_2704[num4] /*75*/], unk14.f_96);
										Global_2097536.f_2775[num4] = Global_2097536.f_2704[num4];
										Global_2097536.f_2704[num4] = Global_2097536.f_2704[num4] + 1;
								...
								{
									if (IS_GAMER_HANDLE_VALID(unk14) && !func_516(&(Global_2097536[num4 /*901*/][0 /*75*/].f_32), &unk14))
									{
										if (func_516(&unk14, &unk))
											if (Global_2097536.f_2775[num4] < 0)
												Global_2097536.f_2775[num4] = Global_2097536.f_2704[num4];
...
void func_552(var uParam0) // Position - 0x1FD47
{
	if (unk_0xA0C7B98BCF1EEF9E(uParam0))
		unk_0xA91A4C18A2DB01BD(uParam0, 255, 255, 255, 0, 0);
...
void func_553(var uParam0, var uParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1FD67
{
	char* str;
	var unk;
	var unk36;
	...
	else if (IS_BIT_SET(iParam2, 6))
	{
		*uParam1 = *uParam1 + 1;
		...
		if (unk_0x261E3728EE56B3AC() && unk_0x7260716F2E4D7661())
		{
			...
			{
				unk52 = { func_469(unk_0x259BE71D8A81D4FA()) };
			...
			if (unk_0xFE087BC8EB584AA2())
			{
				if (unk_0xEBF44C5F6EF789C0())
				{
					if (unk_0x261E3728EE56B3AC() && unk_0x7260716F2E4D7661())
					{
						...
						{
							unk65 = { func_469(unk_0x259BE71D8A81D4FA()) };
...
void func_554(var uParam0, char* sParam1, var uParam2, int iParam3) // Position - 0x20043
{
	int i;
...
void func_555(var uParam0, char* sParam1, var uParam2, char* sParam3, BOOL bParam4, int iParam5) // Position - 0x20085
{
...
void func_556(var uParam0, var uParam1) // Position - 0x20115
{
...
void func_569(var uParam0) // Position - 0x204DD
{
	...
	func_572(&uParam0->f_358[0 /*189*/], unk_0x4A8C381C258A124D(), iLocal_49.f_1);
...
void func_572(var uParam0, var uParam1, var uParam2) // Position - 0x209C7
{
	uParam0->f_8 = uParam1;
	uParam0->f_9 = uParam2;
	func_573(uParam2, &(iLocal_49.f_243));
	return;
}

void func_573(var uParam0, var uParam1) // Position - 0x209E5
{
	int i;
	...
	if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
	{
		...
		*uParam1 = unk_0x4F06416A18248EA0(uParam0);
		...
		func_574(&uParam0, &(uParam1->f_9), &(uParam1->f_59));
	
		for (i = 0; i <= 11; i = i + 1)
		{
			if (unk_0x5318DF85BEB6B95F(uParam0, i + 1))
				unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_134(i + 1));
		}
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x21F42
{
...
void func_603(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x221BD
{
...
var func_604(int iParam0) // Position - 0x221F4
{
	var unk;
	var unk2;
	var unk3;
	...
	return func_605(unk, unk2, unk3, unk4);
}

var func_605(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x22216
{
	var unk;
...
void func_613(int iParam0, BOOL bParam1) // Position - 0x225B0
{
	...
	TEXT_LABEL_ASSIGN_STRING(&Global_33109[iParam0 /*6*/], unk_0x1AF90EB93E0012D6(), 24);
...
void func_626(int iParam0, BOOL bParam1) // Position - 0x22877
{
	if (IS_BIT_SET(Global_33108, iParam0))
	{
		if (!bParam1)
		{
			unk_0x8744D2E3FC95740E(&Global_33108, iParam0);
