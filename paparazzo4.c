...
BOOL func_77(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x97E6
{
	int num;
...
void func_80(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xA270
{
	int num;
	var unk;
	int num2;
...
BOOL func_93(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE88B
{
	int num;
	int num2;
	int num3;
	...
	if (Global_79644 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !unk_0x15CCE8886267624F())
			{
				...
				unk = { func_370(Global_79645, Global_79647, iParam10) };
				num4 == -0.014f;
...
int func_422(var uParam0, BOOL bParam1) // Position - 0x3016F
{
	int i;
