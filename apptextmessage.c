...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (Global_20930.f_1 != 9)
		{
			...
			else if (func_3(2, Global_20898, 0) || IS_BIT_SET(Global_8801, 12))
			{
				if (unk_0x1B79E937E91F40C3(&Global_113969.f_14144[iLocal_56 /*104*/], "CELL_FINV"))
				{
				}
				else
				{
	...
	if (Global_113969.f_14144[iLocal_56 /*104*/].f_24 == 1)
	{
		if (Global_20908 == 0)
		{
			if (unk_0x875A214D5EBCA509(2, Global_20901))
			{
				...
				unk_0xFE3A52C5B7AE3101(Global_113969.f_14144[iLocal_56 /*104*/].f_16);
				func_45(Global_20911, "SET_DATA_SLOT_EMPTY", 6f, -1082130432, -1082130432, -1082130432, -1082130432);
				func_43();
	...
	else if (Global_20908 == 0)
	{
		if (unk_0x6D05C5731A838CB3(2, Global_20902))
		{
			if (iLocal_58 == 1)
			{
				if (Global_20930.f_1 > 3)
				{
					TEXT_LABEL_ASSIGN_STRING(&Global_76481, unk_0xFACCDE46E24AD056(&Global_23327), 64);
					Global_76612 = 7;
						...
						if (Global_9369[i] == 0)
						{
							...
							else if (num == 7)
							{
								if (Global_79389)
								{
									...
									func_15(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8807[num /*15*/].f_10), SYSTEM::TO_FLOAT(value), -1f, &Global_8807[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20930)
...
void func_15(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11) // Position - 0x164F
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x1D76
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1DB3
{
...
int func_31(eCharacter echParam0) // Position - 0x1DD8
{
...
void func_32() // Position - 0x1DE7
{
	...
	if (Global_20908 == 0)
	{
		if (func_3(2, Global_20899, 0) || Global_113969.f_14054[Global_20930 /*20*/].f_17 == 1 || Global_23346 == true)
		{
			...
			if (Global_113969.f_14144[iLocal_56 /*104*/].f_24 != 0)
			{
				...
				unk = { Global_113969.f_14144[iLocal_56 /*104*/] };
				...
				if (Global_113969.f_14144[iLocal_56 /*104*/].f_17 == 145)
				{
					...
					unk_0x60D332F23943B34F(&(Global_113969.f_14144[iLocal_56 /*104*/].f_50));
					unk_0xCFAD3D478C87321A();
				}
				else
				{
				...
				switch (Global_113969.f_14144[iLocal_56 /*104*/].f_32)
				{
					...
					case 1:
						unk_0x882AEFD55B8D51FB(&Global_113969.f_14144[iLocal_56 /*104*/]);
						unk_0x60D332F23943B34F(&(Global_113969.f_14144[iLocal_56 /*104*/].f_33));
					
						if (Global_113969.f_14144[iLocal_56 /*104*/].f_66 == 1 && !unk_0x1B79E937E91F40C3(&(Global_113969.f_14144[iLocal_56 /*104*/].f_67), "NULL"))
							unk_0x60D332F23943B34F(&(Global_113969.f_14144[iLocal_56 /*104*/].f_67));
					
						if (Global_113969.f_14144[iLocal_56 /*104*/].f_66 == 2 && !unk_0x1B79E937E91F40C3(&(Global_113969.f_14144[iLocal_56 /*104*/].f_67), "NULL") && !unk_0x1B79E937E91F40C3(&(Global_113969.f_14144[iLocal_56 /*104*/].f_83), "NULL"))
						{
							if (unk_0x6BA487C862DB8DDF(&(Global_113969.f_14144[iLocal_56 /*104*/].f_67)))
								unk_0xACF853FB3F6EA7D4(&(Global_113969.f_14144[iLocal_56 /*104*/].f_67));
							else
								unk_0x60D332F23943B34F(&(Global_113969.f_14144[iLocal_56 /*104*/].f_67));
						
							if (unk_0x6BA487C862DB8DDF(&(Global_113969.f_14144[iLocal_56 /*104*/].f_83)))
								unk_0xACF853FB3F6EA7D4(&(Global_113969.f_14144[iLocal_56 /*104*/].f_83));
							else
								unk_0x60D332F23943B34F(&(Global_113969.f_14144[iLocal_56 /*104*/].f_83));
						}
					...
					case 2:
						unk_0x882AEFD55B8D51FB(&Global_113969.f_14144[iLocal_56 /*104*/]);
						unk_0x511D14ED2DA887E1(Global_113969.f_14144[iLocal_56 /*104*/].f_49);
						unk_0xCFAD3D478C87321A();
						break;
				...
				{
					if (unk_0xCF3FA9D6B87D2277(Global_23355[iLocal_56]))
						if (unk_0x445B6F53EA9E6A6F(Global_23355[iLocal_56]))
							str = unk_0x008C0EB38E4459EE(Global_23355[iLocal_56]);
						else
							str = "CHAR_DEFAULT";
					else
						str = "CHAR_DEFAULT";
...
void func_33(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6) // Position - 0x278B
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	func_10(sParam2);
...
void func_36() // Position - 0x2A94
{
	...
	if (Global_113969.f_14144[iLocal_56 /*104*/].f_24 != 0)
	{
		for (i = 0; i < 180; i = i + 1)
		{
			if (!unk_0xD6F9DEE4765092A9(&uLocal_82[i /*6*/]) && unk_0x1B79E937E91F40C3(&Global_113969.f_14144[iLocal_56 /*104*/], &uLocal_82[i /*6*/]))
			{
				if (i < 19)
	...
	for (i = 0; i < 34; i = i + 1)
	{
		...
		if (Global_113969.f_14144[num2 /*104*/].f_24 != 0)
		{
			if (Global_113969.f_14144[num2 /*104*/].f_99[Global_20930] == 1)
			{
				...
				unk_0x330108B080A2132F(i);
				unk_0x330108B080A2132F(Global_113969.f_14144[num2 /*104*/].f_18.f_2);
				unk_0x330108B080A2132F(Global_113969.f_14144[num2 /*104*/].f_18.f_1);
				unk_0x330108B080A2132F(iLocal_57);
			
				if (Global_113969.f_14144[num2 /*104*/].f_17 == 145)
				{
					unk_0x882AEFD55B8D51FB("CELL_CONDFNH" /*<C>~a~</C>*/);
					unk_0x60D332F23943B34F(&(Global_113969.f_14144[num2 /*104*/].f_50));
					unk_0xCFAD3D478C87321A();
				}
				else
				{
				...
				switch (Global_113969.f_14144[num2 /*104*/].f_32)
				{
					...
					case 1:
						unk_0x882AEFD55B8D51FB(&Global_113969.f_14144[num2 /*104*/]);
						unk_0x60D332F23943B34F(&(Global_113969.f_14144[num2 /*104*/].f_33));
					
						if (Global_113969.f_14144[num2 /*104*/].f_66 == 1 && !unk_0x1B79E937E91F40C3(&(Global_113969.f_14144[num2 /*104*/].f_67), "NULL"))
							unk_0x60D332F23943B34F(&(Global_113969.f_14144[num2 /*104*/].f_67));
					
						if (Global_113969.f_14144[num2 /*104*/].f_66 == 2 && !unk_0x1B79E937E91F40C3(&(Global_113969.f_14144[num2 /*104*/].f_67), "NULL") && !unk_0x1B79E937E91F40C3(&(Global_113969.f_14144[num2 /*104*/].f_83), "NULL"))
						{
							if (unk_0x6BA487C862DB8DDF(&(Global_113969.f_14144[num2 /*104*/].f_67)))
								unk_0xACF853FB3F6EA7D4(&(Global_113969.f_14144[num2 /*104*/].f_67));
							else
								unk_0x60D332F23943B34F(&(Global_113969.f_14144[num2 /*104*/].f_67));
						
							if (unk_0x6BA487C862DB8DDF(&(Global_113969.f_14144[num2 /*104*/].f_83)))
								unk_0xACF853FB3F6EA7D4(&(Global_113969.f_14144[num2 /*104*/].f_83));
							else
								unk_0x60D332F23943B34F(&(Global_113969.f_14144[num2 /*104*/].f_83));
						}
					...
					case 2:
						unk_0x882AEFD55B8D51FB(&Global_113969.f_14144[num2 /*104*/]);
						unk_0x511D14ED2DA887E1(Global_113969.f_14144[num2 /*104*/].f_49);
						unk_0xCFAD3D478C87321A();
						break;
...
void func_45(var uParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x33FC
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	unk_0x330108B080A2132F(SYSTEM::ROUND(fParam2));
...
BOOL func_48(int iParam0, BOOL bParam1) // Position - 0x5149
{
	if (func_49(iParam0))
...
BOOL func_49(int iParam0) // Position - 0x518D
{
	int num;
