...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5ED0
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B68
{
	int i;
	float num;
	float num2;
...
void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8F70
{
...
BOOL func_136(var uParam0) // Position - 0xAE68
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAE88
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAFCC
{
	int i;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB16B
{
	if (bParam0)
	{
...
BOOL func_148(int iParam0) // Position - 0xB36C
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB38E
{
...
BOOL func_153(var uParam0) // Position - 0xB425
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB558
{
...
void func_160(var uParam0) // Position - 0xB5AF
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_178(var uParam0, int iParam1) // Position - 0xBD85
{
	int num;
	var unk;
	var unk33;
...
var func_181(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC266
{
	var unk;
...
int func_184(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xC338
{
	int num;
...
BOOL func_190(var uParam0) // Position - 0xCCF2
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_199() || Global_32951 || func_198() || func_197(8, -1) || func_195() || func_101() || func_196() || func_194() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_199() || Global_113016 || Global_32951 || func_198() || func_197(8, -1) || func_101() || func_196() || func_194() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_199() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_197(8, -1) || func_194() || func_193() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xDB55
{
...
float func_209(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xDBF0
{
	var unk;
...
void func_220(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE194
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_230(var uParam0) // Position - 0xEA3F
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_233(var uParam0, var uParam1) // Position - 0xECA8
{
	var unk;
...
BOOL func_236(var uParam0, int iParam1) // Position - 0xEFC8
{
	float num;
...
BOOL func_237(var uParam0, int iParam1) // Position - 0xF03E
{
	return func_238(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_238(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF056
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_239(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xF117
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_240(var uParam0, int iParam1) // Position - 0xF243
{
	int num;
...
BOOL func_242(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xF352
{
	var unk;
	var unk4;
	float num;
...
int func_246(var uParam0, var uParam1) // Position - 0xF45E
{
	int i;
...
int func_247(var uParam0) // Position - 0xF49D
{
...
BOOL func_248(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF4C5
{
	float num;
	float num2;
	int num3;
...
BOOL func_249(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF5C0
{
	float num;
	float num2;
...
BOOL func_250(var uParam0, float fParam1) // Position - 0xF6CC
{
	var unk;
	var unk2;
...
BOOL func_251(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF761
{
	var unk;
	var unk4;
	float num;
...
BOOL func_252(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF7EF
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_254(var uParam0) // Position - 0xF881
{
	var unk;
...
void func_265(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFE44
{
	func_266(uParam0);
...
void func_266(var uParam0) // Position - 0xFE87
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_267(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFF23
{
...
BOOL func_268(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFF7F
{
	int num;
...
void func_284(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x11787
{
	func_230(uParam0);
...
void func_285(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5, int iParam6) // Position - 0x117AE
{
	func_286(uParam0);
...
void func_286(var uParam0) // Position - 0x117CF
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_318(var uParam0, BOOL bParam1) // Position - 0x160E8
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_321(var uParam0) // Position - 0x16172
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_324(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x161FD
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
BOOL func_326(var uParam0, int iParam1) // Position - 0x1629E
{
	if (func_136(uParam0))
...
int func_332(eCharacter echParam0) // Position - 0x163FC
{
	if (!func_36(echParam0))
