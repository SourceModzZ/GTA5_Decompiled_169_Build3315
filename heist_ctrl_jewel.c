...
void func_195(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xCFF3
{
	if (bParam0)
	{
...
BOOL func_200(int iParam0) // Position - 0xD200
{
	int num;
...
BOOL func_201(int iParam0) // Position - 0xD222
{
...
int func_203(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xD26F
{
	int num;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xDC88
{
