...
{
	return !IS_BIT_SET(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_865, 4) && !func_31();
}
...
BOOL func_46() // Position - 0xB41
{
	...
	return IS_BIT_SET(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_865, 5);
}
...
{
	return IS_BIT_SET(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_865, 3);
}
...
{
	return IS_BIT_SET(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_865, 2);
}
...
BOOL func_62(int iParam0) // Position - 0xE2D
{
	if (iParam0 > -1)
	{
		...
		if (IS_BIT_SET(Global_2657971[iParam0 /*465*/].f_200, 4))
			return true;
	}
...
{
	return iParam0 != -1 && IS_BIT_SET(Global_1845281[iParam0 /*883*/].f_865, 1);
}
...
{
	return IS_BIT_SET(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_865, 1);
}
...
{
	return IS_BIT_SET(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_865, 6);
}
