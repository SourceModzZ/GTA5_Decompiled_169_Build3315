...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x16A6
{
	if (iParam2 == -1)
		iParam2 = func_19();
...
void func_61(var uParam0) // Position - 0x1774
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
var func_64(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x1977
{
	var unk;
...
void func_70(char* sParam0, var uParam1) // Position - 0x1C2A
{
...
void func_71(char* sParam0, var uParam1, int iParam2) // Position - 0x1C46
{
	unk_0xAC98CA65AD9A3215(sParam0);
	unk_0xACF853FB3F6EA7D4(uParam1);
...
BOOL func_72(char* sParam0, var uParam1) // Position - 0x1C63
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x1EEE
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1F2B
{
...
int func_85(eCharacter echParam0) // Position - 0x1F50
{
...
void func_87(char* sParam0, var uParam1, int iParam2, int iParam3) // Position - 0x1F7E
{
	iParam3 = iParam3;
...
void func_96(var uParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0x21DA
{
	var unk;
	BOOL flag;
	char* str;
...
BOOL func_100(var uParam0) // Position - 0x2979
{
...
char* func_102(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2AB1
{
	var unk;
...
int func_221(var uParam0) // Position - 0x7477
{
	int i;
	int num;
	int num2;
...
BOOL func_222(int iParam0) // Position - 0x7965
{
	switch (iParam0)
	{
		case joaat("police"):
...
BOOL func_225(var uParam0, var uParam1) // Position - 0x7F8E
{
	var unk;
	var unk2;
	int num;
...
BOOL func_226(var uParam0) // Position - 0x7FE6
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL func_230(int iParam0, int iParam1) // Position - 0x8130
{
	switch (iParam1)
	{
		case joaat("manana"):
...
void func_233(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8446
{
	int num;
...
int func_234(int iParam0, int iParam1) // Position - 0x8474
{
...
var func_241() // Position - 0x89B3
{
	return unk_0xD59511AF30BE1934(unk_0xB6B621402486C3E4());
}

float func_242(var uParam0, int iParam1, int iParam2) // Position - 0x89C3
{
	var unk;
	var unk4;
...
BOOL func_243(var uParam0, var uParam1, var uParam2) // Position - 0x8A21
{
	var unk;
	var unk2;
...
BOOL func_246(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x8B33
{
	var unk;
	BOOL flag;
...
BOOL func_247(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x8C5D
{
	var unk;
	var unk2;
...
float func_248(var uParam0, int iParam1) // Position - 0x8E25
{
	return func_242(unk_0x56E414973C2A8C0E(unk_0xB6B621402486C3E4()), uParam0, iParam1);
}

BOOL func_249(var uParam0, var uParam1) // Position - 0x8E3D
{
	int num;
...
BOOL func_250(var uParam0, var uParam1, var uParam2) // Position - 0x8E92
{
...
BOOL func_251(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x8EE0
{
	float num;
	int num2;
...
BOOL func_253(var uParam0, var uParam1) // Position - 0x9127
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_255(var uParam0, BOOL bParam1, int iParam2) // Position - 0x91FD
{
	int num;
...
int func_256(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x9247
{
	int num;
...
BOOL func_257(var uParam0, BOOL bParam1) // Position - 0x92EB
{
	Vector3 vector;
	Vector3 vector2;
	var unk5;
...
void func_265(var uParam0) // Position - 0x9587
{
	if (!unk_0x4FAFF4BCB7633475(uParam0))
	{
		unk_0x5514EB508DD5A132(uParam0, 1);
...
void func_281(var uParam0) // Position - 0xA145
{
...
void func_282(var uParam0, int iParam1, int iParam2) // Position - 0xA17D
{
...
void func_283(var uParam0, int iParam1, int iParam2) // Position - 0xA1A2
{
...
void func_284(var uParam0, int iParam1, int iParam2) // Position - 0xA1C7
{
...
void func_285(var uParam0, int iParam1, BOOL bParam2) // Position - 0xA1EE
{
	BOOL flag;
...
void func_286(var uParam0, int iParam1, int iParam2) // Position - 0xA649
{
...
void func_287(var uParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xA670
{
	int num;
...
void func_288(var uParam0, int iParam1, int iParam2) // Position - 0xA714
{
...
void func_289(var uParam0, int iParam1, int iParam2) // Position - 0xA739
{
...
void func_290(var uParam0, int iParam1, int iParam2) // Position - 0xA75E
{
...
int func_297(var uParam0, BOOL bParam1) // Position - 0xA8CC
{
	eCharacter num;
...
int func_298(eCharacter echParam0) // Position - 0xA8FF
{
	if (!func_82(echParam0))
