...
BOOL func_44(var uParam0, int iParam1, int iParam2) // Position - 0x19D4
{
	...
	Global_79172[1 /*14*/] = { func_97(num, iParam1, iParam2, -1) };
	...
	{
		unk28 = { func_93(num, 0) };
		Global_79172[1 /*14*/] = { func_97(num, iParam1, unk28[iParam1], -1) };
	
		if (unk_0x1A4EFE92822E3123(uParam0, func_89(iParam1)) > 0 && unk_0x8401C77F508D70FD(uParam0, func_89(iParam1), Global_79172[1 /*14*/].f_3) > 0)
			unk_0xD1C578C204015E1F(uParam0, func_89(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, 0);
	}
...
BOOL func_45(var uParam0, int iParam1, var uParam2) // Position - 0x1B91
{
	...
	{
		if (!func_162(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_64, Global_113969.f_2366.f_539[num /*65*/].f_63))
		{
...
int func_47(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1C6D
{
	...
	if (iParam5 == 0)
	{
		Global_79172[1 /*14*/] = { func_97(num8, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79172[1 /*14*/] = { func_97(num8, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79172[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79172[1 /*14*/] = { func_97(num8, 14, unk18[j], -1) };
							func_63(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
							func_79(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_89(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_89(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_89(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79172[1 /*14*/] = { func_97(num8, i, func_53(uParam0, i, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79172[1 /*14*/] = { func_97(num8, 14, unk59[j], -1) };
			func_63(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
			func_79(14);
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_89(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_89(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_89(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
...
BOOL func_88(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x9BCB
{
	int num;
	...
	{
		if (!func_162(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_61, Global_113969.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
void func_91(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xA655
{
	int num;
	var unk;
	int num2;
...
BOOL func_104(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xEC2E
{
	int num;
	int num2;
	int num3;
...
void func_107(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xED4E
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_100(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_100(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_100(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_162(var uParam0, int iParam1, int iParam2) // Position - 0x1FFE0
{
	int num;
	int num2;
	int i;
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_162(uParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_162(uParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79172[2 /*14*/] = { func_97(num, 14, k, -1) };
								
									if (Global_79172[2 /*14*/].f_12 == j)
										if (func_162(uParam0, 14, k))
											if (!func_51(num, iParam2, 14, k, &unk, &Global_79172[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79172[2 /*14*/] = { func_97(num, i, num2, -1) };
					
						if (!func_51(num, iParam2, i, num2, &unk, &Global_79172[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79172[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_89(iParam1)) && Global_79172[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_89(iParam1)))
	{
		return true;
	}
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x2023B
{
	eCharacter i;
	int num;
...
int func_165(eCharacter echParam0) // Position - 0x2029D
{
...
void func_167(var uParam0, int iParam1) // Position - 0x202B8
{
...
void func_173(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x20919
{
...
void func_174(int iParam0, int iParam1, int iParam2) // Position - 0x209B6
{
	var unk;
	var unk33;
	...
	if (iParam0 != -1)
	{
		...
		func_175(&unk33, unk.f_3, Global_101570, iParam1, iParam2);
	}

	return;
}

void func_175(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4) // Position - 0x209F5
{
...
int func_217(var uParam0, int iParam1) // Position - 0x274BE
{
	int num;
	var unk;
	var unk33;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x27507
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
int func_222(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x278F5
{
	...
	Global_45005[num3 /*6*/].f_1 = iParam0;
...
BOOL func_232(int iParam0, int iParam1) // Position - 0x27E45
{
...
BOOL func_244(var uParam0, var uParam1, int iParam2) // Position - 0x281E4
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x28222
{
...
BOOL func_246(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, int iParam6) // Position - 0x282BD
{
	BOOL flag;
	float num;
...
void func_257(var uParam0, int iParam1, BOOL bParam2) // Position - 0x28715
{
	int i;
...
void func_259(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x28869
{
	var unk;
...
BOOL func_260(var uParam0) // Position - 0x28913
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (!unk_0x4FAFF4BCB7633475(uParam0))
			return true;
...
void func_261(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x28933
{
	if (bParam0)
	{
...
BOOL func_265(int iParam0) // Position - 0x28B34
{
	int num;
...
BOOL func_266(int iParam0) // Position - 0x28B56
{
...
int func_268(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x28BA3
{
	int num;
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x28E65
{
...
void func_277(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, float fParam12, float fParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x28EE0
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
BOOL func_279(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x29300
{
	int i;
	var unk;
	int num;
...
BOOL func_281(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x29446
{
	float num;
	var unk3;
	var unk6;
...
void func_284(var uParam0) // Position - 0x2982F
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_290(var uParam0, int iParam1) // Position - 0x29A0C
{
	if (func_260(uParam0))
...
BOOL func_291(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x29A3F
{
...
void func_292(var uParam0) // Position - 0x29A96
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_299(var uParam0, BOOL bParam1) // Position - 0x29DC8
{
	eCharacter character;
	int num;
	int i;
	...
	if (func_166(character) && !unk_0x4FAFF4BCB7633475(uParam0))
	{
		...
		{
			func_300(uParam0, &Global_113969.f_2366.f_539.f_298[character /*477*/]);
			...
			for (i = 0; i <= 8 - 1; i = i + 1)
			{
				...
				if (bParam1)
				{
					...
					if (Global_113969.f_2366.f_539.f_1730[i /*4*/][character] == num)
...
void func_300(var uParam0, var uParam1) // Position - 0x29EBB
{
	int i;
	int j;
	int k;
...
int func_303(int iParam0, int iParam1) // Position - 0x2A3D6
{
	int num;
	int num2;
	int i;
	...
	if (Global_79644 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !unk_0x15CCE8886267624F())
			{
				...
				unk = { func_308(Global_79645, Global_79647, iParam10) };
				num4 == -0.014f;
...
float func_307(var uParam0) // Position - 0x2B6AB
{
...
void func_324(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x2BF5A
{
	func_325(uParam0);
...
void func_325(var uParam0) // Position - 0x2BF9D
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_326(var uParam0) // Position - 0x2C03C
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void func_333(var uParam0, BOOL bParam1) // Position - 0x2C1BE
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_334(var uParam0) // Position - 0x2C1F9
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_339(var uParam0) // Position - 0x2C2C6
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_340(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2C307
{
	eCharacter character;
	int i;
	var unk;
	...
	if (func_166(character) && !unk_0x4FAFF4BCB7633475(uParam0))
	{
		func_341(uParam0, &Global_113969.f_2366.f_539.f_298[character /*477*/], bParam1);
			...
			if (bParam2)
				if (i == Global_113969.f_2366.f_539.f_1763 || Global_113969.f_2366.f_539.f_1763 == -1 && i == 4)
					if (Global_113969.f_2366.f_539.f_1730[i /*4*/][character] != 0 && Global_113969.f_2366.f_539.f_1730[i /*4*/][character] != joaat("WEAPON_MOLOTOV"))
						if (unk_0x66B90BA528CFEBCE(uParam0, Global_113969.f_2366.f_539.f_1730[i /*4*/][character], 0))
							unk_0x3C0F448853B71C92(uParam0, Global_113969.f_2366.f_539.f_1730[i /*4*/][character], 1);
		}
...
void func_341(var uParam0, var uParam1, BOOL bParam2) // Position - 0x2C468
{
	int num;
	int num2;
	int num3;
...
void func_343(var uParam0, int iParam1, int iParam2) // Position - 0x2CB08
{
	int num;
...
void func_345(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0x2CCCC
{
	int num;
...
BOOL func_346(int iParam0) // Position - 0x2CCEE
{
	switch (iParam0)
	{
...
void func_347(var uParam0, int iParam1, int iParam2) // Position - 0x2D029
{
	int num;
...
var func_351() // Position - 0x2D296
{
	return unk_0x087611B922B50F13(joaat("mpindependence"));
}

void func_352(var uParam0) // Position - 0x2D2A7
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_353(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2D2DF
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
BOOL func_357(char* sParam0, int iParam1, int iParam2) // Position - 0x2D4C8
{
	var unk;
	var unk2;
	int num;
...
int func_361(var uParam0, BOOL bParam1) // Position - 0x2D6FB
{
	int i;
...
void func_364(int iParam0) // Position - 0x2D7ED
{
