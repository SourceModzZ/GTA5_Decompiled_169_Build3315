			...
			case 3:
				...
				else if (!func_46(14))
				{
					...
					if (func_146(iLocal_221, iLocal_223))
					{
						...
						Global_113969.f_10052.f_105 = Global_113969.f_10052.f_105 + num3;
						iLocal_222 = func_161();
						iLocal_223 = func_161();
						func_153(&iLocal_223, 0, 0, 1, 0, 0, 0);
						...
						if (Global_9369[i] == 0)
						{
							...
							else if (num == 7)
							{
								if (Global_79389)
								{
									...
									func_23(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8807[num /*15*/].f_10), SYSTEM::TO_FLOAT(value), -1f, &Global_8807[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20930)
...
void func_23(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x163A
{
...
void func_24(int iParam0) // Position - 0x16ED
{
...
void func_26(var uParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1722
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	unk_0x330108B080A2132F(SYSTEM::ROUND(fParam2));
...
void func_43(var uParam0, char* sParam1, int iParam2) // Position - 0x1EC8
{
...
BOOL func_49(var uParam0, int iParam1, int iParam2) // Position - 0x211A
{
	int num;
	int num2;
	int i;
...
int func_51(var uParam0, int iParam1) // Position - 0x2423
{
	int num;
	var unk;
	var unk2;
...
int func_52(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x2483
{
	int num;
	int num2;
	int num3;
...
BOOL func_53(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x24DA
{
	var unk;
	int i;
...
BOOL func_54(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2ADE
{
	switch (iParam0)
	{
...
BOOL func_58(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x327D
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_59(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x36A2
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_60(int iParam0, int iParam1, int iParam2) // Position - 0x3995
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_62(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x435E
{
	int num;
	var unk;
	int num2;
...
var func_77(int iParam0, int iParam1) // Position - 0x86C8
{
...
BOOL func_82(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x99BB
{
	int num;
	int num2;
	int num3;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1DF66
{
...
int func_143(eCharacter echParam0) // Position - 0x1DF8B
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1E220
{
...
void func_165(var uParam0) // Position - 0x1EE0E
{
...
char* func_167(int iParam0, var uParam1) // Position - 0x1F1A7
{
	*uParam1 = 1;
...
void func_173(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1FDA8
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_174(var uParam0) // Position - 0x1FDF8
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
float func_186(var uParam0, var uParam1, int iParam2) // Position - 0x20450
{
	var unk;
	var unk4;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x204D0
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
		if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
			return true;
...
int func_192(eCharacter echParam0) // Position - 0x2069F
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x20D7B
{
	if (iParam2 == -1)
		iParam2 = func_79();
