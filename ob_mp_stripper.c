...
void main() // Position - 0x0
{
	...
	if (unk_0xFC8BFE4B41177C22(uScriptParam_0))
	{
		...
		uLocal_314 = Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_268.f_35;
		...
		uLocal_389 = Global_1569831.f_146.f_82[5 /*102*/].f_19.f_2;
...
void func_2() // Position - 0xCE5
{
	...
	if (player > -1 && player != _INVALID_PLAYER_INDEX())
	{
		for (i = 0; i < 32; i = i + 1)
		{
			if (Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_268.f_35 == Global_1845281[player /*883*/].f_268[i])
			{
				if (func_9(i) != -1)
				{
...
{
	return IS_BIT_SET(Global_1668667.f_241.f_136[func_15(9) /*33*/][iParam0], func_14(9));
}
...
BOOL func_29(int iParam0) // Position - 0x13C9
{
...
int func_31(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x1416
{
	int num;
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, int iParam3) // Position - 0x1493
{
...
BOOL func_38(var uParam0) // Position - 0x19DE
{
	int num;
...
void func_39(int iParam0, int iParam1, int iParam2) // Position - 0x1A0F
{
	int num;
	int i;
...
void func_40(int iParam0, int iParam1) // Position - 0x1ADF
{
	int num;
...
int func_46(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x1C12
{
	var unk;
...
BOOL func_58(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x1FF5
{
...
int _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x22D7
{
	switch (func_66())
	{
		case 0:
