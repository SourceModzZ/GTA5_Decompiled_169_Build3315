...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5ECC
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B64
{
	int i;
	float num;
	float num2;
...
int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB3DB
{
	int num;
...
BOOL func_154(var uParam0) // Position - 0xB458
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB58B
{
...
void func_161(var uParam0) // Position - 0xB5E2
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_179(var uParam0, int iParam1) // Position - 0xBDB8
{
	int num;
	var unk;
	var unk33;
...
var func_182(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC295
{
	var unk;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD60A
{
...
float func_203(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD6A5
{
	var unk;
...
void func_208(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD87B
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_217(var uParam0) // Position - 0xDEB6
{
	var unk;
...
void func_218(var uParam0) // Position - 0xDF53
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_220(var uParam0) // Position - 0xDFB7
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_229(var uParam0, var uParam1) // Position - 0xE877
{
	var unk;
...
BOOL func_232(var uParam0, int iParam1) // Position - 0xEB97
{
	float num;
...
BOOL func_233(var uParam0, int iParam1) // Position - 0xEC0D
{
	return func_234(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_234(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEC25
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_235(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xECE6
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_236(var uParam0, int iParam1) // Position - 0xEE12
{
	int num;
...
BOOL func_238(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xEF21
{
	var unk;
	var unk4;
	float num;
...
int func_242(var uParam0, var uParam1) // Position - 0xF02D
{
	int i;
...
int func_243(var uParam0) // Position - 0xF06C
{
...
BOOL func_244(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF094
{
	float num;
	float num2;
	int num3;
...
BOOL func_245(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF18F
{
	float num;
	float num2;
...
BOOL func_246(var uParam0, float fParam1) // Position - 0xF29B
{
	var unk;
	var unk2;
...
BOOL func_247(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF330
{
	var unk;
	var unk4;
	float num;
...
BOOL func_248(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF3BE
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_260(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF9AE
{
	func_261(uParam0);
...
void func_261(var uParam0) // Position - 0xF9F1
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_262(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFA8D
{
...
BOOL func_263(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFAE9
{
	int num;
...
void func_265(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFBBD
{
	func_218(uParam0);
...
void func_271(var uParam0, var uParam1) // Position - 0x100B3
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
...
void func_293(var uParam0, BOOL bParam1) // Position - 0x10826
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_296(var uParam0) // Position - 0x108B0
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_299(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1093B
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_300(var uParam0) // Position - 0x1098B
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
int func_305(eCharacter echParam0) // Position - 0x10A68
{
	if (!func_36(echParam0))
