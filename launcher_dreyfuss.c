...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DA3
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A3B
{
	int i;
	float num;
	float num2;
...
void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8E43
{
...
BOOL func_136(var uParam0) // Position - 0xAD3B
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAD5B
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAE9F
{
	int i;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB03E
{
	if (bParam0)
	{
...
BOOL func_148(int iParam0) // Position - 0xB23F
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB261
{
...
int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB2AE
{
	int num;
...
BOOL func_154(var uParam0) // Position - 0xB32B
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB45E
{
...
void func_161(var uParam0) // Position - 0xB4B5
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_179(var uParam0, int iParam1) // Position - 0xBC8B
{
	int num;
	var unk;
	var unk33;
...
BOOL func_182(var uParam0, int iParam1) // Position - 0xBD99
{
	if (func_136(uParam0))
...
float func_183(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4) // Position - 0xBDCC
{
	var unk;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_192() || Global_113016 || Global_32951 || func_191() || func_190(8, -1) || func_101() || func_189() || func_188() || func_187() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_192() || Global_32951 || func_191() || func_190(8, -1) || func_188() || func_101() || func_189() || func_187() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_192() || Global_113016 || Global_32951 || func_191() || func_190(8, -1) || func_188() || func_101() || func_189() || func_187() || Global_113969.f_7691.f_919[character] == 5 || Global_44589 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_192() || Global_113016 || Global_32951 || func_191() || func_190(8, -1) || func_101() || func_189() || func_187() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_192() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_190(8, -1) || func_187() || func_186() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_198(var uParam0) // Position - 0xCF91
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD0D4
{
...
void func_203(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD16F
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_217(var uParam0) // Position - 0xDDCF
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_220(var uParam0, var uParam1) // Position - 0xE038
{
	var unk;
...
BOOL func_223(var uParam0, int iParam1) // Position - 0xE358
{
	float num;
...
BOOL func_224(var uParam0, int iParam1) // Position - 0xE3CE
{
	return func_225(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_225(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE3E6
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_226(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE4A7
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_227(var uParam0, int iParam1) // Position - 0xE5D3
{
	int num;
...
BOOL func_229(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE6E2
{
	var unk;
	var unk4;
	float num;
...
int func_233(var uParam0, var uParam1) // Position - 0xE7EE
{
	int i;
...
int func_234(var uParam0) // Position - 0xE82D
{
...
BOOL func_235(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE855
{
	float num;
	float num2;
	int num3;
...
BOOL func_236(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE950
{
	float num;
	float num2;
...
BOOL func_237(var uParam0, float fParam1) // Position - 0xEA5C
{
	var unk;
	var unk2;
...
BOOL func_238(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEAF1
{
	var unk;
	var unk4;
	float num;
...
BOOL func_239(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEB7F
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_241(var uParam0) // Position - 0xEC11
{
	var unk;
...
void func_252(int iParam0) // Position - 0xF0C5
{
