					...
					else if (func_23(iLocal_94))
					{
						...
						for (i = 243; i <= 262; i = i + 1)
						{
							...
							if (func_16(unk.f_6, func_17(num, 0), false))
							{
								if (unk_0xC450B06E5AAA0985(Global_33328[num /*23*/].f_19))
								{
									unk_0x861AC9C2D48CEA7F(Global_33328[num /*23*/].f_19, 1);
									unk_0x8D777E1B885E428C(Global_33328[num /*23*/].f_19, 10000);
...
void func_76() // Position - 0x3997
{
	...
	if (!func_82(num) || num == 52)
	{
		if (!IS_BIT_SET(Global_113969.f_18577.f_390[iLocal_50], iLocal_49))
		{
			...
			if (num == 58)
				unk_0x0B0C9A0F9AAEB7F0(&Global_113969.f_18577.f_390[iLocal_50], iLocal_49);
...
void func_83(int iParam0) // Position - 0x3D0C
{
	...
	if (!IS_BIT_SET(Global_113969.f_18577[iParam0 /*6*/], 1))
		if (!unk.f_23)
			unk_0x0B0C9A0F9AAEB7F0(&Global_113969.f_18577[iParam0 /*6*/], 1);
		...
		if (IS_BIT_SET(Global_113969.f_18577[iParam0 /*6*/], 1))
		{
			if (!IS_BIT_SET(Global_113969.f_18577[iParam0 /*6*/], 2))
			{
				...
				if (unk.f_15 > 0 && flag)
				{
					...
					{
						func_122(Global_113969.f_18577[iParam0 /*6*/].f_2, &unk34, &unk35, &unk36, &num2, &num3, &num4);
	...
	if (Global_113056[iParam0 /*10*/].f_7 != num6)
	{
		if (func_105(&(Global_113056[iParam0 /*10*/].f_8)))
		{
			...
			{
				num7 = uLocal_72[Global_113056[iParam0 /*10*/].f_8];
			...
			Global_113056[iParam0 /*10*/].f_7 = num6;
		}
	}
...
void func_93(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x47B3
{
	...
	if (bParam1)
	{
		if (!bParam3)
		{
			...
			unk_0x0B0C9A0F9AAEB7F0(&(Global_33328[num /*23*/].f_11), 8);
		}
		else
		{
			...
			unk_0x0B0C9A0F9AAEB7F0(&(Global_33328[num /*23*/].f_11), 10);
		}
...
void func_95(int iParam0) // Position - 0x48A5
{
	...
	unk_0x8744D2E3FC95740E(&(Global_33328[num /*23*/].f_11), 8);
	unk_0x8744D2E3FC95740E(&(Global_33328[num /*23*/].f_11), 10);
	unk_0x0B0C9A0F9AAEB7F0(&(Global_33328[num /*23*/].f_11), 18);
	return;
}
...
void func_98(int iParam0, int iParam1) // Position - 0x4CEE
{
	...
	unk_0xA11116C8E2E46ED4(&(Global_33328[num /*23*/].f_11), 21, 26, iParam1);
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4E9E
{
	...
	if (bParam1)
		unk_0x0B0C9A0F9AAEB7F0(&(Global_33328[num /*23*/].f_11), 28);
	else
		unk_0x8744D2E3FC95740E(&(Global_33328[num /*23*/].f_11), 28);
...
void func_135(int iParam0, int iParam1) // Position - 0x9724
{
	...
	unk_0x0B0C9A0F9AAEB7F0(&(Global_33328[num /*23*/].f_11), 16);
