...
BOOL func_31(var uParam0, int iParam1, int iParam2) // Position - 0x1562
{
	...
	else
	{
		...
		if (unk_0x1A4EFE92822E3123(uParam0, func_76(iParam1)) > 0 && unk_0x8401C77F508D70FD(uParam0, func_76(iParam1), Global_79172[1 /*14*/].f_3) > 0)
			unk_0xD1C578C204015E1F(uParam0, func_76(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, 0);
	}
...
BOOL func_32(var uParam0, int iParam1, var uParam2) // Position - 0x171F
{
	...
	{
		if (!func_149(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_64, Global_113969.f_2366.f_539[num /*65*/].f_63))
		{
...
int func_34(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17FB
{
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
				...
				if (IS_BIT_SET(Global_79172[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							...
							func_50(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
							func_66(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_76(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_76(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_76(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79172[1 /*14*/] = { func_84(num8, i, func_40(uParam0, i, -1), -1) };
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_76(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_76(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_76(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
...
BOOL func_75(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x95DA
{
	int num;
	...
	{
		if (!func_149(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_61, Global_113969.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
void func_78(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xA064
{
	int num;
	var unk;
	int num2;
...
BOOL func_91(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE63A
{
	int num;
	int num2;
	int num3;
...
BOOL func_149(var uParam0, int iParam1, int iParam2) // Position - 0x1F9D9
{
	int num;
	int num2;
	int i;
	...
	else if (Global_79172[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_76(iParam1)) && Global_79172[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_76(iParam1)))
	{
		return true;
	}
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x1FC32
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1FC6F
{
...
int func_152(eCharacter echParam0) // Position - 0x1FC94
{
...
void func_154(var uParam0, int iParam1) // Position - 0x1FCAF
{
...
int func_202(var uParam0, int iParam1) // Position - 0x26D5D
{
	int num;
	var unk;
	var unk33;
...
void func_206(eCharacter echParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x273C8
{
	eCharacter character;
	BOOL flag;
	var unk;
...
void func_207(var uParam0) // Position - 0x275B0
{
...
char* func_209(int iParam0, var uParam1) // Position - 0x27949
{
	*uParam1 = 1;
...
void func_218(var uParam0, int iParam1, BOOL bParam2) // Position - 0x282FC
{
	int i;
...
void func_219(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x283F1
{
	var unk;
...
BOOL func_220(var uParam0) // Position - 0x2849B
{
...
void func_221(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x284BB
{
	if (bParam0)
	{
...
BOOL func_225(int iParam0) // Position - 0x286BC
{
	int num;
...
BOOL func_226(int iParam0) // Position - 0x286DE
{
...
int func_228(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x2872B
{
	int num;
...
void func_232(var uParam0) // Position - 0x287D3
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x28A42
{
...
void func_239(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x28ABE
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
BOOL func_241(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x28EDE
{
	int i;
	var unk;
	int num;
...
BOOL func_243(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x29024
{
	float num;
	var unk3;
	var unk6;
...
void func_246(var uParam0) // Position - 0x2940D
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x294A9
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
		if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
			return true;
...
BOOL func_256(var uParam0, int iParam1) // Position - 0x2969B
{
	if (func_220(uParam0))
...
BOOL func_257(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x296CE
{
...
void func_258(var uParam0) // Position - 0x29725
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL func_267(int iParam0, int iParam1) // Position - 0x29F08
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2A20F
{
...
float func_278(var uParam0, var uParam1, int iParam2) // Position - 0x2A2C3
{
	var unk;
	var unk4;
	...
	if (Global_79644 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !unk_0x15CCE8886267624F())
			{
				...
				unk = { func_289(Global_79645, Global_79647, iParam10) };
				num4 == -0.014f;
...
float func_288(var uParam0) // Position - 0x2A818
{
...
BOOL func_311(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x2B3BB
{
...
BOOL func_312(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x2B417
{
	int num;
...
void func_323(var uParam0, BOOL bParam1) // Position - 0x2B685
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_324(var uParam0) // Position - 0x2B6C0
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_327(var uParam0) // Position - 0x2B73A
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_328(var uParam0) // Position - 0x2B772
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x110821AE6C63DD4F(*uParam0))
...
BOOL func_329(var uParam0) // Position - 0x2B80E
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void func_332(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2B88B
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
BOOL func_336(char* sParam0, int iParam1, int iParam2) // Position - 0x2BA74
{
	var unk;
	var unk2;
	int num;
...
int func_340(var uParam0, BOOL bParam1) // Position - 0x2BCA7
{
	int i;
...
void func_343(int iParam0) // Position - 0x2BD99
{
...
int func_356(eCharacter echParam0) // Position - 0x2C076
{
