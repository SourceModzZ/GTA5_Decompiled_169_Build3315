...
void func_25(var uParam0) // Position - 0x1563
{
	...
	Global_2657971[player /*465*/].f_245 = 0;
	return;
}
...
BOOL func_66(var uParam0) // Position - 0x632F
{
	...
	if (Global_79389)
	{
		...
		return Global_2657971[player /*465*/].f_245;
	}
...
void func_72(var uParam0, int iParam1) // Position - 0x6569
{
	...
	if (Global_79389)
	{
		...
		if (player != _INVALID_PLAYER_INDEX())
			if (Global_2657971[player /*465*/].f_245 == true)
				Global_2657971[player /*465*/].f_245 = 0;
	}
...
void func_81(var uParam0, int iParam1) // Position - 0x6778
{
	...
	Global_2657971[player /*465*/].f_245 = iParam1;
	return;
}
		...
		if (func_329(num))
		{
			if (unk_0xFD5C5BBD1FE92BB7(num, -1, 0) == unk_0x4A8C381C258A124D())
			{
				...
				if (_NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM())
				{
					...
					Global_4535950[num2 /*85*/] = unk_0x4B423FAA24E8ABF0(num);
					Global_4535950[num2 /*85*/].f_1 = iParam0;
				}
				else
				{
...
int func_124(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x9C89
{
	int i;
...
int func_127(int iParam0) // Position - 0x9E6A
{
	var unk;
...
void func_134(int iParam0) // Position - 0xA7F8
{
	...
	else if (IS_BIT_SET(Global_113969.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_136() /*5570*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_113969.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_136() /*5570*/].f_681.f_10), iParam0);
	}
...
void func_137(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xAA82
{
	int num;
...
int func_138(int iParam0, int iParam1) // Position - 0xAAB0
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0xB2F0
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0xB32D
{
...
int func_168(eCharacter echParam0) // Position - 0xB352
{
...
int func_171(int iParam0) // Position - 0xB3F5
{
	int num;
...
BOOL func_173(int iParam0) // Position - 0xB44A
{
	if (!func_11(iParam0))
		return false;
...
Vector3 func_179(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0xB72B
{
	var unk;
...
int func_196(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4) // Position - 0xC805
{
	if (IS_BIT_SET(uParam0->f_113, iParam1) || IS_BIT_SET(uParam0->f_114, iParam1))
		return 1;
...
void func_198(var uParam0, var uParam1) // Position - 0xC920
{
	func_197(uParam0, 0, joaat("prop_carwash_roller_horz"));
	func_197(uParam0, 1, joaat("prop_carwash_roller_vert"));
	func_197(uParam0, 2, joaat("prop_ld_test_01"));
...
void func_211(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11) // Position - 0xCBEF
{
	float num;
	float num2;
	var unk;
...
var func_212(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0xCC9B
{
...
int func_215(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xCEAF
{
	int i;
	int j;
	int k;
	...
	if (iParam5 == 0)
	{
		Global_79172[1 /*14*/] = { func_263(num8, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79172[1 /*14*/] = { func_263(num8, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79172[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79172[1 /*14*/] = { func_263(num8, 14, unk18[j], -1) };
							func_235(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
							func_258(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_225(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_225(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_225(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79172[1 /*14*/] = { func_263(num8, i, func_224(uParam0, i, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79172[1 /*14*/] = { func_263(num8, 14, unk59[j], -1) };
			func_235(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
			func_258(14);
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_225(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_225(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_225(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
...
BOOL func_216(var uParam0, int iParam1, var uParam2) // Position - 0xD6C0
{
	int num;
	...
	{
		if (!func_327(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_64, Global_113969.f_2366.f_539[num /*65*/].f_63))
		{
...
BOOL func_219(int iParam0, int iParam1, int iParam2) // Position - 0xD826
{
	if (iParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_221(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0xD92C
{
	var unk;
	int i;
...
BOOL func_222(int iParam0, int iParam1, int iParam2) // Position - 0xDF30
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_223(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0xDFC9
{
	int num;
	...
	{
		if (!func_327(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_61, Global_113969.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
int func_224(var uParam0, int iParam1, int iParam2) // Position - 0xE074
{
	int i;
	int j;
...
int func_226(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0xE1C5
{
	int num;
...
int func_227(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE4CC
{
	int num;
	int num2;
	int num3;
...
BOOL func_231(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF661
{
	int num;
...
BOOL func_232(int iParam0, int iParam1, var uParam2) // Position - 0xF68A
{
	*uParam2 = -99;
...
int func_233(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0xF954
{
	int num;
...
void func_235(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFD35
{
	int num;
...
BOOL func_236(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFDCF
{
	switch (iParam0)
	{
...
int func_240(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x103E8
{
	int num;
	int num2;
	int num3;
...
int func_241(var uParam0, int iParam1) // Position - 0x104E4
{
	int num;
...
void func_246(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x110F1
{
	int num;
	var unk;
	int num2;
...
BOOL func_252(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x133B6
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_253(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13633
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_254(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13A58
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_255(var uParam0, int iParam1) // Position - 0x13D4B
{
	int num;
	var unk;
...
int func_256(var uParam0, int iParam1) // Position - 0x13D92
{
	int num;
	var unk;
	var unk2;
...
int func_257(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x13DF2
{
	int num;
	int num2;
	int num3;
...
BOOL func_270(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x19D85
{
	int num;
	int num2;
	int num3;
...
void func_272(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x19E97
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_266(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_266(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_266(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_327(var uParam0, int iParam1, int iParam2) // Position - 0x2B3E7
{
	...
	num = unk_0x4B423FAA24E8ABF0(uParam0);
	Global_79172[1 /*14*/] = { func_263(num, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_327(uParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_327(uParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79172[2 /*14*/] = { func_263(num, 14, k, -1) };
								
									if (Global_79172[2 /*14*/].f_12 == j)
										if (func_327(uParam0, 14, k))
											if (!func_221(num, iParam2, 14, k, &unk, &Global_79172[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79172[2 /*14*/] = { func_263(num, i, num2, -1) };
					
						if (!func_221(num, iParam2, i, num2, &unk, &Global_79172[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79172[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_225(iParam1)) && Global_79172[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_225(iParam1)))
	{
		return true;
	}
...
BOOL func_356(int iParam0) // Position - 0x2CA2B
{
	...
	if (unk_0x4D9174D8796EA622() || unk_0xEF37E704F02B50F3() || func_362() || Global_64160 || func_361(false) || func_51(0) || func_357(unk_0x259BE71D8A81D4FA()))
		return false;
...
int _GET_VEHICLE_SEAT_PED_IS_IN(var ped, int includeLastVehicle) // Position - 0x2D613
{
	var unk;
	int num;
	int i;
...
int _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x2D71C
{
	switch (func_22())
	{
		case 0:
