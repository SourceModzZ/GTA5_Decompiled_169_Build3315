...
BOOL func_22(int iParam0) // Position - 0xA8A
{
	...
	num2 = unk_0x8B5B2BE72A7C0CF6(Global_113969.f_10052.f_133, 0, num - 1);
...
void func_88(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x5EAD
{
