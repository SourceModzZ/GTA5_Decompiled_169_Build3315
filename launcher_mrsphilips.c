...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DA5
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A3D
{
	int i;
	float num;
	float num2;
...
void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8E45
{
...
BOOL func_136(var uParam0) // Position - 0xACA9
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xACC9
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAE0D
{
	int i;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAFAC
{
	if (bParam0)
	{
...
BOOL func_148(int iParam0) // Position - 0xB1AD
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB1CF
{
...
int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB21C
{
	int num;
...
BOOL func_154(var uParam0) // Position - 0xB299
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB3CC
{
...
void func_161(var uParam0) // Position - 0xB423
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_179(var uParam0, int iParam1) // Position - 0xBBF9
{
	int num;
	var unk;
	var unk33;
...
BOOL func_186(var uParam0) // Position - 0xC5EE
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void func_196(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCE1B
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
float func_200(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD01F
{
	var unk;
...
void func_211(var uParam0) // Position - 0xDAB5
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_214(var uParam0, var uParam1) // Position - 0xDD1E
{
	var unk;
...
BOOL func_217(var uParam0, int iParam1) // Position - 0xE03E
{
	float num;
...
BOOL func_218(var uParam0, int iParam1) // Position - 0xE0B4
{
	return func_219(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_219(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE0CC
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_220(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE18D
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_221(var uParam0, int iParam1) // Position - 0xE2B9
{
	int num;
...
BOOL func_223(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE3C8
{
	var unk;
	var unk4;
	float num;
...
int func_227(var uParam0, var uParam1) // Position - 0xE4D4
{
	int i;
...
int func_228(var uParam0) // Position - 0xE513
{
...
BOOL func_229(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE53B
{
	float num;
	float num2;
	int num3;
...
BOOL func_230(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE636
{
	float num;
	float num2;
...
BOOL func_231(var uParam0, float fParam1) // Position - 0xE742
{
	var unk;
	var unk2;
...
BOOL func_232(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE7D7
{
	var unk;
	var unk4;
	float num;
...
BOOL func_233(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE865
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_235(var uParam0) // Position - 0xE8F7
{
	var unk;
...
void func_262(var uParam0, BOOL bParam1) // Position - 0xF1E0
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_265(var uParam0) // Position - 0xF26A
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_266(var uParam0) // Position - 0xF2A2
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_269(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF391
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_270(var uParam0) // Position - 0xF3E1
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
