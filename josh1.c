...
BOOL func_76(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x98DE
{
	int num;
...
void func_79(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xA368
{
	int num;
	var unk;
	int num2;
...
BOOL func_92(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE986
{
	int num;
	int num2;
	int num3;
...
int func_206(var uParam0, int iParam1) // Position - 0x27773
{
	int num;
	var unk;
	var unk33;
...
float func_219(var uParam0, var uParam1, int iParam2) // Position - 0x27DA3
{
	var unk;
	var unk4;
...
BOOL func_225(int iParam0, int iParam1) // Position - 0x281C9
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x284AE
{
...
void func_238(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x285B9
{
	var unk;
...
void func_239(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x28663
{
	if (bParam0)
	{
...
BOOL func_243(int iParam0) // Position - 0x28864
{
	int num;
...
BOOL func_244(int iParam0) // Position - 0x28886
{
...
int func_246(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x288D3
{
	int num;
...
BOOL func_250(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5, int iParam6) // Position - 0x28FBC
{
	BOOL flag;
	float num;
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x291D6
{
...
void func_255(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x29252
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
BOOL func_257(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x29672
{
	int i;
	var unk;
	int num;
...
BOOL func_259(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x297B9
{
	float num;
	var unk3;
	var unk6;
...
void func_262(var uParam0) // Position - 0x29BA2
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_264(var uParam0) // Position - 0x29C27
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_270(var uParam0, int iParam1) // Position - 0x29DCB
{
	if (func_300(uParam0))
...
BOOL func_271(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x29DFE
{
...
void func_272(var uParam0) // Position - 0x29E55
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
	...
	if (Global_79644 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !unk_0x15CCE8886267624F())
			{
				...
				unk = { func_285(Global_79645, Global_79647, iParam10) };
				num4 == -0.014f;
...
float func_284(var uParam0) // Position - 0x2A859
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x2AF96
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
		if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
			return true;
...
BOOL func_300(var uParam0) // Position - 0x2AFB7
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (!unk_0x4FAFF4BCB7633475(uParam0))
			return true;
...
void func_301(var uParam0, int iParam1, BOOL bParam2) // Position - 0x2AFD7
{
	int i;
...
void func_304(var uParam0, BOOL bParam1) // Position - 0x2B2A7
{
	var unk;
	float num;
...
void func_305(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x2B31B
{
	func_306(uParam0);
...
void func_306(var uParam0) // Position - 0x2B35E
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_307(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x2B3FA
{
...
BOOL func_308(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x2B456
{
	int num;
...
void func_319(var uParam0, BOOL bParam1) // Position - 0x2B704
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_320(var uParam0) // Position - 0x2B73F
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_323(var uParam0) // Position - 0x2B7B9
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_326(var uParam0) // Position - 0x2B844
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_327(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2B885
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
BOOL func_331(char* sParam0, int iParam1, int iParam2) // Position - 0x2BA6E
{
	var unk;
	var unk2;
	int num;
...
int func_335(var uParam0, BOOL bParam1) // Position - 0x2BCA1
{
	int i;
...
void func_338(int iParam0) // Position - 0x2BD93
{
...
int func_351(eCharacter echParam0) // Position - 0x2C06F
{
	if (!func_154(echParam0))
