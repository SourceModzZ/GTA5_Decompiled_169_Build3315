...
int func_65(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17E2
{
	...
	if (iParam5 == 0)
	{
		Global_79172[1 /*14*/] = { func_118(num8, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79172[1 /*14*/] = { func_118(num8, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79172[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79172[1 /*14*/] = { func_118(num8, 14, unk18[j], -1) };
							func_85(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
							func_108(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_75(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_75(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_75(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79172[1 /*14*/] = { func_118(num8, i, func_74(uParam0, i, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79172[1 /*14*/] = { func_118(num8, 14, unk59[j], -1) };
			func_85(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
			func_108(14);
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_75(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_75(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_75(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
...
BOOL func_66(var uParam0, int iParam1, var uParam2) // Position - 0x1FF3
{
	...
	{
		if (!func_182(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_64, Global_113969.f_2366.f_539[num /*65*/].f_63))
		{
...
BOOL func_73(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x28FC
{
	...
	{
		if (!func_182(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_61, Global_113969.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
BOOL func_125(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE67C
{
	int num;
	int num2;
	int num3;
...
void func_127(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xE78E
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_121(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_121(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_121(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_182(var uParam0, int iParam1, int iParam2) // Position - 0x1FA0A
{
	int num;
	int num2;
	int i;
	...
	num = unk_0x4B423FAA24E8ABF0(uParam0);
	Global_79172[1 /*14*/] = { func_118(num, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_182(uParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_182(uParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79172[2 /*14*/] = { func_118(num, 14, k, -1) };
								
									if (Global_79172[2 /*14*/].f_12 == j)
										if (func_182(uParam0, 14, k))
											if (!func_71(num, iParam2, 14, k, &unk, &Global_79172[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79172[2 /*14*/] = { func_118(num, i, num2, -1) };
					
						if (!func_71(num, iParam2, i, num2, &unk, &Global_79172[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79172[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_75(iParam1)) && Global_79172[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_75(iParam1)))
	{
		return true;
	}
...
void func_184(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1FCA2
{
	if (bParam0)
	{
...
BOOL func_188(int iParam0) // Position - 0x1FEA3
{
	int num;
...
BOOL func_189(int iParam0) // Position - 0x1FEC5
{
...
int func_191(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x1FF12
{
	int num;
...
void func_194(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, float fParam12, float fParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x1FF91
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
BOOL func_196(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x203B5
{
	int i;
	var unk;
	int num;
...
BOOL func_198(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x204FB
{
	float num;
	var unk3;
	var unk6;
...
void func_201(var uParam0) // Position - 0x208E4
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
int func_204(var uParam0, int iParam1) // Position - 0x2097A
{
	int num;
	var unk;
	var unk33;
...
BOOL func_215(var uParam0, int iParam1) // Position - 0x2254C
{
	if (func_216(uParam0))
...
BOOL func_216(var uParam0) // Position - 0x2257F
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (!unk_0x4FAFF4BCB7633475(uParam0))
			return true;
...
BOOL func_217(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x2259F
{
...
void func_218(var uParam0) // Position - 0x225F6
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL func_223(var uParam0, var uParam1, float fParam2, int iParam3) // Position - 0x22846
{
...
BOOL func_225(var uParam0, var uParam1, BOOL bParam2) // Position - 0x2291E
{
...
BOOL func_226(var uParam0, BOOL bParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x22969
{
	float num;
...
BOOL func_227(var uParam0, int iParam1) // Position - 0x22A24
{
	float num;
...
BOOL func_228(var uParam0, int iParam1) // Position - 0x22A9A
{
	return func_229(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_229(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x22AB2
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_230(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0x22B73
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_231(var uParam0, int iParam1) // Position - 0x22C9F
{
	int num;
...
BOOL func_233(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0x22DAE
{
	var unk;
	var unk4;
	float num;
...
int func_236(var uParam0, var uParam1) // Position - 0x22E7B
{
	int i;
...
int func_237(var uParam0) // Position - 0x22EBA
{
...
BOOL func_238(var uParam0, var uParam1, int iParam2) // Position - 0x22EE2
{
	float num;
	Vector3 vector;
...
BOOL func_239(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x22F29
{
	float num;
	float num2;
	int num3;
...
BOOL func_240(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x23024
{
	float num;
	float num2;
...
BOOL func_241(var uParam0, float fParam1) // Position - 0x23130
{
	var unk;
	var unk2;
...
BOOL func_242(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x231C5
{
	var unk;
	var unk4;
	float num;
...
BOOL func_243(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0x23253
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
	...
	if (Global_79644 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !unk_0x15CCE8886267624F())
			{
				...
				unk = { func_258(Global_79645, Global_79647, iParam10) };
				num4 == -0.014f;
...
float func_257(var uParam0) // Position - 0x2397D
{
...
void func_272(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x240B5
{
	var unk;
...
void func_273(var uParam0, int iParam1, BOOL bParam2) // Position - 0x2415F
{
	int i;
...
void func_275(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x24422
{
	func_38(uParam0);
...
BOOL func_276(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x24465
{
...
BOOL func_277(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x244C1
{
	int num;
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x24F41
{
	if (iParam2 == -1)
		iParam2 = func_113();
...
BOOL func_315(var uParam0, int iParam1, int iParam2) // Position - 0x25A01
{
	int num;
	int i;
	var unk;
	...
	{
		unk28 = { func_98(num, 0) };
		Global_79172[1 /*14*/] = { func_118(num, iParam1, unk28[iParam1], -1) };
	
		if (unk_0x1A4EFE92822E3123(uParam0, func_75(iParam1)) > 0 && unk_0x8401C77F508D70FD(uParam0, func_75(iParam1), Global_79172[1 /*14*/].f_3) > 0)
			unk_0xD1C578C204015E1F(uParam0, func_75(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, 0);
	}
...
void func_316(var uParam0, int iParam1) // Position - 0x25BBE
{
...
void func_319(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x25C9F
{
...
void func_320(int iParam0, int iParam1, int iParam2) // Position - 0x25D3C
{
	var unk;
	var unk33;
	...
	if (iParam0 != -1)
	{
		...
		func_321(&unk33, unk.f_3, Global_101570, iParam1, iParam2);
	}

	return;
}

void func_321(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4) // Position - 0x25D7B
{
...
BOOL func_361(char* sParam0, int iParam1, int iParam2) // Position - 0x2B3A4
{
	var unk;
	var unk2;
	int num;
...
int func_365(var uParam0, BOOL bParam1) // Position - 0x2B5D7
{
	int i;
...
void func_368(int iParam0) // Position - 0x2B6C9
{
...
int func_381(eCharacter echParam0) // Position - 0x2B9A2
{
