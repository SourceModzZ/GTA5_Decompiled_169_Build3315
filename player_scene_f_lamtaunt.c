...
void func_47(int iParam0) // Position - 0x26CF
{
	...
	else if (IS_BIT_SET(Global_113969.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_49() /*5570*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_113969.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_49() /*5570*/].f_681.f_10), iParam0);
	}
						...
						if (Global_9369[i] == 0)
						{
							...
							else if (num == 7)
							{
								if (Global_79389)
								{
									...
									func_89(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8807[num /*15*/].f_10), SYSTEM::TO_FLOAT(value), -1f, &Global_8807[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20930)
...
void func_89(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x3E1E
{
...
void func_90(int iParam0) // Position - 0x3ED1
{
...
void func_92(var uParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3F06
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	unk_0x330108B080A2132F(SYSTEM::ROUND(fParam2));
...
BOOL func_100(var uParam0, int iParam1) // Position - 0x447D
{
	int num;
	int num2;
...
int func_112(int iParam0, var uParam1) // Position - 0x4B37
{
	int num;
	BOOL flag;
...
int func_115(int iParam0, var uParam1) // Position - 0x4C34
{
	int num;
	BOOL flag;
...
int func_117(int iParam0, var uParam1) // Position - 0x4D0F
{
	int num;
	BOOL flag;
...
int func_121(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x4F8E
{
	int i;
	float num;
	float num2;
...
eCharacter func_126(int iParam0) // Position - 0x50FF
{
	eCharacter i;
	int num;
	eCharacter character;
		...
		switch (uLocal_269[iParam1])
		{
			case 0:
				if (unk_0x13CCB1AD131C1082(*iParam0, &uLocal_360, &uLocal_441[iParam1 /*16*/], 2))
				{
					...
					if (unk_0xBD3B265153D3BA2D(Global_98843) > num2)
					{
			...
			case 10:
				...
				unk_0xD414C47AFF81382A(5, uLocal_274, Global_96517);
				unk_0xD414C47AFF81382A(5, Global_96517, uLocal_274);
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x58BF
{
	...
	if (!func_136())
	{
		if (unk_0x5266F1D2AEF6F73A(Global_98843))
		{
			for (i = 0; i < iLocal_261; i = i + 1)
			{
				...
				{
					unk_0x3DA436E63AB0F541(iLocal_261[i], Global_98843, &uLocal_360, &uLocal_441[i /*16*/], 8f, -4f, 3, 0, 1148846080, 0);
					uLocal_269[i] = 0;
				}
				else
				{
...
BOOL func_138() // Position - 0x5ABE
{
	...
	if (unk_0x5266F1D2AEF6F73A(Global_98842))
	{
		...
		{
			if (!unk_0x4FAFF4BCB7633475(iLocal_261[i]))
				unk_0x3DA436E63AB0F541(iLocal_261[i], Global_98842, &uLocal_360, &uLocal_376[i /*16*/], 8f, -1000f, 0, 0, 1148846080, 0);
		}
...
BOOL func_139(int iParam0, int iParam1) // Position - 0x5B9E
{
	Vector3 vector;
	float num;
...
void func_147() // Position - 0x5D4E
{
	...
	if (unk_0xFC8BFE4B41177C22(Global_101254))
	{
		if (func_37(CHAR_LAMAR) == unk_0x4B423FAA24E8ABF0(Global_101254))
...
void func_148(int iParam0, int iParam1) // Position - 0x5F2C
{
