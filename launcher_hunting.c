...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E21
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6AB9
{
	int i;
	float num;
	float num2;
...
void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8EC1
{
...
BOOL func_136(var uParam0) // Position - 0xADB9
{
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAF1D
{
	int i;
...
BOOL func_148(int iParam0) // Position - 0xB2BD
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB2DF
{
...
int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB32C
{
	int num;
...
BOOL func_154(var uParam0) // Position - 0xB3A9
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB4DC
{
...
void func_161(var uParam0) // Position - 0xB533
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_179(var uParam0, int iParam1) // Position - 0xBD09
{
	int num;
	var unk;
	var unk33;
...
BOOL func_186(var uParam0) // Position - 0xC6FE
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD044
{
...
float func_200(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD0DF
{
	var unk;
...
void func_201(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD119
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_215(var uParam0) // Position - 0xDD79
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_218(var uParam0, var uParam1) // Position - 0xDFE2
{
	var unk;
...
BOOL func_221(var uParam0, int iParam1) // Position - 0xE302
{
	float num;
...
BOOL func_222(var uParam0, int iParam1) // Position - 0xE378
{
	return func_223(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_223(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE390
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_224(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE451
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_225(var uParam0, int iParam1) // Position - 0xE57D
{
	int num;
...
BOOL func_227(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE68C
{
	var unk;
	var unk4;
	float num;
...
int func_231(var uParam0, var uParam1) // Position - 0xE798
{
	int i;
...
int func_232(var uParam0) // Position - 0xE7D7
{
...
BOOL func_233(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE7FF
{
	float num;
	float num2;
	int num3;
...
BOOL func_234(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE8FA
{
	float num;
	float num2;
...
BOOL func_235(var uParam0, float fParam1) // Position - 0xEA06
{
	var unk;
	var unk2;
...
BOOL func_236(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEA9B
{
	var unk;
	var unk4;
	float num;
...
BOOL func_237(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEB29
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_239(var uParam0) // Position - 0xEBBB
{
	var unk;
...
void func_249(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) // Position - 0xF082
{
...
void func_250(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF0E8
{
	func_251(uParam0);
...
void func_251(var uParam0) // Position - 0xF12B
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_252(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF1C7
{
...
BOOL func_253(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF223
{
	int num;
...
void func_276(var uParam0, BOOL bParam1) // Position - 0xFC5B
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_279(var uParam0) // Position - 0xFCE5
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_282(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFD70
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_283(var uParam0) // Position - 0xFDC0
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
int func_288(eCharacter echParam0) // Position - 0xFE9D
{
	if (!func_36(echParam0))
