...
void func_1() // Position - 0x45A
{
	...
	if (bLocal_99)
	{
		...
		unk_0xAC98CA65AD9A3215(&uLocal_101);
	
		if (bLocal_100)
		{
			unk_0x60D332F23943B34F(&uLocal_105);
		}
		else
		{
			unk_0xACF853FB3F6EA7D4(&Global_44994);
			unk_0xACF853FB3F6EA7D4(&uLocal_105);
		}
...
int func_6(int iParam0, BOOL bParam1, int iParam2) // Position - 0x564
{
	...
	if (func_8(num) && Global_1887305[num /*610*/].f_10.f_430 == iParam2)
		return 1;
...
void func_10(var uParam0) // Position - 0x65E
{
	...
	for (i = 0; i < 6; i = i + 1)
	{
		if (Global_44799[i /*32*/] && Global_44799[i /*32*/].f_4)
		{
			...
			{
				if (!unk_0xF40767E41852FB72(Global_44799[i /*32*/].f_31))
				{
					if (*uParam0 > -1)
						func_11();
...
void func_26() // Position - 0xB5A
{
	if (!unk_0x3555462DB47B7AB1() && !func_32())
	{
		if (func_31(false))
		{
			if (!unk_0xD6F9DEE4765092A9(&(Global_2684504.f_787.f_12)))
			{
				func_30();
				func_27(6, 0);
			}
	...
	if (Global_1835458 != -1)
	{
			...
			if (bLocal_122)
			{
				...
				else
				{
					if (unk_0xA44A2B8A83947D02())
						TEXT_LABEL_ASSIGN_STRING(&Global_2359296[func_39() /*5570*/].f_5393.f_18[Global_1835458 /*6*/], unk_0x6E4BB594E2A075CC(&unk[0 /*13*/]), 24);
		...
		else if (unk_0x0BA1A956D36B210F() || func_37())
		{
			if (IS_GAMER_HANDLE_VALID(unk[0 /*13*/]))
			{
				...
				{
					case 0:
						iLocal_124 = unk_0x310461CE0659232F(&unk, 1);
					...
					case 1:
						num = unk_0xD61DBE5217500D72(iLocal_124, &unk15, 1);
		...
		{
			if (IS_GAMER_HANDLE_VALID(unk[0 /*13*/]))
				TEXT_LABEL_ASSIGN_STRING(&Global_2359296[func_39() /*5570*/].f_5393.f_18[Global_1835458 /*6*/], unk_0x0CA8AE01D86E1FDC(&unk[0 /*13*/]), 24);
