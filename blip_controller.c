...
void main() // Position - 0x0
{
	...
	unk_0x0B0C9A0F9AAEB7F0(&(Global_33328[j /*23*/].f_11), 18);
	j = 0;
		...
		if (Global_33325)
		{
			...
			for (j = 0; j < 263; j = j + 1)
			{
				...
				if (flag2)
				{
					...
					if (num6 > 0)
						if (num5 > 0)
							unk_0x8744D2E3FC95740E(&(Global_33328[j /*23*/].f_11), 0);
						else if (IS_BIT_SET(Global_33328[j /*23*/].f_11, 15))
							unk_0x0B0C9A0F9AAEB7F0(&(Global_33328[j /*23*/].f_11), 0);
					else if (IS_BIT_SET(Global_33328[j /*23*/].f_11, 15))
						unk_0x0B0C9A0F9AAEB7F0(&(Global_33328[j /*23*/].f_11), 0);
					...
					if (IS_BIT_SET(Global_33328[j /*23*/].f_11, 0) && IS_BIT_SET(Global_33328[j /*23*/].f_11, 3))
					{
						...
						if (!unk_0xC450B06E5AAA0985(Global_33328[j /*23*/].f_19))
						{
							...
							if (IS_BIT_SET(Global_33328[j /*23*/].f_11, 19))
							{
								switch (echLocal_62)
								{
									...
									case CHAR_TREVOR:
										...
										{
											Global_33328[j /*23*/].f_19 = unk_0x339BF323C4261E69(Global_33328[j /*23*/][0 /*3*/], Global_33328[j /*23*/].f_10);
											unk_0xF42EBD7CD0682A8B(Global_33328[j /*23*/].f_19, 128);
											unk_0x89FE619BFBB2024B(Global_33328[j /*23*/].f_19, 0);
										}
										else
										{
											Global_33328[j /*23*/].f_19 = unk_0x34864AB7DA700AA6(Global_33328[j /*23*/][echLocal_62 /*3*/]);
											unk_0x4C905FB262965D5D(Global_33328[j /*23*/].f_19, Global_33328[j /*23*/].f_12[echLocal_62]);
										}
										break;
								
									default:
										Global_33328[j /*23*/].f_19 = unk_0x34864AB7DA700AA6(1f, 2f, 3f);
										break;
								}
							}
							...
							{
								Global_33328[j /*23*/].f_19 = unk_0x34864AB7DA700AA6(Global_33328[j /*23*/][0 /*3*/]);
								unk_0x4C905FB262965D5D(Global_33328[j /*23*/].f_19, Global_33328[j /*23*/].f_12[0]);
							}
						...
						else
						{
							if (IS_BIT_SET(Global_33328[j /*23*/].f_11, 19))
							{
								switch (echLocal_62)
								{
									...
									case CHAR_MICHAEL:
									case CHAR_TREVOR:
										unk_0xDABC73EF230B6665(Global_33328[j /*23*/].f_19, Global_33328[j /*23*/][echLocal_62 /*3*/]);
										break;
							...
							{
								unk_0xDABC73EF230B6665(Global_33328[j /*23*/].f_19, Global_33328[j /*23*/][0 /*3*/]);
							}
							...
							if (IS_BIT_SET(Global_33328[j /*23*/].f_11, 9))
							{
								if (bLocal_45)
								{
									unk_0x861AC9C2D48CEA7F(Global_33328[j /*23*/].f_19, 1);
									bLocal_45 = false;
								}
								else
								{
									unk_0xAB1FFF93A0BBFCDB(Global_33328[j /*23*/].f_19, 1);
									bLocal_45 = true;
								}
							
								unk_0x8D777E1B885E428C(Global_33328[j /*23*/].f_19, 10000);
								unk_0x8744D2E3FC95740E(&(Global_33328[j /*23*/].f_11), 9);
							}
							else
							{
								unk_0x861AC9C2D48CEA7F(Global_33328[j /*23*/].f_19, 0);
							}
						}
					...
					else
					{
						if (unk_0xC450B06E5AAA0985(Global_33328[j /*23*/].f_19))
						{
							unk_0xFE54B8568B2ABD12(&(Global_33328[j /*23*/].f_19));
							num3 = num3 + 1;
				...
				unk_0x8744D2E3FC95740E(&(Global_33328[j /*23*/].f_11), 18);
				num7 = 30;
...
void func_11() // Position - 0xAEE
{
	...
	for (i = 0; i < 7; i = i + 1)
	{
		if (uLocal_53[i] != -1)
		{
			if (unk_0xC450B06E5AAA0985(Global_33328[uLocal_53[i] /*23*/].f_19))
			{
				num3 = unk_0xED977E2AE2CB16EE(unk, unk_0x3CF9D442F2C902BD(Global_33328[uLocal_53[i] /*23*/].f_19), 1);
	...
	for (i = 0; i < 7; i = i + 1)
	{
		if (uLocal_53[i] != -1)
			if (i == num)
				if (unk_0xC450B06E5AAA0985(Global_33328[uLocal_53[i] /*23*/].f_19))
					func_16(uLocal_53[i]);
			else if (unk_0xC450B06E5AAA0985(Global_33328[uLocal_53[i] /*23*/].f_19))
				func_12(uLocal_53[i]);
	}
...
void func_20(var uParam0, int iParam1) // Position - 0xEA4
{
			...
			if (IS_BIT_SET(Global_33328[iParam1 /*23*/].f_11, 8))
			{
				if (!func_29(iParam1))
				{
					...
					else
					{
						...
						{
							unk_0x360B279488A775FC(uParam0, IS_BIT_SET(Global_33328[iParam1 /*23*/].f_11, 5));
							unk_0x1456FD5C0C438B19(uParam0, 3);
							unk_0x360B279488A775FC(uParam0, 1);
	...
	if (IS_BIT_SET(Global_33328[iParam1 /*23*/].f_11, 19))
	{
		switch (character)
		{
			...
			case CHAR_MICHAEL:
			case CHAR_TREVOR:
				unk_0xDABC73EF230B6665(Global_33328[iParam1 /*23*/].f_19, Global_33328[iParam1 /*23*/][character /*3*/]);
				break;
		}
	}
...
int func_22(int iParam0) // Position - 0x12AD
{
	...
	num2 = unk_0x8B5B2BE72A7C0CF6(Global_33328[num /*23*/].f_11, 21, 26);
	return num2;
}
...
void func_46(int iParam0, BOOL bParam1) // Position - 0x1C02
{
	...
	if (bParam1)
		unk_0x0B0C9A0F9AAEB7F0(&(Global_33328[num /*23*/].f_11), 2);
	else
		unk_0x8744D2E3FC95740E(&(Global_33328[num /*23*/].f_11), 2);
...
void func_47(int iParam0, char* sParam1) // Position - 0x1C85
{
	...
	if (unk_0xC450B06E5AAA0985(Global_33328[num /*23*/].f_19))
		unk_0x594D5D0D7071B0DE(Global_33328[num /*23*/].f_19, sParam1);
