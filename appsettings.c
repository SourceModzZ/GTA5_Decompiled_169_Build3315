...
void main() // Position - 0x0
{
	...
	for (i = 0; i < 9; i = i + 1)
	{
		...
		else if (unk_0x1B79E937E91F40C3(&(Global_113969.f_14054[Global_20930 /*20*/].f_11), &Global_9605[Global_20930 /*2811*/][1 /*281*/].f_144[i /*6*/]))
		{
...
void func_12() // Position - 0x890
{
	...
	if (iLocal_41 == 1)
	{
		...
		if (func_10(2, Global_20906, 0) || func_10(2, Global_20907, 0) || bLocal_49 || iLocal_63 == 1 || iLocal_64 == 1)
		{
			iLocal_63 = 0;
			iLocal_64 = 0;
			bLocal_49 = false;
			...
			if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
			{
				...
				if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
				{
					...
					{
						if (unk_0x1B79E937E91F40C3(&Global_9605[Global_20930 /*2811*/][1 /*281*/].f_144[iLocal_45 /*6*/], "Silent Ringtone Dummy"))
						{
						}
						else
						{
							unk_0x1BC60757AC20ACCF(&Global_9605[Global_20930 /*2811*/][1 /*281*/].f_144[iLocal_45 /*6*/], unk_0x4A8C381C258A124D(), 1);
						}
					}
				}
			}
			...
			if (iLocal_41 == 4)
			{
				...
				if (Global_79389)
				{
					...
					if (Global_4543361 == 0)
					{
						...
						if (unk_0xE582BF3EDDBB1A68(&unk17) && unk_0x97DD063A9C6137F8(0) && Global_4543364 == 0)
						{
							SYSTEM::SETTIMERA(0);
...
void func_28() // Position - 0x16F8
{
	...
	while (value < 19)
	{
		...
		if (unk_0x1B79E937E91F40C3(&Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_7[Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_259 /*4*/], &Global_9605[Global_20930 /*2811*/][iLocal_41 /*281*/].f_7[num2 /*4*/]))
		{
			iLocal_46 = value;
