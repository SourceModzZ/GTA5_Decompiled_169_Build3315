...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E14
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6AAC
{
	int i;
	float num;
	float num2;
...
void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8EB6
{
...
BOOL func_136(var uParam0) // Position - 0xADAE
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xADCE
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAF12
{
	int i;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB0B1
{
	if (bParam0)
	{
...
BOOL func_148(int iParam0) // Position - 0xB2B2
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB2D4
{
...
int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB321
{
	int num;
...
BOOL func_154(var uParam0) // Position - 0xB39E
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB4D1
{
...
void func_161(var uParam0) // Position - 0xB528
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_179(var uParam0, int iParam1) // Position - 0xBCFE
{
	int num;
	var unk;
	var unk33;
...
BOOL func_186(var uParam0) // Position - 0xC6F4
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
float func_197(var uParam0) // Position - 0xDCD2
{
	if (func_203(uParam0))
		if (func_199(uParam0))
			return uParam0->f_2;
...
BOOL func_199(var uParam0) // Position - 0xDD66
{
	return IS_BIT_SET(*uParam0, 2);
}

void func_200(var uParam0) // Position - 0xDD73
{
	func_201(uParam0, 0f);
	return;
}

void func_201(var uParam0, float fParam1) // Position - 0xDD82
{
...
void func_202(var uParam0) // Position - 0xDDAD
{
	if (!func_203(uParam0))
		func_200(uParam0);
...
BOOL func_203(var uParam0) // Position - 0xDDC5
{
...
BOOL func_209(int iParam0, int iParam1) // Position - 0xE19E
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xE4B4
{
...
void func_218(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE54F
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
float func_222(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xE753
{
	var unk;
...
void func_233(var uParam0) // Position - 0xF1E9
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_236(var uParam0, var uParam1) // Position - 0xF452
{
	var unk;
...
BOOL func_239(var uParam0, int iParam1) // Position - 0xF772
{
	float num;
...
BOOL func_240(var uParam0, int iParam1) // Position - 0xF7E8
{
	return func_241(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_241(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF800
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_242(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xF8C1
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_243(var uParam0, int iParam1) // Position - 0xF9ED
{
	int num;
...
BOOL func_245(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xFAFC
{
	var unk;
	var unk4;
	float num;
...
int func_249(var uParam0, var uParam1) // Position - 0xFC08
{
	int i;
...
int func_250(var uParam0) // Position - 0xFC47
{
...
BOOL func_251(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xFC6F
{
	float num;
	float num2;
	int num3;
...
BOOL func_252(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFD6A
{
	float num;
	float num2;
...
BOOL func_253(var uParam0, float fParam1) // Position - 0xFE76
{
	var unk;
	var unk2;
...
BOOL func_254(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFF0B
{
	var unk;
	var unk4;
	float num;
...
BOOL func_255(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xFF99
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_257(var uParam0) // Position - 0x1002C
{
	var unk;
...
void func_284(var uParam0, BOOL bParam1) // Position - 0x10C6E
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_287(var uParam0) // Position - 0x10CF8
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_288(var uParam0) // Position - 0x10D30
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_291(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10E1F
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_292(var uParam0) // Position - 0x10E6F
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
