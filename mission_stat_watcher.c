					...
					if (Global_64169)
					{
						...
						for (j = 0; j < Global_97542[num2 /*19*/]; j = j + 1)
						{
							if (!func_92(Global_113969.f_1.f_12[num2 /*6*/][j]))
								...
								num4 = num4 + Global_113969.f_1.f_126[Global_64170 /*23*/].f_17[j];
						}
...
void func_90(int iParam0, int iParam1) // Position - 0xD60D
{
	...
	num = Global_64391[iParam1 /*13*/].f_4;
...
void func_107() // Position - 0xE5B1
{
	...
	for (i = 0; i < Global_76261; i = i + 1)
	{
		if (Global_76262[i /*9*/] >= 0)
		{
			num2 = Global_64391[Global_76262[i /*9*/] /*13*/];
			...
			switch (num2)
			{
				case 6:
					if (Global_76262[i /*9*/].f_6 != 0)
					{
						...
						else if (unk_0xFC8BFE4B41177C22(Global_76262[i /*9*/].f_6))
						{
							if (!unk_0x1C2F771CDC87A3A5(Global_76262[i /*9*/].f_6, 0))
							{
								iLocal_628 = Global_76262[i /*9*/].f_8;
								uLocal_627 = unk_0x8D91ADE44AC79BC9(Global_76262[i /*9*/].f_6);
								...
								Global_76262[i /*9*/].f_8 = uLocal_627;
							}
						}
						else
						{
					...
					if (Global_64174)
						if (Global_64176 == -1 || Global_76262[i /*9*/] == Global_64176)
							if (Global_76262[i /*9*/] == 339 || Global_76262[i /*9*/] == 179 || Global_76262[i /*9*/] == 342 || Global_76262[i /*9*/] == 234)
								Global_76262[i /*9*/].f_1 = Global_76262[i /*9*/].f_1 + SYSTEM::ROUND(unk_0x0B852B0BF94A8DC1() * 1000f);
							else
								Global_76262[i /*9*/].f_1 = Global_76262[i /*9*/].f_1 + iLocal_624;
					break;
							...
							if (!(Global_64177 == 0))
							{
								if (unk_0xFC8BFE4B41177C22(Global_64177))
								{
									if (!unk_0x1C2F771CDC87A3A5(Global_64177, 0))
									{
										...
										{
											num = unk_0xDF93B3CFAC96698F(Global_64177);
										
											if (num > Global_76262[i /*9*/].f_2)
												Global_76262[i /*9*/].f_2 = num;
										}
									}
								}
							}
...
void func_108() // Position - 0xE98C
{
	...
	if (Global_64195 > 0)
	{
		...
		for (i = 0; i < 64; i = i + 1)
		{
			...
			{
				if (!unk_0xFC8BFE4B41177C22(Global_64196[i /*2*/]))
				{
					Global_64196[i /*2*/] = 0;
			...
			case 142:
				...
				if (unk_0xFC8BFE4B41177C22(num3))
				{
					...
					if (Global_64325 > 0)
					{
						...
						{
							if (Global_64326[j /*2*/] == unk2)
								num6 = num6 + Global_64326[j /*2*/].f_1;
						}
					}
						...
						if (unk_0x0101C509A6E67F99(unk) && unk_0x56E414973C2A8C0E(unk_0xB6B621402486C3E4()) == unk_0xBD545F8729E9F413(unk) || flag2)
						{
							if (unk_0x0101C509A6E67F99(unk))
							{
								...
								if (Global_64195 > 0)
								{
									...
									if (num7 != -1)
									{
										unk_0xB76C3F86B744BBA5(unk_0xBD545F8729E9F413(Global_64196[num7 /*2*/]), &iLocal_631);
							...
							if (Global_76447 > 0)
							{
								...
								while (!flag)
								{
									...
									{
										if (unk_0xFC8BFE4B41177C22(Global_76414[j /*2*/]))
										{
											if (unk_0x1C2F771CDC87A3A5(Global_76414[j /*2*/], 0))
											{
												if (Global_76414[j /*2*/] == num3)
												{
		...
		if (unk_0x81D4D874CB1DFBE4() == 13)
		{
			if (unk_0x16C990F0AEBBC7A3() == 37)
			{
				...
				if (num5 == 3)
				{
					...
					Global_113969.f_2355[num6 /*2*/] = unk2;
					Global_113969.f_2355[num6 /*2*/].f_1 = unk3;
					func_114();
				}
			}
		}
