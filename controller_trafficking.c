...
void func_85(char* sParam0, int iParam1, int iParam2) // Position - 0x2D59
{
	if (Global_101533 != 10 && Global_101533 != 9)
	{
		...
		func_87(&Global_104530, sParam0, 0, "Start", iParam1, iParam2);
		func_86();
		Global_95691 = 0;
	}
...
void func_99(var uParam0, BOOL bParam1) // Position - 0x52D7
{
	...
	if (func_13(character) && !unk_0x4FAFF4BCB7633475(uParam0))
	{
		...
		{
			func_100(uParam0, &Global_113969.f_2366.f_539.f_298[character /*477*/]);
...
void func_106(var uParam0) // Position - 0x68D5
{
	eCharacter character;
...
BOOL func_108(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x6E5E
{
	var unk;
	var unk2;
...
int func_117(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x7AF6
{
	int i;
	float num;
	float num2;
...
void func_143(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, BOOL bParam6) // Position - 0x9CFC
{
	var unk;
...
void func_145(int iParam0, eCharacter echParam1) // Position - 0x9F3C
{
	var unk;
	int i;
	int j;
...
BOOL func_146(int iParam0) // Position - 0xA13E
{
...
BOOL func_147(int iParam0) // Position - 0xA21B
{
	if (iParam0 == 0)
		return false;
...
BOOL func_148(int iParam0, BOOL bParam1, int iParam2) // Position - 0xA3D9
{
	int i;
	var unk;
...
BOOL func_149(int iParam0) // Position - 0xA55E
{
	int num;
	var unk;
	var unk2;
...
BOOL func_151(int iParam0, int iParam1) // Position - 0xA641
{
	int num;
	int num2;
...
BOOL func_157(int iParam0) // Position - 0xA97E
{
	int num;
	var unk;
...
BOOL func_158(int iParam0) // Position - 0xA9C5
{
	int i;
...
BOOL func_159(int iParam0) // Position - 0xAA00
{
	int i;
...
BOOL func_160(int iParam0) // Position - 0xAA7C
{
	int i;
		...
		case 7:
			if (!unk_0xF40767E41852FB72(iLocal_28))
			{
				...
				else
				{
					...
					Global_113969.f_19986.f_11 = unk3;
					func_1(105, false, false);
					Global_113969.f_19986.f_14 = 0;
					iLocal_45 = 9;
				}
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_192() || Global_113016 || Global_32951 || func_186() || func_185(8, -1) || func_140() || func_191() || func_184() || func_190() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_192() || Global_32951 || func_186() || func_185(8, -1) || func_184() || func_140() || func_191() || func_190() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_192() || Global_113016 || Global_32951 || func_186() || func_185(8, -1) || func_184() || func_140() || func_191() || func_190() || Global_113969.f_7691.f_919[character] == 5 || Global_44589 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_192() || Global_113016 || Global_32951 || func_186() || func_185(8, -1) || func_140() || func_191() || func_190() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_192() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_185(8, -1) || func_190() || func_189() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
