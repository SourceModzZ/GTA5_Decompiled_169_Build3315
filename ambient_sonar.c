...
void func_9(var uParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2F9
{
	...
	if (bParam4)
		unk_0x0B0C9A0F9AAEB7F0(&Global_8802, 1);
	else
		unk_0x8744D2E3FC95740E(&Global_8802, 1);
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x1D1B
{
	if (iParam2 == -1)
		iParam2 = func_53();
...
void func_63(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2E01
{
	int num;
...
int func_64(int iParam0, int iParam1) // Position - 0x2E2F
{
...
void func_83(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, char* sParam6, char* sParam7) // Position - 0x35E5
{
	var unk;
...
void func_102(int iParam0, int iParam1, BOOL bParam2) // Position - 0x3E18
{
	...
	if (iParam0 == 1)
	{
		...
		{
			if (bParam2)
				unk_0x0B0C9A0F9AAEB7F0(&(Global_113969.f_10052.f_122), iParam1);
			else
				unk_0x8744D2E3FC95740E(&(Global_113969.f_10052.f_122), iParam1);
		
			return;
		}
	
		if (bParam2)
			unk_0x0B0C9A0F9AAEB7F0(&(Global_113969.f_10052.f_122.f_1), iParam1 - 32);
		else
			unk_0x8744D2E3FC95740E(&(Global_113969.f_10052.f_122.f_1), iParam1 - 32);
	}
	else if (iParam0 == 0)
	{
		if (iParam1 <= 31)
		{
			if (bParam2)
				unk_0x0B0C9A0F9AAEB7F0(&(Global_113969.f_10052.f_125), iParam1);
			else
				unk_0x8744D2E3FC95740E(&(Global_113969.f_10052.f_125), iParam1);
		
			return;
		}
	
		if (bParam2)
			unk_0x0B0C9A0F9AAEB7F0(&(Global_113969.f_10052.f_125.f_1), iParam1 - 32);
		else
			unk_0x8744D2E3FC95740E(&(Global_113969.f_10052.f_125.f_1), iParam1 - 32);
	}

	return;
}

void func_103(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3F04
{
	if (iParam1 < 0 || iParam1 >= 64)
		return;
...
void func_104(var uParam0) // Position - 0x3F65
{
...
int func_105(var uParam0) // Position - 0x3F85
{
	var unk;
	int num;
...
void func_106(var uParam0, var uParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x4014
{
	var unk;
...
void func_107(var uParam0, var uParam1, var uParam2) // Position - 0x412D
{
	var unk;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x41B2
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
void func_120(var uParam0, int iParam1, int iParam2) // Position - 0x46DF
{
	int i;
	int num;
...
BOOL func_124(var uParam0) // Position - 0x4B0D
{
	if (!unk_0xFC8BFE4B41177C22(uParam0))
		return false;
