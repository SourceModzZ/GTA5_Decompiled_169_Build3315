				...
				case 3:
					...
					else
					{
						...
						if (!func_102(3) && !Global_101567)
						{
							...
							{
								if (!func_120(iLocal_92, 1) || !unk_0xFC8BFE4B41177C22(func_101()) && !Global_101567)
								{
									func_113(10);
									break;
								}
				...
				case 6:
					...
					if (!unk_0xF40767E41852FB72(iLocal_50))
					{
						...
						if (iLocal_97 != -1)
						{
							if (func_120(Global_112617, 0))
							{
								unk_0x375B1B37EF136A49(func_41(iLocal_97), 0, Global_101570, 0);
...
void func_8(int iParam0, BOOL bParam1) // Position - 0xD3B
{
	...
	if (bParam1)
		unk_0x0B0C9A0F9AAEB7F0(&(Global_33328[num /*23*/].f_11), 13);
	else
		unk_0x8744D2E3FC95740E(&(Global_33328[num /*23*/].f_11), 13);
...
void func_19(int iParam0) // Position - 0x136D
{
	...
	if (i < 3)
	{
		unk_0x8744D2E3FC95740E(&Global_113969.f_20413.f_150[i], num);
		unk_0x8744D2E3FC95740E(&Global_113969.f_20413.f_150[i], num);
	}
...
void func_64(var uParam0, char* sParam1, var uParam2, int iParam3, int iParam4) // Position - 0x61B2
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x64E3
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x6520
{
...
int func_71(eCharacter echParam0) // Position - 0x6545
{
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6) // Position - 0x673B
{
	int i;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_99() || Global_113016 || Global_32951 || func_98() || func_84(8, -1) || func_97() || func_96() || func_95() || func_86() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_99() || Global_32951 || func_98() || func_84(8, -1) || func_95() || func_97() || func_96() || func_86() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_99() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_84(8, -1) || func_86() || func_94() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
...
void func_130(var uParam0) // Position - 0x834B
{
	if (uParam0->f_9 != 0)
	{
