...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D3A
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x69D2
{
	int i;
	float num;
	float num2;
...
void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8DDA
{
...
BOOL func_136(var uParam0) // Position - 0xACD2
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xACF2
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAE36
{
	int i;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAFD5
{
	if (bParam0)
	{
...
BOOL func_148(int iParam0) // Position - 0xB1D6
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB1F8
{
...
int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB245
{
	int num;
...
BOOL func_154(var uParam0) // Position - 0xB2C2
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB3F5
{
...
void func_161(var uParam0) // Position - 0xB44C
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_179(var uParam0, int iParam1) // Position - 0xBC22
{
	int num;
	var unk;
	var unk33;
...
BOOL func_186(var uParam0) // Position - 0xC619
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void func_196(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCE46
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
float func_200(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD04A
{
	var unk;
...
void func_211(var uParam0) // Position - 0xDAE0
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_214(var uParam0, var uParam1) // Position - 0xDD49
{
	var unk;
...
BOOL func_217(var uParam0, int iParam1) // Position - 0xE069
{
	float num;
...
BOOL func_218(var uParam0, int iParam1) // Position - 0xE0DF
{
	return func_219(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_219(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE0F7
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_220(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE1B8
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_221(var uParam0, int iParam1) // Position - 0xE2E4
{
	int num;
...
BOOL func_223(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE3F3
{
	var unk;
	var unk4;
	float num;
...
int func_227(var uParam0, var uParam1) // Position - 0xE4FF
{
	int i;
...
int func_228(var uParam0) // Position - 0xE53E
{
...
BOOL func_229(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE566
{
	float num;
	float num2;
	int num3;
...
BOOL func_230(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE661
{
	float num;
	float num2;
...
BOOL func_231(var uParam0, float fParam1) // Position - 0xE76D
{
	var unk;
	var unk2;
...
BOOL func_232(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE802
{
	var unk;
	var unk4;
	float num;
...
BOOL func_233(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE890
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_235(var uParam0) // Position - 0xE922
{
	var unk;
...
BOOL func_245(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xEE24
{
...
BOOL func_246(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xEE80
{
	int num;
...
void func_248(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xEF54
{
	func_211(uParam0);
...
int func_251(eCharacter echParam0) // Position - 0xF0AD
{
	if (!func_36(echParam0))
...
void func_270(var uParam0, BOOL bParam1) // Position - 0xF738
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_273(var uParam0) // Position - 0xF7C2
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_274(var uParam0) // Position - 0xF7FA
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_277(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF8E9
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_278(var uParam0) // Position - 0xF939
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_280(var uParam0, int iParam1) // Position - 0xF9EB
{
	if (func_136(uParam0))
