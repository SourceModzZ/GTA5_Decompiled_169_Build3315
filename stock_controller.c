	...
	for (i = 0; i < 204; i = i + 1)
	{
		if (!Global_59908[i /*7*/])
		{
			if (Global_59908[i /*7*/].f_2)
			{
				...
				{
					unk_0xDF7F16323520B858(Global_59908[i /*7*/].f_3, &(Global_59908[i /*7*/].f_5), -1);
				}
				else
				{
					value = 0f;
					unk_0x2F0966A034F5ADC6(Global_59908[i /*7*/].f_3, &value, -1);
					Global_59908[i /*7*/].f_5 = SYSTEM::FLOOR(value);
				}
			}
		}
	}
...
int func_5() // Position - 0x2FE
{
	...
	for (i = 0; i < 80; i = i + 1)
	{
		if (Global_56465[i /*36*/].f_8)
		{
			...
			{
				num2 = Global_59346[Global_56465[i /*36*/].f_35 /*7*/];
				unk_0x2F0966A034F5ADC6(num2, &(Global_56465[i /*36*/].f_9), -1);
			
				if (Global_56465[i /*36*/].f_9 > 0f)
				{
					num3 = 0f;
					unk_0x3BD9AF4ED006CA00(num2, 0, &(Global_56465[i /*36*/].f_33));
					Global_56465[i /*36*/].f_31 = Global_56465[i /*36*/].f_9;
					Global_56465[i /*36*/].f_32 = Global_56465[i /*36*/].f_9;
					num3 = num3 + Global_56465[i /*36*/].f_33;
					...
					for (j = 0; j < 4; j = j + 1)
					{
						...
						if (num4 > Global_56465[i /*36*/].f_31)
							Global_56465[i /*36*/].f_31 = num4;
					
						if (num4 < Global_56465[i /*36*/].f_32)
							Global_56465[i /*36*/].f_32 = num4;
					...
					if (num5 > Global_56465[i /*36*/].f_31)
						Global_56465[i /*36*/].f_31 = num5;
				
					if (num5 < Global_56465[i /*36*/].f_32)
						Global_56465[i /*36*/].f_32 = num5;
				
					Global_56465[i /*36*/].f_33 = num5 - num3;
					Global_56465[i /*36*/].f_34 = (Global_56465[i /*36*/].f_33 / num3) * 100f;
				}
				else
				{
					num = num + 1;
...
void func_41() // Position - 0x1836
{
	...
	for (i = 0; i < 204; i = i + 1)
	{
		if (!Global_59908[i /*7*/])
		{
			if (Global_59908[i /*7*/].f_2)
			{
				...
				if (!Global_59908[i /*7*/].f_4)
				{
					unk_0xDF7F16323520B858(Global_59908[i /*7*/].f_3, &num, -1);
				}
				else
				{
					value = 0f;
					...
					if (Global_59908[i /*7*/].f_5 < num2)
						num = num2;
					else
						num = Global_59908[i /*7*/].f_5;
				}
			
				Global_59908[i /*7*/].f_6 = num - Global_59908[i /*7*/].f_5;
			}
		}
	...
	for (i = 0; i < 80; i = i + 1)
	{
		if (!Global_56465[i /*36*/].f_8)
		{
			...
			if (Global_56465[i /*36*/].f_10 != 0f)
				num4 = num4 + ((0.02f * Global_56465[i /*36*/].f_9 * Global_56465[i /*36*/].f_10) - Global_56465[i /*36*/].f_9);
		
			num4 = num4 + (unk_0xD2AA6F822D3A55D2(-Global_59620[num3 /*7*/].f_6, Global_59620[num3 /*7*/].f_6) * 0.1f * Global_56465[i /*36*/].f_9);
			Global_59620[num3 /*7*/] = Global_59620[num3 /*7*/] * 0.995f;
		
			if (num4 < 0f)
				num4 = num4 * Global_59620[num3 /*7*/].f_2;
			else if (num4 > 0f)
				num4 = num4 * Global_59620[num3 /*7*/].f_1;
		
			num4 = func_46(num4, -Global_59620[num3 /*7*/].f_5, Global_59620[num3 /*7*/].f_5);
			num5 = 61;
		
			if (i == num5 && func_45(44) && !func_45(64) && num4 > 0f)
			{
				Global_56465[i /*36*/].f_9 = Global_56465[i /*36*/].f_9 - num4;
			}
			else
			{
				if (num4 > 0f)
			...
			if (Global_56465[i /*36*/].f_9 > Global_59620[num3 /*7*/].f_3)
			{
				num7 = Global_56465[i /*36*/].f_9 - Global_59620[num3 /*7*/].f_3;
				num7 = num7 * 0.5f;
				Global_56465[i /*36*/].f_9 = Global_56465[i /*36*/].f_9 - num7;
			}
			else if (Global_56465[i /*36*/].f_9 < Global_59620[num3 /*7*/].f_4)
			{
				num8 = Global_59620[num3 /*7*/].f_4 - Global_56465[i /*36*/].f_9;
				num8 = num8 * 0.5f;
				Global_56465[i /*36*/].f_9 = Global_56465[i /*36*/].f_9 + num8;
			}
		
			Global_59620[num3 /*7*/] = Global_59620[num3 /*7*/] - (((num4 * 0.66f) + (Global_59620[num3 /*7*/] * 0.33f)) * 0.02f);
...
BOOL func_61(int iParam0, var uParam1) // Position - 0x2566
{
	...
	for (i = 0; i < 68; i = i + 1)
	{
		if (Global_78179.f_484[i] == iParam0)
		{
			if (func_62(&Global_78179.f_555[0 /*21*/], i))
			{
				if (IS_BIT_SET(Global_78179.f_555[0 /*21*/].f_9, 10) && Global_78179.f_555[0 /*21*/].f_4 == unk_0x4B423FAA24E8ABF0(iParam0))
				{
					*uParam1 = i;
					return true;
				}
	...
	for (i = 0; i < 80; i = i + 1)
	{
		if (Global_56465[i /*36*/].f_8)
		{
			...
			if (num > -1)
			{
				...
				unk_0x1164A75E490C27B6(Global_59346[num /*7*/].f_3[iParam0], num2, 1);
			}
		}
	}
			...
			if (Global_56465[i /*36*/].f_32 > 0f && Global_56465[i /*36*/].f_31 > 0f && Global_56465[i /*36*/].f_9 > 0f)
			{
				...
				for (j = 15; j >= 0; j = j + -1)
				{
					...
					else
					{
						...
						unk = unk_0xD2AA6F822D3A55D2(-num5 * num7, num5 * num6);
						Global_56465[i /*36*/].f_14[j] = Global_56465[i /*36*/].f_14[j + 1] + unk;
					}
				...
				if (num14 != 1f)
				{
					...
					for (j = 0; j <= 15; j = j + 1)
					{
						...
						Global_56465[i /*36*/].f_14[j] = Global_56465[i /*36*/].f_14[j] * (unk_0xD2AA6F822D3A55D2(0.95f, 1.05f) + (num16 * num15));
...
void func_94() // Position - 0x5A1F
{
	...
	if (!Global_113969.f_20567.f_101)
	{
		...
		{
			if (!Global_56465[i /*36*/].f_8)
				Global_56465[i /*36*/].f_9 = unk_0xD2AA6F822D3A55D2(15f, 290f);
		}
		...
		for (j = 0; j <= 15; j = j + 1)
		{
			...
			for (i = 0; i < 80; i = i + 1)
			{
				...
				Global_56465[i /*36*/].f_9 = Global_56465[i /*36*/].f_9 * unk_0xD2AA6F822D3A55D2(num, num2);
				Global_56465[i /*36*/].f_9 = func_93(func_92(unk_0x1D5CD3EAAA7422B0(Global_56465[i /*36*/].f_9), 3.5f), 290f);
			}
		}
...
void func_95() // Position - 0x5B64
{
	...
	num = unk_0xC5935DFB3F39785A(0, Global_61627 - 1);
	...
	for (i = 0; i < 4; i = i + 1)
	{
		for (j = 0; j < 3; j = j + 1)
		{
			...
			while (!func_88(&Global_61630[num /*14*/], i))
			{
				num = unk_0xC5935DFB3F39785A(0, Global_61627 - 1);
				SYSTEM::WAIT(2000);
			}
		
			Global_61630[num /*14*/].f_10 = 0f;
			num = unk_0xC5935DFB3F39785A(0, Global_61627 - 1);
		}
	}
