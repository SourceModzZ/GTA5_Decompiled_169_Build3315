...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E2B
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6AC3
{
	int i;
	float num;
	float num2;
...
void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8ECB
{
...
BOOL func_136(var uParam0) // Position - 0xADC3
{
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAF06
{
	int i;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB0A5
{
	if (bParam0)
	{
...
BOOL func_147(int iParam0) // Position - 0xB2A6
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB2C8
{
...
int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB315
{
	int num;
...
BOOL func_153(var uParam0) // Position - 0xB392
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB4C5
{
...
void func_160(var uParam0) // Position - 0xB51C
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_178(var uParam0, int iParam1) // Position - 0xBCF2
{
	int num;
	var unk;
	var unk33;
...
var func_181(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC1D0
{
	var unk;
...
BOOL func_189(var uParam0) // Position - 0xCC29
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void func_200(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4) // Position - 0xD4A7
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD7CF
{
...
float func_206(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD86A
{
	var unk;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xD9AA
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_211(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD9CB
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_225(var uParam0) // Position - 0xE62B
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_228(var uParam0, var uParam1) // Position - 0xE894
{
	var unk;
...
BOOL func_231(var uParam0, int iParam1) // Position - 0xEBB4
{
	float num;
...
BOOL func_232(var uParam0, int iParam1) // Position - 0xEC2A
{
	return func_233(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_233(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEC42
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_234(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xED03
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_235(var uParam0, int iParam1) // Position - 0xEE2F
{
	int num;
...
BOOL func_237(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xEF3E
{
	var unk;
	var unk4;
	float num;
...
int func_241(var uParam0, var uParam1) // Position - 0xF04A
{
	int i;
...
int func_242(var uParam0) // Position - 0xF089
{
...
BOOL func_243(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF0B1
{
	float num;
	float num2;
	int num3;
...
BOOL func_244(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF1AC
{
	float num;
	float num2;
...
BOOL func_245(var uParam0, float fParam1) // Position - 0xF2B8
{
	var unk;
	var unk2;
...
BOOL func_246(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF34D
{
	var unk;
	var unk4;
	float num;
...
BOOL func_247(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF3DB
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_249(var uParam0) // Position - 0xF46D
{
	var unk;
...
BOOL func_260(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFB2C
{
...
BOOL func_261(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFB88
{
	int num;
...
void func_268(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x1003C
{
	func_269(uParam0);
...
void func_269(var uParam0) // Position - 0x1007F
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_270(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5, int iParam6) // Position - 0x1011B
{
	func_271(uParam0);
...
void func_271(var uParam0) // Position - 0x1013C
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_294(var uParam0, BOOL bParam1) // Position - 0x109CC
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_297(var uParam0) // Position - 0x10A56
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_300(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10AE1
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
int func_305(eCharacter echParam0) // Position - 0x10BCD
{
	if (!func_36(echParam0))
