...
void func_45(int iParam0) // Position - 0x2287
{
	...
	else if (IS_BIT_SET(Global_113969.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_47() /*5570*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_113969.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_47() /*5570*/].f_681.f_10), iParam0);
	}
...
BOOL func_81(int iParam0) // Position - 0x2F70
{
	int num;
...
BOOL func_82(int iParam0) // Position - 0x2F92
{
...
int func_84(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x2FDF
{
	int num;
...
void func_89(var uParam0) // Position - 0x30A2
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_92(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, BOOL bParam5, int iParam6) // Position - 0x3196
{
	BOOL flag;
	float num;
...
BOOL func_93(var uParam0, int iParam1) // Position - 0x31F2
{
	if (func_76(uParam0))
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x3346
{
...
void func_100(var uParam0, BOOL bParam1) // Position - 0x33E1
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x35DA
{
	return unk_0xD1A6A821F5AC81DB(unk_0x56E414973C2A8C0E(uParam0), 0);
}

int func_103(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x35ED
{
	int i;
	int j;
	int k;
	...
	if (iParam5 == 0)
	{
		Global_79172[1 /*14*/] = { func_151(num8, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79172[1 /*14*/] = { func_151(num8, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79172[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79172[1 /*14*/] = { func_151(num8, 14, unk18[j], -1) };
							func_123(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
							func_146(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_113(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_113(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_113(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79172[1 /*14*/] = { func_151(num8, i, func_112(uParam0, i, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79172[1 /*14*/] = { func_151(num8, 14, unk59[j], -1) };
			func_123(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
			func_146(14);
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_113(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_113(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_113(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
...
BOOL func_104(var uParam0, int iParam1, var uParam2) // Position - 0x3DFE
{
	int num;
	...
	{
		if (!func_215(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_64, Global_113969.f_2366.f_539[num /*65*/].f_63))
		{
...
BOOL func_107(int iParam0, int iParam1, int iParam2) // Position - 0x3F64
{
	if (iParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_111(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x470C
{
	...
	{
		if (!func_215(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_61, Global_113969.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
BOOL func_158(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x10514
{
	int num;
	int num2;
	int num3;
...
void func_160(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10626
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_154(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_154(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_154(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_215(var uParam0, int iParam1, int iParam2) // Position - 0x21AC4
{
	int num;
	int num2;
	int i;
	...
	num = unk_0x4B423FAA24E8ABF0(uParam0);
	Global_79172[1 /*14*/] = { func_151(num, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_215(uParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_215(uParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79172[2 /*14*/] = { func_151(num, 14, k, -1) };
								
									if (Global_79172[2 /*14*/].f_12 == j)
										if (func_215(uParam0, 14, k))
											if (!func_109(num, iParam2, 14, k, &unk, &Global_79172[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79172[2 /*14*/] = { func_151(num, i, num2, -1) };
					
						if (!func_109(num, iParam2, i, num2, &unk, &Global_79172[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79172[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_113(iParam1)) && Global_79172[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_113(iParam1)))
	{
		return true;
	}
...
BOOL func_226(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x21FB1
{
...
void func_227(var uParam0) // Position - 0x22008
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_234(var uParam0) // Position - 0x22315
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
...
void func_235(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x22367
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_236(var uParam0) // Position - 0x223B7
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
...
void func_242(var uParam0, char* sParam1, int iParam2) // Position - 0x227B5
{
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x22BA2
{
...
float func_257(var uParam0, var uParam1, int iParam2) // Position - 0x23457
{
	var unk;
	var unk4;
...
void func_258(int iParam0, var uParam1, float fParam2, int iParam3, BOOL bParam4) // Position - 0x234B5
{
	int num;
	float num2;
	float num3;
...
void func_263(var uParam0) // Position - 0x23A7D
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_265(var uParam0) // Position - 0x23D40
{
...
void func_270(var uParam0, var uParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x24074
{
	func_271(uParam0, uParam1, 0f, 0f, 0f, iParam2, iParam3, bParam4, bParam5, bParam6);
	return;
}

void func_271(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x24091
{
...
void func_272(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, char* sParam5, int iParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x240C9
{
	char* str;
	BOOL flag;
...
BOOL func_276(char* sParam0) // Position - 0x24574
{
...
BOOL func_280(var uParam0, int iParam1) // Position - 0x2492C
{
...
int _GET_VEHICLE_SEAT_PED_IS_IN(var ped, int includeLastVehicle) // Position - 0x2498E
{
	var unk;
	int num;
	int i;
...
void func_286(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0x24A51
{
	var unk;
	int num;
	int num2;
...
BOOL func_288(var uParam0) // Position - 0x24B71
{
...
BOOL func_295(var uParam0) // Position - 0x25093
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
void func_297(var uParam0, char* sParam1, int iParam2) // Position - 0x250FE
{
	char* str;
...
int func_298(var uParam0) // Position - 0x251D8
{
	return func_299(uParam0);
}

int func_299(var uParam0) // Position - 0x251E6
{
	int num;
...
void func_302(var uParam0) // Position - 0x25259
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_303(var uParam0) // Position - 0x252F5
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void func_304(var uParam0) // Position - 0x2531F
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
int func_313(var uParam0, BOOL bParam1, int iParam2) // Position - 0x25844
{
	iParam2 = iParam2;
	return func_314(uParam0, bParam1, 145);
}

int func_314(var uParam0, BOOL bParam1, int iParam2) // Position - 0x2585A
{
	int num;
...
int func_315(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x258A4
{
	int num;
...
{
	switch (func_319(&Global_33008, 0, 5, false, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return true;
...
void func_339(var uParam0) // Position - 0x281A6
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
...
BOOL func_343(int iParam0, char* sParam1, var uParam2) // Position - 0x28382
{
...
void func_347(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x284BF
{
	int i;
...
void func_351(var uParam0) // Position - 0x2871C
{
	func_352(uParam0, "NULL", uParam0->f_1);
	return;
}

void func_352(var uParam0, char* sParam1, var uParam2) // Position - 0x28730
{
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_394() || Global_113016 || Global_32951 || func_393() || func_25(8, -1) || func_392() || func_391() || func_390() || func_389() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_394() || Global_32951 || func_393() || func_25(8, -1) || func_390() || func_392() || func_391() || func_389() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_394() || Global_113016 || Global_32951 || func_393() || func_25(8, -1) || func_390() || func_392() || func_391() || func_389() || Global_113969.f_7691.f_919[character] == 5 || Global_44589 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_394() || Global_113016 || Global_32951 || func_393() || func_25(8, -1) || func_392() || func_391() || func_389() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_394() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_25(8, -1) || func_389() || func_388() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
...
void func_405(int iParam0) // Position - 0x2A6BB
{
	...
	if (func_417())
	{
		...
		func_409(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_408(Global_113958, true), 64);
...
void func_422(int iParam0, char* sParam1, var uParam2) // Position - 0x2B006
{
	if (IS_BIT_SET(iParam0, 30))
	{
		switch (func_344(iParam0))
