...
{
	return IS_BIT_SET(Global_1845281[iParam0 /*883*/].f_140, 6);
}
	...
	switch (iLocal_328)
	{
		case 0:
			if (Global_110663 && !bLocal_326 && !Global_262145.f_10615)
			{
				...
				{
					if (!unk_0xD6F9DEE4765092A9(&Global_110651[i /*4*/]))
						iLocal_329 = i;
				}
			...
			if (!Global_110663 && unk_0x76CD105BCAC6EB9F() && func_21(3763, -1) && !bLocal_331 || unk_0x510D0699BE9C6D06(unk_0x775142054EC39277(unk_0x7E3F74F641EE6B27(), uLocal_332)) > 25000)
			{
		...
		case 1:
			if (iLocal_330 == 0)
			{
				unk_0x271FD9228830C5F4(&Global_110651[iLocal_329 /*4*/], &iLocal_330);
			}
			else if (!unk_0x078BF797A07B0C7C(iLocal_330))
			{
				switch (unk_0x9B55331B5F9C67C8(iLocal_330))
				{
					case 0:
						...
						for (j = 0; j < num; j = j + 1)
						{
							if (!unk_0xD6F9DEE4765092A9(&Global_110499[j /*4*/]))
							{
								if (unk_0x70E57E9927B6BA58(&Global_110499[j /*4*/]) == unk_0x70E57E9927B6BA58(&Global_110651[iLocal_329 /*4*/]))
								{
									flag = true;
									j = num + 1;
								}
		...
		case 2:
			if (iLocal_330 == 0)
			{
				...
				unk_0x54B88AF600DB0C95(&Global_110651[iLocal_329 /*4*/], &unk5, &iLocal_330);
			}
			...
			if (unk_0x095CCC9C5DC3BBF2(iLocal_330))
			{
				if (!unk_0xF7A6291F5AE831D1(iLocal_330))
				{
					...
					for (k = 0; k < num3; k = k + 1)
					{
						...
						if (!unk_0xD6F9DEE4765092A9(unk21) && unk_0x70E57E9927B6BA58(unk21) == unk_0x70E57E9927B6BA58(&Global_110651[iLocal_329 /*4*/]))
						{
							num2 = k;
							k = num3 + 1;
						}
...
int func_16(char* sParam0) // Position - 0x870
{
	...
	for (i = 0; i < Global_110651; i = i + 1)
	{
		if (unk_0xD6F9DEE4765092A9(&Global_110651[i /*4*/]))
		{
			...
			Global_110660[i] = unk_0x76CD105BCAC6EB9F();
			Global_110663 = true;
			Global_110664 = true;
	...
	if (bLocal_326 && iLocal_328 == 0 && !bLocal_87 && !Global_262145.f_10614 && iLocal_70 != 0)
	{
		...
		if (unk_0x095CCC9C5DC3BBF2(iLocal_330))
		{
			if (!unk_0xF7A6291F5AE831D1(iLocal_330))
			{
				...
				Global_110665 = num2 >= Global_110499;
			
				for (i = 0; i < num2; i = i + 1)
				{
					if (i < Global_110499)
					{
						TEXT_LABEL_ASSIGN_STRING(&Global_110499[i /*4*/], unk_0x649D7167E25976C9(iLocal_330, i), 16);
...
int func_33(int iParam0) // Position - 0x2116
{
...
int func_36(int iParam0) // Position - 0x2225
{
...
int func_39(int iParam0) // Position - 0x2334
{
...
int func_42(int iParam0) // Position - 0x2443
{
...
var func_45(int iParam0, int iParam1) // Position - 0x2559
{
...
var func_48(int iParam0, int iParam1) // Position - 0x25C6
{
...
int func_50(int iParam0, int iParam1) // Position - 0x260B
{
...
void func_57(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2D8C
{
	int num;
...
int func_58(int iParam0, int iParam1) // Position - 0x2DAF
{
...
BOOL func_63(Player plParam0, int iParam1) // Position - 0x2F9F
{
	BOOL flag;
...
BOOL func_65(Player plParam0) // Position - 0x3039
{
	int num;
...
var func_69(var uParam0) // Position - 0x30F6
{
	return uParam0;
}
...
BOOL func_83(var uParam0, var uParam1, char* sParam2, var uParam3) // Position - 0x365E
{
	switch (uParam0->f_3)
	{
		case 0:
...
BOOL func_86(var uParam0) // Position - 0x3909
{
	int i;
...
BOOL func_102(int iParam0) // Position - 0x3DA7
{
...
int func_117(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3EFF
{
	return func_118(iParam0, sParam1, iParam2, iParam3, iParam4, iParam5, iParam6, bParam7);
}

int func_118(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3F1B
{
	int num;
...
int func_122(Player plParam0) // Position - 0x40F4
{
	if (plParam0 > -1)
...
struct<13> func_127(Player plParam0) // Position - 0x42C6
{
	var unk;
...
void func_128(int iParam0, int iParam1, int iParam2) // Position - 0x42DD
{
	if (func_151())
	{
		...
		if (func_136(unk_0x259BE71D8A81D4FA()))
		{
			...
			Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_206.f_6 = func_133(iParam0, true);
		}
...
void func_129(int iParam0, int iParam1, BOOL bParam2) // Position - 0x43EF
{
	int num;
...
void func_132(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x44D7
{
	int num;
...
BOOL func_136(int iParam0) // Position - 0x4B0F
{
	if (!func_65(iParam0))
		return false;
...
void func_139(var uParam0) // Position - 0x4BAD
{
	...
	for (i = 0; i < unk_0x95C7A22DBE7AEF4C(); i = i + 1)
	{
		...
		if (unk_0x7206AEB20960CCC8(unk2))
		{
			...
			{
				if (unk_0x1864096A95E36EBA(player) == unk || func_142(unk_0x1864096A95E36EBA(player), unk, 0, -1))
				{
					num = num + 1;
				
					if (player != unk_0x259BE71D8A81D4FA())
						if (func_141(unk_0x259BE71D8A81D4FA(), player))
							flag = true;
				}
			}
		}
...
BOOL func_141(var uParam0, Player plParam1) // Position - 0x4CBA
{
	if (unk_0x7260716F2E4D7661())
	{
		Global_2707308 = { func_127(uParam0) };
		Global_2707321 = { func_127(plParam1) };
...
BOOL func_143(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5072
{
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		if (!_NETWORK_IS_PLAYER_VALID(player, true, true) || func_63(player, 0) || IS_BIT_SET(Global_2657971[player /*465*/].f_200, 2) || func_144(player))
		{
		}
...
BOOL func_144(Player plParam0) // Position - 0x519E
{
...
void func_145(BOOL bParam0, var uParam1) // Position - 0x51B6
{
	...
	else
	{
		for (i = 0; i < 32; i = i + 1)
		{
			...
			if (_NETWORK_IS_PLAYER_VALID(player, true, true))
			{
				if (player != unk_0x259BE71D8A81D4FA())
				{
					if (func_146(unk_0x259BE71D8A81D4FA(), player) <= 20f)
					{
						num = num + 1;
	...
	if (flag)
		num3 = SYSTEM::ROUND(func_140(*uParam1, 100) * 10f * Global_262145.f_3922);

	if (num > 4)
		num = 4;

	if (num >= 1)
		num4 = SYSTEM::ROUND(func_140(*uParam1, 100) * 20f * Global_262145.f_3920);
...
float func_146(var uParam0, Player plParam1) // Position - 0x52CE
{
	return SYSTEM::VDIST(_GET_PLAYER_COORDS(uParam0), _GET_PLAYER_COORDS(plParam1));
}

Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x52EA
{
	return unk_0xD1A6A821F5AC81DB(unk_0x56E414973C2A8C0E(plParam0), 0);
}

int func_148(var uParam0) // Position - 0x52FD
{
	int num;
...
int func_155(Player plParam0) // Position - 0x54DA
{
	return func_156(func_157(plParam0));
}
...
int func_157(Player plParam0) // Position - 0x5506
{
	if (func_65(plParam0))
		if (func_158(plParam0, false))
			return Global_1887305[plParam0 /*610*/].f_10.f_33;

	return -1;
}

BOOL func_158(Player plParam0, BOOL bParam1) // Position - 0x5532
{
	if (func_65(plParam0))
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x560C
{
	Player player;
...
void func_168(int iParam0, int iParam1) // Position - 0x56AC
{
	...
	unk_0xC7B4A5CCCF31FA28(iParam0, "awardLabel", &Global_2697753);
...
BOOL func_169(int iParam0) // Position - 0x57AB
{
...
void func_174(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, int iParam36) // Position - 0x6148
{
	...
	if (func_54())
	{
		TEXT_LABEL_COPY(&unk2, { func_177(iParam36) }, 16);
		...
		if (unk_0x38640D2193CB547F(803) == 1 && uParam1->f_165 == 0)
		{
			...
			for (i = 0; i < num; i = i + 1)
			{
				...
				if (unk == unk36)
				{
					...
					if (unk36.f_2)
						func_184("CREWPROM" /*You have been promoted to ~a~ status in the hierarchy of Crew ~a~.*/, &unk47, &(unk.f_1));
					else
						func_184("CREWDEMO" /*You have been demoted to ~a~ status in the hierarchy of Crew ~a~.*/, &unk47, &(unk.f_1));
		...
		if (unk_0x38640D2193CB547F(803) == 1 && uParam1->f_165 == 0)
		{
			switch (num2)
			{
				...
				case joaat("MP1_AWD_50_VEHICLES_BLOWNUP"):
					...
					{
						if (num2.f_17 > 1)
							func_190("SCFEED_13" /*~a~ has blown up ~1~ vehicles in GTA Online. You've blown up ~1~.*/, &(num2.f_1), num2.f_17, num, 0, true);
						else
							func_190("SCFEED_13b" /*~a~ has blown up ~1~ vehicle in GTA Online. You've blown up ~1~.*/, &(num2.f_1), num2.f_17, num, 0, true);
				...
				case joaat("MP1_AWD_VEHICLES_JACKEDR"):
					...
					{
						if (num2.f_17 > 1)
							func_190("SCFEED_10" /*~a~ has stolen ~1~ vehicles in GTA Online. You've stolen ~1~.*/, &(num2.f_1), num2.f_17, num, 0, true);
						else
							func_190("SCFEED_10b" /*~a~ has stolen ~1~ vehicle in GTA Online. You've stolen ~1~.*/, &(num2.f_1), num2.f_17, num, 0, true);
				...
				case joaat("MP1_AWD_FMTIME5STARWANTED"):
					...
					if (num2.f_17 > num)
					{
						func_190("SCFEED_4" /*~a~ survived a 5 star Wanted Level for ~1~ minutes in GTA Online. Your best time is ~1~ minutes.*/, &(num2.f_1), num2.f_17, num, 0, true);
						uParam1->f_165 = 1;
					}
					break;
					...
					if (num2.f_17 > num)
					{
						...
						else
						{
							if (unk_0x4721B5E26C8861C8())
								func_190("SCFEED_5" /*~a~ did a wheelie for ~1~m in GTA Online. Your furthest distance is ~1~m.*/, &(num2.f_1), num2.f_17, num, 0, true);
							else
								func_190("SCFEED_5b" /*~a~ did a wheelie for ~1~ft in GTA Online. Your furthest distance is ~1~ft.*/, &(num2.f_1), num2.f_17, num, 0, true);
				...
				case joaat("MP1_AWD_FMDRIVEWITHOUTCRASH"):
					...
					if (num2.f_17 > num)
					{
						func_190("SCFEED_6" /*~a~ drove without crashing for ~1~ minutes in GTA Online. Your best time is ~1~ minutes.*/, &(num2.f_1), num2.f_17, num, 0, true);
						uParam1->f_165 = 1;
					}
					break;
				...
				case joaat("MP1_AWD_FMMOSTFLIPSINONEVEHICLE"):
					...
					{
						if (num2.f_17 > 1)
							func_190("SCFEED_7" /*~a~ did ~1~ flips in 1 jump in GTA Online. Your highest amount is ~1~.*/, &(num2.f_1), num2.f_17, num, 0, true);
						else
							func_190("SCFEED_7b" /*~a~ did ~1~ flip in 1 jump in GTA Online. Your highest amount is ~1~.*/, &(num2.f_1), num2.f_17, num, 0, true);
				...
				case joaat("MP1_AWD_FMMOSTSPINSINONEVEHICLE"):
					...
					{
						if (num2.f_17 > 1)
							func_190("SCFEED_8" /*~a~ did ~1~ spins in 1 jump in GTA Online. Your highest amount is ~1~.*/, &(num2.f_1), num2.f_17, num, 0, true);
						else
							func_190("SCFEED_8b" /*~a~ did ~1~ spin in 1 jump in GTA Online. Your highest amount is ~1~.*/, &(num2.f_1), num2.f_17, num, 0, true);
				...
				case joaat("MP1_CHAR_FM_RACE_RECORD_TIMES") /* collision: MPPLY_ARENAWARSPSTAT_INT54 */:
					if (func_116() == 0 && !unk_0x834C960822A4683F() && !func_115() && !func_114() && !func_113() && !func_112() && !func_111() && !func_110() && !func_109() && !func_108() && func_165() && func_103() && Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_96 != 8 && Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_96 != 9 && !func_101(unk_0x259BE71D8A81D4FA()) && !func_100() && !func_98(unk_0x259BE71D8A81D4FA(), true, false))
					{
						flag.f_16 = 1;
						flag.f_20 = -1;
						flag.f_21 = -1;
						...
						if (func_83(&flag, &(num2.f_20), &unk128, &unk217))
						{
							if (flag)
							{
								func_187("SCFEED_11" /*~a~ set a Race World Record on ~a~ with the time: ~a~.*/, &(num2.f_1), num2.f_17, &(unk128.f_22), true, 2f);
...
int func_190(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x6C2E
{
	int num;
	var unk;
...
struct<4> func_196() // Position - 0x6E47
{
	...
	for (i = 0; i <= 7; i = i + 1)
	{
		if (i < 2)
		{
			...
			TEXT_LABEL_APPEND_STRING(&unk, func_197(num), 16);
		}
		else if (i < 5)
		{
...
void func_199() // Position - 0x71E8
{
	...
	if (unk_0xEF61EA953D7D9120())
	{
		...
		num6 = num4 - num3;
		num7 = (num6 / num) * num2;
		value = func_201(num5 - num7, 0, 100);
...
void func_204(int iParam0) // Position - 0x7453
{
	...
	if (!Global_2359296[func_195() /*5570*/].f_593.f_41[iParam0])
	{
		...
		unk_0x43183279AE613B06();
		unk_0x2A160FB19DDAA9B3();
		Global_2359296[func_195() /*5570*/].f_593.f_41[iParam0] = true;
	}
...
void func_205(eCharacter echParam0) // Position - 0x74D6
{
	...
	if (echParam0 == CHAR_MICHAEL)
	{
		...
		num6 = { Global_113969.f_20121[0 /*43*/] };
		num7 = { Global_113969.f_20121.f_130[0 /*41*/] };
	}
	else if (echParam0 == CHAR_FRANKLIN)
	{
		...
		num6 = { Global_113969.f_20121[1 /*43*/] };
		num7 = { Global_113969.f_20121.f_130[1 /*41*/] };
	}
	else if (echParam0 == CHAR_TREVOR)
	{
		...
		num6 = { Global_113969.f_20121[2 /*43*/] };
		num7 = { Global_113969.f_20121.f_130[2 /*41*/] };
	}
	else if (echParam0 == CHAR_MULTIPLAYER)
	{
		...
		if (func_479(iLocal_74, &num8))
			func_478(&num6, num8);
		else
			func_478(&num6, 0);
	
		num7 = { Global_2359296[func_195() /*5570*/].f_593 };
		...
		else
		{
			...
			for (j = 0; j < Global_113969.f_20121; j = j + 1)
			{
				if (!Global_113969.f_20121[j /*43*/].f_41)
				{
					...
					if (Global_113969.f_20121[j /*43*/] != 0 && Global_113969.f_20121[j /*43*/].f_29 != 0)
		...
		if (!Global_113969.f_20121.f_273[echParam0])
		{
			if (!func_477(0) && !func_477(3) && !func_477(2) || !func_176(0))
			{
				if (echParam0 == CHAR_FRANKLIN || echParam0 == CHAR_MICHAEL && func_176(0) && func_476(echParam0) && !Global_113969.f_9088.f_99.f_58[135] || echParam0 == CHAR_TREVOR && func_176(0) && func_476(echParam0) && !Global_113969.f_9088.f_99.f_58[136])
				{
					...
					num9.f_31 = 49;
					num9.f_81 = 2;
					func_475(echParam0, &num9, 1);
					func_474(num9.f_5, num9.f_7, -1, true, &num10);
					func_474(num9.f_6, -1, -1, false, &num11);
					func_202("carUnlocked", 1);
					func_202("carModel", num9);
					...
					if (num9 == joaat("buffalo2"))
					{
						...
						func_202("carColour1", num10);
						func_202("carColour2", num11);
	...
	if (unk_0x76CD105BCAC6EB9F())
	{
		...
		if (iLocal_132 == 0)
			flag2 = func_471(joaat("MPPLY_CARAPP_DATA_SENT_0"));
		else if (iLocal_132 == 1)
			flag2 = func_471(joaat("MPPLY_CARAPP_DATA_SENT_1"));
		else if (iLocal_132 == 2)
			flag2 = func_471(joaat("MPPLY_CARAPP_DATA_SENT_2"));
		else if (iLocal_132 == 3)
			flag2 = func_471(joaat("MPPLY_CARAPP_DATA_SENT_3"));
		else if (iLocal_132 == 4)
			flag2 = func_471(joaat("MPPLY_CARAPP_DATA_SENT_4"));
		...
		else if (unk_0x76CD105BCAC6EB9F() && _NETWORK_IS_PLAYER_VALID(unk_0x259BE71D8A81D4FA(), true, true))
		{
			if (SYSTEM::TIMERB() > 5000)
			{
				...
				else if (iLocal_133 == 2)
				{
					...
					if (func_414(&unk205, iLocal_134) == -1)
					{
						iLocal_134 = 0;
						iLocal_133 = iLocal_133 + 1;
						SYSTEM::SETTIMERB(0);
	...
	if (num7.f_33)
	{
		if (unk_0x76CD105BCAC6EB9F())
		{
			if (func_85() == 0)
			{
				num12 = Global_2359296[func_195() /*5570*/].f_593.f_62;
			
				if (Global_1586521[num12 /*142*/].f_66 == num7)
				{
					if (num7.f_37)
					{
						num7.f_38 = 0;
						...
						if (iLocal_107 == 0)
						{
							...
							{
								unk_0x9586B50628529A63(&(Global_2359296[func_195() /*5570*/].f_593.f_28), &iLocal_105);
							}
						}
						else if (iLocal_107 == 1)
						{
							if (iLocal_106 == 0)
							{
								unk_0x271FD9228830C5F4(&(Global_2359296[func_195() /*5570*/].f_593.f_28), &iLocal_106);
							}
					...
					else if (func_413(unk_0x259BE71D8A81D4FA(), true, false))
					{
					}
					else if (!func_165())
					{
					...
					else if (bLocal_121)
					{
						...
						else
						{
							...
							{
								func_396(&num7, false);
								unk_0x0B0C9A0F9AAEB7F0(&(Global_1586521[num12 /*142*/].f_103), 14);
								bLocal_122 = true;
								func_373(num12, &Global_1586521[num12 /*142*/], true, -1, false, false);
								func_129(407109726, 3, false);
							}
						
							if (func_296(_CHAR_LS_CUSTOMS_2, "SOCIAL_CARAPP1" /*Your Los Santos Customs order has been processed for your ~a~.*/, unk_0x93E7527CFECC7CD8(num7), false, -99, 0, 0, false, 0))
							{
								flag4 = unk_0x227D0C27EB51D76C() >= num7.f_27;
								flag5 = !flag4 && unk_0x227D0C27EB51D76C() > 0;
							
								if (num7.f_27 > 0)
									unk_0x231BA68A82FF0316(num7.f_27, num7, 8, 1, flag4, "CMOD_MAIN_0", unk_0x70E57E9927B6BA58(func_295(39, 0, false)), unk_0x70E57E9927B6BA58("CMOD_MAIN_0"), 0, flag5);
					...
					{
						if (func_296(_CHAR_LS_CUSTOMS_2, "SOCIAL_CARAPP3" /*We could not process your Los Santos Customs order due to lack of funds. Drop by one of our garages with your ~a~ when you have enough money.*/, unk_0x93E7527CFECC7CD8(num7), false, -99, 0, 0, false, 0))
						{
							num7.f_33 = 0;
							num7.f_36 = 1;
							num7.f_35 = 0;
					...
					else if (func_296(_CHAR_LS_CUSTOMS_2, "SOCIAL_CARAPP" /*Drop by Los Santos Customs to have your ~a~ order fulfilled.*/, unk_0x93E7527CFECC7CD8(num7), false, -99, 0, 0, false, 0))
					{
						num7.f_33 = 0;
						num7.f_36 = 1;
						num7.f_35 = 0;
		...
		{
			if (Global_113969.f_2366.f_539.f_2407[0 /*295*/][echParam0 /*98*/] == num7 || Global_113969.f_2366.f_539.f_2407[1 /*295*/][echParam0 /*98*/] == num7 || Global_113969.f_2366.f_539.f_2407[2 /*295*/][echParam0 /*98*/] == num7 || Global_113969.f_2366.f_539.f_2407[3 /*295*/][echParam0 /*98*/] == num7 || echParam0 == CHAR_FRANKLIN && num7 == joaat("buffalo2") && !Global_113969.f_20121.f_281[echParam0] || echParam0 == CHAR_MICHAEL && num7 == joaat("tailgater") && !Global_113969.f_20121.f_281[echParam0] || echParam0 == CHAR_TREVOR && num7 == joaat("bodhi2") && !Global_113969.f_20121.f_281[echParam0])
			{
				if (num7.f_37)
				{
					num7.f_38 = 0;
					...
					if (iLocal_107 == 0)
					{
						...
						{
							unk_0x9586B50628529A63(&(Global_113969.f_20121.f_130[echParam0 /*41*/].f_28), &iLocal_105);
						}
					}
					else if (iLocal_107 == 1)
					{
						if (iLocal_106 == 0)
						{
							unk_0x271FD9228830C5F4(&(Global_113969.f_20121.f_130[echParam0 /*41*/].f_28), &iLocal_106);
						}
						else if (!unk_0x078BF797A07B0C7C(iLocal_106))
						{
							switch (unk_0x9B55331B5F9C67C8(iLocal_106))
				...
				else if (uLocal_109[echParam0])
				{
					...
					if (!func_284(num7.f_27) && echParam0 != CHAR_FRANKLIN || Global_113969.f_20121.f_281[echParam0])
					{
						num7.f_39 = 1;
					}
					else
				...
				else if (num7.f_39)
				{
					if (!func_477(0) && !func_477(3) && !func_477(2))
					{
						if (func_265(_CHAR_LS_CUSTOMS_2, "SOCIAL_CARAPP3" /*We could not process your Los Santos Customs order due to lack of funds. Drop by one of our garages with your ~a~ when you have enough money.*/, 2, unk_0xFACCDE46E24AD056(unk_0x93E7527CFECC7CD8(Global_113969.f_20121.f_130[echParam0 /*41*/])), -99, "NULL", 1, 0, 0, 0, 0, true, 0, 1, 0, 0, 0))
						{
							num7.f_33 = 0;
							num7.f_36 = 1;
							num7.f_35 = 0;
				...
				else if (!func_477(0) && !func_477(3) && !func_477(2))
				{
					...
					if (func_265(_CHAR_LS_CUSTOMS_2, &unk212, 2, unk_0xFACCDE46E24AD056(unk_0x93E7527CFECC7CD8(Global_113969.f_20121.f_130[echParam0 /*41*/])), -99, "NULL", 1, 0, 0, 0, 0, true, 0, 1, 0, 0, 0))
					{
						num7.f_33 = 0;
						num7.f_36 = 1;
						num7.f_35 = 0;
	...
	if (unk_0x76CD105BCAC6EB9F())
		if (echParam0 != CHAR_MULTIPLAYER || !func_261(39) || func_260() || func_98(unk_0x259BE71D8A81D4FA(), true, false))
			flag6 = false;
		...
		for (i = 0; i < 2; i = i + 1)
		{
				...
				if (unk_0xEF61EA953D7D9120())
				{
					...
					if (num13 != 0 && num13 != num7.f_26 && func_23("character") == num && !unk_0x76CD105BCAC6EB9F() || func_23("vehicle") == iLocal_73)
					{
						...
						if (!unk_0xAD1840C2E6AF7D5E(num7))
							if (echParam0 == CHAR_MICHAEL)
								num7 = func_258(CHAR_MICHAEL, 1);
							else if (echParam0 == CHAR_FRANKLIN)
								num7 = func_258(CHAR_FRANKLIN, 1);
							else if (echParam0 == CHAR_TREVOR)
								num7 = func_258(CHAR_TREVOR, 1);
							else
								num7 = joaat("buffalo2");
						...
						num7.f_18 = func_257(func_23("bulletProofTyres"));
			...
			else if (i == 1 && flag)
			{
				...
				if (unk_0xEF61EA953D7D9120())
				{
					...
					if (num7.f_32 > 4)
					{
						if (num7.f_32 == 6 || num7.f_32 == 12 && !func_254(num7.f_32, -1))
						{
						}
						else
						{
					...
					TEXT_LABEL_ASSIGN_STRING(&(num7.f_28), func_253("carPlateText"), 16);
				}
	...
	if (!num6.f_41 && flag6 && num6.f_40)
	{
		...
		func_202("appUID", num14);
		Global_113969.f_20121.f_272 = num14;
		value = 0;
		value2 = 0;
		...
		else
		{
			...
			if (num6 == joaat("sanchez") || num6 == joaat("faggio2") || num6 == joaat("dune") || num6 == joaat("bfinjection") || !func_219(num6.f_10))
				num6.f_27 = 0;
			...
			if (unk_0x76CD105BCAC6EB9F())
			{
				...
				func_202("playerGangR", num3);
				func_202("playerGangG", num4);
				func_202("playerGangB", num5);
			}
			...
			func_202("carColour1", num6.f_1);
			func_202("carColour2", num6.f_2);
			func_202("windowTint", num6.f_3);
			func_202("bulletProofTyres", func_207(num6.f_16));
			func_202("carEngine", num6.f_7);
			func_202("carBrakes", num6.f_8);
			func_202("carExhaust", num6.f_11);
			func_202("carWheel", num6.f_9);
			func_202("tyreSmokeColourRed", num6.f_4);
			func_202("tyreSmokeColourGreen", num6.f_5);
			func_202("tyreSmokeColourBlue", num6.f_6);
			func_202("carHorn", num6.f_14);
			func_202("carArmour", num6.f_13);
			func_202("carTurbo", num6.f_17);
			func_202("carSuspension", num6.f_12);
			func_202("carXenonLights", num6.f_15);
			func_202("tyreSmoke", num6.f_18);
			func_202("tyreSmoke", num6.f_18);
			func_202("carWheelType", num6.f_10);
			func_202("carEngineCount", num6.f_24);
			func_202("carBrakesCount", num6.f_25);
			func_202("carExhaustCount", num6.f_26);
			func_202("carWheelCount", num6.f_27);
			func_202("carHornCount", num6.f_28);
			func_202("carArmourCount", num6.f_29);
			func_202("carSuspensionCount", num6.f_30);
			func_202("carHorn1", num6.f_33[0]);
			func_202("carHorn2", num6.f_33[1]);
			func_202("carHorn3", num6.f_33[2]);
			func_202("carHorn4", num6.f_33[3]);
			func_202("carHorn5", num6.f_33[4]);
			func_472("carPriceModifier", num6.f_31);
			...
			if (!unk_0x76CD105BCAC6EB9F() || IS_BIT_SET(Global_1586521[iLocal_75 /*142*/].f_103, 17))
				unk_0x0B0C9A0F9AAEB7F0(&num17, 0);
		
			if (!unk_0x76CD105BCAC6EB9F() || IS_BIT_SET(Global_1586521[iLocal_75 /*142*/].f_103, 18))
				unk_0x0B0C9A0F9AAEB7F0(&num17, 1);
		
			func_202("newItemUnlocks", num17);
		}
		...
		bLocal_87 = true;
		unk_0x1E0C7CB82F66748E("plate");
		func_202("carPlateBack", num6.f_23);
		unk_0x43183279AE613B06();
		unk_0x2A160FB19DDAA9B3();
		num6.f_40 = 0;
		bLocal_104 = true;
		...
		if (!unk_0x76CD105BCAC6EB9F())
		{
			Global_113969.f_20121.f_277[echParam0] = 1;
		}
		else
		{
			if (num2 == 0)
			...
			Global_2359296[func_195() /*5570*/].f_593.f_41[iLocal_73] = false;
		}
	}
	...
	switch (echParam0)
	{
		...
		case CHAR_FRANKLIN:
		case CHAR_TREVOR:
			Global_113969.f_20121[echParam0 /*43*/] = { num6 };
			Global_113969.f_20121.f_130[echParam0 /*41*/] = { num7 };
			break;
	
		case CHAR_MULTIPLAYER:
			func_206(&num6);
			Global_2359296[func_195() /*5570*/].f_593 = { num7 };
			break;
	}
...
int func_208(int iParam0) // Position - 0x913C
{
	...
	if (func_210(iParam0) || iParam0 == -1576586413)
		return 38;
...
BOOL func_209(int iParam0) // Position - 0xA07B
{
	switch (iParam0)
	{
		case joaat("adder"):
...
BOOL func_210(int iParam0) // Position - 0xAEDA
{
	switch (iParam0)
	{
		case joaat("deity"):
...
BOOL func_211(int iParam0) // Position - 0xAF69
{
	switch (iParam0)
	{
		case joaat("scarab"):
...
BOOL func_212(int iParam0) // Position - 0xB055
{
	switch (iParam0)
	{
		case joaat("hunter"):
...
BOOL func_213(int iParam0) // Position - 0xB0AE
{
	switch (iParam0)
	{
		case joaat("havok"):
...
BOOL func_217(int iParam0) // Position - 0xB1E8
{
	switch (iParam0)
	{
		case joaat("formula"):
...
BOOL func_218(int iParam0, int iParam1) // Position - 0xB214
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
BOOL func_220(int iParam0) // Position - 0xB63A
{
	if (iParam0 == 0)
		return false;
...
BOOL func_224() // Position - 0xB946
{
	...
	unk8 = { func_248(joaat("MPPLY_STARTED_MP")) };

	if (func_225(unk8, unk, 7))
		return true;
...
BOOL func_250(var uParam0) // Position - 0xC27B
{
	...
	unk_0xE33678A9AE50A01B(unk, Global_1586521[iLocal_75 /*142*/].f_69);
...
float func_251(var uParam0) // Position - 0xC455
{
	int num;
	int num2;
	int num3;
...
int func_256(eCharacter echParam0, int iParam1) // Position - 0xC633
{
	int num;
	int i;
...
int func_258(eCharacter echParam0, int iParam1) // Position - 0xC6AF
{
	int num;
...
BOOL func_265(eCharacter echParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, int iParam12, int iParam13, int iParam14, char* sParam15, char* sParam16) // Position - 0xCB71
{
	int num;
...
int func_267(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0xCC30
{
	...
	func_268(echParam0, sParam1, num2, func_272(unk_0x259BE71D8A81D4FA()));
	return 1;
}
...
BOOL func_271(int iParam0, int iParam1) // Position - 0xD219
{
						...
						if (Global_9369[i] == 0)
						{
							...
							else if (num == 7)
							{
								if (Global_79389)
								{
									...
									func_274(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8807[num /*15*/].f_10), SYSTEM::TO_FLOAT(value), -1f, &Global_8807[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20930)
...
void func_274(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0xD7C9
{
...
void func_275(int iParam0) // Position - 0xD87C
{
...
void func_277(var uParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD8B1
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	unk_0x330108B080A2132F(SYSTEM::ROUND(fParam2));
...
{
	if (Global_79389)
		return _NETWORK_IS_PLAYER_VALID(unk_0x259BE71D8A81D4FA(), bParam0, !func_287(true));
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0xE034
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0xE071
{
...
int func_293(eCharacter echParam0) // Position - 0xE096
{
...
BOOL func_296(eCharacter echParam0, char* sParam1, char* sParam2, BOOL bParam3, int iParam4, char* sParam5, char* sParam6, BOOL bParam7, int iParam8) // Position - 0xE771
{
	var unk;
	int num;
	...
	return func_297(&unk, echParam0, func_372(), sParam1, num, 3, iParam8, sParam2, bParam3, iParam4, sParam5, sParam6, -1);
}

BOOL func_297(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, char* sParam7, BOOL bParam8, int iParam9, char* sParam10, char* sParam11, Player plParam12) // Position - 0xE7AA
{
	var unk;
	var unk2;
	int num;
	...
	if (func_361(unk, unk2, num))
	{
		if (func_360())
			return false;
	
		func_359();
		return func_304(uParam0, echParam1, plParam12, sParam2, sParam3, iParam4, iParam5, iParam6, sParam7, bParam8, iParam9, sParam10, sParam11);
	}

	if (!func_303(iParam4))
		return false;

	func_298(unk, unk2, num, sParam3, iParam4, iParam5, iParam6);
	return false;
}

void func_298(var uParam0, var uParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6) // Position - 0xE88F
{
...
BOOL func_304(var uParam0, eCharacter echParam1, Player plParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, char* sParam8, BOOL bParam9, int iParam10, char* sParam11, char* sParam12) // Position - 0xE995
{
	var unk;
...
BOOL func_305(eCharacter echParam0, Player plParam1, char* sParam2, int iParam3, char* sParam4, BOOL bParam5, int iParam6, char* sParam7, char* sParam8) // Position - 0xEA8F
{
	BOOL flag;
	...
	if (func_307(echParam0, plParam1, sParam2, flag, iParam3, sParam4, bParam5, iParam6, sParam7, sParam8))
	{
		func_306(120000);
		return 1;
	}
...
BOOL func_307(eCharacter echParam0, Player plParam1, char* sParam2, BOOL bParam3, int iParam4, char* sParam5, BOOL bParam6, int iParam7, char* sParam8, char* sParam9) // Position - 0xEAE9
{
	Player player;
	int num;
	char* str;
	...
	num2 = 0;
	str2 = func_321(sParam5, bParam6, &num2);
	...
	if (!(num2 == 0) || !unk_0xD6F9DEE4765092A9(str))
		flag2 = func_318(echParam0, sParam2, num7, str2, num3, str, num2, num8, 1, num6, 0, flag, num5, 0, num4, sParam8, sParam9);
	else
...
int func_312(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0xECD5
{
	...
	func_313(echParam0, sParam1, num2, func_272(unk_0x259BE71D8A81D4FA()));
	return 1;
}

void func_313(eCharacter echParam0, char* sParam1, BOOL bParam2, var uParam3) // Position - 0xF0C2
{
	eCharacter character;
...
BOOL func_318(eCharacter echParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, int iParam12, int iParam13, int iParam14, char* sParam15, char* sParam16) // Position - 0xF49D
{
	int num;
...
char* func_321(char* sParam0, BOOL bParam1, var uParam2) // Position - 0xF5EF
{
	if (unk_0xD6F9DEE4765092A9(sParam0))
		return sLocal_19;
...
int func_322(Player plParam0) // Position - 0xF62C
{
	int num;
...
void func_323(Player plParam0, BOOL bParam1) // Position - 0xF662
{
	if (!_NETWORK_IS_PLAYER_VALID(plParam0, false, true))
		return;

	if (func_325(plParam0) != -1)
		return;
...
BOOL func_324(Player plParam0) // Position - 0xF6CE
{
	int i;
...
int func_325(Player plParam0) // Position - 0xF700
{
	int i;
...
BOOL func_329(eCharacter echParam0, Player plParam1, char* sParam2, int iParam3, char* sParam4, BOOL bParam5, int iParam6, char* sParam7, char* sParam8) // Position - 0xF873
{
	BOOL flag;

	func_328();
	flag = false;
	return func_307(echParam0, plParam1, sParam2, flag, iParam3, sParam4, bParam5, iParam6, sParam7, sParam8);
}

BOOL func_330(eCharacter echParam0, Player plParam1, char* sParam2, int iParam3, char* sParam4, BOOL bParam5, int iParam6, char* sParam7, char* sParam8) // Position - 0xF89A
{
	BOOL flag;

	flag = false;
	return func_331(echParam0, plParam1, sParam2, flag, iParam3, sParam4, bParam5, iParam6, sParam7, sParam8);
}

BOOL func_331(eCharacter echParam0, Player plParam1, char* sParam2, BOOL bParam3, int iParam4, char* sParam5, BOOL bParam6, int iParam7, char* sParam8, char* sParam9) // Position - 0xF8BD
{
	Player player;
	int num;
	char* str;
	...
	if (!(num2 == 0) || !unk_0xD6F9DEE4765092A9(str))
		flag2 = func_265(echParam0, sParam2, num7, str2, num3, str, num2, num8, 1, num6, 0, flag, num5, 0, num4, sParam8, sParam9);
	else
...
BOOL func_333(eCharacter echParam0, Player plParam1, char* sParam2, int iParam3, char* sParam4, BOOL bParam5, int iParam6, char* sParam7, char* sParam8) // Position - 0xFA1B
{
	BOOL flag;
	...
	if (func_331(echParam0, plParam1, sParam2, flag, iParam3, sParam4, bParam5, iParam6, sParam7, sParam8))
	{
		func_306(120000);
		return 1;
	}
...
BOOL func_361(var uParam0, var uParam1, int iParam2) // Position - 0x10364
{
	if (!func_362(uParam0))
		return 0;
...
BOOL func_362(var uParam0) // Position - 0x103A3
{
	if (!func_363())
		return false;
...
BOOL func_370(var uParam0, var uParam1, int iParam2) // Position - 0x104E2
{
	if (!func_368())
		return false;

	return func_361(uParam0, uParam1, iParam2);
}

var func_371(char* sParam0, char* sParam1) // Position - 0x10500
{
	var unk;
...
int func_373(int iParam0, var uParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5) // Position - 0x10526
{
	...
	!bParam4;
	num = func_394(1411, iParam0);
	func_17(num, uParam1->f_138, iParam3);
	!bParam4;
	num = func_394(1412, iParam0);
	...
	else
	{
		...
		for (i = 0; i < 49; i = i + 1)
		{
			if (i < 25)
			{
				num = func_394(1414, iParam0) + i;
				func_17(num, uParam1->f_9[i], iParam3);
			}
			else
			{
				num = func_392(iParam0) + (i - 25);
				func_17(num, uParam1->f_9[i], iParam3);
			}
		}
		...
		for (i = 0; i < 2; i = i + 1)
		{
			num = func_394(1439, iParam0) + i;
			func_17(num, uParam1->f_59[i], iParam3);
		}
	}

	num = func_394(1441, iParam0);
	func_17(num, uParam1->f_62, iParam3);
	!bParam4;
	num = func_394(1442, iParam0);
	func_17(num, uParam1->f_63, iParam3);
	!bParam4;
	num = func_394(1443, iParam0);
	...
	{
		num = func_394(1444, iParam0);
		func_17(num, uParam1->f_65, iParam3);
		!bParam4;
	}

	num = func_394(1445, iParam0);
	...
	{
		num = func_394(3880, iParam0);
		func_17(num, uParam1->f_74, iParam3);
		num = func_394(3881, iParam0);
		func_17(num, uParam1->f_75, iParam3);
		num = func_394(3882, iParam0);
		...
		num = func_377(iParam0, false);
		func_17(num, uParam1->f_102, iParam3);
	}

	num2 = Global_2359296[func_195() /*5570*/].f_681.f_1275;
...
void func_374(int iParam0, var uParam1, int iParam2) // Position - 0x10982
{
	int num;
...
{
	if (bParam2)
		return func_383(unk_0x259BE71D8A81D4FA(), false);

	if (bParam1)
	{
		if (func_383(unk_0x259BE71D8A81D4FA(), false))
			return false;
...
BOOL func_383(int iParam0, BOOL bParam1) // Position - 0x19D26
{
	...
	return IS_BIT_SET(Global_2657971[iParam0 /*465*/].f_200, 24);
}

BOOL func_384(Player plParam0) // Position - 0x19D8C
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		return IS_BIT_SET(Global_2657971[plParam0 /*465*/].f_200, 9);

	return false;
}

BOOL func_385(Player plParam0) // Position - 0x19DAF
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		return IS_BIT_SET(Global_1845281[plParam0 /*883*/].f_268.f_391, 2);
...
BOOL func_393(int iParam0) // Position - 0x1AA28
{
	switch (iParam0)
	{
		case 10:
...
int func_394(int iParam0, int iParam1) // Position - 0x1AAF3
{
	...
	else if (iParam1 < func_378(11))
	{
		num = 11234 - 1411;
		num = num + iParam0;
		num = num + ((iParam1 - func_378(7)) * (1456 - 1411));
	}
	else if (iParam1 <= 157)
	{
		num = 11234 - 1411;
...
BOOL func_395(int iParam0) // Position - 0x1C34F
{
...
int func_396(var uParam0, BOOL bParam1) // Position - 0x1C370
{
	...
	num = Global_2359296[func_195() /*5570*/].f_593.f_62;

	if (*uParam0 == Global_1586521[num /*142*/].f_66 && uParam0->f_36 && uParam0->f_35)
	{
		Global_1586521[num /*142*/].f_1 = { uParam0->f_28 };
		Global_1586521[num /*142*/] = uParam0->f_32;
	
		if (func_397(uParam0->f_1, &unk2, &unk, &unk6, &unk7) && *uParam0 != joaat("sovereign"))
		{
			unk_0x8744D2E3FC95740E(&(Global_1586521[num /*142*/].f_77), 13);
			Global_1586521[num /*142*/].f_5 = unk6;
			Global_1586521[num /*142*/].f_7 = unk7;
			Global_1586521[num /*142*/].f_138 = unk;
		}
	
		if (func_397(uParam0->f_2, &unk2, &unk, &unk6, &unk7) && *uParam0 != joaat("sovereign"))
		{
			unk_0x8744D2E3FC95740E(&(Global_1586521[num /*142*/].f_77), 12);
			Global_1586521[num /*142*/].f_6 = unk6;
			Global_1586521[num /*142*/].f_139 = unk;
		}
	
		if (uParam0->f_18)
			unk_0x0B0C9A0F9AAEB7F0(&(Global_1586521[num /*142*/].f_77), 9);
		else
			unk_0x8744D2E3FC95740E(&(Global_1586521[num /*142*/].f_77), 9);
	
		Global_1586521[num /*142*/].f_62 = uParam0->f_6;
		Global_1586521[num /*142*/].f_63 = uParam0->f_7;
		Global_1586521[num /*142*/].f_64 = uParam0->f_8;
	
		if (uParam0->f_5 == -1)
			Global_1586521[num /*142*/].f_65 = 0;
		else
			Global_1586521[num /*142*/].f_65 = uParam0->f_5;
	
		if (uParam0->f_13 != -1)
			Global_1586521[num /*142*/].f_9[4] = uParam0->f_13;
	
		if (uParam0->f_9 != -1)
			Global_1586521[num /*142*/].f_9[11] = uParam0->f_9;
	
		if (uParam0->f_10 != -1)
			Global_1586521[num /*142*/].f_9[12] = uParam0->f_10;
	
		if (uParam0->f_16 != -1 && uParam0->f_16 < 9)
			Global_1586521[num /*142*/].f_9[14] = uParam0->f_16;
	
		if (uParam0->f_14 != -1)
			Global_1586521[num /*142*/].f_9[15] = uParam0->f_14;
	
		if (uParam0->f_15 != -1)
			Global_1586521[num /*142*/].f_9[16] = uParam0->f_15;
	
		if (uParam0->f_11 != -1 && func_219(uParam0->f_12))
		{
			Global_1586521[num /*142*/].f_9[23] = uParam0->f_11;
			Global_1586521[num /*142*/].f_69 = -1;
		}
	
		if (uParam0->f_19 != -1)
			Global_1586521[num /*142*/].f_9[18] = uParam0->f_19;
	
		if (uParam0->f_17 != -1)
			Global_1586521[num /*142*/].f_9[22] = uParam0->f_17;
	
		if (uParam0->f_20 != -1)
			Global_1586521[num /*142*/].f_9[20] = uParam0->f_20;
	
		if (func_480(num, &unk8))
		{
			if (bParam1)
			{
				unk_0x0B0C9A0F9AAEB7F0(&(Global_1586521[num /*142*/].f_103), 25);
				unk_0x8744D2E3FC95740E(&(Global_1586521[num /*142*/].f_103), 26);
			}
		}
...
BOOL func_398(var uParam0, int iParam1) // Position - 0x1DB31
{
	...
	num = 0;
	num2 = Global_1586521[iParam1 /*142*/].f_5;
	num3 = Global_1586521[iParam1 /*142*/].f_6;
	num4 = Global_1586521[iParam1 /*142*/].f_7;
	num5 = Global_1586521[iParam1 /*142*/].f_65;
	...
	if (func_411(uParam0->f_1, &num6, &num7))
	{
		if (num6 != -1 && num7 != -1 && num6 != num2 || num7 != num4)
		{
			func_397(uParam0->f_1, &unk3, &num9, &num6, &num7);
			...
			num11 = func_402(&unk3, num10, true, true, false, 0, false);
			num = num + num11;
		}
	}

	if (func_411(uParam0->f_2, &num8, &unk2))
	{
		if (num8 != -1 && num8 != num3)
		{
			func_397(uParam0->f_2, &unk3, &num9, &num6, &num7);
			...
			num11 = func_402(&unk3, num10, false, true, false, false, false);
			num = num + num11;
		}
	}
	...
	if (!IS_BIT_SET(Global_1586521[iParam1 /*142*/].f_77, 9))
		if (uParam0->f_18)
			num = num + 25000;

	unk7 = Global_1586521[iParam1 /*142*/].f_62;
	unk8 = Global_1586521[iParam1 /*142*/].f_63;
	unk9 = Global_1586521[iParam1 /*142*/].f_64;
	...
	unk = Global_1586521[iParam1 /*142*/].f_9[11];
	...
	unk = Global_1586521[iParam1 /*142*/].f_9[12];
	...
	unk = Global_1586521[iParam1 /*142*/].f_9[4];
	...
	unk = Global_1586521[iParam1 /*142*/].f_9[23];
	uParam0->f_11 != unk && uParam0->f_11 != -1;
	unk = Global_1586521[iParam1 /*142*/].f_9[14];
	...
	unk = Global_1586521[iParam1 /*142*/].f_9[16];
	...
	unk = Global_1586521[iParam1 /*142*/].f_9[15];
...
int func_402(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1E4C9
{
	int value;
...
int func_403(var uParam0) // Position - 0x1E5C8
{
	int num;
...
int func_404(var uParam0) // Position - 0x1EA60
{
	int num;
...
int func_405(var uParam0) // Position - 0x1EBBF
{
	int num;
...
int func_406(var uParam0) // Position - 0x1F057
{
	int num;
...
BOOL func_408(Player plParam0) // Position - 0x1F12C
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657971[plParam0 /*465*/].f_322.f_8 != -1)
				return func_409(Global_2657971[plParam0 /*465*/].f_322.f_8) == 22;
...
int func_410(var uParam0) // Position - 0x1F673
{
	int num;
...
BOOL func_413(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1FB5A
{
	if (bParam1)
		if (func_101(iParam0))
			return true;
...
BOOL func_415(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x1FCAC
{
	int num;
	...
	if (iParam0 == 4)
		if (iParam1 == 32 || iParam1 == 91)
			return func_133(func_419(unk_0x259BE71D8A81D4FA(), true), false) >= 100;
...
BOOL func_416(int iParam0, int iParam1) // Position - 0x1FE0E
{
	switch (iParam1)
	{
		...
		case 169:
		case 137:
			if (func_133(func_419(unk_0x259BE71D8A81D4FA(), true), false) >= func_417(iParam0, iParam1))
				return 1;
			else
				return 0;
			break;
...
BOOL func_420(int iParam0) // Position - 0x20785
{
	switch (iParam0)
	{
		case joaat("police"):
...
BOOL func_421(Player plParam0) // Position - 0x20815
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657971[plParam0 /*465*/].f_322.f_8 != -1)
				return func_409(Global_2657971[plParam0 /*465*/].f_322.f_8) == 26;

	return false;
}

BOOL func_422(Player plParam0) // Position - 0x2085C
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_408(plParam0) && Global_2657971[plParam0 /*465*/].f_322.f_11 == plParam0)
			return 1;

	return 0;
}

int func_423(var uParam0) // Position - 0x20891
{
	int num;
...
void func_424(var uParam0) // Position - 0x20DC5
{
	*uParam0 = 0;
...
BOOL func_425(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x20F4E
{
	int num;
	...
	else
	{
		...
		if (iParam0 == 85 || iParam0 == 86 || iParam0 == 87 || iParam0 == 88)
			if (func_432(iParam2) || func_431(num))
				return true;
		...
		if (iParam0 == 72 || iParam0 == 73 || iParam0 == 74 || iParam0 == 75)
			if (num == joaat("barrage") || func_431(num))
				return true;
		...
		if (iParam0 == 21 || iParam0 == 22 || iParam0 == 23)
			...
			if (func_431(num) || func_210(num) && !func_430(num))
				return true;
...
BOOL func_430(int iParam0) // Position - 0x2146B
{
	switch (iParam0)
	{
		case 610429990:
...
BOOL func_431(int iParam0) // Position - 0x2149A
{
...
BOOL func_432(int iParam0) // Position - 0x214DC
{
...
BOOL func_433(int iParam0) // Position - 0x21621
{
	int num;
	...
	if (unk_0xFC8BFE4B41177C22(iParam0) && unk_0xD9F5E1FEFD1329E4(iParam0, 0))
	{
		...
		if (unk_0x9E20DC08879FF3FC(iParam0) && !func_435(iParam0) || func_434(num))
			return true;
...
BOOL func_434(int iParam0) // Position - 0x2169E
{
	switch (iParam0)
	{
		case joaat("mule"):
...
BOOL func_435(int iParam0) // Position - 0x216FA
{
...
BOOL func_436(Player plParam0) // Position - 0x217C2
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657971[plParam0 /*465*/].f_322.f_8 != -1)
				return func_409(Global_2657971[plParam0 /*465*/].f_322.f_8) == 13;

	return false;
}

BOOL func_437(int iParam0) // Position - 0x21809
{
	BOOL flag;
	...
	if (!func_439(unk_0x259BE71D8A81D4FA()) && iParam0 != joaat("thruster") && iParam0 != joaat("avenger") && iParam0 != func_438(true) && !flag)
		return false;
...
BOOL func_440(Player plParam0) // Position - 0x218DA
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;

	if (func_441(plParam0) && Global_2657971[plParam0 /*465*/].f_322.f_11 == plParam0)
		return true;

	return false;
}

BOOL func_441(Player plParam0) // Position - 0x21913
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657971[plParam0 /*465*/].f_322.f_8 != -1)
				return func_409(Global_2657971[plParam0 /*465*/].f_322.f_8) == 9;

	return false;
}

BOOL func_442(int iParam0, BOOL bParam1) // Position - 0x2195A
{
	switch (unk_0x4B423FAA24E8ABF0(iParam0))
	{
		case joaat("technical"):
...
int func_443(int iParam0) // Position - 0x219B5
{
	...
	if (unk_0xFC8BFE4B41177C22(iParam0))
	{
		for (i = 0; i < 32; i = i + 1)
		{
			if (Global_2672855.f_231[i] == iParam0)
				return i;
		}
	}
...
BOOL func_444(int iParam0, int iParam1) // Position - 0x219EE
{
	if (iParam1 == 0)
...
BOOL func_453(int iParam0) // Position - 0x21EE9
{
	if (unk_0x259BE71D8A81D4FA() != _INVALID_PLAYER_INDEX())
	{
		...
		if (func_98(unk_0x259BE71D8A81D4FA(), true, false) && Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_268.f_35 > 0 || IS_BIT_SET(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_268.f_33, 14) || IS_BIT_SET(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_268.f_33, 11))
			return false;
...
BOOL func_454(int iParam0) // Position - 0x21FE2
{
...
BOOL func_456(Player plParam0) // Position - 0x22013
{
...
void func_468(var uParam0) // Position - 0x22163
{
	*uParam0 = 0;
...
void func_469(int iParam0, int iParam1) // Position - 0x223B4
{
	int num;
...
BOOL func_471(int iParam0) // Position - 0x223EC
{
	int num;
	int num2;
...
BOOL func_480(int iParam0, var uParam1) // Position - 0x22979
{
	int num;
	...
	if (unk_0x76CD105BCAC6EB9F() && _NETWORK_IS_PLAYER_VALID(unk_0x259BE71D8A81D4FA(), true, true))
	{
		...
		if (func_483(num))
		{
			for (i = 0; i < 10; i = i + 1)
			{
				...
				if (num2 >= 0 && Global_1586521[num2 /*142*/].f_66 != 0 && !IS_BIT_SET(Global_1586521[num2 /*142*/].f_103, 1) || IS_BIT_SET(Global_1586521[num2 /*142*/].f_103, 2) && func_220(Global_1586521[num2 /*142*/].f_66))
					if (func_480(num2, &unk))
						if (!IS_BIT_SET(Global_1586521[num2 /*142*/].f_103, 26))
							unk_0x0B0C9A0F9AAEB7F0(&(Global_1586521[num2 /*142*/].f_103), 25);
			}
...
void func_484() // Position - 0x22D3C
{
	...
	switch (iLocal_327)
	{
		case 0:
			...
			if (!func_485(unk_0x259BE71D8A81D4FA(), true))
			{
				for (i = 0; i < 10; i = i + 1)
				{
					num = Global_2359296[func_195() /*5570*/].f_593.f_74[i] - 1;
				
					if (num >= 0 && Global_1586521[num /*142*/].f_66 == 0 || IS_BIT_SET(Global_1586521[num /*142*/].f_103, 1) && !IS_BIT_SET(Global_1586521[num /*142*/].f_103, 2))
					{
						...
						for (j = 0; j < 10; j = j + 1)
						{
							if (Global_2359296[func_195() /*5570*/].f_593.f_63[j] == num + 1)
		...
		case 1:
			...
			if (Global_2359296[func_195() /*5570*/].f_681.f_2 != Global_2359296[func_195() /*5570*/].f_593.f_85 && Global_2359296[func_195() /*5570*/].f_681.f_2 != -1 && Global_1586521[Global_2359296[func_195() /*5570*/].f_681.f_2 /*142*/].f_66 != 0 && !IS_BIT_SET(Global_1586521[Global_2359296[func_195() /*5570*/].f_681.f_2 /*142*/].f_103, 1) || IS_BIT_SET(Global_1586521[Global_2359296[func_195() /*5570*/].f_681.f_2 /*142*/].f_103, 2))
			{
				num = Global_2359296[func_195() /*5570*/].f_681.f_2;
				Global_2359296[func_195() /*5570*/].f_593.f_85 = num;
			}
			else if (Global_2359296[func_195() /*5570*/].f_593.f_86 != 0)
			{
				num = Global_2359296[func_195() /*5570*/].f_593.f_86 - 1;
			...
			if (num != -1)
			{
				...
				for (i = 0; i < 10; i = i + 1)
				{
					if (Global_2359296[func_195() /*5570*/].f_593.f_63[i] == num + 1)
						flag2 = true;
				}
				...
				if (!flag2)
				{
					...
					for (i = 0; i < 10; i = i + 1)
					{
						if (Global_2359296[func_195() /*5570*/].f_593.f_63[i] == Global_2359296[func_195() /*5570*/].f_593.f_74[num5])
						{
							Global_2359296[func_195() /*5570*/].f_593.f_63[i] = num + 1;
							i = 11;
						}
					}
				}
			
				Global_2359296[func_195() /*5570*/].f_593.f_74[0] = num + 1;
				j = 1;
			...
			else if (Global_110667)
			{
				...
				if (num2 > 0)
				{
					...
					for (i = 0; i <= 516; i = i + 1)
					{
						if (func_480(i, &j) && Global_1586521[i /*142*/].f_66 != 0 && !IS_BIT_SET(Global_1586521[i /*142*/].f_103, 1) || IS_BIT_SET(Global_1586521[i /*142*/].f_103, 2) && func_220(Global_1586521[i /*142*/].f_66))
							num3 = num3 + 1;
					...
					if (num3 > 10 - num2)
					{
						...
						if (num != -1)
						{
							...
							Global_2359296[func_195() /*5570*/].f_593.f_74[num4] = num + 1;
						}
					}
				}
			}
...
BOOL func_486(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x233AA
{
	...
	if (Global_2657971[plParam0 /*465*/].f_322.f_8 != -1)
	{
		if (iParam2 == -1 || func_409(Global_2657971[plParam0 /*465*/].f_322.f_8) != iParam2)
		{
			if (bParam1)
				return func_487(plParam0) == plParam0;
...
Player func_487(Player plParam0) // Position - 0x23431
{
	int num;
	...
	{
		num = func_409(func_491(plParam0));
...
Player func_488(Player plParam0) // Position - 0x234C0
{
	if (func_65(plParam0))
...
BOOL func_489(Player plParam0, BOOL bParam1) // Position - 0x234E3
{
	if (!func_65(plParam0))
		return false;
	...
	return func_65(Global_1887305[plParam0 /*610*/].f_10);
}

BOOL func_490(Player plParam0) // Position - 0x2351B
{
	if (func_65(plParam0))
		if (func_65(Global_1887305[plParam0 /*610*/].f_10))
			return Global_1887305[plParam0 /*610*/].f_10 == plParam0;

	return false;
}

int func_491(Player plParam0) // Position - 0x23550
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
void func_493(var uParam0) // Position - 0x238A9
{
...
BOOL func_494(int iParam0, int iParam1) // Position - 0x23A27
{
	...
	if (func_497(iLocal_89, iParam0, iParam1, &unk))
		return func_495(unk);
...
int func_498(int iParam0) // Position - 0x24978
{
	var unk;
	int i;
...
BOOL func_499(int iParam0, int iParam1, BOOL bParam2) // Position - 0x249A9
{
	if (bParam2)
		return true;
...
BOOL func_501(int iParam0, int iParam1) // Position - 0x24BAB
{
	int num;
	int i;
...
BOOL func_504(int iParam0) // Position - 0x25EEA
{
	switch (iParam0)
	{
		case -1696319096:
...
BOOL func_505(int iParam0) // Position - 0x25F46
{
	switch (iParam0)
	{
		case joaat("calico"):
...
BOOL func_508(int iParam0) // Position - 0x26115
{
	switch (iParam0)
	{
		case joaat("veto"):
...
void func_511(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x265B0
{
	...
	if (iParam1 == -1)
	{
		if (!func_517(iParam0))
		{
			if (unk_0x76CD105BCAC6EB9F())
			{
				if (iParam0 == 0)
				{
					...
					{
						num = i * 3;
						num2 = func_514(unk_0x70E57E9927B6BA58(sParam2));
					
						if (num2 != -1)
							unk_0x0B0C9A0F9AAEB7F0(&Global_2359296[func_195() /*5570*/].f_681.f_2693[num + (num2 / 32)], num2 % 32);
					}
				}
				else
				{
					...
					{
						num4 = num3 * 3;
						num5 = func_514(unk_0x70E57E9927B6BA58(sParam2));
					
						if (num5 != -1)
							unk_0x0B0C9A0F9AAEB7F0(&Global_2359296[func_195() /*5570*/].f_681.f_2693[num4 + (num5 / 32)], num5 % 32);
					}
				
					num6 = func_512(iParam0, iParam3, iParam4, iParam5);
				
					if (num6 > 0)
						unk_0x0B0C9A0F9AAEB7F0(&Global_2359296[func_195() /*5570*/].f_681.f_3612[num6 / 32], num6 % 32);
				}
			}
		...
		else if (func_425(iParam1, -1, 0, -1) || iParam1 == -1)
		{
			...
			if (num7 > 0)
				unk_0x0B0C9A0F9AAEB7F0(&Global_2359296[func_195() /*5570*/].f_681.f_3612[num7 / 32], num7 % 32);
		}
	}
	else if (func_517(iParam0) && func_425(iParam1, -1, 0, -1))
	{
		...
		if (num8 > 0)
			unk_0x0B0C9A0F9AAEB7F0(&Global_2359296[func_195() /*5570*/].f_681.f_3612[num8 / 32], num8 % 32);
	}
	...
	if (iParam0 == 0)
	{
		for (j = 0; j < 306; j = j + 1)
		{
			if (func_425(iParam1, -1, 0, -1))
			{
				...
				if (unk_0x76CD105BCAC6EB9F())
					unk_0x0B0C9A0F9AAEB7F0(&Global_2359296[func_195() /*5570*/].f_681.f_47[num9], iParam1 % 32);
				else
					unk_0x0B0C9A0F9AAEB7F0(&Global_113969.f_668.f_90[num9], iParam1 % 32);
			}
		}
	}
	else if (func_425(iParam1, -1, 0, -1))
	{
		...
		if (num10 != -1)
		{
			...
			if (unk_0x76CD105BCAC6EB9F())
			{
				...
				if (num12 >= 0)
					unk_0x0B0C9A0F9AAEB7F0(&Global_2359296[func_195() /*5570*/].f_681.f_47[num11], num12);
			}
			else
			{
				unk_0x0B0C9A0F9AAEB7F0(&Global_113969.f_668.f_90[num11], num12);
			}
		}
	}
...
BOOL func_515(Player plParam0) // Position - 0x3F12E
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657971[plParam0 /*465*/].f_322.f_8 != -1)
				return func_409(Global_2657971[plParam0 /*465*/].f_322.f_8) == 23;
...
void func_520(int iParam0, int iParam1, BOOL bParam2) // Position - 0x3F96B
{
	...
	else if (unk_0x76CD105BCAC6EB9F())
	{
		if (func_85() == 0)
		{
			num = func_49(func_263(iParam0), -1);
			unk_0x8744D2E3FC95740E(&num, iParam1);
			func_132(func_263(iParam0), num, -1, 1);
		}
	}
	else
	{
		...
		switch (iLocal_85)
		{
			...
			case 1:
				if (unk_0x898EDBE06F676B56() != 1)
				{
					...
					func_202(&unk15, Global_2359296[num /*5570*/].f_593.f_61);
					unk_0x43183279AE613B06();
					unk_0x2A160FB19DDAA9B3();
					iLocal_85 = 0;
				}
		...
		switch (iLocal_85)
		{
			...
			case 1:
				if (unk_0x898EDBE06F676B56() != 1)
				{
					...
					TEXT_LABEL_APPEND_INT(&unk5, Global_113969.f_20121.f_266, 16);
					TEXT_LABEL_APPEND_STRING(&unk5, "_order", 16);
					unk_0x1E0C7CB82F66748E(&unk5);
					unk_0xE231BAAA0221F57B();
					unk_0x43183279AE613B06();
...
void func_528() // Position - 0x40470
{
	...
	if (!bLocal_131 || Global_110498)
	{
		...
		if (unk != Global_113969.f_20121.f_272)
			bLocal_103 = true;
...
void func_537() // Position - 0x409F0
{
	...
	else
	{
		...
		iLocal_67 = 1;
		iLocal_69 = 21;
		num = func_569(unk_0x259BE71D8A81D4FA());
		...
		if (num != -1)
		{
			...
			if (num2 == -1)
				num2 = unk_0xA71D65C4998B3DF8(unk_0x70E57E9927B6BA58(&(Global_4718592.f_127465)));
		
			iLocal_69 = func_568(num2);
		
			if (num == 0)
				if (func_413(unk_0x259BE71D8A81D4FA(), false, false) && func_546(*Global_4718592.f_127178, *Global_4718592.f_185586))
					iLocal_67 = 20;
		...
		if (unk_0x76CD105BCAC6EB9F() && !func_115() && !func_571() && !(func_85() == -1) && unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
		{
			if (Global_2693456 > 10000)
			{
				...
				if (unk > Global_2693449 || unk.f_1 > Global_2693449.f_1 || unk.f_2 > Global_2693449.f_2)
				{
...
BOOL func_549(int iParam0) // Position - 0x40F60
{
	int i;
...
BOOL func_550(int iParam0) // Position - 0x40FAD
{
	int i;
...
BOOL func_551(int iParam0) // Position - 0x40FFA
{
	int i;
...
BOOL func_552(int iParam0) // Position - 0x41047
{
	int i;
...
BOOL func_553(int iParam0) // Position - 0x41094
{
	int i;
...
BOOL func_554(int iParam0) // Position - 0x410E1
{
	int i;
...
BOOL func_555(int iParam0) // Position - 0x4112E
{
	int i;
...
BOOL func_556(int iParam0) // Position - 0x4117B
{
	int i;
...
BOOL func_557(int iParam0) // Position - 0x411C8
{
	int i;
...
BOOL func_558(int iParam0) // Position - 0x41215
{
	int i;
...
BOOL func_559(int iParam0) // Position - 0x41262
{
	int i;
...
BOOL func_560(int iParam0) // Position - 0x412AF
{
	int i;
...
BOOL func_561(int iParam0) // Position - 0x412FC
{
	int i;
...
BOOL func_562(int iParam0) // Position - 0x41349
{
	int i;
...
BOOL func_563(int iParam0) // Position - 0x41396
{
	int i;
...
BOOL func_564(int iParam0, BOOL bParam1) // Position - 0x413E2
{
	int i;
...
BOOL func_565(int iParam0) // Position - 0x41433
{
...
int func_569(int iParam0) // Position - 0x415B2
{
