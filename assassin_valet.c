...
void func_166(int iParam0) // Position - 0x88F5
{
	...
	else if (IS_BIT_SET(Global_113969.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_168() /*5570*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_113969.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_168() /*5570*/].f_681.f_10), iParam0);
	}
...
void func_258(var uParam0) // Position - 0xCC4A
{
	BOOL flag;
	var unk;
...
BOOL func_267(var uParam0, int iParam1) // Position - 0xD118
{
	if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_268(var uParam0, float fParam1) // Position - 0xD168
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
float func_269(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4) // Position - 0xD19A
{
	var unk;
...
void func_275(var uParam0) // Position - 0xD348
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
...
void func_276(var uParam0) // Position - 0xD373
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
		if (unk_0xF6C26AE940C14749(*uParam0))
...
void func_278(var uParam0, BOOL bParam1) // Position - 0xD4EA
{
...
int func_280(int iParam0, int iParam1, BOOL bParam2) // Position - 0xD5CB
{
	int num;
...
float func_283(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0xD821
{
...
BOOL func_300(var uParam0) // Position - 0xDEFD
{
	int i;
...
void func_301(var uParam0, var uParam1, int iParam2) // Position - 0xDF2B
{
...
int func_302(var uParam0) // Position - 0xE007
{
	int i;
...
eCharacter func_303(var uParam0) // Position - 0xE049
{
	int i;
...
int func_304(var uParam0, eCharacter echParam1, int iParam2) // Position - 0xE0AC
{
	int i;
...
int func_305(eCharacter echParam0, int iParam1) // Position - 0xE13A
{
	int num;
...
void func_307(var uParam0, var uParam1) // Position - 0xE3D8
{
	int i;
...
void func_313(int iParam0, char* sParam1, int iParam2, int iParam3) // Position - 0xEB6B
{
	func_314(&Global_107514, unk_0x1AF90EB93E0012D6(), iParam0, sParam1, iParam3, iParam2);
	return;
}

void func_314(var uParam0, var uParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xEB87
{
	int i;
	eCharacter j;
...
BOOL func_317(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0xFABA
{
	var unk;
...
BOOL func_318(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0xFBE9
{
	int i;
	var unk;
	int num;
...
var func_322(int iParam0, int iParam1) // Position - 0xFEED
{
	return unk_0xD69CE161FE614531(2, iParam0, func_171(iParam1));
}

void func_323(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0xFF02
{
	eCharacter character;
...
void func_324(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x1044C
{
	eCharacter character;
...
void func_326(var uParam0, BOOL bParam1) // Position - 0x106A6
{
	eCharacter character;
	var unk;
	int i;
	...
	if (func_20(character) && !unk_0x4FAFF4BCB7633475(uParam0))
	{
		...
		{
			func_327(uParam0, &Global_113969.f_2366.f_539.f_298[character /*477*/]);
...
void func_327(var uParam0, var uParam1) // Position - 0x10799
{
	int i;
	int j;
	int k;
...
void func_333(var uParam0) // Position - 0x11CA4
{
	eCharacter character;
...
BOOL func_335(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x1222F
{
	var unk;
	var unk2;
...
int func_343(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x12E80
{
	int i;
	float num;
	float num2;
...
int func_377(var uParam0) // Position - 0x151E2
{
...
int func_379(var uParam0, int iParam1) // Position - 0x15684
{
	int num;
	var unk;
	var unk33;
...
int func_386(var uParam0, BOOL bParam1) // Position - 0x16DA0
{
	var unk;
	int num;
...
int func_387(var uParam0, BOOL bParam1) // Position - 0x16DCA
{
	int i;
...
void func_397(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x176AE
{
	if (bParam0)
	{
...
BOOL func_401(int iParam0) // Position - 0x178AF
{
	int num;
...
BOOL func_402(int iParam0) // Position - 0x178D1
{
...
int func_404(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x1791E
{
	int num;
...
void func_408(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, float fParam12, float fParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x17A26
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
BOOL func_409(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x17E1C
{
	float num;
	var unk3;
	var unk6;
...
void func_412(var uParam0) // Position - 0x18206
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void func_416(int iParam0, int iParam1, BOOL bParam2) // Position - 0x18320
{
...
int func_421(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1862E
{
...
void func_422(var uParam0) // Position - 0x18685
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_428(var uParam0, char* sParam1) // Position - 0x18AA1
{
	if (unk_0x3EE1A6D743332852(unk_0x259BE71D8A81D4FA(), 0))
	{
		if (unk_0xC450B06E5AAA0985(uParam0))
...
BOOL func_431(char* sParam0, int iParam1, int iParam2) // Position - 0x18B18
{
...
var func_433(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x18B5F
{
	var unk;
...
BOOL func_441(var uParam0, float fParam1) // Position - 0x19409
{
...
void func_442(var uParam0) // Position - 0x19427
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_443(var uParam0, float fParam1) // Position - 0x1943D
{
	if (func_58(uParam0))
...
void func_466(var uParam0, BOOL bParam1) // Position - 0x1A457
{
	if (!unk_0x4FAFF4BCB7633475(uParam0))
...
void func_467(var uParam0, BOOL bParam1) // Position - 0x1A493
{
	var unk;
...
var func_474(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x1ACA0
{
	return func_475(&(Global_107514.f_2890), fParam0, fParam3, false);
}

var func_475(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0x1ACBA
{
	var unk;
	Vector3 vector;
	BOOL flag;
...
void func_476(var uParam0, eCharacter echParam1) // Position - 0x1AF6C
{
	var unk;
	int i;
	int j;
	...
	func_307(uParam0, &(Global_113969.f_32753.f_5510));
	return;
}

BOOL func_477(var uParam0) // Position - 0x1B16E
{
...
BOOL func_478(int iParam0) // Position - 0x1B24B
{
	if (iParam0 == 0)
		return false;
...
BOOL func_479(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1B409
{
	int i;
	var unk;
...
BOOL func_480(int iParam0) // Position - 0x1B58E
{
	int num;
	var unk;
	var unk2;
...
BOOL func_482(int iParam0, int iParam1) // Position - 0x1B671
{
	int num;
	int num2;
...
BOOL func_490(var uParam0) // Position - 0x1B9DA
{
	int num;
	var unk;
...
BOOL func_491(var uParam0) // Position - 0x1BA21
{
	int i;
...
BOOL func_492(var uParam0) // Position - 0x1BA5C
{
	int i;
...
BOOL func_493(var uParam0) // Position - 0x1BAD8
{
	int i;
...
BOOL func_503(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x1D75F
{
	...
	{
		case joaat("cargobob"):
			if (func_505(uParam0, Global_78179.f_139[38], false))
			{
				func_497(38);
				return true;
			}
		...
		case joaat("firetruk"):
			if (func_505(uParam0, Global_78179.f_139[43], true))
			{
				func_497(43);
				return true;
			}
...
void func_507(eCharacter echParam0, int iParam1) // Position - 0x1DAC5
{
	...
	for (i = 0; i < 9; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(Global_98844[i]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x4B423FAA24E8ABF0(Global_98844[i]) == func_305(echParam0, iParam1))
				{
...
void func_508(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1DB63
{
	...
	if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
	{
		...
		if (IS_BIT_SET(uParam1->f_77, 15) || func_526(uParam0) || uParam1->f_62 == 0 && uParam1->f_63 == 0 && uParam1->f_64 == 0 && uParam1->f_9[20] > 0 && func_525())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
	...
	for (i = 0; i < *uParam1; i = i + 1)
	{
		...
		else if (unk_0x94C9CD3D66808551(*uParam0, num) != uParam1->[i] - 1)
		{
			...
			if (uParam1->[i] > 0)
			{
				...
				else if (func_522(*uParam0, num, uParam1->[i] - 1))
				{
				}
				else
				{
...
BOOL func_517(var uParam0) // Position - 0x1E5D5
{
	int i;
	int num;
	int num2;
...
int func_519(var uParam0, int iParam1) // Position - 0x1E708
{
	int value;
	int value2;
	float num;
...
int func_520(var uParam0, int iParam1) // Position - 0x1E7F1
{
	int i;
	...
	for (i = unk_0x5B59C12A02157D00(uParam0, iParam1) - 1; i >= 0 && func_522(uParam0, iParam1, i); i = i - 1)
	{
	}
...
BOOL func_521(int iParam0, int iParam1) // Position - 0x1E853
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
BOOL func_522(var uParam0, int iParam1, int iParam2) // Position - 0x1EC32
{
...
void func_524(var uParam0, var uParam1) // Position - 0x1EC5F
{
	int num;
	int num2;
...
BOOL func_526(var uParam0) // Position - 0x1ECE8
{
	int num;
...
BOOL func_529(var uParam0) // Position - 0x1EDA3
{
	if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
...
int func_530(var uParam0) // Position - 0x1EE2A
{
...
{
	if (func_533(iParam0, false))
		return Global_1887305[iParam0 /*610*/].f_10.f_182;

	return -1;
}

BOOL func_533(int iParam0, BOOL bParam1) // Position - 0x1EE99
{
	if (func_401(iParam0))
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(var uParam0, int iParam1) // Position - 0x1EF09
{
	var unk;
...
void func_536(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4) // Position - 0x1EF56
{
	int i;
...
void func_552(var uParam0, int iParam1) // Position - 0x1F7D6
{
	int num;
