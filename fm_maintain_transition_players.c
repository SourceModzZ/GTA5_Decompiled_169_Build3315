...
void main() // Position - 0x0
{
	...
	if (iScriptParam_0.f_14 == 0 && !func_759())
	{
		...
		else
		{
			...
			func_706(&(Global_2684504.f_783), iScriptParam_0, iScriptParam_0.f_1, iScriptParam_0.f_11, &(iScriptParam_0.f_8), iScriptParam_0.f_5, iScriptParam_0.f_4, iScriptParam_0.f_3, &(iLocal_935.f_10), &(iLocal_935.f_8), 0, false, num);
			iLocal_935.f_13 = 1;
		}
	}
	...
	while (true)
	{
		...
		if (iLocal_935.f_8 == 1)
		{
			if (!unk_0x3555462DB47B7AB1() && !func_693(unk_0x259BE71D8A81D4FA()) && _IS_FMMC_ACTIVE())
			{
				iLocal_935.f_8 = 0;
				...
				if (!func_690() && !iScriptParam_0.f_3 && !func_689())
				{
					if (func_684())
					{
						if (!iLocal_935.f_13)
						{
							...
							func_706(&(Global_2684504.f_783), iScriptParam_0, iScriptParam_0.f_1, iScriptParam_0.f_11, &unk, iScriptParam_0.f_5, true, iScriptParam_0.f_3, &(iLocal_935.f_10), &(iLocal_935.f_8), 0, false, num2);
							iLocal_935.f_13 = 1;
							iLocal_935.f_5 = 0;
						}
		...
		if (func_552())
		{
			if (!iLocal_935.f_16)
			{
				if (!iLocal_935.f_4)
				{
					...
					func_706(&(Global_2684504.f_783), iScriptParam_0, iScriptParam_0.f_1, iScriptParam_0.f_11, &(iScriptParam_0.f_8), iScriptParam_0.f_5, iScriptParam_0.f_4, iScriptParam_0.f_3, &(iLocal_935.f_10), &(iLocal_935.f_8), 1, true, num2);
					iLocal_935.f_4 = 1;
					iLocal_935.f_5 = 0;
				}
				else if (iLocal_935.f_5 == 0)
		...
		{
			uLocal_1025 = unk_0x5295501D0862870D();
			uLocal_1026 = unk_0x18E502A71E28968C();
			uLocal_1027 = unk_0x4BA5A16068183C5E();
				...
				case 1:
					if (func_86(&iLocal_201))
					{
						if (func_29(&iLocal_201, &uLocal_326, bLocal_189))
						{
							...
							{
								Global_1882632[unk_0x259BE71D8A81D4FA() /*146*/] = Global_4718592.f_3527;
					...
					{
						unk_0x0B0C9A0F9AAEB7F0(&(iLocal_201.f_119), 0);
						func_92(&iLocal_201, 4);
					}
					break;
		...
		{
			unk_0xCBE10A13619B9FAA(uLocal_1025, uLocal_1026, uLocal_1027);
			...
			if (func_18())
			{
				...
				if (!func_698())
					if (iScriptParam_0.f_14)
						unk_0xCBE10A13619B9FAA(Global_1928044.f_8, 0, 0);
			}
			else
			{
				func_96(iScriptParam_0, &iScriptParam_0);
		...
		case 4:
			if (func_52(uParam0))
			{
				if (!func_46(uParam0, bParam2))
				{
					...
					if (bParam2 && uLocal_195[num3] != 0)
					{
						if (uParam0->f_73[num3] >= uLocal_195[num3])
						{
							if (uParam0->f_7 - 2 > 0)
							{
								num3 = uParam0->f_7 - 2;
					...
					if (num != -1)
					{
						unk_0x0B0C9A0F9AAEB7F0(&iLocal_982, num);
			...
			for (j = 0; j < Global_2685444.f_1.f_2805; j = j + 1)
			{
				if (i != j && iParam1 != uParam0->[j /*19*/].f_1)
					if (uLocal_984[i] < uLocal_984[j])
						unk_0x0B0C9A0F9AAEB7F0(&iLocal_980, i);
					else if (uLocal_984[i] == uLocal_984[j])
						unk_0x0B0C9A0F9AAEB7F0(&iLocal_981, i);
			}
		}
	}
		...
		for (i = 0; i < Global_2685444.f_1.f_2805; i = i + 1)
		{
			for (j = 0; j < Global_2685444.f_1.f_2805; j = j + 1)
			{
				if (i != j)
				{
					...
					{
						unk_0x0B0C9A0F9AAEB7F0(&iLocal_983, i);
...
{
	unk_0x8744D2E3FC95740E(&(Global_2684504.f_2), 7);
	return;
}

void func_104() // Position - 0x3E8A
{
	unk_0x8744D2E3FC95740E(&Global_2684504, 9);
	return;
}

void func_105() // Position - 0x3E9C
{
	unk_0x8744D2E3FC95740E(&Global_2684504, 13);
	return;
}

void func_106() // Position - 0x3EAE
{
	unk_0x8744D2E3FC95740E(&(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_97.f_32), 0);
	return;
}
...
void func_118(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x4124
{
	...
	for (j = 0; j <= iParam1 - 1; j = j + 1)
	{
		...
		{
			num3 = SYSTEM::CEIL(SYSTEM::TO_FLOAT(value) / SYSTEM::TO_FLOAT(Global_4718592.f_120529[j]));
				...
				for (i = 0; i <= Global_2685444.f_1.f_2805 - 1; i = i + 1)
				{
					for (j = 0; j <= Global_2685444.f_1.f_2805 - 1; j = j + 1)
					{
						if (Global_2685444.f_1.f_845[i /*57*/].f_44 == Global_2685444.f_1.f_845[j /*57*/].f_44)
							unk_0x0B0C9A0F9AAEB7F0(&num3, Global_2685444.f_1.f_845[i /*57*/].f_44);
					}
				}
			
				for (i = 0; i <= Global_2685444.f_1.f_2805 - 1; i = i + 1)
				{
					if (!IS_BIT_SET(num3, Global_2685444.f_1.f_845[i /*57*/].f_44))
...
int func_125() // Position - 0x48AB
{
	...
	if (unk_0xA8F635A578C0CE07(&unk, 13))
	{
		for (i = 0; i <= Global_2685444.f_1.f_2805 - 1; i = i + 1)
		{
			if (unk_0xA8F635A578C0CE07(&Global_2685444.f_1.f_845[i /*57*/], 13))
				if (unk_0xD43ED7463CB7671C(&Global_2685444.f_1.f_845[i /*57*/], &unk))
					return i;
		}
	}
...
{
	func_128(1);
	unk_0x0B0C9A0F9AAEB7F0(&(iLocal_935.f_3), 1);
	return;
}
...
{
	if (bParam0)
		unk_0x0B0C9A0F9AAEB7F0(&(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_11.f_1), 0);
	else
		unk_0x8744D2E3FC95740E(&(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_11.f_1), 0);
...
BOOL func_140() // Position - 0x4D01
{
	...
	num = Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_193;
...
int _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x4DDC
{
	switch (func_9())
	{
		case 0:
...
void func_147(var uParam0) // Position - 0x4E4E
{
	...
	else if (unk_0x834C960822A4683F() && func_148() && func_18())
	{
		func_11(0);
		func_6(uParam0->f_3);
		iLocal_1019 = 1;
...
void func_149(BOOL bParam0) // Position - 0x4ED3
{
	...
	func_172();
	func_166();
	unk_0x4AD0013B427A98CA(Global_1575088, Global_1575087);
	func_150();
...
void func_153(int iParam0, int iParam1, int iParam2) // Position - 0x506B
{
	...
	unk_0x0B0C9A0F9AAEB7F0(&Global_1663780[num], iParam2);
	return;
}
...
void func_157(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x51CB
{
	...
	while (num < num2)
	{
		unk_0x0B0C9A0F9AAEB7F0(&Global_1664209[num /*6*/], iParam2);
...
void func_166() // Position - 0x5665
{
	...
	if (unk_0x99DFE4CAC19D527F())
	{
		...
		{
			Global_1575115[unk_0x259BE71D8A81D4FA() /*35*/] = { func_170() };
		
			if (func_169())
				if (func_167(unk_0x259BE71D8A81D4FA(), &Global_1576240, &Global_1576241, &Global_1576242))
					Global_1576239 = 1;
				else
					Global_1576239 = 0;
		}
		...
		{
			Global_1575115[unk_0x259BE71D8A81D4FA() /*35*/] = -1;
			Global_1576239 = 0;
		}
	}
...
BOOL func_167(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x56DE
{
	var unk;
	var unk36;
...
struct<13> func_168(int iParam0) // Position - 0x5738
{
	var unk;
...
void func_172() // Position - 0x57D3
{
	...
	if (num == Global_152645.f_7)
		num2 = 0;
	else
		num2 = 0;

	func_173(num, 11, num2, true, 1);
	return;
}

int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x5806
{
	int num;
	int i;
	int num2;
	...
	if (IS_BIT_SET(Global_79172[1 /*14*/].f_6, 0))
	{
			...
			if (iParam4 == 1 && bParam3 == true)
			{
				...
				for (i = 0; i < num; i = i + 1)
				{
					...
					if (num2 != 0 && num2 != joaat("0"))
						func_202(num2, 1, true, true, -1);
					else
						func_173(iParam0, func_199(unk), num3, true, 0);
				}
			}
		
			if (iParam1 == 12)
			{
				unk2 = { func_196(iParam0, iParam2) };
				...
				for (j = 0; j <= 14; j = j + 1)
				{
					if (unk2[j] != -99 && j != 12 && j != 14)
					{
						if (j != 13)
						{
							func_173(iParam0, j, unk2[j], true, 1);
							func_192(iParam0, j, unk2[j], true, false);
						}
						else
						{
							unk19 = { func_189(iParam0, unk2[j]) };
						
							for (k = 0; k <= 8; k = k + 1)
							{
								if (unk19[k] >= 10)
								{
									func_173(iParam0, 14, unk19[k], true, 1);
									func_192(iParam0, 14, unk19[k], true, false);
								}
							}
						}
					}
		...
		else
		{
			if (iParam1 != 5)
			{
				num4 = func_187(func_188(iParam1, Global_79172[1 /*14*/].f_2), Global_79169);
			
				if (bParam3)
					unk_0x0B0C9A0F9AAEB7F0(&num4, Global_79172[1 /*14*/].f_1);
				else
					unk_0x8744D2E3FC95740E(&num4, Global_79172[1 /*14*/].f_1);
			
				func_184(func_188(iParam1, Global_79172[1 /*14*/].f_2), num4, Global_79169, 1);
			}
		
			if (iParam1 == 12)
			{
				unk29 = { func_196(iParam0, iParam2) };
				...
				for (l = 0; l <= 14; l = l + 1)
				{
					if (unk29[l] != -99 && l != 12 && l != 14)
					{
						if (l != 13)
						{
							func_173(iParam0, l, unk29[l], true, 1);
							func_192(iParam0, l, unk29[l], true, false);
						}
						else
						{
							unk46 = { func_189(iParam0, unk29[l]) };
						
							for (m = 0; m <= 8; m = m + 1)
							{
								func_173(iParam0, 14, unk46[m], true, 1);
								func_192(iParam0, 14, unk46[m], true, false);
							}
						}
					}
				}
			...
			if (iParam4 == 1 && bParam3 == true)
			{
				if (iParam0 == joaat("MP_M_Freemode_01"))
				{
					if (iParam1 == 14)
					{
						...
						{
							num5 = 75 + Global_79172[1 /*14*/].f_4;
							func_173(iParam0, 14, num5, true, 0);
						}
						else if (iParam2 >= 75 && iParam2 <= 82)
						{
							num5 = 83 + Global_79172[1 /*14*/].f_4;
							func_173(iParam0, 14, num5, true, 0);
						}
					}
					else if (iParam1 == 8)
					{
						...
						{
							num5 = 64 + Global_79172[1 /*14*/].f_4;
							func_173(iParam0, 8, num5, true, 0);
						}
						else if (iParam2 >= 64 && iParam2 <= 79)
						{
							num5 = 48 + Global_79172[1 /*14*/].f_4;
							func_173(iParam0, 8, num5, true, 0);
						}
						else if (iParam2 >= 96 && iParam2 <= 111)
						{
							num5 = 112 + Global_79172[1 /*14*/].f_4;
							func_173(iParam0, 8, num5, true, 0);
						}
						else if (iParam2 >= 112 && iParam2 <= 127)
						{
							num5 = 96 + Global_79172[1 /*14*/].f_4;
							func_173(iParam0, 8, num5, true, 0);
						}
						else if (iParam2 >= 176 && iParam2 <= 191)
						{
							num5 = 160 + Global_79172[1 /*14*/].f_4;
							func_173(iParam0, 8, num5, true, 0);
						}
						else if (iParam2 >= 160 && iParam2 <= 175)
						{
							num5 = 176 + Global_79172[1 /*14*/].f_4;
							func_173(iParam0, 8, num5, true, 0);
						}
						else if (iParam2 >= 32 && iParam2 <= 47)
						{
							num5 = 0 + Global_79172[1 /*14*/].f_4;
							func_173(iParam0, 11, num5, true, 0);
						}
						else if (iParam2 >= 224 && iParam2 <= 239)
						{
							num5 = 16 + Global_79172[1 /*14*/].f_4;
							func_173(iParam0, 11, num5, true, 0);
						}
					}
					else if (iParam1 == 11)
					{
						...
						{
							num5 = 32 + Global_79172[1 /*14*/].f_4;
							func_173(iParam0, 8, num5, true, 0);
						}
						else if (iParam2 >= 16 && iParam2 <= 31)
						{
							num5 = 224 + Global_79172[1 /*14*/].f_4;
							func_173(iParam0, 8, num5, true, 0);
						}
						else if (iParam2 >= 220 && iParam2 <= 235)
						{
							...
							{
								case 220:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_0"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_0"), 8, 3), true, 0);
									break;
							
								case 221:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_1"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_1"), 8, 3), true, 0);
									break;
							
								case 222:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_2"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_2"), 8, 3), true, 0);
									break;
							
								case 223:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_3"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_3"), 8, 3), true, 0);
									break;
							
								case 224:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_4"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_4"), 8, 3), true, 0);
									break;
							
								case 225:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_5"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_5"), 8, 3), true, 0);
									break;
							
								case 226:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_6"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_6"), 8, 3), true, 0);
									break;
							
								case 227:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_7"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_7"), 8, 3), true, 0);
									break;
							
								case 228:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_8"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_8"), 8, 3), true, 0);
									break;
							
								case 229:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_9"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_9"), 8, 3), true, 0);
									break;
							
								case 230:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_10"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_10"), 8, 3), true, 0);
									break;
							
								case 231:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_11"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_11"), 8, 3), true, 0);
									break;
							
								case 232:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_12"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_12"), 8, 3), true, 0);
									break;
							
								case 233:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_13"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_13"), 8, 3), true, 0);
									break;
							
								case 234:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_14"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_14"), 8, 3), true, 0);
									break;
							
								case 235:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_15"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_15"), 8, 3), true, 0);
									break;
							}
						}
						else if (iParam2 >= 188 && iParam2 <= 203)
						{
							...
							{
								case 188:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_8_0"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_9_0"), 8, 3), true, 0);
									break;
							
								case 189:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_8_1"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_9_1"), 8, 3), true, 0);
									break;
							
								case 190:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_8_2"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_9_2"), 8, 3), true, 0);
									break;
							
								case 191:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_8_3"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_9_3"), 8, 3), true, 0);
									break;
							
								case 192:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_8_4"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_9_4"), 8, 3), true, 0);
									break;
							
								case 193:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_8_5"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_9_5"), 8, 3), true, 0);
									break;
							
								case 194:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_8_6"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_9_6"), 8, 3), true, 0);
									break;
							
								case 195:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_8_7"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_9_7"), 8, 3), true, 0);
									break;
							
								case 196:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_8_8"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_9_8"), 8, 3), true, 0);
									break;
							
								case 197:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_8_9"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_9_9"), 8, 3), true, 0);
									break;
							
								case 198:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_8_10"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_9_10"), 8, 3), true, 0);
									break;
							
								case 199:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_8_11"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_9_11"), 8, 3), true, 0);
									break;
							
								case 200:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_8_12"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_9_12"), 8, 3), true, 0);
									break;
							
								case 201:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_8_13"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_9_13"), 8, 3), true, 0);
									break;
							
								case 202:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_8_14"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_9_14"), 8, 3), true, 0);
									break;
							
								case 203:
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_8_15"), 8, 3), true, 0);
									func_173(iParam0, 8, func_182(iParam0, joaat("DLC_MP_HEIST_M_SPECIAL_9_15"), 8, 3), true, 0);
									break;
							}
						}
					}
					else if (iParam1 == 7)
					{
						if (iParam2 >= 41 && iParam2 <= 56)
						{
							...
							{
								case 0:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_0"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_0"), 7, 3), true, 0);
									break;
							
								case 1:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_1"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_1"), 7, 3), true, 0);
									break;
							
								case 2:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_2"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_2"), 7, 3), true, 0);
									break;
							
								case 3:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_3"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_3"), 7, 3), true, 0);
									break;
							
								case 4:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_4"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_4"), 7, 3), true, 0);
									break;
							
								case 5:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_5"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_5"), 7, 3), true, 0);
									break;
							
								case 6:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_6"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_6"), 7, 3), true, 0);
									break;
							
								case 7:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_7"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_7"), 7, 3), true, 0);
									break;
							
								case 8:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_8"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_8"), 7, 3), true, 0);
									break;
							
								case 9:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_9"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_9"), 7, 3), true, 0);
									break;
							
								case 10:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_10"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_10"), 7, 3), true, 0);
									break;
							
								case 11:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_11"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_11"), 7, 3), true, 0);
									break;
							
								case 12:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_12"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_12"), 7, 3), true, 0);
									break;
							
								case 13:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_13"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_13"), 7, 3), true, 0);
									break;
							
								case 14:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_14"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_14"), 7, 3), true, 0);
									break;
							
								case 15:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_15"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_15"), 7, 3), true, 0);
									break;
							}
						}
						else if (iParam2 >= 73 && iParam2 <= 88)
						{
							...
							{
								case 0:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_0"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_0"), 7, 3), true, 0);
									break;
							
								case 1:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_1"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_1"), 7, 3), true, 0);
									break;
							
								case 2:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_2"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_2"), 7, 3), true, 0);
									break;
							
								case 3:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_3"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_3"), 7, 3), true, 0);
									break;
							
								case 4:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_4"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_4"), 7, 3), true, 0);
									break;
							
								case 5:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_5"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_5"), 7, 3), true, 0);
									break;
							
								case 6:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_6"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_6"), 7, 3), true, 0);
									break;
							
								case 7:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_7"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_7"), 7, 3), true, 0);
									break;
							
								case 8:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_8"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_8"), 7, 3), true, 0);
									break;
							
								case 9:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_9"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_9"), 7, 3), true, 0);
									break;
							
								case 10:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_10"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_10"), 7, 3), true, 0);
									break;
							
								case 11:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_11"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_11"), 7, 3), true, 0);
									break;
							
								case 12:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_12"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_12"), 7, 3), true, 0);
									break;
							
								case 13:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_13"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_13"), 7, 3), true, 0);
									break;
							
								case 14:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_14"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_14"), 7, 3), true, 0);
									break;
							
								case 15:
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_15"), 7, 3), true, 0);
									func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_15"), 7, 3), true, 0);
									break;
							}
						}
					}
				...
				if (iParam1 == 11)
				{
					num6 = func_181(iParam0, iParam2, Global_79172[1 /*14*/].f_4);
				
					if (num6 != -99)
						func_173(iParam0, 8, num6, true, 0);
					...
					if (iParam2 >= 192 && iParam2 <= 203)
					{
						...
						{
							case 199:
								func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI_F_ACCS2_0"), 7, 4), true, 0);
								break;
						
							case 200:
								func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI_F_ACCS2_1"), 7, 4), true, 0);
								break;
						
							case 201:
								func_173(iParam0, 7, func_182(iParam0, joaat("DLC_MP_BUSI_F_ACCS2_2"), 7, 4), true, 0);
								break;
						}
					}
				}
				...
				{
					num6 = func_176(iParam0, iParam2, Global_79172[1 /*14*/].f_4);
				
					if (num6 != -99)
						func_173(iParam0, 11, num6, true, 0);
				}
			}
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x709D
{
	if (iParam2 == -1)
		iParam2 = func_281();
...
BOOL func_175(int iParam0, int iParam1) // Position - 0x70BB
{
	if (iParam1 == -1)
		iParam1 = func_281();
...
int func_176(int iParam0, int iParam1, int iParam2) // Position - 0x70D7
{
	int num;
	int num2;
	int num3;
	...
	if (iParam0 == joaat("MP_M_Freemode_01"))
	{
		...
		{
			num2 = func_177(iParam0, iParam1, 8, 3);
			...
			if (num2 != -1)
			{
				...
				for (i = 0; i < num3; i = i + 1)
				{
					...
					if (num6 == 11)
					{
						...
						{
							num = func_182(iParam0, num4, 11, 3);
							return num;
						}
						else
						{
	...
	else if (iParam0 == joaat("MP_F_Freemode_01"))
	{
		...
		{
			num7 = func_177(iParam0, iParam1, 8, 4);
			...
			if (num7 != -1)
			{
				...
				for (j = 0; j < num8; j = j + 1)
				{
					...
					if (num11 == 11)
					{
						...
						{
							num = func_182(iParam0, num9, 11, 4);
							return num;
						}
						else
						{
...
int func_177(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x73CE
{
	var unk;
	int num;
	int num2;
...
int func_178(int iParam0, int iParam1) // Position - 0x74E8
{
	switch (iParam0)
	{
...
int func_180(int iParam0) // Position - 0x793F
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_181(int iParam0, int iParam1, int iParam2) // Position - 0x79A0
{
	int num;
	int num2;
	int num3;
	...
	if (iParam0 == joaat("MP_M_Freemode_01"))
	{
		...
		{
			num2 = func_177(iParam0, iParam1, 11, 3);
	...
	else if (iParam0 == joaat("MP_F_Freemode_01"))
	{
		...
		{
			num7 = func_177(iParam0, iParam1, 11, 4);
...
int func_182(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7C95
{
	var unk;
	int i;
	int num;
...
int func_183(int iParam0) // Position - 0x7D50
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_184(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7DAF
{
	int num;
...
int func_185(int iParam0, int iParam1) // Position - 0x7DDD
{
	return unk_0xD69CE161FE614531(0, iParam0, func_186(iParam1));
}
...
struct<10> func_189(int iParam0, int iParam1) // Position - 0x826B
{
	int i;
	var unk;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				default:
					func_190(&unk, iParam0, iParam1, 10);
					break;
			}
			break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				default:
					func_190(&unk, iParam0, iParam1, 9);
					break;
			}
			break;
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				...
				default:
					func_190(&unk, iParam0, iParam1, 25);
					break;
			}
			break;
...
void func_190(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8B9A
{
	int num;
	var unk;
	int num2;
			...
			for (i = 0; i < unk.f_3; i = i + 1)
			{
				if (unk_0xCD4F2395AE80D510(unk.f_1, i, &num2) && num2.f_2 != -1)
					if (num2 != 0 && num2 != -1 && num2 != joaat("0"))
						uParam0->[num2.f_2] = func_182(iParam1, num2, 14, num);
					else if (num2.f_1 != -1)
...
int func_192(int iParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8D0C
{
	int num;
	int num2;
	int num3;
	...
	if (IS_BIT_SET(Global_79172[1 /*14*/].f_6, 0) && !IS_BIT_SET(Global_79172[1 /*14*/].f_6, 6))
	{
		...
		if (iParam1 != 5)
		{
			num = func_187(func_194(iParam1, Global_79172[1 /*14*/].f_2), Global_79169);
		
			if (bParam3)
				unk_0x0B0C9A0F9AAEB7F0(&num, Global_79172[1 /*14*/].f_1);
			else
				unk_0x8744D2E3FC95740E(&num, Global_79172[1 /*14*/].f_1);
		
			func_184(func_194(iParam1, Global_79172[1 /*14*/].f_2), num, Global_79169, 1);
		}
	
		if (bParam4)
		{
			if (func_193(iParam1, Global_79172[1 /*14*/].f_2, &num2))
			{
				num3 = func_187(num2, Global_79169);
				unk_0x0B0C9A0F9AAEB7F0(&num3, Global_79172[1 /*14*/].f_1);
				func_184(num2, num3, Global_79169, 1);
			}
		}
		...
		if (Global_79170 == 1 && bParam3 == true)
		{
			if (iParam0 == joaat("MP_M_Freemode_01"))
			{
				if (iParam1 == 14)
				{
					if (iParam2 >= 83 && iParam2 <= 90)
					{
						num4 = 75 + Global_79172[1 /*14*/].f_4;
						func_192(iParam0, 14, num4, true, bParam4);
					}
					else if (iParam2 >= 75 && iParam2 <= 82)
					{
						num4 = 83 + Global_79172[1 /*14*/].f_4;
						func_192(iParam0, 14, num4, true, bParam4);
					}
				}
				else if (iParam1 == 8)
				{
					if (iParam2 >= 48 && iParam2 <= 63)
					{
						num4 = 64 + Global_79172[1 /*14*/].f_4;
						func_192(iParam0, 8, num4, true, bParam4);
					}
					else if (iParam2 >= 64 && iParam2 <= 79)
					{
						num4 = 48 + Global_79172[1 /*14*/].f_4;
						func_192(iParam0, 8, num4, true, bParam4);
					}
					else if (iParam2 >= 96 && iParam2 <= 111)
					{
						num4 = 112 + Global_79172[1 /*14*/].f_4;
						func_192(iParam0, 8, num4, true, bParam4);
					}
					else if (iParam2 >= 112 && iParam2 <= 127)
					{
						num4 = 96 + Global_79172[1 /*14*/].f_4;
						func_192(iParam0, 8, num4, true, bParam4);
					}
					else if (iParam2 >= 176 && iParam2 <= 191)
					{
						num4 = 160 + Global_79172[1 /*14*/].f_4;
						func_192(iParam0, 8, num4, true, bParam4);
					}
					else if (iParam2 >= 160 && iParam2 <= 175)
					{
						num4 = 176 + Global_79172[1 /*14*/].f_4;
						func_192(iParam0, 8, num4, true, bParam4);
					}
					else if (iParam2 >= 32 && iParam2 <= 47)
					{
						num4 = 0 + Global_79172[1 /*14*/].f_4;
						func_192(iParam0, 11, num4, true, bParam4);
					}
					else if (iParam2 >= 224 && iParam2 <= 239)
					{
						num4 = 16 + Global_79172[1 /*14*/].f_4;
						func_192(iParam0, 11, num4, true, bParam4);
					}
				}
				else if (iParam1 == 11)
				{
					if (iParam2 >= 0 && iParam2 <= 15)
					{
						num4 = 32 + Global_79172[1 /*14*/].f_4;
						func_192(iParam0, 8, num4, true, bParam4);
					}
					else if (iParam2 >= 16 && iParam2 <= 31)
					{
						num4 = 224 + Global_79172[1 /*14*/].f_4;
						func_192(iParam0, 8, num4, true, bParam4);
					}
				}
			}
			...
			if (iParam1 == 11)
			{
				num5 = func_181(iParam0, iParam2, Global_79172[1 /*14*/].f_4);
			
				if (num5 != -99)
					func_192(iParam0, 8, num5, true, bParam4);
			}
			else if (iParam1 == 8)
			{
				num5 = func_176(iParam0, iParam2, Global_79172[1 /*14*/].f_4);
			
				if (num5 != -99)
					func_192(iParam0, 11, num5, true, bParam4);
			}
		}
...
struct<17> func_196(int iParam0, int iParam1) // Position - 0x9A29
{
	int i;
	var unk;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				default:
					func_197(&unk, iParam0, iParam1, 53);
					break;
			}
			break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				default:
					func_197(&unk, iParam0, iParam1, 47);
					break;
			}
			break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				default:
					func_197(&unk, iParam0, iParam1, 48);
					break;
			}
			break;
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				...
				default:
					func_197(&unk, iParam0, iParam1, 26);
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				...
				default:
					func_197(&unk, iParam0, iParam1, 28);
					break;
			}
			break;
	}
...
void func_197(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB871
{
	int num;
	var unk;
	int num2;
		...
		for (i = 0; i < unk.f_4; i = i + 1)
		{
			if (unk_0xABE43EB6EBE5F2F5(unk.f_1, i, &num2))
			{
				if (num2 != 0 && num2 != -1 && num2 != joaat("0"))
				{
					...
					{
						uParam0->[func_199(num2.f_2)] = num2;
						uParam0->f_16 = 1;
					}
					else
					{
						uParam0->[func_199(num2.f_2)] = func_182(iParam1, num2, func_199(num2.f_2), num);
					}
				}
				else if (num2.f_1 != -1)
				{
					uParam0->[func_199(num2.f_2)] = num2.f_1;
				}
			}
		}
...
void func_200(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xBB7C
{
	int num;
	var unk;
	int num2;
	...
	if (func_201(iParam0, iParam1, &num2, &unk, bParam2, bParam3))
	{
		num3 = func_187(num2, num);
		unk_0x8744D2E3FC95740E(&num3, unk);
		func_184(num2, num3, num, 1);
	}

	return;
}

BOOL func_201(int iParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xBBC4
{
	int value;
...
void func_202(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE747
{
	int num;
	var unk;
	int num2;
...
struct<14> func_203(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xE78F
{
	func_248();
...
void func_204(int iParam0, int iParam1, int iParam2) // Position - 0xE7D0
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_208(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xFCDC
{
	int num;
	int num2;
	int num3;
	...
	if (func_201(iParam0, iParam1, &num3, &num2, bParam2, bParam3))
	{
...
void func_211(int iParam0, int iParam1) // Position - 0xFDFC
{
	int num;

	num = 0;
	Global_79172[0 /*14*/].f_5 = 4;
	func_212(num, iParam0, 0, iParam1);
	return;
}

void func_212(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFE1C
{
	int num;
	var unk;
	var unk2;
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_206(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_206(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_206(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
void func_213(int iParam0, int iParam1) // Position - 0x100A5
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79172[0 /*14*/].f_5 = 4;
			func_212(num6, iParam0, 9, iParam1);
			return;
	}
...
void func_214(int iParam0, int iParam1) // Position - 0x101A8
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79172[0 /*14*/].f_5 = 4;
			func_212(num6, iParam0, 28, iParam1);
			return;
	}
...
void func_215(int iParam0, int iParam1) // Position - 0x10487
{
	BOOL flag;
	int value;
	var unk;
	...
	{
		Global_79172[0 /*14*/].f_5 = 4;
		func_212(num5, iParam0, 327, iParam1);
...
void func_216(int iParam0, int iParam1) // Position - 0x1325C
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79172[0 /*14*/].f_5 = 4;
			func_212(num6, iParam0, 6, iParam1);
			return;
	}
...
void func_217(int iParam0, int iParam1) // Position - 0x13361
{
	BOOL flag;
	int value;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79172[0 /*14*/].f_5 = 4;
			func_212(num5, iParam0, 55, iParam1);
...
void func_218(int iParam0, int iParam1) // Position - 0x13B3D
{
	BOOL flag;
	int value;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79172[0 /*14*/].f_5 = 4;
			func_212(num5, iParam0, 26, iParam1);
...
void func_219(int iParam0, int iParam1) // Position - 0x13E22
{
	BOOL flag;
	int value;
	var unk;
	...
	{
		Global_79172[0 /*14*/].f_5 = 4;
		func_212(num5, iParam0, 256, iParam1);
...
void func_220(int iParam0, int iParam1) // Position - 0x1544B
{
	BOOL flag;
	int value;
	var unk;
...
void func_221(int iParam0, int iParam1) // Position - 0x16AAA
{
	BOOL flag;
	int num;
	var unk;
	...
	{
		Global_79172[0 /*14*/].f_5 = 4;
		func_212(num6, iParam0, 16, iParam1);
		return;
	}
...
void func_222(int iParam0, int iParam1) // Position - 0x16C05
{
	BOOL flag;
	int num;
	var unk;
	...
	{
		Global_79172[0 /*14*/].f_5 = 4;
		func_212(num6, iParam0, 36, iParam1);
		return;
	}
...
void func_223(int iParam0, int iParam1) // Position - 0x16E85
{
	BOOL flag;
	int value;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79172[0 /*14*/].f_5 = 4;
			func_212(num5, iParam0, 136, iParam1);
...
void func_230(int iParam0, int iParam1) // Position - 0x1860F
{
	BOOL flag;
	int value;
	var unk;
...
void func_231(int iParam0, int iParam1) // Position - 0x19D74
{
	BOOL flag;
	int value;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79172[0 /*14*/].f_5 = 4;
			func_212(num5, iParam0, 92, iParam1);
			return;
	}
...
void func_232(int iParam0, int iParam1, int iParam2) // Position - 0x1AC45
{
	switch (iParam0)
	{
		case 2:
...
void func_234(int iParam0, int iParam1) // Position - 0x1AF1B
{
	int num;
...
void func_235(int iParam0, int iParam1) // Position - 0x1AF3B
{
	BOOL flag;
	int num;
	var unk;
...
void func_236(int iParam0, int iParam1) // Position - 0x1B03E
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79172[0 /*14*/].f_5 = 3;
			func_212(num6, iParam0, 26, iParam1);
			return;
	}
...
void func_237(int iParam0, int iParam1) // Position - 0x1B2EF
{
	BOOL flag;
	int value;
	var unk;
...
void func_238(int iParam0, int iParam1) // Position - 0x1E0B0
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79172[0 /*14*/].f_5 = 3;
			func_212(num6, iParam0, 7, iParam1);
			return;
	}
...
void func_239(int iParam0, int iParam1) // Position - 0x1E1D1
{
	BOOL flag;
	int value;
	var unk;
...
void func_240(int iParam0, int iParam1) // Position - 0x1EAC9
{
	BOOL flag;
	int value;
	var unk;
...
void func_241(int iParam0, int iParam1) // Position - 0x1ED80
{
	BOOL flag;
	int value;
	var unk;
...
void func_242(int iParam0, int iParam1) // Position - 0x203BD
{
	BOOL flag;
	int value;
	var unk;
...
void func_243(int iParam0, int iParam1) // Position - 0x219F0
{
	BOOL flag;
	int num;
	var unk;
...
void func_244(int iParam0, int iParam1) // Position - 0x21B47
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79172[0 /*14*/].f_5 = 3;
			func_212(num6, iParam0, 46, iParam1);
			return;
	}
...
void func_245(int iParam0, int iParam1) // Position - 0x21E63
{
	BOOL flag;
	int value;
	var unk;
	...
	{
		Global_79172[0 /*14*/].f_5 = 3;
		func_212(num5, iParam0, 241, iParam1);
...
void func_246(int iParam0, int iParam1) // Position - 0x24356
{
	BOOL flag;
	int value;
	var unk;
	...
	{
		Global_79172[0 /*14*/].f_5 = 3;
		func_212(num5, iParam0, 237, iParam1);
...
void func_247(int iParam0, int iParam1) // Position - 0x258E1
{
	BOOL flag;
	int value;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79172[0 /*14*/].f_5 = 3;
			func_212(num5, iParam0, 91, iParam1);
			return;
	}
...
void func_251(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x27188
{
	int num;

	num = func_252(iParam0, iParam2);
...
int func_252(int iParam0, int iParam1) // Position - 0x271AB
{
	return unk_0xD69CE161FE614531(2, iParam0, func_186(iParam1));
}

void func_253(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x271C0
{
	int num;
...
struct<7> func_256(int iParam0) // Position - 0x27259
{
	int num;
	var unk;
	var unk8;
...
void func_265() // Position - 0x27470
{
	...
	for (i = 0; i <= 6; i = i + 1)
	{
		...
		if (func_267(unk_0x259BE71D8A81D4FA()))
		{
			...
			unk_0x8744D2E3FC95740E(&(Global_2657971[num /*465*/].f_240), Global_1666576[i]);
		
			if (Global_2657971[num /*465*/].f_240 == 0)
				Global_2657971[num /*465*/].f_239 = 0;
		}
	}
...
void func_266() // Position - 0x27520
{
	...
	{
		num = unk_0x259BE71D8A81D4FA();
		Global_2657971[num /*465*/].f_240 = 0;
		Global_2657971[num /*465*/].f_239 = 0;
	}
...
BOOL func_267(int iParam0) // Position - 0x27551
{
	if (!func_268(iParam0))
		return false;
...
BOOL func_268(int iParam0) // Position - 0x27570
{
	int num;
...
void func_270(int iParam0, int iParam1) // Position - 0x275BE
{
	int num;
...
BOOL func_297() // Position - 0x27D72
{
	...
	if (_IS_FMMC_ACTIVE() && unk_0x834C960822A4683F() && func_298() <= 26 && unk_0x78411E34CF90EA8C(Global_2684504.f_783))
		return true;
...
void func_304() // Position - 0x27EC2
{
	...
	if (Global_2697525 != 0f)
		unk_0xD09188DB6289E413(Global_2697525);

	unk_0x43F4B7E163A31644(fLocal_187, fLocal_188);
	return;
}
...
void func_310() // Position - 0x27FCD
{
	...
	for (i = 0; i <= *Global_4980736.f_88124 - 1; i = i + 1)
	{
		if (!_IS_NULL_VECTOR(Global_4980736.f_88133[i /*169*/]))
		{
			...
			unk_0xCD644A03314C3DF9(Global_4980736.f_88133[i /*169*/]);
		}
	}
...
var func_311(int iParam0, int iParam1, int iParam2) // Position - 0x2802E
{
	var unk;
	var unk2;
	var unk3;
...
char* func_313(int iParam0, int iParam1, int iParam2) // Position - 0x2808E
{
	var unk;
	char* str;
...
char* func_314(int iParam0, BOOL bParam1) // Position - 0x287CE
{
	var unk;
...
int func_316(int iParam0, var uParam1) // Position - 0x2973C
{
	int i;
	int num;
...
int func_318(int iParam0, int iParam1, int iParam2) // Position - 0x2988C
{
	iParam0 = unk_0xAC96042A1278D845(iParam0);
...
int func_325(int iParam0) // Position - 0x29E8A
{
	int num;
	int num2;
	int num3;

	num = Global_4980736.f_88133[iParam0 /*169*/].f_15;

	if (Global_262145.f_21618)
	{
		if (!func_344())
		{
			num2 = unk_0x5A0A30874C8AA5B2(Global_4980736.f_88133[iParam0 /*169*/].f_15);
		
			if (func_341(num2) && !func_322())
				Global_4980736.f_88133[iParam0 /*169*/].f_15 = joaat("PICKUP_VEHICLE_WEAPON_PISTOL");
		}
	}

	if (func_340() && func_339(num) == 0 && func_338(num) == 0 && func_337(num) == 0)
	{
		num2 = func_336(*Global_4980736.f_88127);
	...
	else if (num == joaat("PICKUP_VEHICLE_CUSTOM_SCRIPT") && Global_4980736.f_88133[iParam0 /*169*/].f_25 != -1)
	...
	if (num3 > -1 && !func_330())
		if (num3 < func_329(num2))
			if (!func_327(unk_0x259BE71D8A81D4FA(), 0) && !Global_1836668 && !func_326())
...
BOOL func_327(int iParam0, int iParam1) // Position - 0x2A001
{
	BOOL flag;
...
int func_329(int iParam0) // Position - 0x2A09B
{
	switch (iParam0)
	{
		case joaat("WEAPON_PISTOL"):
...
int func_335(int iParam0) // Position - 0x2A2CD
{
	switch (iParam0)
	{
		case joaat("WEAPON_PISTOL"):
...
int func_336(int iParam0) // Position - 0x2A89B
{
	int num;
...
int func_337(int iParam0) // Position - 0x2A8BA
{
...
int func_338(int iParam0) // Position - 0x2A8D1
{
...
int func_339(int iParam0) // Position - 0x2A8F7
{
...
BOOL func_341(int iParam0) // Position - 0x2A945
{
...
BOOL func_342(int iParam0) // Position - 0x2A993
{
...
void func_346() // Position - 0x2AB17
{
	...
	if (func_353())
	{
		...
		for (i = 0; i <= func_352() - 1; i = i + 1)
		{
			...
			{
				unk_0x1F3227D731DA86BA(Global_4718592.f_110663[i /*64*/]);
				num = i;
			}
		}
		...
		if (func_349() && func_327(unk_0x259BE71D8A81D4FA(), 0))
		{
			for (i = 0; i <= func_352() - 1; i = i + 1)
			{
				if (!_IS_NULL_VECTOR(Global_4718592.f_110663[i /*64*/]))
				{
					if (i != 0 && i != num)
					{
						...
						unk_0xCD644A03314C3DF9(Global_4718592.f_110663[i /*64*/]);
					}
				}
			}
		}
		...
		if (!_IS_NULL_VECTOR(Global_4718592.f_110663[0 /*64*/]))
		{
			...
			unk_0xCD644A03314C3DF9(Global_4718592.f_110663[0 /*64*/]);
		}
	
		if (!_IS_NULL_VECTOR(Global_4718592.f_110663[num /*64*/]))
		{
			unk_0xBC6E3BF0E1E57442(144);
			unk_0xCD644A03314C3DF9(Global_4718592.f_110663[num /*64*/]);
		}
	}
	else
	{
		...
		if (!_IS_NULL_VECTOR(Global_4718592.f_110663[0 /*64*/]))
			unk_0x1F3227D731DA86BA(Global_4718592.f_110663[0 /*64*/]);
		...
		if (!_IS_NULL_VECTOR(unk_0xF10F2A2453AF1DFB(Global_4718592.f_110663[0 /*64*/], func_347(Global_4718592.f_110663[0 /*64*/], Global_4718592.f_110663[1 /*64*/]), 0f, (float)num2, 0f)))
		{
			unk_0xBC6E3BF0E1E57442(145);
			unk_0xCD644A03314C3DF9(unk_0xF10F2A2453AF1DFB(Global_4718592.f_110663[0 /*64*/], func_347(Global_4718592.f_110663[0 /*64*/], Global_4718592.f_110663[1 /*64*/]), 0f, (float)num2, 0f));
		}
	}
...
var func_347(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x2ADFC
{
...
void func_348(int iParam0) // Position - 0x2AE16
{
	...
	!IS_BIT_SET(Global_2685444.f_1.f_2813[num], num2);
	unk_0x0B0C9A0F9AAEB7F0(&Global_2685444.f_1.f_2813[num], num2);
	return;
}
...
BOOL func_357() // Position - 0x2B151
{
	...
	if (Global_4718592 == 1 && Global_4718592.f_3559 != 1 && !func_359(unk_0x259BE71D8A81D4FA()))
		if (func_356(Global_4718592) > 0)
			return true;

	if (Global_4718592 == 0 && !func_359(unk_0x259BE71D8A81D4FA()))
		if (Global_4718592.f_2 == 5 || Global_4718592.f_2 == 6)
			if (func_356(Global_4718592) > 0)
				return true;

	if (Global_4718592 == 3 && !func_359(unk_0x259BE71D8A81D4FA()) && !func_358(*Global_4718592.f_185586))
		if (func_356(Global_4718592) > 0)
			return true;
...
BOOL func_359(int iParam0) // Position - 0x2B2D1
{
...
int func_360(int iParam0) // Position - 0x2B38F
{
...
void func_373(var uParam0) // Position - 0x2B5F8
{
	...
	if (func_505())
	{
		...
		if (!func_307(43))
		{
			...
			{
				if (func_684() && !unk_0x3555462DB47B7AB1())
				{
					func_492(&(uParam0->f_11), uParam0->f_4);
					unk = { func_404(uParam0->f_11, uParam0->f_15) };
					unk = { func_402(&unk, uParam0->f_4) };
					...
					{
						if (func_327(unk_0x259BE71D8A81D4FA(), 0))
							if (!Global_2621443)
								num = 1;
						...
						unk_0x4A3280817398D754(unk, func_382(), func_381());
						func_380();
						func_379();
						func_348(43);
						func_378();
...
{
	unk_0x8744D2E3FC95740E(&(Global_2684504.f_2), 1);
	return;
}

void func_375() // Position - 0x2B902
{
	unk_0x0B0C9A0F9AAEB7F0(&(Global_2684504.f_2), 0);
	return;
}
...
{
	unk_0x8744D2E3FC95740E(&Global_2684504, 27);
	return;
}

void func_379() // Position - 0x2B947
{
	unk_0x8744D2E3FC95740E(&(Global_2684504.f_2), 0);
	return;
}

void func_380() // Position - 0x2B95A
{
	unk_0x0B0C9A0F9AAEB7F0(&(Global_2684504.f_2), 1);
	return;
}
...
BOOL func_411(Vector3 vParam0, var uParam1, var uParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x2BF01
{
	...
	unk3 = { Global_4718592.f_210289[iParam3 /*190*/][1 /*3*/] };
	...
	num8 = Global_4718592.f_210289[iParam3 /*190*/].f_7 * iParam7;
	...
	switch (Global_4718592.f_210289[iParam3 /*190*/].f_10)
	{
		case 0:
			...
			if (func_414(vParam0, vector, unk3))
				if (bParam6)
					if (func_413(vParam0, vector.f_2, unk3.f_2))
						num = 1;
				else
					num = 1;
			break;
...
{
	func_419(unk_0x259BE71D8A81D4FA(), bParam0);
	return;
}

void func_419(int iParam0, BOOL bParam1) // Position - 0x2C2FF
{
	int num;

	num = iParam0;
	func_420(&(Global_2657971[num /*465*/].f_444), 0, bParam1);
	return;
}

void func_420(var uParam0, int iParam1, BOOL bParam2) // Position - 0x2C31E
{
	func_421(uParam0, iParam1, bParam2);
	return;
}

void func_421(var uParam0, int iParam1, BOOL bParam2) // Position - 0x2C330
{
	if (bParam2)
...
void func_430(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x2C82E
{
	...
	if (unk_0x76CD105BCAC6EB9F())
		Global_2738935.f_455 = unk_0x7E3F74F641EE6B27();
...
void func_432(int iParam0) // Position - 0x2C990
{
	if (iParam0 < 32)
		if (IS_BIT_SET(Global_2672855.f_63.f_1, iParam0))
			unk_0x8744D2E3FC95740E(&(Global_2672855.f_63.f_1), iParam0);
	else if (IS_BIT_SET(Global_2672855.f_63.f_2, iParam0 - 32))
		unk_0x8744D2E3FC95740E(&(Global_2672855.f_63.f_2), iParam0 - 32);
...
void func_433(int iParam0) // Position - 0x2C9E0
{
	if (iParam0 < 32)
		if (!IS_BIT_SET(Global_2672855.f_63.f_1, iParam0))
			unk_0x0B0C9A0F9AAEB7F0(&(Global_2672855.f_63.f_1), iParam0);
	else if (!IS_BIT_SET(Global_2672855.f_63.f_2, iParam0 - 32))
		unk_0x0B0C9A0F9AAEB7F0(&(Global_2672855.f_63.f_2), iParam0 - 32);
...
BOOL func_438() // Position - 0x2CAE5
{
	...
	if (unk_0x834C960822A4683F() && !Global_2697528)
		return true;
...
BOOL func_447(var uParam0, var uParam1, BOOL bParam2) // Position - 0x2CC7D
{
	...
	{
		unk_0x8744D2E3FC95740E(&Global_1963766, 1);
	...
	unk_0x0B0C9A0F9AAEB7F0(&Global_1963766, 1);
	return true;
}
...
void func_456(BOOL bParam0, var uParam1) // Position - 0x2D0D3
{
	...
	for (i = 0; i <= 3; i = i + 1)
	{
		...
		if (Global_4718592.f_178456.f_29[i] > 0 && bParam0)
		{
			...
			unk_0x0A047107933868D4(*uParam1, str, Global_4718592.f_178456.f_29[i]);
		}
		else
		{
...
void func_457(var uParam0, char* sParam1, BOOL bParam2) // Position - 0x2D17D
{
	if (bParam2)
			...
			if (flag)
			{
				if (!Global_1964355)
				{
					...
					if (!IS_BIT_SET(Global_1963766, 4))
						unk_0x0B0C9A0F9AAEB7F0(&Global_1963766, 4);
				}
				else
				{
...
void func_466(BOOL bParam0) // Position - 0x2D551
{
	...
	if (bParam0)
	{
		str = func_467(Global_4718592.f_178456.f_2);
...
{
	if (unk_0x8960847E5FD7B48F() == -1 && func_343())
		return 1;

	if (unk_0x8960847E5FD7B48F() != -1 && !bParam0 && func_343())
		return 1;
...
void func_474() // Position - 0x2D6ED
{
	if (func_343())
	{
		...
		unk_0x8744D2E3FC95740E(&Global_1963766, 4);
...
void func_479(BOOL bParam0, var uParam1) // Position - 0x2DA00
{
	...
	for (i = 0; i <= 3; i = i + 1)
	{
		...
		{
			unk_0x907994FF361E5295(*uParam1, str);
			unk_0x0A047107933868D4(*uParam1, str, Global_4718592.f_178456.f_34[i]);
		}
		else
		{
			unk_0x62BCE536D41AC07D(*uParam1, str);
...
int func_499(var uParam0, BOOL bParam1) // Position - 0x318FE
{
	int num;
		...
		case 2:
			if (func_532())
			{
				...
				if (func_299() != 57)
				{
					if (func_512() > 4)
					{
						if (unk_0x78411E34CF90EA8C(Global_2684504.f_783))
						{
							if (!func_507(unk_0xA452B06E281A9014(Global_2684504.f_783), -194.2056f, -1853.7499f, 70.3345f, 3f, false))
							{
								unk_0x1761457F86AD0EE2(Global_2684504.f_783, -194.2056f, -1853.7499f, 70.3345f);
								unk_0x5E5CEC33463AD803(Global_2684504.f_783, -10.0011f, 0f, 131.0271f, 2);
								unk_0x58BDA5D9262F5D30(Global_2684504.f_783, 42.6052f);
							}
						}
					}
				}
...
void func_513() // Position - 0x31F30
{
	...
	if (Global_2708031 == unk)
		return;

	Global_2708031 = unk;

	if (func_526() && func_525() != joaat("am_mp_arena_garage") || unk_0x486FF5D06E9659F1(joaat("base_lounge_seats")) > 0)
		return;
	...
	switch (func_512())
	{
		...
		case 3:
			if (unk_0x2200033BCF24787D(joaat("END_OF_MOVIE_MARKER")) || _STOPWATCH_HAS_TIME_PASSED(&Global_2708038, 10000, true))
			{
				func_518(func_524(), &unk2);
				unk_0x7C7F282055FB517C(1, &unk2, 1);
				_STOPWATCH_RESET(&Global_2708038, true, false);
				func_517();
				func_98(4);
		...
		case 4:
			num = func_514(1157234688);
		
			if (num > 100 || _STOPWATCH_HAS_TIME_PASSED(&Global_2708038, 10000, true))
				func_98(5);
			break;
		...
		case 5:
			...
			{
				if (unk_0x2200033BCF24787D(Global_2708033))
				{
					Global_2708034 = Global_2708033;
					func_517();
				}
			}
			else if (unk_0x2200033BCF24787D(Global_2708032))
			{
				Global_2708034 = Global_2708032;
				func_517();
			}
		
			num = func_514(Global_2708036);
...
int func_515(var uParam0, int iParam1) // Position - 0x3214A
{
	int num;
	float num2;
...
{
	Global_2708037 = unk_0x7E3F74F641EE6B27();
	return;
}
...
{
	return Global_1943520.f_558 != 0 && unk_0x486FF5D06E9659F1(Global_1943520.f_558) > 0;
}
...
{
	unk_0x0B0C9A0F9AAEB7F0(&(Global_2684504.f_3), 8);
	return;
}
...
void func_537(BOOL bParam0, int iParam1, BOOL bParam2) // Position - 0x32576
{
	...
	if (unk_0x38D063D8CF6D1967(str))
	{
		...
		func_538(&unk, &unk2, &unk3, &unk4, bParam2);
	...
	if (bParam4)
	{
		...
		*uParam1 = Global_1964364.f_7.f_1 + num2;
		...
		if (func_507(Global_1964364.f_7, Global_1964364.f_4, 0.02f, false))
			Global_1964364.f_4 = { unk_0xD2AA6F822D3A55D2(0.4751f, 0.5249f), unk_0xD2AA6F822D3A55D2(0.4751f, 0.5249f), 0f };
...
{
	if (Global_2696640 == true || func_660() || unk_0x834C960822A4683F() && func_543(&(Global_1934536.f_58)))
		if (iLocal_192 != 1)
...
{
	if (Global_1680307 >= 0 && Global_1680307 < unk_0x8044961915B48136())
		unk_0x21880A4FCBA19269(Global_1680307);
	else
...
void func_546(var uParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x32905
{
...
BOOL func_547() // Position - 0x329B9
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_548() // Position - 0x329CF
{
	...
	if (func_327(unk_0x259BE71D8A81D4FA(), 0))
		if (Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_829 != _INVALID_PLAYER_INDEX())
			if (_NETWORK_IS_PLAYER_VALID(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_829, false, true))
				if (func_551(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_829, true, false))
					return false;
...
void func_553() // Position - 0x32ACD
{
	...
	{
		if (!_STOPWATCH_IS_INITIALIZED(&uLocal_1022) && unk_0x834C960822A4683F())
		{
...
{
	unk_0x0B0C9A0F9AAEB7F0(&Global_2684504, 19);
	return;
}

void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, int iParam3) // Position - 0x32D26
{
	...
	else
	{
		...
		if (unk_0x762604C40829DB72(plParam0) && unk_0x75EAB09F5E974116(plParam0) || iParam3 == 1)
		{
			...
			if (!flag20)
			{
				...
				else if (flag14 || !func_327(unk_0x259BE71D8A81D4FA(), 0) && !func_570() && !func_569(unk_0x259BE71D8A81D4FA()))
			...
			if (bParam1)
			{
				...
				if (!func_566(unk) && !unk_0xB431D60610E7F85F(unk))
					if (!flag22)
...
BOOL func_566(var uParam0) // Position - 0x33271
{
	int num;
...
void func_567(int iParam0, int iParam1, int iParam2) // Position - 0x332A2
{
	int num;
	int i;
	...
	if (num == 0)
	{
		...
		func_270(joaat("MPPLY_IS_CHAR_SPECTATING"), iParam0);
	}
...
BOOL func_569(int iParam0) // Position - 0x333CA
{
...
void func_578(int iParam0, int iParam1, BOOL bParam2) // Position - 0x33503
{
	...
	num = func_616(func_328(iParam1, false), iParam0);
	...
	{
		case 0:
			if (func_267(unk_0x259BE71D8A81D4FA()) && unk_0x261E3728EE56B3AC() && func_612())
				func_600(iParam1);
			...
			unk_0xAECA84689B07DB71(func_581());
			num3 = func_580(9, 0);
			num2 = func_580(8, 0);
...
var func_583(int iParam0, int iParam1) // Position - 0x337DB
{
	return unk_0xD69CE161FE614531(1, iParam0, func_186(iParam1));
}

int func_584() // Position - 0x337F0
{
...
int func_585(int iParam0, int iParam1) // Position - 0x33849
{
	...
	if (func_591(iParam0))
	{
		...
		if (func_588(unk_0x259BE71D8A81D4FA()) && num2 == 1)
			return 1237;
...
void func_600(int iParam0) // Position - 0x3439D
{
	...
	func_184(641, num, iParam0, 1);
	func_184(642, func_608(num + 1, false, 1), iParam0, 1);
	func_184(643, func_608(num, false, 1), iParam0, 1);
	func_601(joaat("MPPLY_CURRENT_CREW_RANK"), func_602(func_603(unk_0x259BE71D8A81D4FA()), true));
	return;
}

void func_601(int iParam0, int iParam1) // Position - 0x343FA
{
	int num;
...
int func_603(int iParam0) // Position - 0x3442A
{
	var unk;
	int num;

	unk = { func_168(iParam0) };
...
int func_605(int iParam0) // Position - 0x344C1
{
	int num;
	int num2;
...
int func_607(var uParam0) // Position - 0x34555
{
...
void func_622() // Position - 0x34CAA
{
	...
	if (unk_0x76CD105BCAC6EB9F())
	{
		for (i = 0; i < 32; i = i + 1)
		{
			...
			{
				if (Global_1845281[num3 /*883*/].f_829 == unk_0x259BE71D8A81D4FA() && func_327(num3, 0) && num3 != unk_0x259BE71D8A81D4FA())
				{
					unk = { func_168(num3) };
...
void func_637(var uParam0, char* sParam1, int iParam2, char* sParam3) // Position - 0x34FA4
{
	if (*uParam0 == 0)
	{
		if (!unk_0xD6F9DEE4765092A9(sParam3) && func_301() != -1 && func_697() || func_698() && !func_639(func_301()) && func_638() - 1 > unk_0x39D1D336459711BE())
		{
			unk_0xB661D6EC3F065818(sParam3);
			unk_0x60D332F23943B34F(&(Global_2685444.f_1.f_845[func_301() /*57*/].f_13));
...
int func_653(var uParam0) // Position - 0x35335
{
	if (!unk_0xF8A8852F99E201DD(uParam0))
		return 0;
...
void func_667(int iParam0) // Position - 0x35568
{
	...
	if (func_669() == 0 || unk_0x4D9174D8796EA622())
	{
		func_668(1);
...
void func_671(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x355DF
{
	...
	if (func_669() == 1 || unk_0x4D9174D8796EA622() || bParam0)
	{
		func_668(0);
	...
	for (i = 0; i < 32; i = i + 1)
	{
		if (func_679(i))
		{
			*uParam0 = 0;
			...
			{
				unk = { func_168(unk_0x259BE71D8A81D4FA()) };
...
void func_691(var uParam0, var uParam1, var uParam2) // Position - 0x35952
{
	if (!func_550())
		return;
...
BOOL func_693(int iParam0) // Position - 0x3598C
{
...
BOOL func_701(int iParam0) // Position - 0x35B10
{
...
{
	unk_0x8744D2E3FC95740E(&(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_97.f_32), 3);
	return;
}

void func_705() // Position - 0x35B67
{
	unk_0x8744D2E3FC95740E(&(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_97.f_32), 1);
	return;
}

void func_706(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, BOOL bParam10, BOOL bParam11, var uParam12, var uParam13, int iParam14, BOOL bParam15, int iParam16) // Position - 0x35B83
{
	var unk;
	var unk4;
	float num;
	...
	func_546(uParam0, iParam1, 1, iParam14, true);
	...
	if (func_746(iParam1))
	{
		*uParam6 = { func_745(iParam1, uParam2) };
		unk4 = { func_744(iParam1, uParam2) };
		num = func_743(iParam1, uParam2);
	}
	...
	if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
	{
		if (_IS_NULL_VECTOR(unk))
		{
			if (func_327(unk_0x259BE71D8A81D4FA(), 0))
			{
				if (unk_0xFC8BFE4B41177C22(func_740()) && !unk_0x1C2F771CDC87A3A5(func_740(), 0))
				{
					unk = { unk_0xD1A6A821F5AC81DB(func_740(), 1) };
					unk4 = { 0f, 0f, unk_0xCFC0C995455A6204(func_740()) };
			...
			if (func_739(unk_0x259BE71D8A81D4FA()) || func_738(unk_0x259BE71D8A81D4FA()) && func_737())
				unk.f_2 = unk.f_2 + 1.5f;
			else if (unk_0xF8A8852F99E201DD(unk_0xF8F35890F43ED2AE(unk_0x4A8C381C258A124D())))
				if (func_739(unk_0x259BE71D8A81D4FA()))
	...
	else if (func_735(unk_0x259BE71D8A81D4FA()))
	{
	...
	{
		if (func_734(unk_0x259BE71D8A81D4FA()))
		{
			unk = { unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1) };
			unk4 = { 0f, 0f, unk_0xCFC0C995455A6204(unk_0x4A8C381C258A124D()) };
			unk.f_2 = unk.f_2 + 0.4f;
	...
	{
		num3 = func_733(unk_0x259BE71D8A81D4FA());
		unk = { unk_0xF10F2A2453AF1DFB(func_732(num3), func_731(num3), 3.5688f, 7.9792f, 4.1641f) };
		unk4 = { -21.6791f, 0f, func_731(num3) + 40.237f };
		num = 70f;
	}
	...
	{
		func_687();
		func_724(&unk7, 144, Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_268.f_35);
	
		if (!_IS_NULL_VECTOR(unk7))
			unk = { unk7 };
	
		func_719(&unk7, 144, Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_268.f_35);
		unk4 = { unk7 };
	}
...
BOOL func_709() // Position - 0x36525
{
	...
	if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
	{
		...
		if (func_711(unk, true) && !func_710(unk, true))
			return true;
	}
...
BOOL func_710(var uParam0, BOOL bParam1) // Position - 0x36560
{
	if (Global_79389)
...
BOOL func_711(var uParam0, BOOL bParam1) // Position - 0x365B4
{
	if (Global_79389)
		if (unk_0xFC8BFE4B41177C22(uParam0) && !bParam1 || unk_0xD9F5E1FEFD1329E4(uParam0, 0))
			if (unk_0xD130E7CDEE903624(uParam0, "Player_Vehicle"))
...
BOOL func_718(int iParam0) // Position - 0x366BD
{
...
void func_720(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x36872
{
	...
	*uParam2 = { func_722(iParam1, iParam3) };
	...
	unk14 = { func_721(unk14, -unk[0 /*6*/].f_3.f_2) };
	unk14 = { func_721(unk14, unk[1 /*6*/].f_3.f_2) };
...
struct<6> func_722(var uParam0, int iParam1) // Position - 0x37D6A
{
	var unk;
	var unk7;
	int num;
...
int func_733(int iParam0) // Position - 0x38240
{
	return Global_2652592[iParam0 /*3*/];
}

BOOL func_734(int iParam0) // Position - 0x38250
{
...
var func_740() // Position - 0x3887B
{
	if (unk_0xFC8BFE4B41177C22(func_742()))
		return func_742();

	return func_741();
}

var func_741() // Position - 0x38899
{
	return Global_2621446.f_2;
}

var func_742() // Position - 0x388A7
{
...
{
	if (!unk_0x47CB3D397940E783(func_748(false)))
		unk_0xDCAFFD08A08087EB(func_748(bParam0), 0, 1);
...
{
	unk_0x0B0C9A0F9AAEB7F0(&Global_2684504, 13);
	return;
}
