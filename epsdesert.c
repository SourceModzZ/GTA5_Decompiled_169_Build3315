						...
						if (func_140(unk_0x4A8C381C258A124D(), 12, iLocal_35))
						{
							if (func_139() && !func_167())
							{
								...
								if (num > 0.01f)
								{
									...
									Global_113969.f_10052.f_107 = Global_113969.f_10052.f_107 + num;
									...
									if (Global_113969.f_10052.f_107 < 1609f * 5f && (1609f * 5f) - Global_113969.f_10052.f_107 < fLocal_208 - 160.9f)
									{
										if (func_134())
										{
											num2 = func_133(Global_113969.f_10052.f_107);
											fLocal_218 = num2;
										}
										else
										{
...
int func_11(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xA2F
{
	...
	if (iParam5 == 0)
	{
		Global_79172[1 /*14*/] = { func_64(num8, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79172[1 /*14*/] = { func_64(num8, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79172[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79172[1 /*14*/] = { func_64(num8, 14, unk18[j], -1) };
							func_31(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
							func_54(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_21(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_21(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_21(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79172[1 /*14*/] = { func_64(num8, i, func_20(uParam0, i, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79172[1 /*14*/] = { func_64(num8, 14, unk59[j], -1) };
			func_31(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
			func_54(14);
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_21(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_21(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_21(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
...
BOOL func_12(var uParam0, int iParam1, var uParam2) // Position - 0x1240
{
	...
	{
		if (!func_140(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_64, Global_113969.f_2366.f_539[num /*65*/].f_63))
		{
...
BOOL func_19(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x1B49
{
	...
	{
		if (!func_140(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_61, Global_113969.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
BOOL func_71(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xD905
{
	int num;
	int num2;
	int num3;
...
void func_73(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xDA17
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_67(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_67(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_67(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_140(var uParam0, int iParam1, int iParam2) // Position - 0x1F493
{
	...
	num = unk_0x4B423FAA24E8ABF0(uParam0);
	Global_79172[1 /*14*/] = { func_64(num, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_140(uParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_140(uParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79172[2 /*14*/] = { func_64(num, 14, k, -1) };
								
									if (Global_79172[2 /*14*/].f_12 == j)
										if (func_140(uParam0, 14, k))
											if (!func_17(num, iParam2, 14, k, &unk, &Global_79172[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79172[2 /*14*/] = { func_64(num, i, num2, -1) };
					
						if (!func_17(num, iParam2, i, num2, &unk, &Global_79172[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79172[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_21(iParam1)) && Global_79172[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_21(iParam1)))
	{
		return true;
	}
