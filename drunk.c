...
int func_90(int iParam0, BOOL bParam1, int iParam2) // Position - 0x2D7A
{
	...
	if (func_92(num) && Global_1887305[num /*610*/].f_10.f_430 == iParam2)
		return 1;

	return 0;
}

BOOL func_91(int iParam0, int iParam1) // Position - 0x2DD6
{
	if (func_92(iParam0))
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, int iParam3) // Position - 0x2E47
{
...
BOOL func_112(var uParam0) // Position - 0x39C4
{
...
BOOL func_113(var uParam0) // Position - 0x39E3
{
	Vector3 vector;
...
void func_124() // Position - 0x3D03
{
	...
	{
		if (unk_0x9B5C1660CCDF7189(uLocal_41.f_1, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE")) == 1 && !IS_BIT_SET(Global_1943520.f_3, 27))
			return;
		...
		if (unk_0x76CD105BCAC6EB9F() && uLocal_41.f_1 == unk_0x4A8C381C258A124D() && Global_76498 && !Global_45004)
		{
			if (Global_45036[iLocal_63 /*5*/].f_3 >= 10)
				Global_45036[iLocal_63 /*5*/].f_3 = 9;
...
BOOL func_127(int iParam0, BOOL bParam1) // Position - 0x4224
{
	if (func_92(iParam0))
...
float func_142(var uParam0, float fParam1, float fParam2) // Position - 0x4C17
{
	float num;
	var unk;
	var unk2;
...
void func_143(var uParam0, float fParam1) // Position - 0x4CAB
{
...
void func_153(var uParam0) // Position - 0x51B1
{
...
void func_181(var uParam0, char* sParam1, int iParam2) // Position - 0x5C3B
{
