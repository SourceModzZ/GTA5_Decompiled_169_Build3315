...
void main() // Position - 0x0
{
	...
	if (unk_0x96CFB880BAC634CE(4))
	{
		...
		Global_1574599 = 0;
		unk_0xA6B31A9A2BC308B5(Global_1667211.f_471, Global_1667211.f_472, Global_1667211.f_499, Global_1667211.f_500);
...
void func_2(var uParam0, var uParam1, var uParam2) // Position - 0x552
{
	...
	if (unk_0x6D05C5731A838CB3(2, 187) || func_12(187, &(Global_1668667.f_1060), 1) && flag)
	{
	...
	if (unk_0x6D05C5731A838CB3(2, 188) || func_12(188, &(Global_1668667.f_1060), 1) && flag)
	{
		_STOPWATCH_DESTROY(uParam2);
		_STOPWATCH_INITIALIZE(uParam2, false, false);
	...
	if (unk_0x6D05C5731A838CB3(2, 189) || unk_0x6D05C5731A838CB3(2, 241) || func_12(189, &(Global_1668667.f_1060), 1) && flag)
	{
		_STOPWATCH_DESTROY(uParam2);
		_STOPWATCH_INITIALIZE(uParam2, false, false);
	...
	if (unk_0x6D05C5731A838CB3(2, 190) || unk_0x6D05C5731A838CB3(2, 242) || func_12(190, &(Global_1668667.f_1060), 1) && flag)
	{
		_STOPWATCH_DESTROY(uParam2);
		_STOPWATCH_INITIALIZE(uParam2, false, false);
		...
		switch (uParam1->f_7)
		{
			case 0:
				if (num3 == 0 || num3 == 1)
				{
					...
					{
						Global_1666627.f_1 = num4 % 4;
						Global_1666627.f_3 = num4 / 4;
					}
				}
				break;
		}
	...
	if (*uParam0 == 0)
	{
		...
		for (i = 0; i <= 19; i = i + 1)
		{
			if (uParam0->f_1[i] == 1)
			{
				...
				unk_0x330108B080A2132F(uParam0->f_364[i]);
				unk_0x330108B080A2132F(uParam0->f_427[i]);
...
void func_17(var uParam0, int iParam1) // Position - 0x4CCD
{
	...
	if (uParam0->f_473 == 0)
	{
		if (uParam0->f_472 != -1)
		{
			...
			unk_0x330108B080A2132F(0);
			unk_0x330108B080A2132F(uParam0->f_472);
			unk_0xE6B753D52F4CA222();
			uParam0->f_472 = -1;
			uParam0->f_473 = 1;
		}
...
void func_21(var uParam0) // Position - 0x4D58
{
...
void func_34(var uParam0, var uParam1) // Position - 0x50D7
{
...
BOOL func_37(var uParam0) // Position - 0x510A
{
...
void func_45(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5283
{
	int num;
...
int func_46(int iParam0, int iParam1) // Position - 0x52B1
{
...
var func_51(int iParam0, int iParam1) // Position - 0x536B
{
...
var func_109(int iParam0, int iParam1) // Position - 0xC1D2
{
...
void func_129(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4) // Position - 0x11D4D
{
...
void func_130(int iParam0) // Position - 0x11DAA
{
	...
	if (func_137(iParam0))
	{
		...
		if (!IS_BIT_SET(Global_1667211.f_471, num))
			unk_0x0B0C9A0F9AAEB7F0(&(Global_1667211.f_471), num);
	
		if (flag)
			if (!IS_BIT_SET(Global_1667211.f_472, num))
				unk_0x0B0C9A0F9AAEB7F0(&(Global_1667211.f_472), num);
	}
	...
	if (func_132(iParam0))
	{
		...
		if (!IS_BIT_SET(Global_1667211.f_499, num2))
			unk_0x0B0C9A0F9AAEB7F0(&(Global_1667211.f_499), num2);
	
		if (flag2)
			if (!IS_BIT_SET(Global_1667211.f_500, num2))
				unk_0x0B0C9A0F9AAEB7F0(&(Global_1667211.f_500), num2);
	}
...
void func_149(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x12629
{
