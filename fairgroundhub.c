...
void func_3(var uParam0) // Position - 0xA39
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int _GET_VEHICLE_SEAT_PED_IS_IN(var ped, int includeLastVehicle) // Position - 0xBB6
{
	var unk;
	int num;
	int i;
...
int func_12(var uParam0, var uParam1, var uParam2) // Position - 0xD9B
{
...
void func_13(var uParam0, var uParam1) // Position - 0xDE7
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(var message) // Position - 0xE5D
{
	unk_0x39DCBE5519BD783A(message);
	return unk_0x7EBCD400E7DE179C(0);
}

BOOL func_16(var uParam0, var uParam1) // Position - 0xE70
{
...
BOOL func_20(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFCE
{
	return SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(uParam0, iParam5), vParam1) <= fParam4 * fParam4;
}

int func_21(var uParam0, var uParam1) // Position - 0xFEC
{
	if (unk_0xD6F9DEE4765092A9(uParam1))
		return 0;
...
void func_22(var uParam0) // Position - 0x1035
{
	unk_0xAC98CA65AD9A3215(uParam0);
	unk_0x5E01B6B1F460FE3F(0, 1, 1, -1);
	return;
...
BOOL func_25(var uParam0, int iParam1) // Position - 0x10CC
{
	int num;
...
BOOL func_26(var uParam0) // Position - 0x1168
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x1192
{
...
BOOL func_28(var uParam0) // Position - 0x11B3
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
		if (unk_0x1C2F771CDC87A3A5(uParam0, 0))
			return true;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x1375
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x13B2
{
...
int func_36(eCharacter echParam0) // Position - 0x13D7
{
	return Global_2169[echParam0 /*29*/];
}

int func_37(int iParam0) // Position - 0x13E6
{
	int num;
...
BOOL func_39(int iParam0) // Position - 0x143B
{
	if (!func_40(iParam0))
		return false;
...
BOOL func_40(int iParam0) // Position - 0x145A
{
	int num;
...
BOOL func_45(int iParam0) // Position - 0x1587
{
	...
	if (unk_0x4D9174D8796EA622() || unk_0xEF37E704F02B50F3() || func_43() || Global_64160 || func_44(false) || func_50(0) || func_46(unk_0x259BE71D8A81D4FA()))
		return false;

	return true;
}

BOOL func_46(var uParam0) // Position - 0x15ED
{
	if (func_49(uParam0))
		return true;
...
BOOL func_47(int iParam0) // Position - 0x1610
{
	int num;
...
BOOL func_48(int iParam0, int iParam1) // Position - 0x162E
{
	return IS_BIT_SET(Global_1887305[iParam0 /*610*/].f_10.f_4, iParam1);
}

BOOL func_49(int iParam0) // Position - 0x1646
{
	int num;
