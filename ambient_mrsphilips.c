...
void func_68(var uParam0) // Position - 0x56F2
{
	eCharacter character;
...
BOOL func_70(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5C7D
{
	var unk;
	var unk2;
...
int func_79(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6915
{
	int i;
	float num;
	float num2;
...
void func_118(char* sParam0, var uParam1, int iParam2) // Position - 0x8D28
{
...
BOOL func_137(var uParam0) // Position - 0xAB28
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0xAB48
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
int func_147(var uParam0, int iParam1) // Position - 0xAD93
{
	int num;
	var unk;
	var unk33;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_166() || Global_32951 || func_165() || func_164(8, -1) || func_162() || func_102() || func_163() || func_161() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_166() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_164(8, -1) || func_161() || func_160() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
