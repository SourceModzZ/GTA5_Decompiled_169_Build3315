...
void func_105() // Position - 0x40BD
{
	if (!func_134())
	{
		if (!unk_0x1C2F771CDC87A3A5(uLocal_67, 0))
		{
			if (unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), uLocal_47, 65f, 60f, 60f, 0, 1, 0) || Global_113964)
			{
...
{
	switch (func_113(&Global_33008, 0, 5, false, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return true;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_172() || Global_32951 || func_171() || func_51(8, -1) || func_168() || func_170() || func_169() || func_167() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_172() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_51(8, -1) || func_167() || func_166() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
...
void func_181(int iParam0) // Position - 0x7FFA
{
	...
	if (func_134())
	{
		...
		func_184(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_183(Global_113958, true), 64);
