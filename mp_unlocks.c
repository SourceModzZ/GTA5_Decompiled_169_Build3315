...
var func_14(int iParam0, int iParam1) // Position - 0x1B55
{
...
int func_20(int iParam0) // Position - 0x1C8A
{
	return iParam0 / 32;
}
...
void func_24(int iParam0, var uParam1, int iParam2, var uParam3, char* sParam4, BOOL bParam5, int iParam6) // Position - 0x1CD9
{
...
BOOL func_29(int iParam0, int iParam1) // Position - 0x1F38
{
	if (!func_33())
		return false;
...
var func_36(int iParam0, int iParam1) // Position - 0x2207
{
...
void func_38(int iParam0, var uParam1, int iParam2, var uParam3, char* sParam4, int iParam5) // Position - 0x2264
{
	if (unk_0xF3F7B05FC4684A7C("SET_DATA_SLOT"))
	{
		unk_0x330108B080A2132F(iParam0);
...
int func_42(int iParam0) // Position - 0x2662
{
	int num;
	int num2;
...
var func_44(int iParam0, int iParam1) // Position - 0x26A4
{
...
BOOL func_46(int iParam0, int iParam1) // Position - 0x26D5
{
	if (iParam1 == -1)
		iParam1 = func_16();
...
void func_48(int iParam0, var uParam1, int iParam2, var uParam3, char* sParam4, char* sParam5, int iParam6) // Position - 0x2745
{
	if (unk_0xF3F7B05FC4684A7C("SET_DATA_SLOT"))
	{
		unk_0x330108B080A2132F(iParam0);
...
void func_49(int iParam0, var uParam1, int iParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, int iParam7) // Position - 0x2799
{
	if (unk_0xF3F7B05FC4684A7C("SET_DATA_SLOT"))
	{
		unk_0x330108B080A2132F(iParam0);
...
int func_65(int iParam0, BOOL bParam1) // Position - 0x3327
{
	bParam1;
	return func_66(iParam0);
}

int func_66(int iParam0) // Position - 0x333A
{
...
BOOL func_67(int iParam0) // Position - 0x3391
{
	if (!func_68(iParam0))
		return false;
...
BOOL func_68(int iParam0) // Position - 0x33B0
{
	int num;
...
void func_70(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x33EF
{
	if (iParam1 == -1)
		return;
...
BOOL func_75(int iParam0) // Position - 0x35E3
{
	int num;
	int num2;
	int num3;
	...
	if (unk_0x2645430E708CBFAC(2, iParam0) || unk_0x61C3701AD6D746B2(2, iParam0) || func_76(iParam0, &(Global_1668667.f_1060), 1))
	{
...
BOOL func_76(int iParam0, var uParam1, int iParam2) // Position - 0x3677
{
	int num;
	int num2;
	int num3;
...
BOOL func_81() // Position - 0x3947
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_82() // Position - 0x395D
{
