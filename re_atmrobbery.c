				...
				if (!func_133() && !func_130())
				{
					...
					if (unk_0xC450B06E5AAA0985(iLocal_101))
					{
						if (!unk_0x4FAFF4BCB7633475(iLocal_97))
						{
							...
							{
								if (unk_0xFAA48325A90263BE(unk_0x4A8C381C258A124D(), iLocal_98, Global_20, 0, 1, 0))
								{
...
void func_7(int iParam0) // Position - 0x3303
{
	...
	else if (IS_BIT_SET(Global_113969.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_9() /*5570*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_113969.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_9() /*5570*/].f_681.f_10), iParam0);
	}
...
BOOL func_89(int iParam0) // Position - 0x5924
{
	int num;
...
BOOL func_90(int iParam0) // Position - 0x5946
{
...
int func_92(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x5993
{
	int num;
...
int func_111(var uParam0) // Position - 0x6691
{
	return func_112(uParam0);
}

int func_112(var uParam0) // Position - 0x669F
{
	int num;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0x66D7
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_116(int iParam0, int iParam1, float fParam2, int iParam3, BOOL bParam4) // Position - 0x6933
{
	int num;
	float num2;
	float num3;
...
float func_119(int iParam0, int iParam1, int iParam2) // Position - 0x6C98
{
	var unk;
	var unk4;
...
BOOL func_128(int iParam0, int iParam1) // Position - 0x7320
{
...
BOOL func_131(int iParam0) // Position - 0x7492
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iParam0))
...
BOOL func_134(int iParam0, BOOL bParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x75BF
{
	float num;
...
BOOL func_135(int iParam0, int iParam1) // Position - 0x767A
{
	float num;
...
BOOL func_136(int iParam0, int iParam1) // Position - 0x76F0
{
	return func_137(iParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_137(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x7708
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_138(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0x77C9
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_139(var uParam0, int iParam1) // Position - 0x78F5
{
	int num;
...
BOOL func_141(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x7A04
{
	var unk;
	var unk4;
	float num;
...
int func_145(var uParam0, var uParam1) // Position - 0x7B10
{
	int i;
...
BOOL func_147(var uParam0, int iParam1, int iParam2) // Position - 0x7B77
{
	float num;
	Vector3 vector;
...
BOOL func_148(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7BBE
{
	float num;
	float num2;
	int num3;
...
BOOL func_149(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7CB9
{
	float num;
	float num2;
...
BOOL func_150(int iParam0, float fParam1) // Position - 0x7DC5
{
	var unk;
	var unk2;
...
BOOL func_151(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x7E5A
{
	var unk;
	var unk4;
	float num;
...
BOOL func_152(int iParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0x7EE8
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_154(var uParam0, int iParam1, char* sParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x7F67
{
	func_155(uParam0, iParam1, sParam2, iParam3, bParam4, bParam5, bParam6);
	return;
}

void func_155(var uParam0, int iParam1, char* sParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x7F81
{
	func_156(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, bParam5, bParam6);
	return;
}

void func_156(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, char* sParam5, int iParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x7F9E
{
	if (!unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 1))
...
void func_157(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, char* sParam5, int iParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x7FD6
{
	char* str;
	BOOL flag;
...
BOOL func_165(var uParam0, int iParam1) // Position - 0x883B
{
	if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
	{
...
int _GET_VEHICLE_SEAT_PED_IS_IN(var ped, int includeLastVehicle) // Position - 0x889D
{
	var unk;
	int num;
	int i;
...
void func_171(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0x8960
{
	var unk;
	int num;
	int num2;
...
BOOL func_173(var uParam0) // Position - 0x8A80
{
...
BOOL func_179(int iParam0) // Position - 0x8F5B
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
		if (unk_0x55B80B6E7AB61270(iParam0))
...
void func_181(var uParam0, char* sParam1, int iParam2) // Position - 0x8FC6
{
	char* str;
...
float func_182(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x90A0
{
	var unk;
...
BOOL func_183(int iParam0, int iParam1) // Position - 0x90DA
{
	if (func_131(iParam0))
...
{
	switch (func_191(&Global_33008, 0, 5, false, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return true;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x9FEA
{
...
BOOL func_203(int iParam0, var uParam1, var uParam2) // Position - 0xA19D
{
...
{
	if (Global_113958 == func_226() && unk_0x9FA91AA1AC724CD0() && Global_113959)
		return true;
...
void func_229(var uParam0) // Position - 0xCE69
{
	func_230(uParam0, &(uParam0->f_2), uParam0->f_1);
	return;
}

void func_230(var uParam0, var uParam1, var uParam2) // Position - 0xCE7F
{
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_270() || Global_32951 || func_269() || func_60(8, -1) || func_266() || func_268() || func_267() || func_265() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_270() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_60(8, -1) || func_265() || func_264() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
...
void func_280(int iParam0) // Position - 0xE7B0
{
	...
	if (func_225())
	{
		...
		func_284(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_283(Global_113958, true), 64);
...
void func_296(int iParam0, var uParam1, var uParam2) // Position - 0xF0D5
{
	if (IS_BIT_SET(iParam0, 30))
	{
		switch (func_204(iParam0))
