...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5F3E
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6BD6
{
	int i;
	float num;
	float num2;
...
void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8FDE
{
...
BOOL func_136(var uParam0) // Position - 0xAED6
{
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xB019
{
	int i;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB1B8
{
	if (bParam0)
	{
...
BOOL func_147(int iParam0) // Position - 0xB3B9
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB3DB
{
...
int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB428
{
	int num;
...
BOOL func_153(var uParam0) // Position - 0xB4A5
{
...
BOOL func_158(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB5B6
{
...
void func_159(var uParam0) // Position - 0xB60D
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_177(var uParam0, int iParam1) // Position - 0xBDE3
{
	int num;
	var unk;
	var unk33;
...
var func_180(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC2C1
{
	var unk;
...
BOOL func_184(var uParam0, int iParam1) // Position - 0xC43A
{
	if (func_136(uParam0))
...
BOOL func_190(var uParam0) // Position - 0xCDF4
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xD638
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD794
{
...
float func_207(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD82F
{
	var unk;
...
void func_209(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD896
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_223(var uParam0) // Position - 0xE4F6
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_226(var uParam0, var uParam1) // Position - 0xE75F
{
	var unk;
...
BOOL func_229(var uParam0, int iParam1) // Position - 0xEA7F
{
	float num;
...
BOOL func_230(var uParam0, int iParam1) // Position - 0xEAF5
{
	return func_231(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_231(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEB0D
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_232(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xEBCE
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_233(var uParam0, int iParam1) // Position - 0xECFA
{
	int num;
...
BOOL func_235(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xEE09
{
	var unk;
	var unk4;
	float num;
...
int func_239(var uParam0, var uParam1) // Position - 0xEF15
{
	int i;
...
int func_240(var uParam0) // Position - 0xEF54
{
...
BOOL func_241(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEF7C
{
	float num;
	float num2;
	int num3;
...
BOOL func_242(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF077
{
	float num;
	float num2;
...
BOOL func_243(var uParam0, float fParam1) // Position - 0xF183
{
	var unk;
	var unk2;
...
BOOL func_244(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF218
{
	var unk;
	var unk4;
	float num;
...
BOOL func_245(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF2A6
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_247(var uParam0) // Position - 0xF338
{
	var unk;
...
void func_257(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0xF6FC
{
...
void func_258(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6) // Position - 0xF72E
{
	func_259(uParam0);
...
void func_259(var uParam0) // Position - 0xF74F
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_264(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF9BA
{
...
BOOL func_265(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFA16
{
	int num;
...
void func_268(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFDEE
{
	func_269(uParam0);
...
void func_269(var uParam0) // Position - 0xFE31
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x110821AE6C63DD4F(*uParam0))
...
void func_289(var uParam0, BOOL bParam1) // Position - 0x1069B
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_292(var uParam0) // Position - 0x10725
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_295(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x107B0
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
int func_300(eCharacter echParam0) // Position - 0x1089C
{
	if (!func_36(echParam0))
