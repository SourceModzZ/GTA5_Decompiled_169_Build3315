			...
			while (num == 0)
			{
				...
				if (unk_0x0A5BC2689B1DF62B())
				{
					...
					if (num3 >= 0)
					{
						...
						Global_1666627.f_1 = num3 % 3;
						Global_1666627.f_3 = num3 / 3;
						func_155(num3, &Global_1666925);
						func_160(&Global_1666925);
					}
				}
...
void func_1(var uParam0, var uParam1, var uParam2) // Position - 0x30C
{
	...
	if (unk_0x6D05C5731A838CB3(2, 187) || func_6(187, &(Global_1668667.f_1060), 1) && flag)
	{
	...
	if (unk_0x6D05C5731A838CB3(2, 188) || func_6(188, &(Global_1668667.f_1060), 1) && flag)
	{
		_STOPWATCH_DESTROY(uParam2);
		_STOPWATCH_INITIALIZE(uParam2, false, false);
	...
	if (unk_0x6D05C5731A838CB3(2, 189) || unk_0x6D05C5731A838CB3(2, 241) || func_6(189, &(Global_1668667.f_1060), 1) && flag)
	{
		_STOPWATCH_DESTROY(uParam2);
		_STOPWATCH_INITIALIZE(uParam2, false, false);
	...
	if (unk_0x6D05C5731A838CB3(2, 190) || unk_0x6D05C5731A838CB3(2, 242) || func_6(190, &(Global_1668667.f_1060), 1) && flag)
	{
...
int func_33(int iParam0, int iParam1) // Position - 0x2D6B
{
...
var func_39(int iParam0, int iParam1) // Position - 0x2E9F
{
...
int func_46(int iParam0) // Position - 0x3576
{
	return Global_1845281[iParam0 /*883*/].f_206.f_6;
}

int func_47(int iParam0, var uParam1, int iParam2) // Position - 0x358B
{
	int num;
...
int func_49(int iParam0, var uParam1, int iParam2) // Position - 0x37E4
{
	int num;
...
int func_51(int iParam0, var uParam1, int iParam2) // Position - 0x3A4B
{
	int num;
...
BOOL func_53(int iParam0, int iParam1, int iParam2) // Position - 0x4841
{
	int num;
	int num2;
...
int func_56(int iParam0, int iParam1, int iParam2) // Position - 0x6E65
{
	int num;
...
void func_61(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7AD9
{
	int num;
...
int func_63(int iParam0, int iParam1, int iParam2) // Position - 0x7C8A
{
	int num;
...
BOOL func_64(int iParam0, int iParam1, int iParam2) // Position - 0x7CA4
{
	int num;
	int num2;
...
int func_69(int iParam0, int iParam1, int iParam2) // Position - 0x7EF9
{
	int num;
...
int func_74(int iParam0, int iParam1, int iParam2) // Position - 0x81B2
{
	int num;
...
BOOL func_75(int iParam0, int iParam1, int iParam2) // Position - 0x81CC
{
	int num;
	int num2;
...
void func_76(int iParam0, int iParam1, BOOL bParam2) // Position - 0x81FE
{
	...
	if (num > -1)
		if (bParam2)
			unk_0x0B0C9A0F9AAEB7F0(&Global_2749864.f_991[func_77(iParam0, iParam1)], func_28(num));
		else
			unk_0x8744D2E3FC95740E(&Global_2749864.f_991[func_77(iParam0, iParam1)], func_28(num));
...
BOOL func_83(int iParam0, int iParam1) // Position - 0x9062
{
	int num;
	int num2;
...
int func_84(int iParam0, int iParam1) // Position - 0x9087
{
	var unk;

	unk = Global_2749864.f_991[func_77(iParam0, iParam1)];
	return unk;
}
...
BOOL func_91(int iParam0, int iParam1, int iParam2) // Position - 0x9FF2
{
	int num;
	int num2;
...
BOOL func_95(int iParam0, int iParam1, int iParam2) // Position - 0xA724
{
	int num;
	int num2;
...
BOOL func_97(int iParam0) // Position - 0xA80E
{
	switch (iParam0)
	{
		case joaat("WEAPON_PISTOL_MK2"):
...
BOOL func_100(int iParam0) // Position - 0xB5FE
{
...
var func_103(int iParam0, int iParam1) // Position - 0xB6FD
{
...
int _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xB779
{
	var unk;
...
BOOL func_131(int iParam0) // Position - 0xBE7E
{
	switch (iParam0)
	{
		case joaat("COMPONENT_PISTOL_CLIP_02"):
...
BOOL func_133(int iParam0) // Position - 0xC0D6
{
	switch (iParam0)
	{
		case joaat("COMPONENT_ASSAULTRIFLE_CLIP_03"):
...
BOOL func_142(int iParam0) // Position - 0xEF27
{
	int num;
	BOOL num2;
...
BOOL func_143(int iParam0) // Position - 0xEF45
{
	if (unk_0x76CD105BCAC6EB9F())
		if (func_144())
...
void func_150(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4) // Position - 0xF04E
{
...
BOOL func_152(int iParam0) // Position - 0xF102
{
	int num;
	int num2;
	int num3;
	...
	{
		if (!IS_BIT_SET(Global_1668667.f_1049[num2], num3))
		{
			unk_0x0B0C9A0F9AAEB7F0(&Global_1668667.f_1049[num2], num3);
			return true;
		}
	}
	else if (IS_BIT_SET(Global_1668667.f_1049[num2], num3))
	{
		unk_0x8744D2E3FC95740E(&Global_1668667.f_1049[num2], num3);
	}
...
BOOL func_154(int iParam0) // Position - 0xFF8A
{
	int i;
...
void func_159(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x10038
{
