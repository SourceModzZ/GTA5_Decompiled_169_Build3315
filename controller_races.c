					...
					if (num2 > 43681f)
					{
						if (!func_7(num))
						{
							if (!Global_113943[i])
							{
								...
								unk_0x8744D2E3FC95740E(&(Global_113969.f_24982.f_3), i);
							}
							else if (unk_0x1DD05E817C89C737() - Global_113949[i] > 60000)
							{
								Global_113943[i] = false;
								Global_113949[i] = unk_0x1DD05E817C89C737();
								func_3(num);
								func_2(num, true, true);
								unk_0x8744D2E3FC95740E(&(Global_113969.f_24982.f_3), i);
							}
				...
				if (num2 > 43681f)
				{
					if (!func_7(num))
					{
						if (!Global_113933[i])
						{
							func_3(num);
							func_2(num, true, true);
							unk_0x8744D2E3FC95740E(&(Global_113969.f_24979.f_2), i);
						}
						else if (unk_0x1DD05E817C89C737() - Global_113938[i] > 60000)
						{
							Global_113933[i] = false;
							Global_113938[i] = unk_0x1DD05E817C89C737();
							func_3(num);
							func_2(num, true, true);
							unk_0x8744D2E3FC95740E(&(Global_113969.f_24979.f_2), i);
						}
