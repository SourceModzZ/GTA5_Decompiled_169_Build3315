...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (Global_20930.f_1 != 9 && Global_23320 == 0 && Global_23319 == 0)
		{
			...
			{
				if (unk_0x1B79E937E91F40C3(&Global_4541819[iLocal_34 /*104*/], "CELL_FINV"))
				{
				}
				else
				{
	...
	if (Global_4541819[iLocal_34 /*104*/].f_24 == 1)
	{
		if (Global_20908 == 0)
		{
			if (unk_0x6D05C5731A838CB3(2, Global_20901))
			{
				...
				unk_0xFE3A52C5B7AE3101(Global_4541819[iLocal_34 /*104*/].f_16);
				func_56(Global_20911, "SET_DATA_SLOT_EMPTY", 8f, -1082130432, -1082130432, -1082130432, -1082130432);
				func_53();
...
void func_21(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11) // Position - 0x1814
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x1CAC
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1CE9
{
...
int func_35(eCharacter echParam0) // Position - 0x1D0E
{
	...
	if (Global_20908 == 0)
	{
		if (func_3(2, Global_20899, 0) || Global_4543069 == 1 || Global_23346 == 1)
		{
			...
			if (Global_4541819[iLocal_34 /*104*/].f_24 != 0)
			{
				...
				unk = { Global_4541819[iLocal_34 /*104*/] };
				...
				{
					unk_0x882AEFD55B8D51FB("CELL_FROM_FIELD" /*From: ~a~*/);
					unk_0x60D332F23943B34F(&(Global_4541819[iLocal_34 /*104*/].f_50));
					unk_0xCFAD3D478C87321A();
				}
				else
				{
					unk_0x882AEFD55B8D51FB("CELL_FROM_FIELD" /*From: ~a~*/);
					unk_0xACF853FB3F6EA7D4(&(Global_2169[Global_4541819[iLocal_34 /*104*/].f_17 /*29*/].f_3));
					unk_0xCFAD3D478C87321A();
				}
				...
				switch (Global_4541819[iLocal_34 /*104*/].f_32)
				{
					...
					case 1:
						unk_0x882AEFD55B8D51FB(&Global_4541819[iLocal_34 /*104*/]);
						unk_0x60D332F23943B34F(&(Global_4541819[iLocal_34 /*104*/].f_33));
					
						if (Global_4541819[iLocal_34 /*104*/].f_66 == 1 && !unk_0x1B79E937E91F40C3(&(Global_4541819[iLocal_34 /*104*/].f_67), "NULL"))
							unk_0x60D332F23943B34F(&(Global_4541819[iLocal_34 /*104*/].f_67));
					
						if (Global_4541819[iLocal_34 /*104*/].f_66 == 2 && !unk_0x1B79E937E91F40C3(&(Global_4541819[iLocal_34 /*104*/].f_67), "NULL") && !unk_0x1B79E937E91F40C3(&(Global_4541819[iLocal_34 /*104*/].f_83), "NULL"))
						{
							if (unk_0x6BA487C862DB8DDF(&(Global_4541819[iLocal_34 /*104*/].f_67)))
								unk_0xACF853FB3F6EA7D4(&(Global_4541819[iLocal_34 /*104*/].f_67));
							else
								unk_0x60D332F23943B34F(&(Global_4541819[iLocal_34 /*104*/].f_67));
						
							if (unk_0x6BA487C862DB8DDF(&(Global_4541819[iLocal_34 /*104*/].f_83)))
								unk_0xACF853FB3F6EA7D4(&(Global_4541819[iLocal_34 /*104*/].f_83));
							else
								unk_0x60D332F23943B34F(&(Global_4541819[iLocal_34 /*104*/].f_83));
						}
					...
					case 2:
						unk_0x882AEFD55B8D51FB(&Global_4541819[iLocal_34 /*104*/]);
						unk_0x511D14ED2DA887E1(Global_4541819[iLocal_34 /*104*/].f_49);
						unk_0xCFAD3D478C87321A();
						break;
...
void func_38(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2B17
{
	int num;

	if (iParam0 != 14835)
	{
		num = func_39(iParam0, iParam2);
...
int func_39(int iParam0, int iParam1) // Position - 0x2B45
{
...
void func_42() // Position - 0x2B9A
{
	...
	if (Global_4541819[iLocal_34 /*104*/].f_24 != 0)
	{
		for (i = 0; i < 59; i = i + 1)
		{
			if (unk_0x1B79E937E91F40C3(&Global_4541819[iLocal_34 /*104*/], &uLocal_60[i /*6*/]))
			{
...
BOOL func_43(var uParam0) // Position - 0x2C35
{
...
float func_46(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11, float fParam12, BOOL bParam13) // Position - 0x2DC0
{
	...
	num = func_48(SYSTEM::TO_FLOAT(unk_0x1DD05E817C89C737() - iLocal_16) / fParam12, 0f, 1f);
...
void func_52(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6) // Position - 0x32DF
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	func_16(sParam2);
...
void func_53() // Position - 0x333A
{
	...
	while (num < 11)
	{
		...
		num3 = 0;
		num4 = 11;
		Global_4541819[num4 /*104*/].f_18 = -1;
		Global_4541819[num4 /*104*/].f_18.f_1 = 0;
		Global_4541819[num4 /*104*/].f_18.f_2 = 0;
		Global_4541819[num4 /*104*/].f_18.f_3 = 0;
		Global_4541819[num4 /*104*/].f_18.f_5 = 0;
		...
		while (num3 < 12)
		{
			...
			if (unk[num3] == 0)
			{
				if (Global_4541819[num3 /*104*/].f_24 != 0)
				{
					...
					{
						if (func_55(Global_4541819[num3 /*104*/].f_18, Global_4541819[num4 /*104*/].f_18))
						{
							num4 = num3;
						
							if (Global_4541819[num4 /*104*/].f_28 == 0)
								iLocal_35 = 0;
							else
								iLocal_35 = 1;
						}
		...
		if (Global_4541819[num4 /*104*/].f_24 != 0)
		{
			if (Global_4541819[num4 /*104*/].f_99[Global_20930] == 1)
			{
				unk_0x88F483FBD433696A(Global_20911, "SET_DATA_SLOT");
				...
				if (Global_4541819[num4 /*104*/].f_17 == 145)
				{
					unk_0x882AEFD55B8D51FB("CELL_2000" /*~a~*/);
					unk_0x60D332F23943B34F(&(Global_4541819[num4 /*104*/].f_50));
					unk_0xCFAD3D478C87321A();
				}
				else
				{
					func_16(&(Global_2169[Global_4541819[num4 /*104*/].f_17 /*29*/].f_3));
				}
			
				unk14 = { Global_4541819[num4 /*104*/] };
			
				if (func_43(&Global_4541819[num4 /*104*/]))
				{
					num5 = func_54(7315, -1);
...
var func_54(int iParam0, int iParam1) // Position - 0x3676
{
	if (iParam1 == -1)
		iParam1 = func_41();
...
void func_56(var uParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x377D
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	unk_0x330108B080A2132F(SYSTEM::ROUND(fParam2));
