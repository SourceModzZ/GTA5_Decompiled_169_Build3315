...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E7F
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B17
{
	int i;
	float num;
	float num2;
...
void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8F1F
{
...
BOOL func_136(var uParam0) // Position - 0xAE17
{
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAF5A
{
	int i;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB0F9
{
	if (bParam0)
	{
...
BOOL func_147(int iParam0) // Position - 0xB2FA
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB31C
{
...
int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB369
{
	int num;
...
BOOL func_153(var uParam0) // Position - 0xB3E6
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB519
{
...
void func_160(var uParam0) // Position - 0xB570
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_178(var uParam0, int iParam1) // Position - 0xBD46
{
	int num;
	var unk;
	var unk33;
...
var func_181(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC223
{
	var unk;
...
BOOL func_189(var uParam0) // Position - 0xCC7C
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_198() || Global_32951 || func_197() || func_196(8, -1) || func_194() || func_101() || func_195() || func_193() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_198() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_196(8, -1) || func_193() || func_192() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_206(int iParam0, int iParam1) // Position - 0xD92F
{
...
float func_213(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xDBF7
{
	var unk;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xDD91
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_218(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDDB2
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_232(var uParam0) // Position - 0xEA12
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_235(var uParam0, var uParam1) // Position - 0xEC7B
{
	var unk;
...
BOOL func_238(var uParam0, int iParam1) // Position - 0xEF9B
{
	float num;
...
BOOL func_239(var uParam0, int iParam1) // Position - 0xF011
{
	return func_240(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_240(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF029
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_241(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xF0EA
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_242(var uParam0, int iParam1) // Position - 0xF216
{
	int num;
...
BOOL func_244(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xF325
{
	var unk;
	var unk4;
	float num;
...
int func_248(var uParam0, var uParam1) // Position - 0xF431
{
	int i;
...
int func_249(var uParam0) // Position - 0xF470
{
...
BOOL func_250(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF498
{
	float num;
	float num2;
	int num3;
...
BOOL func_251(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF593
{
	float num;
	float num2;
...
BOOL func_252(var uParam0, float fParam1) // Position - 0xF69F
{
	var unk;
	var unk2;
...
BOOL func_253(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF734
{
	var unk;
	var unk4;
	float num;
...
BOOL func_254(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF7C2
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_256(var uParam0) // Position - 0xF854
{
	var unk;
...
BOOL func_265(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFAE2
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xFC0A
{
...
void func_275(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x100BE
{
	func_232(uParam0);
...
void func_276(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x100E5
{
	func_277(uParam0);
...
void func_277(var uParam0) // Position - 0x10128
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_280(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6) // Position - 0x10545
{
	func_281(uParam0);
...
void func_281(var uParam0) // Position - 0x10566
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_283(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x1079F
{
...
BOOL func_284(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x107FB
{
	int num;
...
void func_289(var uParam0, var uParam1) // Position - 0x10CD4
{
	var unk;
	float num;
...
void func_315(var uParam0, BOOL bParam1) // Position - 0x118C8
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_318(var uParam0) // Position - 0x11952
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_321(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x119DD
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
int func_326(eCharacter echParam0) // Position - 0x11AC9
{
	if (!func_36(echParam0))
