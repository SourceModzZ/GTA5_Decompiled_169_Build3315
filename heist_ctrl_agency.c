	...
	switch (iParam1)
	{
		case 5:
			*uParam2 = { Global_100937[iParam0 /*98*/] };
			...
			{
				if (unk_0x26715B0ED6702C87(Global_101240[iParam0 /*3*/], -829.7478f, 192.11703f, 76.73248f, -827.13837f, 153.85951f, 59.961723f, 33.25f, 0, 1))
				{
...
BOOL func_204(int iParam0, int iParam1) // Position - 0xD72E
{
	int i;
...
var func_212(var uParam0) // Position - 0xE208
{
	return uParam0;
}
...
int func_220(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x11841
{
	int i;
	float num;
	float num2;
...
var func_225(int iParam0, int iParam1) // Position - 0x11A23
{
...
var func_233(int iParam0, int iParam1) // Position - 0x1225B
{
	return unk_0xD69CE161FE614531(2, iParam0, func_226(iParam1));
}

void func_234(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x12270
{
	eCharacter character;
...
void func_235(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x127B9
{
	eCharacter character;
...
void func_241(var uParam0) // Position - 0x12C71
{
	int i;
	var unk;
	int num;
...
void func_243(var uParam0) // Position - 0x12FA7
{
	eCharacter character;
...
void func_249(var uParam0, BOOL bParam1) // Position - 0x13294
{
	func_261(uParam0);
...
void func_250(var uParam0) // Position - 0x132C8
{
	eCharacter character;
...
void func_251(var uParam0) // Position - 0x1330F
{
	eCharacter character;
...
void func_252(var uParam0) // Position - 0x1334D
{
	eCharacter character;
...
void func_253(var uParam0) // Position - 0x134DA
{
	eCharacter character;
...
void func_254(var uParam0) // Position - 0x13516
{
	eCharacter character;
...
void func_255(var uParam0, BOOL bParam1) // Position - 0x13573
{
	eCharacter character;
	var unk;
	int i;
	...
	if (func_102(character) && !unk_0x4FAFF4BCB7633475(uParam0))
	{
		if (uParam0 == unk_0x4A8C381C258A124D())
		{
			func_256(uParam0, &Global_113969.f_2366.f_539.f_298[character /*477*/]);
...
void func_256(var uParam0, var uParam1) // Position - 0x13666
{
	int i;
	int j;
	int k;
...
void func_261(var uParam0) // Position - 0x14902
{
	eCharacter character;
...
void func_284(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x153C3
{
	if (bParam0)
	{
		unk_0x6A84D4B060E73EF5(unk_0x259BE71D8A81D4FA(), 0);
...
BOOL func_288(int iParam0) // Position - 0x155C4
{
	int num;
...
BOOL func_289(int iParam0) // Position - 0x155E6
{
...
int func_291(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x15633
{
	int num;
...
int func_296(var uParam0, int iParam1, eCharacter echParam2) // Position - 0x15F19
{
	var unk;
	var unk2;
...
void func_297(var uParam0, eCharacter echParam1) // Position - 0x15F59
{
	var unk;
	int i;
	int j;
	...
	func_298(uParam0, &(Global_113969.f_32753.f_5510));
	return;
}

void func_298(var uParam0, var uParam1) // Position - 0x1615B
{
	int i;
...
BOOL func_303(var uParam0) // Position - 0x16779
{
...
BOOL func_304(int iParam0) // Position - 0x16856
{
	if (iParam0 == 0)
		return false;
...
BOOL func_305(var uParam0) // Position - 0x16A14
{
	int num;
	var unk;
...
BOOL func_306(var uParam0) // Position - 0x16A5B
{
	int i;
...
BOOL func_307(var uParam0) // Position - 0x16A96
{
	int i;
...
BOOL func_308(var uParam0) // Position - 0x16B12
{
	int i;
...
int func_309(var uParam0) // Position - 0x16BFA
{
	int i;
...
BOOL func_310(var uParam0, int iParam1, BOOL bParam2) // Position - 0x16C5D
{
	int i;
	var unk;
	int num;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x16DA3
{
