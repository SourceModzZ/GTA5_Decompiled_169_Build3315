...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x147C
{
	if (iParam2 == -1)
		iParam2 = func_9();
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x1CE5
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1D22
{
...
int func_37(eCharacter echParam0) // Position - 0x1D47
{
...
void func_50(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x20EB
{
...
BOOL func_70(int iParam0, int iParam1) // Position - 0x296D
{
	...
	switch (iLocal_68)
	{
		...
		case 2:
			...
			if (unk_0xFC8BFE4B41177C22(uLocal_56))
			{
				if (!unk_0x4FAFF4BCB7633475(uLocal_56))
				{
					if (unk_0x65FFA94B82A71741(uLocal_56, uLocal_110, Global_20, 1, 1, 0) && func_116(true, false, true))
					{
...
var func_122(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x4F92
{
	var unk;
...
int func_124(var uParam0, BOOL bParam1, int iParam2) // Position - 0x4FD5
{
	int num;
...
int func_125(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x501F
{
	int num;
...
var func_134(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x5960
{
...
{
	switch (func_145(&Global_33008, 0, 5, false, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return true;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x6CD6
{
...
void func_154(var uParam0, char* sParam1, int iParam2) // Position - 0x7056
{
...
BOOL func_160(var uParam0) // Position - 0x7389
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
BOOL func_163(var uParam0) // Position - 0x746E
{
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_218() || Global_32951 || func_217() || func_78(8, -1) || func_214() || func_216() || func_215() || func_213() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_218() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_78(8, -1) || func_213() || func_212() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
...
void func_228(int iParam0) // Position - 0xAC5A
{
	...
	if (func_180())
	{
		...
		func_231(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_230(Global_113958, true), 64);
