...
void func_6(int iParam0) // Position - 0x1A36
{
	...
	else if (IS_BIT_SET(Global_113969.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_8() /*5570*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_113969.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_8() /*5570*/].f_681.f_10), iParam0);
	}
...
BOOL func_160(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x9069
{
	int num;
	int num2;
	int num3;
...
void func_163(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xBCFC
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_155(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_155(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_155(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_218(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x1D19A
{
	int num;
...
int func_219(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x1D4A1
{
	int num;
	int num2;
	int num3;
...
var func_223(int iParam0, int iParam1) // Position - 0x1D766
{
	return unk_0xD69CE161FE614531(2, iParam0, func_11(iParam1));
}

void func_224(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x1D77B
{
	eCharacter character;
...
void func_225(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x1DCC4
{
	eCharacter character;
...
void func_226(var uParam0, int iParam1) // Position - 0x1DF05
{
	int bitShift;
	BOOL flag;
...
struct<4> func_228(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3) // Position - 0x1E065
{
	...
	if (!func_233(&(Global_113969.f_19964), 8) && bParam1 && iParam0 != 4 && func_231(3) > 0 && unk_0xD2AA6F822D3A55D2(0, 1065353216) < 0.75f)
	{
		num = 8;
		*uParam3 = 4;
	}
...
void func_236(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6, int iParam7, int iParam8) // Position - 0x1E843
{
	if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
...
void func_248(var uParam0) // Position - 0x222F2
{
	if (!func_76(uParam0))
		func_121(uParam0);
...
void func_258(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x225BC
{
	unk_0x747786364137DC63(1);
	unk_0x37B894853929BF1A(1);
	func_262();
