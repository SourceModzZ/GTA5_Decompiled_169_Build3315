...
void func_11(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, int iParam11) // Position - 0xFAD
{
						...
						if (Global_9369[i] == 0)
						{
							...
							else if (num == 7)
							{
								if (Global_79389)
								{
									...
									func_11(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8807[num /*15*/].f_10), SYSTEM::TO_FLOAT(value), -1f, &Global_8807[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20930)
...
void func_27(eCharacter echParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x260B
{
	...
	flag = false;
	TEXT_LABEL_ASSIGN_STRING(&unk, func_30(iParam1, &flag), 64);
	...
	if (character == echParam0)
	{
		...
		if (flag)
			func_28(unk_0x5C7E2225D7451992(&unk, &unk, 0, 2, unk_0xFACCDE46E24AD056(AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(iParam1)), 0));
		else
			func_28(unk_0x5C7E2225D7451992("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, unk_0xFACCDE46E24AD056(AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(iParam1)), 0));
...
char* func_30(int iParam0, var uParam1) // Position - 0x2B8C
{
	*uParam1 = 1;
...
void func_39(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x31BF
{
	int num;
	int i;
	int num2;
...
void func_55(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x4215
{
	int num;
	BOOL flag;
	int num2;
	...
	else
	{
		...
		else
		{
			...
			unk49 = { func_31(Global_45269[num10 /*12*/].f_1) };
		
			if (Global_54569[num9 /*203*/].f_10[num3 /*48*/].f_1)
				TEXT_LABEL_COPY(&unk49, { Global_54569[num9 /*203*/].f_10[num3 /*48*/].f_2 }, 16);
			...
			flag3 = false;
			flag3 = func_56(uParam0, Global_54569[num9 /*203*/].f_1, num3, num11);
			...
			if (!flag3)
			{
				...
				if (Global_54569[num9 /*203*/].f_10[num3 /*48*/].f_6 > 0)
				{
					...
					{
						unk_0xACF853FB3F6EA7D4(&Global_54569[num9 /*203*/].f_10[num3 /*48*/].f_7[k /*4*/]);
					}
...
BOOL func_56(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4602
{
	int num;
	int num2;
	int num3;
	...
	for (i = 0; i < 16; i = i + 1)
	{
		...
		{
			case 72:
				if (Global_113969.f_24907[num4 /*4*/] == 0)
					flag = true;
				break;
		
			case 73:
				if (Global_113969.f_24907[num4 /*4*/] == 1)
					flag = true;
				break;
		
			case 74:
				if (Global_113969.f_24907[num4 /*4*/] == 2)
					flag = true;
				break;
		}
		...
		if (flag)
		{
			...
			unk_0x511D14ED2DA887E1(Global_113969.f_24907[num4 /*4*/].f_3);
			unk_0xCFAD3D478C87321A();
			unk_0xE6B753D52F4CA222();
			num3 = num3 + 1;
			num = 1;
...
void func_60(eCharacter echParam0, int iParam1) // Position - 0x4C98
{
	...
	Global_54568 = num5;
	unk_0xD0D00ED689D6CA81(func_15(num5), 0);

	while (!unk_0x38D063D8CF6D1967(func_15(num5)))
	{
		SYSTEM::WAIT(100);
	}
...
void func_62() // Position - 0x4E7A
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (Global_45264[i] != -1)
		{
			unk_0xFE3A52C5B7AE3101(Global_45264[i]);
			Global_45264[i] = -1;
		}
	}
...
void func_63(var uParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4EB9
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	unk_0x330108B080A2132F(SYSTEM::ROUND(fParam2));
...
void func_64(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6) // Position - 0x4F1C
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	func_9(sParam2);
...
int func_65(var uParam0, eCharacter echParam1) // Position - 0x4F77
{
	int num;
	int i;
	int num2;
	...
	for (j = 0; j < num2; j = j + 1)
	{
		...
		{
			num7 = Global_54207[num /*120*/].f_18[i];
			num8 = -1;
			k = 0;
		
			for (k = 0; k < 7; k = k + 1)
			{
				if (Global_54569[k /*203*/].f_1 == num7)
					num8 = k;
			}
			...
			{
				num9 = Global_54207[num /*120*/].f_1[i];
				num10 = 0;
			
				if (Global_54207[num /*120*/].f_69[i])
					num10 = 1;
			
				num11 = Global_54569[num8 /*203*/].f_10[num9 /*48*/];
			
				if (num10 == 1)
					if (Global_45269[num11 /*12*/].f_4 > 0)
						if (Global_54207[num /*120*/].f_35[i] == 0)
							num10 = 2;
			
				unk5 = { func_31(Global_45269[num11 /*12*/]) };
				unk_0x88F483FBD433696A(uParam0, "SET_DATA_SLOT");
				unk_0x330108B080A2132F(8);
				unk_0x330108B080A2132F(j);
				unk_0x330108B080A2132F(num10);
				unk_0x330108B080A2132F(0);
				func_9(AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0(Global_45269[num11 /*12*/].f_2));
				func_9(&unk5);
				unk_0xE6B753D52F4CA222();
			}
		}
...
float func_68(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11, float fParam12, BOOL bParam13) // Position - 0x5500
{
	...
	num = func_70(SYSTEM::TO_FLOAT(unk_0x1DD05E817C89C737() - iLocal_16) / fParam12, 0f, 1f);
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x5BE5
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x5C22
{
...
int func_83(eCharacter echParam0) // Position - 0x5C47
{
