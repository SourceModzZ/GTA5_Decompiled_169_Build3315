...
void func_57(int iParam0, BOOL bParam1) // Position - 0x257A
{
	...
	{
		case 10:
			unk_0x0B0C9A0F9AAEB7F0(&(Global_113969.f_1.f_119), 14);
			break;
	
		case 13:
			unk_0x0B0C9A0F9AAEB7F0(&(Global_113969.f_1.f_119), 16);
			break;
	
		case 12:
			unk_0x0B0C9A0F9AAEB7F0(&(Global_113969.f_1.f_119), 15);
			break;
	
		case 11:
			unk_0x0B0C9A0F9AAEB7F0(&(Global_113969.f_1.f_119), 17);
			break;
	}
...
int func_81(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x2EC1
{
	int i;
	int j;
	int k;
	...
	if (iParam5 == 0)
	{
		Global_79172[1 /*14*/] = { func_133(num8, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79172[1 /*14*/] = { func_133(num8, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79172[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79172[1 /*14*/] = { func_133(num8, 14, unk18[j], -1) };
							func_101(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
							func_124(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_91(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_91(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_91(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79172[1 /*14*/] = { func_133(num8, i, func_90(uParam0, i, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79172[1 /*14*/] = { func_133(num8, 14, unk59[j], -1) };
			func_101(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
			func_124(14);
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_91(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_91(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_91(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
...
BOOL func_82(var uParam0, int iParam1, var uParam2) // Position - 0x36D2
{
	...
	{
		if (!func_197(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_64, Global_113969.f_2366.f_539[num /*65*/].f_63))
		{
...
BOOL func_85(int iParam0, int iParam1, int iParam2) // Position - 0x3838
{
	if (iParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_87(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x393E
{
	var unk;
	int i;
...
BOOL func_88(int iParam0, int iParam1, int iParam2) // Position - 0x3F42
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_89(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x3FDB
{
	...
	{
		if (!func_197(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_61, Global_113969.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
int func_90(var uParam0, int iParam1, int iParam2) // Position - 0x4087
{
	int i;
	int j;
...
int func_92(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x41D8
{
	int num;
...
int func_93(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x44DF
{
	int num;
	int num2;
	int num3;
...
BOOL func_97(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5674
{
	int num;
...
BOOL func_98(int iParam0, int iParam1, var uParam2) // Position - 0x569D
{
	*uParam2 = -99;
...
int func_99(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x5967
{
	int num;
...
void func_101(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5D48
{
	int num;
...
BOOL func_102(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5DE2
{
	switch (iParam0)
	{
...
int func_106(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x63D2
{
	int num;
	int num2;
	int num3;
...
BOOL func_118(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x93A3
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_119(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x9620
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_120(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x9A45
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_121(var uParam0, int iParam1) // Position - 0x9D38
{
	int num;
	var unk;
...
int func_122(var uParam0, int iParam1) // Position - 0x9D7F
{
	int num;
	var unk;
	var unk2;
...
void func_126(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x9F2A
{
	int num;
...
int func_127(int iParam0, int iParam1) // Position - 0x9F58
{
...
BOOL func_140(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xFF21
{
	int num;
	int num2;
	int num3;
...
void func_142(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10035
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_136(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_136(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_136(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_197(var uParam0, int iParam1, int iParam2) // Position - 0x21663
{
	...
	num = unk_0x4B423FAA24E8ABF0(uParam0);
	Global_79172[1 /*14*/] = { func_133(num, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_197(uParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_197(uParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79172[2 /*14*/] = { func_133(num, 14, k, -1) };
								
									if (Global_79172[2 /*14*/].f_12 == j)
										if (func_197(uParam0, 14, k))
											if (!func_87(num, iParam2, 14, k, &unk, &Global_79172[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79172[2 /*14*/] = { func_133(num, i, num2, -1) };
					
						if (!func_87(num, iParam2, i, num2, &unk, &Global_79172[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79172[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_91(iParam1)) && Global_79172[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_91(iParam1)))
	{
		return true;
	}
...
{
	switch (func_252(&Global_33008, 0, 5, false, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return true;
...
{
	if (Global_113958 == func_49() && unk_0x9FA91AA1AC724CD0() && Global_113959)
		return true;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_316() || Global_113016 || Global_32951 || func_315() || func_22(8, -1) || func_314() || func_313() || func_312() || func_311() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_316() || Global_32951 || func_315() || func_22(8, -1) || func_312() || func_314() || func_313() || func_311() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_316() || Global_113016 || Global_32951 || func_315() || func_22(8, -1) || func_312() || func_314() || func_313() || func_311() || Global_113969.f_7691.f_919[character] == 5 || Global_44589 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_316() || Global_113016 || Global_32951 || func_315() || func_22(8, -1) || func_314() || func_313() || func_311() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_316() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_22(8, -1) || func_311() || func_310() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
...
void func_327(int iParam0) // Position - 0x28459
{
	...
	if (func_257())
	{
		...
		func_330(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_329(Global_113958, true), 64);
...
int func_341() // Position - 0x28C99
{
	...
	if (Global_22286 == 4)
	{
		...
		if (num > -1)
		{
			if (unk_0x6BA487C862DB8DDF(&Global_21154[num /*6*/]))
			{
				unk = { Global_21905 };
