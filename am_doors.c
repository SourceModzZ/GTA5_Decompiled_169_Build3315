...
void func_1() // Position - 0x24E
{
	...
	{
		if (_NETWORK_IS_PLAYER_VALID(unk_0xB23E0F9B63D009A8(iLocal_180), false, true))
		{
			if (IS_BIT_SET(uLocal_218[iLocal_180 /*4*/].f_2, iLocal_181))
				unk_0x0B0C9A0F9AAEB7F0(&iLocal_183.f_2[iLocal_181], iLocal_180);
			else
				unk_0x8744D2E3FC95740E(&iLocal_183.f_2[iLocal_181], iLocal_180);
		}
		else
		{
			unk_0x8744D2E3FC95740E(&iLocal_183.f_6[iLocal_181], iLocal_180);
			unk_0x8744D2E3FC95740E(&iLocal_183.f_6[iLocal_181], iLocal_180);
		}
	...
	if (uLocal_207[iParam0] == 0)
	{
		if (unk_0xE2A2194077783E19(uParam1) == -1)
		{
			if (unk_0x117BCCA03F7A311A(uParam1) != iParam2)
			{
				...
				{
					unk_0x0B0C9A0F9AAEB7F0(&uLocal_207[iParam0], num);
...
void func_9() // Position - 0x5A4
{
	...
	if (IS_BIT_SET(Global_2748866, iLocal_182) || IS_BIT_SET(Global_2748866.f_1, iLocal_182) || IS_BIT_SET(Global_2748866.f_2, iLocal_182))
	{
		if (IS_BIT_SET(Global_2748866, iLocal_182))
			unk_0x0B0C9A0F9AAEB7F0(&(uLocal_218[unk_0x259BE71D8A81D4FA() /*4*/].f_2), iLocal_182);
	
		if (IS_BIT_SET(Global_2748866.f_1, iLocal_182))
			unk_0x8744D2E3FC95740E(&(uLocal_218[unk_0x259BE71D8A81D4FA() /*4*/].f_2), iLocal_182);
	
		if (IS_BIT_SET(Global_2748866.f_2, iLocal_182))
			unk_0x0B0C9A0F9AAEB7F0(&(uLocal_218[unk_0x259BE71D8A81D4FA() /*4*/].f_3), iLocal_182);
	}
	else if (num <= 20f)
	{
		if (unk_0x26715B0ED6702C87(vector, uLocal_128[iLocal_182 /*17*/].f_3, uLocal_128[iLocal_182 /*17*/].f_6, uLocal_128[iLocal_182 /*17*/].f_9, 0, 1))
			if (!IS_BIT_SET(uLocal_218[unk_0x259BE71D8A81D4FA() /*4*/].f_2, iLocal_182))
				unk_0x0B0C9A0F9AAEB7F0(&(uLocal_218[unk_0x259BE71D8A81D4FA() /*4*/].f_2), iLocal_182);
		...
		if (iLocal_182 == 0 || iLocal_182 == 1 || iLocal_182 == 2)
			if (_GET_ACTIVE_PV_SLOT() >= 0)
				if (func_10(29))
					if (!IS_BIT_SET(uLocal_218[unk_0x259BE71D8A81D4FA() /*4*/].f_2, iLocal_182))
						unk_0x0B0C9A0F9AAEB7F0(&(uLocal_218[unk_0x259BE71D8A81D4FA() /*4*/].f_2), iLocal_182);
				else if (IS_BIT_SET(uLocal_218[unk_0x259BE71D8A81D4FA() /*4*/].f_2, iLocal_182) && !unk_0x26715B0ED6702C87(vector, uLocal_128[iLocal_182 /*17*/].f_3, uLocal_128[iLocal_182 /*17*/].f_6, uLocal_128[iLocal_182 /*17*/].f_9, 0, 1))
					unk_0x8744D2E3FC95740E(&(uLocal_218[unk_0x259BE71D8A81D4FA() /*4*/].f_2), iLocal_182);
	}
	else if (IS_BIT_SET(uLocal_218[unk_0x259BE71D8A81D4FA() /*4*/].f_2, iLocal_182))
	{
		unk_0x8744D2E3FC95740E(&(uLocal_218[unk_0x259BE71D8A81D4FA() /*4*/].f_2), iLocal_182);
	}
	...
	for (i = 0; i < 4; i = i + 1)
	{
		...
		if (unk_0xED977E2AE2CB16EE(_GET_PLAYER_COORDS(unk_0x259BE71D8A81D4FA()), unk.f_1, 1) < 150f)
		{
			...
			if (flag)
			{
				if (uLocal_347[i] != 1f)
				{
					uLocal_347[i] = uLocal_347[i] + (unk.f_12 * SYSTEM::TIMESTEP());
				
					if (uLocal_347[i] > 1f)
						uLocal_347[i] = 1f;
				
					unk_0x60F1DCFB89B4F353(unk, 1);
					unk_0x3A15B21067339E98(unk, uLocal_347[i], 0, 0);
...
void func_31(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, int iParam15) // Position - 0x5789
{
	if (iParam0 != 0)
	{
...
{
	uLocal_218[unk_0xAE032CEDCF23C6D5() /*4*/] = iParam0;
	return;
}
...
BOOL func_40(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x5A18
{
	...
	unk_0x6F4A865F87C7A3AD(&iLocal_183, 24, 0);
	unk_0x7B13DC83218D9AF5(&uLocal_218, 129, 0);
...
int _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x6E5C
{
	switch (func_33())
	{
		case 0:
