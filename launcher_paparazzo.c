...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DEC
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A84
{
	int i;
	float num;
	float num2;
...
void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8E8D
{
...
BOOL func_136(var uParam0) // Position - 0xAD85
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xADA5
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAEE9
{
	int i;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB088
{
	if (bParam0)
	{
...
BOOL func_148(int iParam0) // Position - 0xB289
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB2AB
{
...
int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB2F8
{
	int num;
...
BOOL func_154(var uParam0) // Position - 0xB375
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB4A8
{
...
void func_161(var uParam0) // Position - 0xB4FF
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_179(var uParam0, int iParam1) // Position - 0xBCD5
{
	int num;
	var unk;
	var unk33;
...
var func_182(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC1B1
{
	var unk;
...
BOOL func_190(var uParam0) // Position - 0xCC0A
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void func_200(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD437
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
float func_204(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD63B
{
	var unk;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD8C1
{
...
void func_219(var uParam0) // Position - 0xE285
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_222(var uParam0, var uParam1) // Position - 0xE4EE
{
	var unk;
...
BOOL func_225(var uParam0, int iParam1) // Position - 0xE80E
{
	float num;
...
BOOL func_226(var uParam0, int iParam1) // Position - 0xE884
{
	return func_227(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_227(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE89C
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_228(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE95D
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_229(var uParam0, int iParam1) // Position - 0xEA89
{
	int num;
...
BOOL func_231(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xEB98
{
	var unk;
	var unk4;
	float num;
...
int func_235(var uParam0, var uParam1) // Position - 0xECA4
{
	int i;
...
int func_236(var uParam0) // Position - 0xECE3
{
...
BOOL func_237(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xED0B
{
	float num;
	float num2;
	int num3;
...
BOOL func_238(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEE06
{
	float num;
	float num2;
...
BOOL func_239(var uParam0, float fParam1) // Position - 0xEF12
{
	var unk;
	var unk2;
...
BOOL func_240(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEFA7
{
	var unk;
	var unk4;
	float num;
...
BOOL func_241(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF035
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_243(var uParam0) // Position - 0xF0C7
{
	var unk;
...
void func_254(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF9A9
{
	func_219(uParam0);
...
void func_255(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF9D0
{
	func_256(uParam0);
...
void func_256(var uParam0) // Position - 0xFA13
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_257(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5, int iParam6) // Position - 0xFAAF
{
	func_258(uParam0);
...
void func_258(var uParam0) // Position - 0xFAD0
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_259(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFB11
{
...
BOOL func_260(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFB6D
{
	int num;
...
void func_287(var uParam0, BOOL bParam1) // Position - 0x11134
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_290(var uParam0) // Position - 0x111BE
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_293(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x11249
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
int func_298(eCharacter echParam0) // Position - 0x11335
{
	if (!func_36(echParam0))
