...
{
	func_111(&Global_107514, unk_0x1AF90EB93E0012D6(), iParam0, sParam1, iParam3, iParam2);
	return;
}
...
void func_140(var uParam0, BOOL bParam1) // Position - 0x7BA6
{
	...
	if (func_26(character) && !unk_0x4FAFF4BCB7633475(uParam0))
	{
		...
		{
			func_141(uParam0, &Global_113969.f_2366.f_539.f_298[character /*477*/]);
...
void func_147(var uParam0) // Position - 0x91D1
{
	eCharacter character;
...
BOOL func_149(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x975C
{
	var unk;
	var unk2;
...
int func_157(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0xA3AD
{
	int i;
	float num;
	float num2;
...
int func_191(var uParam0) // Position - 0xC70D
{
...
int func_193(var uParam0, int iParam1) // Position - 0xCBAF
{
	int num;
	var unk;
	var unk33;
...
int func_200(var uParam0, BOOL bParam1) // Position - 0xE2CB
{
	var unk;
	int num;
...
int func_201(var uParam0, BOOL bParam1) // Position - 0xE2F5
{
	int i;
...
void func_206(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4) // Position - 0xF0E5
{
	unk_0x37B894853929BF1A(1);
	unk_0x747786364137DC63(1);
...
int func_215(var uParam0, float fParam1, float fParam2, float fParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8) // Position - 0xF851
{
...
void func_217(int iParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, BOOL bParam9) // Position - 0xF96D
{
...
void func_225(var uParam0, BOOL bParam1) // Position - 0xFC25
{
	func_42(uParam0, bParam1, false);
	return;
}

BOOL func_226(var uParam0, var uParam1) // Position - 0xFC36
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xFF30
{
...
BOOL func_234(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11, BOOL bParam12, int iParam13, BOOL bParam14, int iParam15) // Position - 0x10016
{
	...
	if (unk_0xFC8BFE4B41177C22(Global_104530.f_4))
	{
		if (unk_0xD9F5E1FEFD1329E4(Global_104530.f_4, 0))
		{
			if (func_270(24) != Global_104530.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_267(unk_0xD1A6A821F5AC81DB(Global_104530.f_4, 1), iParam5, &unk, &num))
					{
						fParam0 = { unk };
						fParam3 = num;
					}
...
void func_239(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, BOOL bParam6) // Position - 0x112B4
{
	var unk;
...
void func_241(int iParam0, eCharacter echParam1) // Position - 0x114F4
{
	var unk;
	int i;
	int j;
...
BOOL func_242(int iParam0) // Position - 0x116F6
{
...
BOOL func_243(int iParam0) // Position - 0x117D3
{
	if (iParam0 == 0)
		return false;
...
BOOL func_244(int iParam0, BOOL bParam1, int iParam2) // Position - 0x11991
{
	int i;
	var unk;
...
BOOL func_245(int iParam0) // Position - 0x11B16
{
	int num;
	var unk;
	var unk2;
...
BOOL func_247(int iParam0, int iParam1) // Position - 0x11BF9
{
	int num;
	int num2;
...
BOOL func_255(int iParam0) // Position - 0x11F62
{
	int num;
	var unk;
...
BOOL func_256(int iParam0) // Position - 0x11FA9
{
	int i;
...
BOOL func_257(int iParam0) // Position - 0x11FE4
{
	int i;
...
BOOL func_258(int iParam0) // Position - 0x12060
{
	int i;
...
int func_268(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x13C67
{
	int i;
	float num;
	float num2;
...
BOOL func_275(int iParam0, int iParam1) // Position - 0x14186
{
	return false;
}

int func_276(eCharacter echParam0) // Position - 0x141DF
{
...
int func_287(var uParam0) // Position - 0x1484B
{
...
void func_292(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x15EF2
{
	unk_0x4CAD907F190E6F10(uParam0, sParam1, sParam2, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(iParam3), iParam4);
	return;
}

BOOL func_293(var uParam0, int iParam1, BOOL bParam2) // Position - 0x15F0C
{
	int num;
...
void func_302(var uParam0) // Position - 0x166A7
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
int func_303(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, BOOL bParam12) // Position - 0x166DF
{
	BOOL flag;
...
BOOL func_310(var uParam0, eCharacter echParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x16F55
{
	int num;
...
int func_312(eCharacter echParam0) // Position - 0x1701B
{
	if (!func_26(echParam0))
...
int func_318(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x17D32
{
...
void func_324(var uParam0) // Position - 0x18336
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_325(var uParam0) // Position - 0x18361
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x183FD
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
		if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
			return true;
...
BOOL func_327(var uParam0) // Position - 0x1841E
{
...
void func_328(var uParam0) // Position - 0x18448
{
	var unk;
	int i;
	int num;
...
void func_329(var uParam0) // Position - 0x184E4
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_330(var uParam0) // Position - 0x18525
{
	BOOL flag;
	var unk;
