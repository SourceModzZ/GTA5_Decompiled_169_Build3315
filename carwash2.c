...
int func_125(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x9C99
{
	int i;
...
int func_128(int iParam0) // Position - 0x9E7A
{
	var unk;
...
void func_135(int iParam0) // Position - 0xA808
{
	...
	else if (IS_BIT_SET(Global_113969.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_137() /*5570*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_113969.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_137() /*5570*/].f_681.f_10), iParam0);
	}
...
void func_138(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xAA92
{
	int num;
...
int func_139(int iParam0, int iParam1) // Position - 0xAAC0
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0xB300
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0xB33D
{
...
int func_169(eCharacter echParam0) // Position - 0xB362
{
...
int func_172(int iParam0) // Position - 0xB405
{
	int num;
...
BOOL func_174(int iParam0) // Position - 0xB45A
{
	if (!func_11(iParam0))
		return false;
...
Vector3 func_179(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0xB72E
{
	var unk;
...
int func_196(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4) // Position - 0xC623
{
	if (IS_BIT_SET(uParam0->f_113, iParam1) || IS_BIT_SET(uParam0->f_114, iParam1))
		return 1;
...
void func_198(var uParam0, var uParam1) // Position - 0xC73E
{
	func_197(uParam0, 0, joaat("prop_carwash_roller_horz"));
	func_197(uParam0, 1, joaat("prop_carwash_roller_vert"));
	func_197(uParam0, 2, joaat("prop_ld_test_01"));
...
void func_212(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11) // Position - 0xCB35
{
	float num;
	float num2;
	var unk;
...
var func_213(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0xCBE1
{
...
int func_216(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xCDF5
{
	int i;
	int j;
	int k;
	...
	if (iParam5 == 0)
	{
		Global_79172[1 /*14*/] = { func_264(num8, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79172[1 /*14*/] = { func_264(num8, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79172[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79172[1 /*14*/] = { func_264(num8, 14, unk18[j], -1) };
							func_236(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
							func_259(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_226(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_226(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_226(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79172[1 /*14*/] = { func_264(num8, i, func_225(uParam0, i, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79172[1 /*14*/] = { func_264(num8, 14, unk59[j], -1) };
			func_236(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
			func_259(14);
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_226(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_226(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_226(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
...
BOOL func_217(var uParam0, int iParam1, var uParam2) // Position - 0xD606
{
	int num;
	...
	{
		if (!func_328(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_64, Global_113969.f_2366.f_539[num /*65*/].f_63))
		{
...
BOOL func_220(int iParam0, int iParam1, int iParam2) // Position - 0xD76C
{
	if (iParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_222(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0xD872
{
	var unk;
	int i;
...
BOOL func_223(int iParam0, int iParam1, int iParam2) // Position - 0xDE76
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_224(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0xDF0F
{
	int num;
	...
	{
		if (!func_328(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_61, Global_113969.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
int func_225(var uParam0, int iParam1, int iParam2) // Position - 0xDFBA
{
	int i;
	int j;
...
int func_227(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0xE10B
{
	int num;
...
int func_228(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE412
{
	int num;
	int num2;
	int num3;
...
BOOL func_232(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF5A7
{
	int num;
...
BOOL func_233(int iParam0, int iParam1, var uParam2) // Position - 0xF5D0
{
	*uParam2 = -99;
...
int func_234(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0xF89A
{
	int num;
...
void func_236(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFC7B
{
	int num;
...
BOOL func_237(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFD15
{
	switch (iParam0)
	{
...
BOOL func_271(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x19C55
{
	int num;
	int num2;
	int num3;
...
void func_273(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x19D67
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_267(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_267(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_267(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_328(var uParam0, int iParam1, int iParam2) // Position - 0x2B3E7
{
	...
	num = unk_0x4B423FAA24E8ABF0(uParam0);
	Global_79172[1 /*14*/] = { func_264(num, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_328(uParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_328(uParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79172[2 /*14*/] = { func_264(num, 14, k, -1) };
								
									if (Global_79172[2 /*14*/].f_12 == j)
										if (func_328(uParam0, 14, k))
											if (!func_222(num, iParam2, 14, k, &unk, &Global_79172[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79172[2 /*14*/] = { func_264(num, i, num2, -1) };
					
						if (!func_222(num, iParam2, i, num2, &unk, &Global_79172[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79172[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_226(iParam1)) && Global_79172[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_226(iParam1)))
	{
		return true;
	}
...
BOOL func_364(int iParam0) // Position - 0x2CE15
{
	...
	if (unk_0x4D9174D8796EA622() || unk_0xEF37E704F02B50F3() || func_370() || Global_64160 || func_369(false) || func_52(0) || func_365(unk_0x259BE71D8A81D4FA()))
		return false;
...
int _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x2DA20
{
	switch (func_22())
	{
		case 0:
