...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E1C
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6AB4
{
	int i;
	float num;
	float num2;
...
void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8EBC
{
...
BOOL func_136(var uParam0) // Position - 0xADB4
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xADD4
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAF18
{
	int i;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB0B7
{
	if (bParam0)
	{
...
BOOL func_148(int iParam0) // Position - 0xB2B8
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB2DA
{
...
int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB327
{
	int num;
...
BOOL func_154(var uParam0) // Position - 0xB3A4
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB4D7
{
...
void func_161(var uParam0) // Position - 0xB52E
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_179(var uParam0, int iParam1) // Position - 0xBD04
{
	int num;
	var unk;
	var unk33;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_194() || Global_32951 || func_193() || func_192(8, -1) || func_190() || func_101() || func_191() || func_189() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_194() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_192(8, -1) || func_189() || func_188() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD015
{
...
float func_199(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD0B0
{
	var unk;
...
void func_200(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD0EA
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_209(var uParam0) // Position - 0xD725
{
	var unk;
...
void func_210(var uParam0) // Position - 0xD7C2
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_212(var uParam0) // Position - 0xD826
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_220(var uParam0, var uParam1) // Position - 0xE0B3
{
	var unk;
...
BOOL func_223(var uParam0, int iParam1) // Position - 0xE3D3
{
	float num;
...
BOOL func_224(var uParam0, int iParam1) // Position - 0xE449
{
	return func_225(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_225(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE461
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_226(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE522
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_227(var uParam0, int iParam1) // Position - 0xE64E
{
	int num;
...
BOOL func_229(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE75D
{
	var unk;
	var unk4;
	float num;
...
int func_233(var uParam0, var uParam1) // Position - 0xE869
{
	int i;
...
int func_234(var uParam0) // Position - 0xE8A8
{
...
BOOL func_235(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE8D0
{
	float num;
	float num2;
	int num3;
...
BOOL func_236(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE9CB
{
	float num;
	float num2;
...
BOOL func_237(var uParam0, float fParam1) // Position - 0xEAD7
{
	var unk;
	var unk2;
...
BOOL func_238(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEB6C
{
	var unk;
	var unk4;
	float num;
...
BOOL func_239(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEBFA
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_250(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF2C3
{
	func_210(uParam0);
...
void func_251(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF2EA
{
	func_252(uParam0);
...
void func_252(var uParam0) // Position - 0xF32D
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_253(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF3C9
{
...
BOOL func_254(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF425
{
	int num;
...
void func_275(var uParam0, BOOL bParam1) // Position - 0xFBB0
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_278(var uParam0) // Position - 0xFC3A
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_281(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFCC5
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_282(var uParam0) // Position - 0xFD15
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
int func_287(eCharacter echParam0) // Position - 0xFDF2
{
	if (!func_36(echParam0))
