...
void func_5(int iParam0) // Position - 0xB82
{
	...
	else if (IS_BIT_SET(Global_113969.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_7() /*5570*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_113969.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_7() /*5570*/].f_681.f_10), iParam0);
	}
...
void func_45(int iParam0) // Position - 0x1743
{
	...
	Global_23574[iParam0 /*9*/].f_2 = unk;
	Global_23574[iParam0 /*9*/].f_2.f_1 = unk2;
	Global_23574[iParam0 /*9*/].f_2.f_2 = unk3;
	Global_23574[iParam0 /*9*/].f_2.f_3 = unk4;
	Global_23574[iParam0 /*9*/].f_2.f_4 = num;
	Global_23574[iParam0 /*9*/].f_2.f_5 = unk5;
	return;
}
