...
BOOL func_98(var uParam0, int iParam1, int iParam2) // Position - 0x3D81
{
	...
	else
	{
		...
		Global_79172[1 /*14*/] = { func_151(num, iParam1, unk28[iParam1], -1) };
	
		if (unk_0x1A4EFE92822E3123(uParam0, func_143(iParam1)) > 0 && unk_0x8401C77F508D70FD(uParam0, func_143(iParam1), Global_79172[1 /*14*/].f_3) > 0)
			unk_0xD1C578C204015E1F(uParam0, func_143(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, 0);
	}
...
int func_101(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x401C
{
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
				...
				if (IS_BIT_SET(Global_79172[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							...
							func_117(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
							func_133(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_143(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_143(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_143(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79172[1 /*14*/] = { func_151(num8, i, func_107(uParam0, i, -1), -1) };
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_143(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_143(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_143(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
...
BOOL func_142(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0xBD6A
{
	int num;
...
void func_145(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC7F6
{
	int num;
	var unk;
	int num2;
...
BOOL func_158(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x10E14
{
	int num;
	int num2;
	int num3;
...
BOOL func_215(var uParam0, int iParam1, int iParam2) // Position - 0x225F9
{
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_215(uParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_79172[2 /*14*/].f_12 == j)
										if (func_215(uParam0, 14, k))
											if (!func_105(num, iParam2, 14, k, &unk, &Global_79172[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						if (!func_105(num, iParam2, i, num2, &unk, &Global_79172[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79172[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_143(iParam1)) && Global_79172[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_143(iParam1)))
	{
		return true;
	}
...
void func_222(int iParam0, int iParam1, int iParam2) // Position - 0x22E55
{
	...
	if (iParam0 != -1)
	{
		...
		func_223(&unk33, unk.f_3, Global_101570, iParam1, iParam2);
	}
	...
	if (Global_79644 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !unk_0x15CCE8886267624F())
			{
				...
				unk = { func_413(Global_79645, Global_79647, iParam10) };
				num4 == -0.014f;
