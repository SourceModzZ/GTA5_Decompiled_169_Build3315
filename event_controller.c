...
void func_1() // Position - 0xA5
{
	...
	Global_56417 = num3;
	Global_56417.f_12 = num4;
	Global_56417.f_24 = num5;
	Global_56417.f_36 = num6;
	return;
}
...
BOOL func_37(var uParam0, var uParam1, var uParam2) // Position - 0x1E58
{
	int num;
	var unk;
	var unk3;
...
void func_47(var uParam0) // Position - 0x22AC
{
	int num;
...
var func_53(int iParam0, int iParam1) // Position - 0x237A
{
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, int iParam3) // Position - 0x25F5
{
...
BOOL func_80(var uParam0) // Position - 0x2B40
{
	int num;
...
void func_81(int iParam0, int iParam1, int iParam2) // Position - 0x2B71
{
	int num;
	int i;
...
void func_82(int iParam0, int iParam1) // Position - 0x2C41
{
	int num;
...
BOOL func_84(int iParam0) // Position - 0x2CB5
{
...
BOOL func_88(int iParam0) // Position - 0x2D9C
{
	int num;
...
var func_103(int iParam0, int iParam1) // Position - 0x3526
{
...
int func_112(var uParam0) // Position - 0x3618
{
	if (func_113())
	{
		*uParam0 = 11;
...
void func_138(int iParam0) // Position - 0x3CD9
{
	...
	{
		Global_2746026.f_33 = unk.f_1;
		Global_2746026.f_34 = unk;
	}
	...
	if (unk_0xFCEF367B86651ED3(1, iParam0, &unk, 21))
	{
		if (Global_2746026.f_3 == 0)
		{
			...
			else
			{
				...
				TEXT_LABEL_COPY(&(Global_2746026.f_4), { unk }, 16);
				Global_2746026.f_20 = { unk.f_8 };
				TEXT_LABEL_ASSIGN_STRING(&Global_2746026.f_39[0 /*16*/], "", 64);
				Global_2746026.f_58 = -2;
				Global_2746026.f_56 = 0;
				Global_2746026.f_57 = 0;
...
BOOL func_140(var uParam0) // Position - 0x3DE8
{
	if (Global_79389)
	{
		if (func_50() == false)
...
BOOL func_141(int iParam0) // Position - 0x3F6C
{
	int num;
	var unk;
...
BOOL _NETWORK_IS_PLAYER_VALID(int player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x406A
{
	int num;
...
void func_147(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11) // Position - 0x414F
{
