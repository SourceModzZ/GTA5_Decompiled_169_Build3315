...
BOOL func_39(var uParam0, int iParam1, int iParam2) // Position - 0x184E
{
	...
	else
	{
		...
		if (unk_0x1A4EFE92822E3123(uParam0, func_84(iParam1)) > 0 && unk_0x8401C77F508D70FD(uParam0, func_84(iParam1), Global_79172[1 /*14*/].f_3) > 0)
			unk_0xD1C578C204015E1F(uParam0, func_84(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, 0);
	}
...
BOOL func_40(var uParam0, int iParam1, var uParam2) // Position - 0x1A0B
{
	...
	{
		if (!func_157(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_64, Global_113969.f_2366.f_539[num /*65*/].f_63))
		{
...
int func_42(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1AE7
{
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
				...
				if (IS_BIT_SET(Global_79172[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							...
							func_58(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
							func_74(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_84(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_84(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_84(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79172[1 /*14*/] = { func_92(num8, i, func_48(uParam0, i, -1), -1) };
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_84(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_84(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_84(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
...
BOOL func_83(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x9836
{
	int num;
	...
	{
		if (!func_157(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_61, Global_113969.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
void func_86(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xA2C0
{
	int num;
	var unk;
	int num2;
...
BOOL func_99(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE891
{
	int num;
	int num2;
	int num3;
...
BOOL func_157(var uParam0, int iParam1, int iParam2) // Position - 0x1FD97
{
	...
	else if (Global_79172[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_84(iParam1)) && Global_79172[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_84(iParam1)))
	{
		return true;
	}
...
int func_325(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, var uParam5, char* sParam6, int iParam7) // Position - 0x2BBD2
{
...
BOOL func_326(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, var uParam5, BOOL bParam6) // Position - 0x2BC2E
{
	int num;
