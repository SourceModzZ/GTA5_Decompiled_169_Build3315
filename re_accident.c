...
BOOL func_30(int iParam0, int iParam1) // Position - 0x1955
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x1C99
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1CD6
{
...
int func_41(eCharacter echParam0) // Position - 0x1CFB
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x3026
{
	if (iParam2 == -1)
		iParam2 = func_6();
...
void func_78(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3B6B
{
	int num;
...
int func_79(int iParam0, int iParam1) // Position - 0x3B99
{
...
int func_83(var uParam0, BOOL bParam1, int iParam2) // Position - 0x3C1A
{
	int num;
...
int func_84(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3C64
{
	int num;
...
{
	switch (func_91(&Global_33008, 0, 5, false, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return true;
...
int func_98(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4371
{
...
void func_100(var uParam0) // Position - 0x4EDA
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x4FD1
{
...
BOOL func_108(int iParam0, char* sParam1, var uParam2) // Position - 0x50DD
{
...
void func_115(var uParam0) // Position - 0x53EC
{
	func_116(uParam0, "NULL", uParam0->f_1);
	return;
}

void func_116(var uParam0, char* sParam1, var uParam2) // Position - 0x5400
{
...
void func_122(int iParam0, char* sParam1, var uParam2) // Position - 0x5855
{
	if (IS_BIT_SET(iParam0, 30))
	{
		switch (func_109(iParam0))
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_174() || Global_32951 || func_173() || func_44(8, -1) || func_170() || func_172() || func_171() || func_169() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_174() || Global_113016 || Global_32951 || func_173() || func_44(8, -1) || func_172() || func_171() || func_169() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_174() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_44(8, -1) || func_169() || func_168() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
...
void func_183(int iParam0) // Position - 0x8E5D
{
	...
	if (func_136())
	{
		...
		func_186(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_185(Global_113958, true), 64);
...
void func_195(var uParam0, int iParam1) // Position - 0x9670
{
	...
	func_196(uParam0, &(Global_113969.f_32753.f_5510));
	return;
}
...
BOOL func_213(var uParam0) // Position - 0xA644
{
	int num;
	var unk;
...
BOOL func_214(var uParam0) // Position - 0xA68B
{
	int i;
...
BOOL func_215(var uParam0) // Position - 0xA6C6
{
	int i;
...
BOOL func_216(var uParam0) // Position - 0xA742
{
	int i;
...
int func_217(var uParam0) // Position - 0xA82A
{
	int i;
...
BOOL func_218(var uParam0, int iParam1, BOOL bParam2) // Position - 0xA88D
{
	int i;
	var unk;
	int num;
