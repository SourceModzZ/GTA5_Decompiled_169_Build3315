...
BOOL func_59(var uParam0, int iParam1, var uParam2) // Position - 0x23CA
{
	...
	{
		if (!func_175(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_64, Global_113969.f_2366.f_539[num /*65*/].f_63))
		{
...
BOOL func_102(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0xA1F6
{
	int num;
	...
	{
		if (!func_175(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_61, Global_113969.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
void func_105(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xAC80
{
	int num;
	var unk;
	int num2;
...
BOOL func_118(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xF25C
{
	int num;
	int num2;
	int num3;
...
BOOL func_175(var uParam0, int iParam1, int iParam2) // Position - 0x205EB
{
	int num;
	int num2;
	int i;
...
void func_176(var uParam0, int iParam1) // Position - 0x20844
{
...
void func_181(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x20DA8
{
...
void func_182(int iParam0, int iParam1, int iParam2) // Position - 0x20E45
{
	var unk;
	var unk33;
	...
	if (iParam0 != -1)
	{
		...
		func_183(&unk33, unk.f_3, Global_101570, iParam1, iParam2);
	}

	return;
}

void func_183(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4) // Position - 0x20E84
{
...
int func_226(var uParam0, int iParam1) // Position - 0x27989
{
	int num;
	var unk;
	var unk33;
...
void func_232(var uParam0) // Position - 0x280BC
{
...
char* func_234(int iParam0, var uParam1) // Position - 0x28455
{
	*uParam1 = 1;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x2909E
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
float func_242(var uParam0, var uParam1, int iParam2) // Position - 0x290E1
{
	var unk;
	var unk4;
...
void func_245(var uParam0, int iParam1, BOOL bParam2) // Position - 0x29495
{
	int i;
...
int func_246(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x2958A
{
	int num;
...
void func_249(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2964E
{
	var unk;
...
BOOL func_250(var uParam0) // Position - 0x296F8
{
...
void func_251(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x29718
{
	if (bParam0)
	{
...
BOOL func_255(int iParam0) // Position - 0x29919
{
	int num;
...
BOOL func_256(int iParam0) // Position - 0x2993B
{
...
BOOL func_259(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5, int iParam6) // Position - 0x299AB
{
	BOOL flag;
	float num;
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x29BC5
{
...
void func_264(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, float fParam12, float fParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x29C40
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
BOOL func_266(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x2A060
{
	int i;
	var unk;
	int num;
...
BOOL func_268(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x2A1A6
{
	float num;
	var unk3;
	var unk6;
...
void func_271(var uParam0) // Position - 0x2A58F
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_278(var uParam0, int iParam1) // Position - 0x2A7A8
{
	if (func_250(uParam0))
...
BOOL func_279(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x2A7DB
{
...
void func_280(var uParam0) // Position - 0x2A832
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2B11A
{
	...
	if (Global_79644 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !unk_0x15CCE8886267624F())
			{
				...
				unk = { func_298(Global_79645, Global_79647, iParam10) };
				num4 == -0.014f;
...
float func_297(var uParam0) // Position - 0x2B49A
{
...
BOOL func_323(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x2C13A
{
...
BOOL func_324(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x2C196
{
	int num;
...
void func_336(var uParam0, BOOL bParam1) // Position - 0x2C42B
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_337(var uParam0) // Position - 0x2C466
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_340(var uParam0) // Position - 0x2C4E0
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_341(var uParam0) // Position - 0x2C518
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_342(var uParam0) // Position - 0x2C5B4
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void func_345(var uParam0) // Position - 0x2C631
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_346(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2C672
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
BOOL func_350(char* sParam0, int iParam1, int iParam2) // Position - 0x2C85B
{
	var unk;
	var unk2;
	int num;
...
int func_354(var uParam0, BOOL bParam1) // Position - 0x2CA8E
{
	int i;
...
void func_357(int iParam0) // Position - 0x2CB80
{
...
int func_371(eCharacter echParam0) // Position - 0x2CE88
{
