...
int func_7(int iParam0, int iParam1) // Position - 0x18E2
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x1A96
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1AD3
{
...
int func_17(eCharacter echParam0) // Position - 0x1AF8
{
	return Global_2169[echParam0 /*29*/];
}

void func_18(var uParam0) // Position - 0x1B07
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
float func_24(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x1C8B
{
	var unk;
...
BOOL func_34(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1EC2
{
...
void func_35(var uParam0) // Position - 0x1F19
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_37(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x2096
{
	if (bParam0)
	{
...
BOOL func_41(int iParam0) // Position - 0x2297
{
	int num;
...
BOOL func_42(int iParam0) // Position - 0x22B9
{
...
int func_44(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x2306
{
	int num;
...
BOOL func_47(var uParam0, float fParam1, float fParam2) // Position - 0x245D
{
	float num;
	float num2;
	float num3;
...
BOOL func_55(int iParam0, int iParam1) // Position - 0x2A04
{
...
int func_68(var uParam0, BOOL bParam1, int iParam2) // Position - 0x2E31
{
	iParam2 = iParam2;
	return func_69(uParam0, bParam1, 145);
}

int func_69(var uParam0, BOOL bParam1, int iParam2) // Position - 0x2E47
{
	int num;
...
int func_70(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2E91
{
	int num;
...
void func_72(var uParam0) // Position - 0x2F4C
{
	BOOL flag;
	var unk;
...
int func_73(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, BOOL bParam12) // Position - 0x2FBE
{
	BOOL flag;
...
void func_74(var uParam0, char* sParam1, int iParam2) // Position - 0x31B2
{
	char* str;
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x328C
{
...
void func_80(var uParam0, var uParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x348D
{
	func_81(uParam0, uParam1, 0f, 0f, 0f, iParam2, iParam3, bParam4, bParam5, bParam6);
	return;
}

void func_81(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x34AA
{
	func_82(uParam0, uParam1, fParam2, iParam5, iParam6, bParam7, bParam8, bParam9);
	return;
}

void func_82(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x34C8
{
...
void func_83(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, char* sParam5, int iParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x3500
{
	char* str;
	BOOL flag;
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x39AB
{
...
BOOL func_88(char* sParam0) // Position - 0x39C2
{
...
BOOL func_92(var uParam0, int iParam1) // Position - 0x3D7A
{
	if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
	{
...
int _GET_VEHICLE_SEAT_PED_IS_IN(var ped, int includeLastVehicle) // Position - 0x3DDC
{
	var unk;
	int num;
	int i;
...
void func_98(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0x3E9F
{
	var unk;
	int num;
	int num2;
...
BOOL func_100(var uParam0) // Position - 0x3FBF
{
...
BOOL func_107(var uParam0) // Position - 0x44E3
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
		if (unk_0x55B80B6E7AB61270(uParam0))
...
int func_109(var uParam0, BOOL bParam1, int iParam2) // Position - 0x454E
{
	iParam2 = iParam2;
	return func_110(uParam0, bParam1, false);
}

int func_110(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4563
{
...
void func_112(int iParam0, var uParam1, float fParam2, int iParam3, BOOL bParam4) // Position - 0x45DB
{
	int num;
	float num2;
	float num3;
...
float func_117(var uParam0, var uParam1, int iParam2) // Position - 0x4E18
{
	var unk;
	var unk4;
...
BOOL func_118(var uParam0, int iParam1) // Position - 0x4E76
{
	if (func_119(uParam0))
...
BOOL func_119(var uParam0) // Position - 0x4EA9
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x57D6
{
	if (iParam2 == -1)
		iParam2 = func_9();
...
{
	switch (func_164(&Global_33008, 0, 5, false, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return true;
...
BOOL func_171(var uParam0) // Position - 0x7269
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x9734
{
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_230() || Global_32951 || func_229() || func_62(8, -1) || func_226() || func_228() || func_227() || func_225() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_230() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_62(8, -1) || func_225() || func_224() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
...
void func_252(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB9D3
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
