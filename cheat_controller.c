...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (unk_0x76CD105BCAC6EB9F() && _NETWORK_IS_PLAYER_VALID(unk_0x259BE71D8A81D4FA(), true, true) && !Global_1836461 && Global_32948 == 0)
			func_113();
...
void func_31(int iParam0, BOOL bParam1) // Position - 0xBD2
{
	if (bParam1)
	{
		unk_0x0B0C9A0F9AAEB7F0(&Global_33198, iParam0);
		func_5(iParam0);
	}
	else
	{
		unk_0x8744D2E3FC95740E(&Global_33198, iParam0);
	}
...
BOOL func_106(int iParam0, int iParam1) // Position - 0x3BD8
{
	if (IS_BIT_SET(Global_33200, iParam0))
	{
		if (iParam1 != 0)
		{
			...
			{
				unk_0x8744D2E3FC95740E(&Global_33200, iParam0);
				bLocal_91 = true;
				return true;
			}
			else
