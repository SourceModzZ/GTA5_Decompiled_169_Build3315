...
int func_63(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x527E
{
	...
	if (iParam5 == 0)
	{
		Global_79172[1 /*14*/] = { func_115(num8, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79172[1 /*14*/] = { func_115(num8, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79172[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79172[1 /*14*/] = { func_115(num8, 14, unk18[j], -1) };
							func_83(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
							func_106(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_73(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_73(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_73(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79172[1 /*14*/] = { func_115(num8, i, func_72(uParam0, i, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79172[1 /*14*/] = { func_115(num8, 14, unk59[j], -1) };
			func_83(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
			func_106(14);
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_73(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_73(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_73(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
...
BOOL func_64(var uParam0, int iParam1, var uParam2) // Position - 0x5A8F
{
	...
	{
		if (!func_179(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_64, Global_113969.f_2366.f_539[num /*65*/].f_63))
		{
...
BOOL func_67(int iParam0, int iParam1, int iParam2) // Position - 0x5BF5
{
	if (iParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_69(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x5CFB
{
	var unk;
	int i;
...
BOOL func_70(int iParam0, int iParam1, int iParam2) // Position - 0x62FF
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_71(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x6398
{
	int num;
	...
	{
		if (!func_179(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_61, Global_113969.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
int func_72(var uParam0, int iParam1, int iParam2) // Position - 0x6443
{
	int i;
	int j;
...
int func_74(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x6594
{
	int num;
...
int func_75(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x689B
{
	int num;
	int num2;
	int num3;
...
BOOL func_79(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7A30
{
	int num;
...
BOOL func_80(int iParam0, int iParam1, var uParam2) // Position - 0x7A59
{
	*uParam2 = -99;
...
int func_81(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x7D23
{
	int num;
...
void func_83(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8105
{
	int num;
...
BOOL func_84(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x819F
{
	switch (iParam0)
	{
...
int func_88(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x878F
{
	int num;
	int num2;
	int num3;
...
int func_89(var uParam0, int iParam1) // Position - 0x888B
{
	int num;
...
BOOL func_100(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB75D
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_101(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB9DA
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_102(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xBDFF
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_103(var uParam0, int iParam1) // Position - 0xC0F3
{
	int num;
	var unk;
...
int func_104(var uParam0, int iParam1) // Position - 0xC13A
{
	int num;
	var unk;
	var unk2;
...
int func_105(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0xC19A
{
	int num;
	int num2;
	int num3;
...
void func_124(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x122B5
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_118(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_118(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_118(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_179(var uParam0, int iParam1, int iParam2) // Position - 0x235E4
{
	...
	num = unk_0x4B423FAA24E8ABF0(uParam0);
	Global_79172[1 /*14*/] = { func_115(num, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_179(uParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_179(uParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79172[2 /*14*/] = { func_115(num, 14, k, -1) };
								
									if (Global_79172[2 /*14*/].f_12 == j)
										if (func_179(uParam0, 14, k))
											if (!func_69(num, iParam2, 14, k, &unk, &Global_79172[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79172[2 /*14*/] = { func_115(num, i, num2, -1) };
					
						if (!func_69(num, iParam2, i, num2, &unk, &Global_79172[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79172[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_73(iParam1)) && Global_79172[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_73(iParam1)))
	{
		return true;
	}
	...
	if (Global_79644 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !unk_0x15CCE8886267624F())
			{
				...
				unk = { func_226(Global_79645, Global_79647, iParam10) };
				num4 == -0.014f;
...
BOOL func_286(var uParam0, int iParam1, int iParam2) // Position - 0x2C566
{
	...
	{
		unk28 = { func_96(num, 0) };
		Global_79172[1 /*14*/] = { func_115(num, iParam1, unk28[iParam1], -1) };
	
		if (unk_0x1A4EFE92822E3123(uParam0, func_73(iParam1)) > 0 && unk_0x8401C77F508D70FD(uParam0, func_73(iParam1), Global_79172[1 /*14*/].f_3) > 0)
			unk_0xD1C578C204015E1F(uParam0, func_73(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, 0);
	}
...
void func_291(int iParam0, int iParam1, int iParam2) // Position - 0x2C8A1
{
	...
	if (iParam0 != -1)
	{
		...
		func_292(&unk33, unk.f_3, Global_101570, iParam1, iParam2);
	}
...
BOOL func_338(char* sParam0, int iParam1, int iParam2) // Position - 0x323AA
{
	var unk;
	var unk2;
	int num;
...
int func_342(var uParam0, BOOL bParam1) // Position - 0x325E1
{
	int i;
...
void func_345(int iParam0) // Position - 0x326D3
{
