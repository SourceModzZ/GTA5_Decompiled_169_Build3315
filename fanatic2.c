...
BOOL func_79(var uParam0, int iParam1, int iParam2) // Position - 0x24E9
{
	...
	num = unk_0x4B423FAA24E8ABF0(uParam0);
	Global_79172[1 /*14*/] = { func_132(num, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_79172[1 /*14*/] = { func_132(num, iParam1, unk28[iParam1], -1) };
	
		if (unk_0x1A4EFE92822E3123(uParam0, func_124(iParam1)) > 0 && unk_0x8401C77F508D70FD(uParam0, func_124(iParam1), Global_79172[1 /*14*/].f_3) > 0)
			unk_0xD1C578C204015E1F(uParam0, func_124(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, 0);
	}
...
BOOL func_80(var uParam0, int iParam1, var uParam2) // Position - 0x26A6
{
	...
	{
		if (!func_196(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_64, Global_113969.f_2366.f_539[num /*65*/].f_63))
		{
...
int func_82(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x2782
{
	...
	if (iParam5 == 0)
	{
		Global_79172[1 /*14*/] = { func_132(num8, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79172[1 /*14*/] = { func_132(num8, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79172[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79172[1 /*14*/] = { func_132(num8, 14, unk18[j], -1) };
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							unk_0xD1C578C204015E1F(uParam0, func_124(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_124(i)));
						else
							unk_0xD1C578C204015E1F(uParam0, func_124(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79172[1 /*14*/] = { func_132(num8, i, func_88(uParam0, i, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79172[1 /*14*/] = { func_132(num8, 14, unk59[j], -1) };
			func_98(uParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
			func_114(14);
	...
	{
		if (iParam4 == -1)
			unk_0xD1C578C204015E1F(uParam0, func_124(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, unk_0xDAF263B0E792EAEC(uParam0, func_124(iParam1)));
		else
			unk_0xD1C578C204015E1F(uParam0, func_124(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
...
BOOL func_123(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0xA582
{
	int num;
	...
	{
		if (!func_196(uParam0, Global_113969.f_2366.f_539[num /*65*/].f_61, Global_113969.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
void func_126(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB00C
{
	int num;
	var unk;
	int num2;
...
BOOL func_139(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xF628
{
	int num;
	int num2;
	int num3;
...
void func_141(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF73A
{
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_135(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_135(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79370)
		{
			...
			func_135(&Global_79172[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
...
BOOL func_196(var uParam0, int iParam1, int iParam2) // Position - 0x20D90
{
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_196(uParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_196(uParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79172[2 /*14*/] = { func_132(num, 14, k, -1) };
								
									if (Global_79172[2 /*14*/].f_12 == j)
										if (func_196(uParam0, 14, k))
											if (!func_86(num, iParam2, 14, k, &unk, &Global_79172[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79172[2 /*14*/] = { func_132(num, i, num2, -1) };
					
						if (!func_86(num, iParam2, i, num2, &unk, &Global_79172[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79172[1 /*14*/].f_3 == unk_0xC0120BBCC298EA2F(uParam0, func_124(iParam1)) && Global_79172[1 /*14*/].f_4 == unk_0xD6AED6BFCC58AF7F(uParam0, func_124(iParam1)))
	{
		return true;
	}
...
void func_203(int iParam0, int iParam1, int iParam2) // Position - 0x215EC
{
	...
	if (iParam0 != -1)
	{
		...
		func_204(&unk33, unk.f_3, Global_101570, iParam1, iParam2);
	}
...
void func_281(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x29B3B
{
...
void func_286(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2A320
{
	float num;
...
void func_291(var uParam0, var uParam1, float fParam2, float fParam3, BOOL bParam4) // Position - 0x2A63A
{
	int num;
	float num2;
	float num3;
...
void func_292(var uParam0, var uParam1, BOOL bParam2, int iParam3, int iParam4) // Position - 0x2A793
{
	float num;
	float num2;
...
var func_293(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x2A865
{
	var unk;
...
void func_296(var uParam0, char* sParam1, int iParam2) // Position - 0x2A90A
{
	char* str;
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x2A9EB
{
	unk_0x39DCBE5519BD783A(message);
	return unk_0x7EBCD400E7DE179C(0);
}

void func_298(var uParam0, var uParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x2A9FE
{
	func_299(uParam0, uParam1, 0f, 0f, 0f, iParam2, iParam3, bParam4, bParam5, bParam6);
	return;
}

void func_299(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x2AA1B
{
	func_300(uParam0, uParam1, fParam2, iParam5, iParam6, bParam7, bParam8, bParam9);
	return;
}

void func_300(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x2AA39
{
...
void func_301(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, char* sParam5, int iParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x2AA71
{
	char* str;
	BOOL flag;
...
BOOL func_305(char* sParam0) // Position - 0x2AF25
{
...
BOOL func_309(var uParam0, int iParam1) // Position - 0x2B2DE
{
	if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
	{
...
int _GET_VEHICLE_SEAT_PED_IS_IN(var ped, int includeLastVehicle) // Position - 0x2B340
{
	var unk;
	int num;
	int i;
...
void func_316(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0x2B45A
{
	var unk;
	int num;
	int num2;
...
BOOL func_318(var uParam0) // Position - 0x2B57E
{
...
BOOL func_325(var uParam0) // Position - 0x2BAA0
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
BOOL func_330(int iParam0, BOOL bParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x2BDC1
{
	float num;
...
BOOL func_331(int iParam0, int iParam1) // Position - 0x2BE7C
{
	float num;
...
BOOL func_332(int iParam0, int iParam1) // Position - 0x2BEF2
{
	return func_333(iParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_333(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2BF0A
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_334(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0x2BFCB
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_335(var uParam0, int iParam1) // Position - 0x2C0F8
{
	int num;
...
BOOL func_337(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2C207
{
	var unk;
	var unk4;
	float num;
...
int func_341(var uParam0, var uParam1) // Position - 0x2C313
{
	int i;
...
BOOL func_343(var uParam0, int iParam1, int iParam2) // Position - 0x2C37A
{
	float num;
	Vector3 vector;
...
BOOL func_344(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2C3C1
{
	float num;
	float num2;
	int num3;
...
BOOL func_345(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2C4BC
{
	float num;
	float num2;
...
BOOL func_346(int iParam0, float fParam1) // Position - 0x2C5C8
{
	var unk;
	var unk2;
...
BOOL func_347(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x2C65D
{
	var unk;
	var unk4;
	float num;
...
BOOL func_348(int iParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0x2C6EB
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_349(var uParam0) // Position - 0x2C733
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_350(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6, int iParam7) // Position - 0x2C76B
{
	if (!unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
int func_356(int iParam0, int iParam1, int iParam2) // Position - 0x2CF11
{
	int num;
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x2D251
{
...
int func_361(int iParam0) // Position - 0x2D4FE
{
	iParam0 = iParam0;
	return 14;
}
...
void func_371(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12) // Position - 0x2E1EA
{
	int num;
	int i;
	...
	if (Global_79644 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !unk_0x15CCE8886267624F())
			{
				...
				unk = { func_432(Global_79645, Global_79647, iParam10) };
				num4 == -0.014f;
...
void func_451(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x33838
{
	func_27(uParam0);
...
void func_452(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5, int iParam6) // Position - 0x3387B
{
	func_30(uParam0);
...
BOOL func_453(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x3389C
{
...
BOOL func_454(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x338F8
{
	int num;
...
void func_465(var uParam0, BOOL bParam1) // Position - 0x33C8D
{
	if (bParam1)
		func_30(uParam0);
	else
...
BOOL func_470(char* sParam0, int iParam1, int iParam2) // Position - 0x33E62
{
	var unk;
	var unk2;
	int num;
