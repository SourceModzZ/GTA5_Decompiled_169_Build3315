...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DB1
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A49
{
	int i;
	float num;
	float num2;
...
void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8E52
{
...
BOOL func_136(var uParam0) // Position - 0xAD4A
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAD6A
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAEAE
{
	int i;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB04D
{
	if (bParam0)
	{
...
BOOL func_148(int iParam0) // Position - 0xB24E
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB270
{
...
int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB2BD
{
	int num;
...
BOOL func_154(var uParam0) // Position - 0xB33A
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB46D
{
...
void func_161(var uParam0) // Position - 0xB4C4
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_179(var uParam0, int iParam1) // Position - 0xBC9A
{
	int num;
	var unk;
	var unk33;
...
BOOL func_186(var uParam0) // Position - 0xC68F
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_195() || Global_32951 || func_194() || func_193(8, -1) || func_191() || func_101() || func_192() || func_190() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_195() || Global_113016 || Global_32951 || func_194() || func_193(8, -1) || func_101() || func_192() || func_190() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_195() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_193(8, -1) || func_190() || func_189() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_197(var uParam0, var uParam1, float fParam2, int iParam3) // Position - 0xCFA5
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD2BD
{
...
float func_206(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD358
{
	var unk;
...
void func_207(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD392
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_221(var uParam0) // Position - 0xDFF2
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_224(var uParam0, var uParam1) // Position - 0xE25B
{
	var unk;
...
BOOL func_227(var uParam0, int iParam1) // Position - 0xE57B
{
	float num;
...
BOOL func_228(var uParam0, int iParam1) // Position - 0xE5F1
{
	return func_229(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_229(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE609
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_230(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE6CA
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_231(var uParam0, int iParam1) // Position - 0xE7F6
{
	int num;
...
BOOL func_233(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE905
{
	var unk;
	var unk4;
	float num;
...
int func_237(var uParam0, var uParam1) // Position - 0xEA11
{
	int i;
...
int func_238(var uParam0) // Position - 0xEA50
{
...
BOOL func_239(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEA78
{
	float num;
	float num2;
	int num3;
...
BOOL func_240(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEB73
{
	float num;
	float num2;
...
BOOL func_241(var uParam0, float fParam1) // Position - 0xEC7F
{
	var unk;
	var unk2;
...
BOOL func_242(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xED14
{
	var unk;
	var unk4;
	float num;
...
BOOL func_243(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEDA2
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_245(var uParam0) // Position - 0xEE34
{
	var unk;
...
void func_257(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF30B
{
	func_258(uParam0);
...
void func_258(var uParam0) // Position - 0xF34E
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_259(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF3EA
{
...
BOOL func_260(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF446
{
	int num;
...
void func_287(var uParam0, BOOL bParam1) // Position - 0xFF55
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_290(var uParam0) // Position - 0xFFDF
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_293(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1006B
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_294(var uParam0) // Position - 0x100BB
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
int func_299(eCharacter echParam0) // Position - 0x10198
{
	if (!func_36(echParam0))
