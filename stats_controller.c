...
void func_2() // Position - 0xD7
{
	...
	if (!flag)
	{
		if (unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) || !unk_0x76CD105BCAC6EB9F() && !func_75(echLocal_57) || unk_0x3555462DB47B7AB1() || func_74() || unk_0xFD216000DC314A92() || unk_0x15CCE8886267624F() || !unk_0xE916D57851F785AB(unk_0x259BE71D8A81D4FA()) || Global_79387 || Global_98797 || bLocal_60)
		{
			bLocal_81 = true;
	...
	if (!unk_0x76CD105BCAC6EB9F() && unk_0x1DD05E817C89C737() - iLocal_55 > 2000 || unk_0x76CD105BCAC6EB9F() && unk_0xDBA141080166EAA2(unk_0x7E3F74F641EE6B27(), unk_0xAD5B43C219C4CB92(uLocal_56, 2000)) || bLocal_58)
	{
		...
		for (j = 0; j < num6; j = j + 1)
		{
			...
			if (unk_0x76CD105BCAC6EB9F())
				...
				num = Global_113969.f_2366.f_539.f_2387[echLocal_57];
			else
			...
			if (func_58(echLocal_57, num5, num, &num2))
			{
				...
				else if (num5 == 0)
				{
					...
					Global_113969.f_2366.f_539.f_2387[echLocal_57] = num2;
				}
				else
				{
...
BOOL func_9() // Position - 0x841
{
	...
	if (IS_BIT_SET(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_879, 16))
		return false;
	...
	if (IS_BIT_SET(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_879, 6))
		return false;
...
{
	return IS_BIT_SET(Global_1882632[iParam0 /*146*/].f_17, 0);
}
...
void func_56(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1746
{
	int num;
	...
	switch (iParam1)
	{
		...
		case 1:
			if (echParam0 == CHAR_MICHAEL)
			{
				...
				value = (num - Global_113969.f_2366.f_539.f_2355[echParam0]) / 175f;
			}
			else if (echParam0 == CHAR_FRANKLIN)
			{
		...
		case 2:
			if (echParam0 == CHAR_MICHAEL)
			{
				...
				value = SYSTEM::TO_FLOAT(value2 - Global_113969.f_2366.f_539.f_2359[echParam0]) / 20f;
			}
			else if (echParam0 == CHAR_FRANKLIN)
			{
		...
		case 4:
			if (echParam0 == CHAR_MICHAEL)
			{
				...
				value = value + (SYSTEM::TO_FLOAT(value2 - Global_113969.f_2366.f_539.f_2363[echParam0]) / 50f);
			}
			else if (echParam0 == CHAR_FRANKLIN)
			{
		...
		case 7:
			if (echParam0 == CHAR_MICHAEL)
			{
				...
				value = (num - Global_113969.f_2366.f_539.f_2367[echParam0]) / 45f;
			}
			else if (echParam0 == CHAR_FRANKLIN)
			{
			...
			if (echParam0 == CHAR_MICHAEL)
			{
				...
				value = value + ((SYSTEM::TO_FLOAT(value2 - Global_113969.f_2366.f_539.f_2371[echParam0]) / 2f) * 1.5f);
			}
			else if (echParam0 == CHAR_FRANKLIN)
			{
		...
		case 6:
			if (echParam0 == CHAR_MICHAEL)
			{
				...
				value3 = value3 - num4;
				value = SYSTEM::TO_FLOAT(num4 - Global_113969.f_2366.f_539.f_2375[echParam0]) / 40f;
				value = value + (SYSTEM::TO_FLOAT(value3 - Global_113969.f_2366.f_539.f_2379[echParam0]) / 80f);
			}
			else if (echParam0 == CHAR_FRANKLIN)
			{
...
var func_70(int iParam0, int iParam1) // Position - 0x2772
{
	...
	if (!bLocal_79)
	{
		...
		else
		{
			...
			if (Global_113969.f_2366.f_539.f_2280[echLocal_57] == 0)
				Global_113969.f_2366.f_539.f_2280[echLocal_57] = unk_0x39D1D336459711BE();
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x3576
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x35B3
{
...
int func_91(eCharacter echParam0) // Position - 0x35D8
{
...
BOOL func_97(int iParam0) // Position - 0x3856
{
	int i;
...
int func_98(int iParam0) // Position - 0x3888
{
	...
	{
		if (Global_1681225[i /*5*/].f_1 == iParam0)
		{
...
BOOL func_105(int iParam0) // Position - 0x3BF0
{
	if (!func_49(iParam0))
		return false;
