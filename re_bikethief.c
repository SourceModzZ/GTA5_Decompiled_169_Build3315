...
{
	switch (func_148(&Global_33008, 0, 5, false, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return true;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_218() || Global_32951 || func_217() || func_22(8, -1) || func_214() || func_216() || func_215() || func_213() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_218() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_22(8, -1) || func_213() || func_212() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
...
void func_230(int iParam0) // Position - 0x98CE
{
	...
	if (func_241())
	{
		...
		func_233(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_232(Global_113958, true), 64);
