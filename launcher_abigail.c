...
void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8E8E
{
...
BOOL func_136(var uParam0) // Position - 0xAD86
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xADA6
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAEEA
{
	int i;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB089
{
	if (bParam0)
	{
...
BOOL func_148(int iParam0) // Position - 0xB28A
{
	int num;
...
int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB2F9
{
	int num;
...
BOOL func_154(var uParam0) // Position - 0xB376
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB4A9
{
...
void func_161(var uParam0) // Position - 0xB500
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
int func_179(var uParam0, int iParam1) // Position - 0xBCD6
{
	int num;
	var unk;
	var unk33;
...
var func_182(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC1B4
{
	var unk;
...
BOOL func_190(var uParam0) // Position - 0xCC0D
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD553
{
...
float func_204(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD5EE
{
	var unk;
...
BOOL func_211(int iParam0, int iParam1) // Position - 0xDCEA
{
...
float func_217(var uParam0, var uParam1, int iParam2) // Position - 0xDF5C
{
	var unk;
	var unk4;
...
void func_218(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDFBA
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_232(var uParam0) // Position - 0xEC14
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_235(var uParam0, var uParam1) // Position - 0xEE7D
{
	var unk;
...
BOOL func_238(var uParam0, int iParam1) // Position - 0xF19D
{
	float num;
...
BOOL func_239(var uParam0, int iParam1) // Position - 0xF213
{
	return func_240(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_240(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF22B
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_241(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xF2EC
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_242(var uParam0, int iParam1) // Position - 0xF418
{
	int num;
...
BOOL func_244(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xF527
{
	var unk;
	var unk4;
	float num;
...
int func_248(var uParam0, var uParam1) // Position - 0xF633
{
	int i;
...
int func_249(var uParam0) // Position - 0xF672
{
...
BOOL func_250(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF69A
{
	float num;
	float num2;
	int num3;
...
BOOL func_251(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF795
{
	float num;
	float num2;
...
BOOL func_252(var uParam0, float fParam1) // Position - 0xF8A1
{
	var unk;
	var unk2;
...
BOOL func_253(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF936
{
	var unk;
	var unk4;
	float num;
...
BOOL func_254(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF9C4
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
void func_256(var uParam0) // Position - 0xFA56
{
	var unk;
...
void func_266(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFE9A
{
	func_267(uParam0);
...
void func_267(var uParam0) // Position - 0xFEDD
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_268(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFF79
{
...
BOOL func_269(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFFD5
{
	int num;
...
void func_296(var uParam0, BOOL bParam1) // Position - 0x10908
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_299(var uParam0) // Position - 0x10992
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_302(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10A1D
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_303(var uParam0) // Position - 0x10A6D
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
int func_308(eCharacter echParam0) // Position - 0x10B4A
{
	if (!func_36(echParam0))
