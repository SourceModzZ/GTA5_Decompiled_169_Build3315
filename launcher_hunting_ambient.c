				...
				case 3:
					...
					else
					{
						...
						if (!func_75(3) && !Global_101567)
						{
							...
							{
								if (!func_89(iLocal_92, 1) || !unk_0xFC8BFE4B41177C22(func_74()) && !Global_101567)
								{
									func_82(10);
									break;
								}
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_71() || Global_32951 || func_70() || func_56(8, -1) || func_67() || func_69() || func_68() || func_58() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
